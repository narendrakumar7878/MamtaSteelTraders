...
export default function GradeF92Flanges() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.07–0.13" },
    ...
    { element: "Molybdenum (Mo)", value: "0.30–0.60" },
    { element: "Tungsten (W)", value: "1.5–2.0" },
    { element: "Vanadium (V)", value: "0.15–0.25" },
    { element: "Nitrogen (N)", value: "0.03–0.07" },
  ];

  const applications = [
    "Ultra-Supercritical Thermal Plants",
    "Extreme-Stress Boiler Headers",
    "Nuclear Extraction Facilities",
    "Advanced Chemical Reactors",
    "High-Efficiency Turbine Piping",
    "Strategic Industrial Pressure Lines",
    "Advanced Material Gas Pipelines",
  ...
  return (
    <>
      <ProductSEO
        title="ASTM A182 F92 Alloy Steel Flanges Supplier Mumbai | Advanced Cr-Mo-W Forged Flanges India"
        description="Premium ultra-high-yield ASTM A182 F92 alloy steel forged flanges for the most demanding supercritical power service. Best prices in Mumbai. Standard sizes available from 1/2 to 60 inches. MTC provided for all orders."
        keywords="ASTM A182 F92 flanges, A182 F92 alloy steel flange price Mumbai, forged F92 flanges India, A182 F92 weld neck flange, F92 slip on flange, ultra supercritical boilers Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/alloy-steel/f92-flanges"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">ASTM A182 F92</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">Ultra-Supercritical Grade</span>
              </div>
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">ASTM A182 F92 Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                The pinnacle of high-temperature alloy technology. ASTM A182 F92 (9Cr-0.5Mo-2W) utilizes tungsten to achieve industry-leading creep rupture strength for ultra-efficient power generation systems.
              </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Elite Creep & Thermal Resilience</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for ultra-supercritical (USC) power plant cycles, the F92 grade represents the highest technological evolution in chromium-molybdenum alloys. It allows for higher operating temperatures and pressures, significantly increasing overall electrical generation efficiency.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium ASTM A182 F92 Flange Inventory</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">India's leading suppliers of certified F92 ultra-high performance alloy flanges. Strategic stock for national power infrastructure projects.</p>
