...
export default function GradeF12Flanges() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.05–0.15" },
    { element: "Manganese (Mn)", value: "0.30–0.60" },
    { element: "Phosphorus (P)", value: "0.045 max" },
    { element: "Sulfur (S)", value: "0.045 max" },
    { element: "Silicon (Si)", value: "0.50 max" },
    { element: "Chromium (Cr)", value: "0.80–1.25" },
    { element: "Molybdenum (Mo)", value: "0.44–0.65" },
  ];

  const applications = [
    "High Temperature Power Plants",
    "Pressure Vessel Nozzle Fabrication",
    "Refinery Cracking Units",
    "Heat Exchanger Shell Piping",
    "Steam Line Infrastructure",
    "Moderate Pressure Industrial Pipes",
    "Chemical Processing Vats",
    "Gas Liquefaction Components"
  ];

  return (
    <>
      <ProductSEO
        title="ASTM A182 F12 Alloy Steel Flanges Supplier Mumbai | 1Cr-0.5Mo Forged Flanges India"
        description="Premium ASTM A182 F12 alloy steel forged flanges for high-temperature pressure applications. Best prices in Mumbai. Standard sizes available from 1/2 to 60 inches. MTC provided for all orders."
        keywords="ASTM A182 F12 flanges, A182 F12 alloy steel flange price Mumbai, forged F12 flanges India, A182 F12 weld neck flange, F12 slip on flange, chromium-molybdenum alloy flanges Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/alloy-steel/f12-flanges"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">ASTM A182 F12</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">High-Temp Forging Grade</span>
              </div>
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">ASTM A182 F12 Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Proven reliability in thermal environments. ASTM A182 F12 offers consistent mechanical properties and resistance to scaling for medium-high temperature pressure systems.
              </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Reliable Thermal Integrity</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for medium high-temperature service, A182 F12 (1-Cr alloy) is slightly lower in chromium than F11 but offers excellent price-to-performance for various thermal power and chemical handling applications.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium ASTM A182 F12 Flange Inventory</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">Trusted stockists of certified chromium alloy flanges in India. We guarantee maximum durability and quality for all industrial orders.</p>
