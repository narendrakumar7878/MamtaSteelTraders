...
export default function GradeF2Flanges() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.05–0.21" },
    { element: "Manganese (Mn)", value: "0.30–0.80" },
    { element: "Phosphorus (P)", value: "0.040 max" },
    { element: "Sulfur (S)", value: "0.040 max" },
    { element: "Silicon (Si)", value: "0.10–0.50" },
    { element: "Chromium (Cr)", value: "0.50–0.81" },
    { element: "Molybdenum (Mo)", value: "0.44–0.65" },
  ];

  const applications = [
    "High Pressure Gas Transmission",
    "Moderate Temperature Petrochemical Systems",
    "Heat Exchanger Shell Piping",
    "Power Station Steam Cycles",
    "Industrial Boiler Connections",
    "Oil & Gas Pipeline Infrastructure",
    "Fertilizer Industry Equipment",
    "Chemical Plant Fluid Handling"
  ];

  return (
    <>
      <ProductSEO
        title="ASTM A182 F2 Alloy Steel Flanges Supplier Mumbai | High-Yield Forged Flanges India"
        description="Premium ASTM A182 F2 alloy steel forged flanges for high-pressure service. Best prices in Mumbai. Standard sizes available from 1/2 to 60 inches. MTC provided for all orders."
        keywords="ASTM A182 F2 flanges, A182 F2 alloy steel flange price Mumbai, forged F2 flanges India, A182 F2 weld neck flange, F2 slip on flange, high pressure alloy steel flanges Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/alloy-steel/f2-flanges"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">ASTM A182 F2</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">High Pressure Grade</span>
              </div>
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">ASTM A182 F2 Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Reinforced chromium-molybdenum alloy steel built for high-pressure durability. ASTM A182 F2 offers excellent mechanical properties for intermediate temperature service in industrial piping systems.
              </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Superior Strength & Weldability</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for high-stress applications, A182 F2 provides a balance of high tensile strength and ease of welding. It is perfectly suited for complex piping assemblies in power and chemical sectors.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium ASTM A182 F2 Flange Inventory</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">Leading stockists of certified A182 F2 flanges. We offer express delivery and complete technical documentation for all high-yield alloy projects.</p>
