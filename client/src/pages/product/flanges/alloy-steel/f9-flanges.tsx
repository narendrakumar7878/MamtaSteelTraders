...
export default function GradeF9Flanges() {
  const chemicalComposition = [
    ...
    { element: "Chromium (Cr)", value: "8.0–10.0" },
  ...
  return (
    <>
      <ProductSEO
        title="ASTM A182 F9 Alloy Steel Flanges Supplier Mumbai | 9Cr-1Mo Forged Flanges India"
        description="Premium ASTM A182 F9 alloy steel forged flanges for extreme temperature and abrasion resistance. Best prices in Mumbai. Standard sizes available from 1/2 to 60 inches. MTC provided for all orders."
        keywords="ASTM A182 F9 flanges, A182 F9 alloy steel flange price Mumbai, forged F9 flanges India, A182 F9 weld neck flange, F9 slip on flange, high temperature chromium-moly flanges India, Mamta Steel Traders"
        canonicalUrl="/product/flanges/alloy-steel/f9-flanges"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">ASTM A182 F9</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">Extreme Temperature Grade</span>
              </div>
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">ASTM A182 F9 Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Ultimate resilience in extreme environments. Featuring 9% chromium and 1% molybdenum, ASTM A182 F9 is designed for critical components that operate in severe thermal and corrosive conditions.
              </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Superior Thermal Performance</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    A182 F9 is often specified in place of lower chromium alloys when increased mechanical strength and resistance to hydrogen-induced stress are required. It is a premier forging choice for high-pressure boilers and refinery infrastructure.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium ASTM A182 F9 Flange Inventory</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">India's leading stockists of certified 9% chromium alloy flanges. We offer fast shipping from Mumbai and complete technical support.</p>
