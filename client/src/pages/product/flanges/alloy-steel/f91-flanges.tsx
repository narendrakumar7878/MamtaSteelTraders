...
export default function GradeF91Flanges() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.08–0.12" },
    { element: "Manganese (Mn)", value: "0.30–0.60" },
    { element: "Phosphorus (P)", value: "0.020 max" },
    { element: "Sulfur (S)", value: "0.010 max" },
    { element: "Silicon (Si)", value: "0.20–0.50" },
    { element: "Chromium (Cr)", value: "8.0–9.5" },
    { element: "Molybdenum (Mo)", value: "0.85–1.05" },
  ...
  const applications = [
    ...
    "Ultra-High Temperature Headers",
    "Pressure Vessel Forgings",
    "Nuclear Power Piping",
    "Chemical Synthesis Towers",
    "Gas Turbine Infrastructure",
  ...
  return (
    <>
      <ProductSEO
        title="ASTM A182 F91 Alloy Steel Flanges Supplier Mumbai | 9Cr-1Mo-V Forged Flanges India"
        description="Premium high-yield ASTM A182 F91 alloy steel forged flanges for supercritical power service. Best prices in Mumbai. Standard sizes available from 1/2 to 60 inches. MTC provided for all orders."
        keywords="ASTM A182 F91 flanges, A182 F91 alloy steel flange price Mumbai, forged F91 flanges India, A182 F91 weld neck flange, F91 slip on flange, supercritical alloy steel flanges Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/alloy-steel/f91-flanges"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">ASTM A182 F91</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">Advanced Supercritical Grade</span>
              </div>
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">ASTM A182 F91 Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Engineering excellence for the next generation of power. ASTM A182 F91 (modified 9Cr-1Mo) provides elite creep-strength and thermal fatigue resistance for supercritical steam service.
              </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Advanced Creep Resilience</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for supercritical and ultra-supercritical power plants, the F91 grade (T91 equivalent) offers significantly higher allowable stress at extreme temperatures. It minimizes wall thickness requirements and thermal stress in high-efficiency boiler headers.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium ASTM A182 F91 Flange Inventory</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">India's leading suppliers of certified F91 advanced alloy flanges. High precision forging and immediate supply from Mumbai stock.</p>
