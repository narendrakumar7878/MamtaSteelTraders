...
export default function GradeF1Flanges() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.28 max" },
  ...
  return (
    <>
      <ProductSEO
        title="ASTM A182 F1 Alloy Steel Flanges Supplier Mumbai | High-Temp Forged Flanges India"
        description="Premium ASTM A182 F1 alloy steel forged flanges for moderate temperature service. Best prices in Mumbai. Standard sizes available from 1/2 to 60 inches. MTC provided for all orders."
        keywords="ASTM A182 F1 flanges, A182 F1 alloy steel flange price Mumbai, forged F1 flanges India, A182 F1 weld neck flange, F1 slip on flange, moderate temperature alloy steel flanges Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/alloy-steel/f1-flanges"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">ASTM A182 F1</span>
            </nav>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-slate-900 via-navy-primary to-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">ASTM A182 F1 Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Carbon-molybdenum alloy steel for higher temperature applications. ASTM A182 F1 provides superior creep resistance and strength for critical boiling and steam systems.
              </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Creep Resistance & Durability</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for elevated temperature service, A182 F1 is an effective alloy for pressure systems that require resistance to creep and temperature-induced stress. It is a cost-effective alternative for moderate high-temp applications.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium ASTM A182 F1 Flange Inventory</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">Supplying certified A182 F1 flanges for mission-critical industrial systems. High precision manufacturing and immediate dispatch from Mumbai.</p>
