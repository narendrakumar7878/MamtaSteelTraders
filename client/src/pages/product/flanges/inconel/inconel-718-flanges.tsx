...
export default function Inconel718Flanges() {
  const chemicalComposition = [
    ...
    { element: "Molybdenum (Mo)", value: "2.80–3.30" },
  ...
  const applications = [
    ...
    "Rocket Motor Cases",
    "Downhole Oil Tools",
    "Fasteners & Space Hardware"
  ];

  return (
    <>
      <ProductSEO
        title="Inconel 718 Flanges Manufacturer Mumbai | ASTM B564 Nickel Alloy 718 Forged Flanges"
        description="Premium ASTM B564 Inconel 718 forged flanges manufacturer in Mumbai. Aerospace-grade age-hardenable superalloy with high strength and excellent weldability."
        keywords="Inconel 718 flanges, Alloy 718 flange price Mumbai, ASTM B564 Inconel 718 forged flanges, Inconel 718 slip on flange, Inconel 718 weld neck flange, aerospace superalloys Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/inconel/718"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">Elite Aerospace Superalloy</span>
              </div>
              ...
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Engineering for the edge of space. Inconel 718 (UNS N07718) is an age-hardenable nickel-chromium alloy, combining high strength and excellent corrosion resistance with superior weldability and post-weld cracking resistance.
              </p>
              <div className="flex gap-4">
                <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-10 py-3 rounded-xl font-bold transition-all shadow-xl">Contact Aerospace Hub</Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               <div className="bg-slate-950 p-8 rounded-2xl shadow-lg text-white">
                  <h3 className="text-xl font-bold mb-6 uppercase border-b border-gold-primary pb-2 inline-block italic font-bold tracking-tighter italic">Strategic Mission Controls</h3>
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Superior Fatigue & Rupture Life</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for high-performance aerospace and defense applications, Inconel 718 offers exceptional tensile and creep-rupture strength at temperatures from cryogenic levels up to 1300°F (700°C). Its unique chemistry provides premium resistance to strain-age cracking during welding.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Aerospace-Grade Inconel 718 Flanges</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">Mumbai's premier manufacturer of high-strength 718 forged flanges. Certified under ASTM B564 and defense standards for all India space and aviation projects.</p>
