...
export default function Inconel600Flanges() {
  ...
  const applications = [
    ...
    "High-Temp Furnace Components",
    "Gas Turbine Systems",
    "Vegetable Oil Fatty Acid Evaporators",
    "Pulp and Paper Industry",
    "Aeronautical Exhaust Systems"
  ];

  return (
    <>
      <ProductSEO
        title="Inconel 600 Flanges Manufacturer Mumbai | ASTM B564 Nickel Alloy 600 Forged Flanges"
        description="Premium ASTM B564 Inconel 600 forged flanges manufacturer in Mumbai. Excellent resistance to oxidation and stress-corrosion cracking up to 1100°C. High-quality superalloys."
        keywords="Inconel 600 flanges, Alloy 600 flange price Mumbai, ASTM B564 Inconel 600 forged flanges, Inconel 600 slip on flange, Inconel 600 weld neck flange, high temperature superalloys Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/inconel/600"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              ...
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Elite performance in thermal extremes. Inconel 600 (UNS N06600) is a nickel-chromium-iron superalloy designed for critical components requiring exceptional resistance to oxidation and stress-corrosion cracking at temperatures up to 1100°C.
              </p>
              <div className="flex gap-4">
                <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-10 py-3 rounded-xl font-bold transition-all shadow-xl">Request Technical Quote</Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               <div className="bg-slate-950 p-8 rounded-2xl shadow-lg text-white">
                  <h3 className="text-xl font-bold mb-6 uppercase border-b border-gold-primary pb-2 inline-block italic font-bold tracking-tighter italic">Aerospace & Industrial Uses</h3>
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Superior Thermal Stability</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for supercritical environments, Inconel 600 maintains high yield and tensile strength at cryogenic temperatures and through extreme heat gradients. Its versatility makes it the premier choice for aerospace engineering and nuclear power systems.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium Inconel 600 Inventory</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">Leading manufacturer of aerospace-grade nickel alloy forged flanges in Mumbai. Full technical documentation and PM testing certificates provided.</p>
