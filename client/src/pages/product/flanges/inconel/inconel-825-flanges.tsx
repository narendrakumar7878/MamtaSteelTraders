...
export default function Inconel825Flanges() {
  ...
  const applications = [
    "Acid Production Components",
    "Chemical Process Vessels",
    "Air Pollution Control Systems",
    "Nuclear Fuel Reprocessing",
    "Pickling Tank Equipment",
  ...
  return (
    <>
      <ProductSEO
        title="Inconel 825 Flanges Manufacturer Mumbai | ASTM B564 Nickel Alloy 825 Forged Flanges"
        description="Premium ASTM B564 Inconel 825 forged flanges manufacturer in Mumbai. Exceptional resistance to reducing and oxidizing acids (Sulfuric & Phosphoric). Best prices in India."
        keywords="Inconel 825 flanges, Alloy 825 flange price Mumbai, ASTM B564 Inconel 825 forged flanges, Inconel 825 slip on flange, Inconel 825 weld neck flange, acid resistant superalloys Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/inconel/825"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">Inconel 825</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">Superior Acid Resistance Grade</span>
              </div>
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">Inconel 825 Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Engineering for the corrosive. Inconel 825 (UNS N08825) is a nickel-iron-chromium-molybdenum-copper superalloy providing elite resistance to oxidizing and reducing environments, making it the premier choice for concentrated acid handling.
              </p>
              <div className="flex gap-4">
                <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-10 py-3 rounded-xl font-bold transition-all shadow-xl">Contact Chemical Specialists</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Elite Multi-Acid Protection</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for heavy-duty chemical processing and nuclear waste handle, Inconel 825 offers exceptional resistance to both sulfuric and phosphoric acids. Its unique chemistry provides premium protection against stress-corrosion cracking and localized pitting in aggressive halide-containing environments and marine industrial zones.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium Inconel 825 Forged Flanges</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">Leading manufacturer of high-corrosion 825 superalloy forged flanges in Mumbai. Expert technical documentation and all-India logistics for national chemical and nuclear projects.</p>
