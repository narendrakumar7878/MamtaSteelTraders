...
export default function Incoloy800Flanges() {
  ...
  return (
    <>
      <ProductSEO
        title="Incoloy 800 Flanges Manufacturer Mumbai | Nickel-Iron-Chromium Forged Flanges India"
        description="Premium ASTM B564 Incoloy 800 forged flanges manufacturer in Mumbai. Exceptional resistance to carburization and oxidation at high temperatures. Best prices in India. MTC provided."
        keywords="Incoloy 800 flanges, ASTM B564 Incoloy 800 flange price Mumbai, Ni-Fe-Cr alloy flanges India, Incoloy 800 slip on flange, Incoloy 800 weld neck flange, Mumbai incoloy alloy traders, Mamta Steel Traders"
        canonicalUrl="/product/flanges/nickel-alloy/incoloy-800"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">High-Temperature Structural Alloy</span>
              </div>
              ...
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Engineering for thermal stability. Incoloy 800 (Nickel-Iron-Chromium alloy) provides exceptional structural strength and resistance to carburization and oxidation in prolonged high-temperature service.
              </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Superior Oxidation Resilience</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for heavy-duty industrial processing, Incoloy 800 is engineered to maintain a stable austenitic structure during prolonged exposure to extreme heat. It provides significant resistance to sulfur-bearing atmospheres and remains the standard for modern high-temperature pressure vessel infrastructure.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium Incoloy 800 Flange Inventory</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">India's leading supplier of high-performance nickel iron chromium forged flanges. Strategic stock available in Mumbai for immediate global dispatch.</p>
