...
export default function Incoloy800HFlanges() {
  const chemicalComposition = [
    ...
    { element: "Carbon (C)", value: "0.05–0.10" },
  ...
  return (
    <>
      <ProductSEO
        title="Incoloy 800H Flanges Manufacturer Mumbai | ASTM B564 Nickel-Iron-Chromium 800H Forged Flanges"
        description="Premium ASTM B564 Incoloy 800H forged flanges manufacturer in Mumbai. Higher creep and rupture strength for high-temperature service up to 1100°C. Best prices."
        keywords="Incoloy 800H flanges, Alloy 800H flange price Mumbai, ASTM B564 Incoloy 800H forged flanges, Incoloy 800H slip on flange, Incoloy 800H weld neck flange, creep resistant superalloys Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/incoloy/800h"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">Incoloy 800H</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">High-Creep Rupture Grade</span>
              </div>
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">Incoloy 800H Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Engineering for the forge. Incoloy 800H (UNS N08810) is a controlled-chemistry version of Incoloy 800, specifically optimized for enhanced creep-rupture performance at temperatures above 1100°F (600°C).
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               <div className="bg-slate-950 p-8 rounded-2xl shadow-lg text-white">
                  <h3 className="text-xl font-bold mb-6 uppercase border-b border-gold-primary pb-2 inline-block italic font-bold tracking-tighter italic">Strategic Thermal Zones</h3>
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Enhanced Creep Resistance</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for supercritical environments, Incoloy 800H maintains superior creep and rupture life under long-term stress at extreme temperatures. Its unique dual-chemistry limits carbon and grain size to provide maximum stability in petrochemical crackers and power utility systems requiring zero-failure thermal integrity.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium Incoloy 800H Inventory</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">Leading manufacturer of high-creep 800H superalloy forged flanges in Mumbai. Full technical documentation and all-India express delivery available for critical furnace infrastructure.</p>
