...
export default function Incoloy800Flanges() {
  ...
  return (
    <>
      <ProductSEO
        title="Incoloy 800 Flanges Manufacturer Mumbai | ASTM B564 Nickel-Iron-Chromium 800 Forged Flanges"
        description="Premium ASTM B564 Incoloy 800 forged flanges manufacturer in Mumbai. High structural strength and resistance to carburization and oxidation at elevated temperatures."
        keywords="Incoloy 800 flanges, Alloy 800 flange price Mumbai, ASTM B564 Incoloy 800 forged flanges, Incoloy 800 slip on flange, Incoloy 800 weld neck flange, heat processing superalloys Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/incoloy/800"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">Incoloy 800</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">Chemical Processing Excellence</span>
              </div>
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">Incoloy 800 Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Engineering for endurance. Incoloy 800 (UNS N08800) is a nickel-iron-chromium superalloy designed for industrial components requiring high structural strength and resistance to carburization in long-term high-temperature service.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               <div className="bg-slate-950 p-8 rounded-2xl shadow-lg text-white">
                  <h3 className="text-xl font-bold mb-6 uppercase border-b border-gold-primary pb-2 inline-block italic font-bold tracking-tighter italic">Process Industry Shields</h3>
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for heavy-duty thermal processing and power generation, Incoloy 800 offers exceptional resistance to internal oxidation and carburization at temperatures up to 1500°F (815°C). It maintains premium structural integrity under long-term exposure to high-heat gradients and corrosive furnace gases.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">Premium Incoloy 800 Forged Flanges</h3>
