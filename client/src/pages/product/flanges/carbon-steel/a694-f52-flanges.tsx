...
export default function GradeA694F52Flanges() {
  ...
  return (
    <>
      <ProductSEO
        title="ASTM A694 F52 Carbon Steel Flanges Supplier Mumbai | High-Yield Pipe Flanges India"
        description="Premium high-yield ASTM A694 F52 carbon steel flanges. 360 MPa minimum yield strength for demanding transmission service. Best prices in Mumbai. All sizes available."
        keywords="ASTM A694 F52 flanges, A694 F52 flange price Mumbai, high yield carbon steel flange, F52 weld neck flange, F52 slip on flange, high pressure transmission flanges Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/carbon-steel/a694-f52-flanges"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">ASTM A694 F52</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">High Yield Grade (360 MPa min)</span>
              </div>
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">ASTM A694 F52 Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                Engineerered for high-pressure transmission networks. F52 provides improved yield strength (52 ksi), making it a cornerstone for modern oil and gas distribution infrastructure.
              </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Reliability at 52,000 PSI</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    Designed for heavy-duty transmission, the A694 F52 grade (360 MPa yield) is a critical component for high-pressure networks. It offers superior mechanical durability compared to standard A105.
                  </p>
               </div>
            </div>
          </div>
