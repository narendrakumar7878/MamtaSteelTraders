...
export default function GradeA694F70Flanges() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.26 max" },
    { element: "Manganese (Mn)", value: "1.40 max" },
    { element: "Phosphorus (P)", value: "0.025 max" },
    { element: "Sulfur (S)", value: "0.025 max" },
    { element: "Silicon (Si)", value: "0.15–0.35" },
  ];

  const applications = [
    "Ultra-High Pressure Gas Pipelines",
    "Critical Natural Gas Transmission",
    "Major Oil Infrastructure Hubs",
    "Extreme Service Off-shore Rigs",
    "High-Stress Structural Flange Joints",
    "Petrochemical Heavy-Wall Nozzles",
    "Strategic Industrial Fluid Lines",
    "Advanced Subsea Pipeline Systems"
  ];

  return (
    <>
      <ProductSEO
        title="ASTM A694 F70 Carbon Steel Flanges Supplier Mumbai | Highest Yield Flanges India"
        description="Premium ultra-high-yield ASTM A694 F70 carbon steel flanges. 485 MPa minimum yield strength for extreme industrial pressure systems. Leading stockists in Mumbai."
        keywords="ASTM A694 F70 flanges, A694 F70 flange price Mumbai, 70 ksi yield flange, F70 weld neck flange, F70 slip on flange, ultra high yield carbon steel Mumbai, Mamta Steel Traders"
        canonicalUrl="/product/flanges/carbon-steel/a694-f70-flanges"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">ASTM A694 F70</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <div className="flex items-center mb-6">
                 ...
                 <span className="text-gold-primary font-bold uppercase tracking-widest text-sm italic">Ultimate High Yield Grade (485 MPa min)</span>
              </div>
              <h1 className="text-5xl font-bold mb-4 uppercase italic tracking-tighter">ASTM A694 F70 Flanges</h1>
              <p className="text-xl text-blue-100 max-w-2xl mb-8 leading-relaxed font-light">
                The pinnacle of high-yield carbon steel forging technology. Developed for the most demanding ultra-high-pressure transmission lines where maximum strength-to-weight ratio is required.
              </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
               ...
               <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  <h3 className="text-lg font-bold text-navy-primary mb-4 uppercase">Maximum Yield Integrity</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    With an uncompromising 485 MPa (70 ksi) minimum yield strength, A694 F70 represents the highest strength grade in the series. Widely utilized in major international natural gas pipeline networks and deep-water offshore production.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-navy-primary rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <h3 className="text-3xl font-bold text-white mb-6 uppercase italic relative z-10">High Pressure Flange Inventory</h3>
             <p className="text-blue-100 mb-8 max-w-xl mx-auto italic relative z-10">Expert suppliers of A694 series flanges. We provide full technical documentation and MTC for all our high-yield carbon steel products in Mumbai and India.</p>
