...
export default function CarbonSteelA516PlatesDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "—", max: "0.23 - 0.27" },
    { element: "Manganese (Mn)", min: "0.60", max: "1.20" },
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength (MPa)", value: "485 - 620 (Gr 70)" },
    { property: "Yield Strength (MPa)", value: "260 (Min)" },
    { property: "Elongation (%)", value: "17% - 21%" },
    { property: "Charpy V-Notch (Test)", value: "Available at -46°C" },
    { property: "Impact Toughness", value: "High (Low Temperature Service)" },
  ];

  const equivalentGrades = [
    { country: "USA / ASTM", grade: "ASTM A516 Gr 70" },
    { country: "International", grade: "ASME SA516 Gr 70" },
    { country: "Germany / DIN", grade: "P355GH / 1.0473" },
    { country: "China / GB", grade: "Q345R" },
    { country: "Europe / EN", grade: "EN 10028-3" },
  ];

  const applications = [
    "Boiler Components & Drums",
    "Pressure Vessels & Storage Tanks",
    "Oil & Gas Processing Equipment",
    "Petrochemical Refineries",
    "Power House & Energy Plants",
  ...
  const specifications = [
    "ASTM A516 / A516M Grade 60/70",
    "ASME SA516 Grade 70",
    "NACE MR0175 / HIC Tested",
    "Thickness: 5mm to 150mm",
    "Finish: Rolled, Normalized, Vacuum Degassed",
    "Certifications: Mill Test Reports (ISO compliant)",
    "Origin: JSW, SAIL, Evonith, ArcelorMittal"
  ];

  return (
    <>
      <ProductSEO
        title="ASTM A516 Grade 70 Pressure Vessel Plates Supplier | Boiler Plates Mumbai"
        description="Premium ASTM A516 Gr 70 Carbon Steel Plates. Ideal for pressure vessels and boilers in low-temperature service. HIC Tested & NACE compliant options. Global exporter from Mumbai to UAE, USA, Saudi Arabia, and Europe."
        keywords="ASTM A516 Gr 70 plates, A516 Grade 60 supplier India, boiler quality steel plates Mumbai, pressure vessel steel ASTM A516, HIC tested steel plates price, A516 Gr 70 chemical composition, ASME SA516 Gr 70 plates stockist, wholesale boiler plates India"
        category="Plates & Sheets"
        productName="ASTM A516 Grade 70 Pressure Vessel Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/carbon-steel/a516-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4 font-sans font-sans">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 font-sans">
              <Link href="/" className="hover:text-amber-600 transition-colors font-sans font-sans font-sans">Home</Link>
              ...
              <ArrowRight className="w-4 h-4 font-sans" />
              <span className="text-amber-600 dark:text-amber-400 font-medium font-sans">ASTM A516 Grade 70</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center font-sans">
              <div className="font-sans">
                <div className="flex items-center mb-6 font-sans">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold font-sans">Boiler & Pressure Quality</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight font-sans">
                  ASTM A516 <span className="text-gold-primary">GR 70</span>
                  <span className="block text-2xl text-blue-200 font-normal mt-2 normal-case tracking-wide font-sans">Pressure Vessel Carbon Steel</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light font-sans font-sans">
                  Engineered for extreme performance. ASTM A516 Gr 70 is the premier choice for pressure vessels and industrial boilers where notch toughness is critical in moderate to lower temperature service.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 font-sans">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group font-sans">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform font-sans" /> Get BQ Quote
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center font-sans font-sans">
                    <Phone className="w-5 h-5 mr-3 font-sans" /> Technical Data
                  </a>
                </div>
              </div>
              <div className="relative group font-sans">
                <div className="absolute -inset-1 bg-gradient-to-r from-gold-primary to-amber-600 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 font-sans"></div>
                <img src={ss_plate_img} alt="ASTM A516 Grade 70 Boiler Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px] font-sans" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md font-sans">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest font-sans">Certified Stockist</p>
                  <p className="text-white font-black text-xl italic uppercase font-sans font-sans">HIC TESTED • NACE MR0175</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 font-sans">
          <div className="max-w-7xl mx-auto font-sans">
            <div className="grid lg:grid-cols-3 gap-12 mb-16 font-sans">
              <div className="lg:col-span-2 space-y-12 font-sans font-sans">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300 font-sans">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase tracking-tighter font-sans">
                    Grade Overview: ASTM A516 Gr 70
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light font-sans font-sans">
                    ASTM A516 Grade 70 is an excellent choice for service in applications lower than ambient temperature. It has excellent notch toughness and is used in both pressure vessels and industrial boilers. Grade 70 offers higher tensile and yield strength when compared to ASTM A516 Grade 60. For projects requiring resistance to Hydrogen Induced Cracking (HIC) and Sulfide Stress Cracking (SSC), we offer NACE MR0175 and HIC Tested plates as per specialized customer requirements. This makes it a standard for the petrochemical, energy, and refining sectors globally.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6 font-sans">
                    <div className="p-6 bg-amber-50 dark:bg-amber-900/20 rounded-xl border-t-4 border-amber-800 font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-amber-400 uppercase text-xs mb-2 tracking-widest font-sans font-sans">Boiler Quality</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans font-sans">Specifically rolled for pressure-retaining components and drums.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-xs mb-2 tracking-widest font-sans font-sans">NACE Compliant</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans font-sans">Options for sour service and highly corrosive gas environments.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900 font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-xs mb-2 tracking-widest font-sans font-sans">Low-Temp Toughness</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans font-sans">Maintains structural integrity at temperatures down to -46°C.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8 font-sans font-sans font-sans">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group font-sans">
                  ...
                  <h3 className="text-2xl font-bold mb-8 uppercase border-b-2 border-gold-primary pb-2 inline-block tracking-widest font-sans">Inventory Scope</h3>
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm font-sans font-sans">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold font-sans">Standard Thickness</p>
                    <p className="text-4xl font-black text-gold-primary italic font-sans">5.0 – 150mm</p>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans font-sans font-sans">
                  <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-navy-primary pb-2 inline-block tracking-widest font-sans font-sans">Equivalent Standards</h3>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans">
                   <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-amber-600 pb-2 inline-block tracking-widest font-sans">Technical Performance</h3>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group font-sans">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase relative z-10 tracking-widest font-sans font-sans">Mill Direct Quality • Global Boiler Specialist</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light font-sans font-sans">Mamta Steel Traders provides mill-certified ASTM A516 Gr 70 plates with full traceability. We specialize in large-format boiler quality plates exported directly from Mumbai to major global oil & gas hubs including UAE, Qatar, Saudi Arabia, USA and South America. HIC and sour service testing available upon request.</p>
