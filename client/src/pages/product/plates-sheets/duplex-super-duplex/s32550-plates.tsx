...
export default function DuplexS32550PlatesDetail() {
  const chemicalComposition = [
    { element: "Chromium (Cr)", min: "24.00", max: "27.00" },
    { element: "Nickel (Ni)", min: "4.50", max: "6.50" },
    { element: "Molybdenum (Mo)", min: "2.90", max: "3.90" },
    { element: "Copper (Cu)", min: "1.50", max: "2.50" },
    { element: "Nitrogen (N)", min: "0.10", max: "0.25" },
    { element: "Manganese (Mn)", min: "—", max: "1.50" },
    { element: "Silicon (Si)", min: "—", max: "1.00" },
    { element: "Carbon (C)", min: "—", max: "0.04" },
    { element: "Iron (Fe)", min: "Remainder", max: "—" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa)", value: "760 (Min)" },
    { property: "Yield Strength (MPa)", value: "550 (Min)" },
    { property: "Elongation (%)", value: "15% (Min)" },
    { property: "Hardness (Brinell)", value: "270 (Typ)" },
    { property: "PREN", value: "≥ 38" },
  ];

  const equivalentGrades = [
    { country: "UNS Number", grade: "UNS S32550" },
    { country: "EN Standard", grade: "1.4507" },
    { country: "Common Name", grade: "Ferralium 255" },
    { country: "DIN", grade: "X2CrNiMoCuN25-6-3" },
    { country: "ASTM", grade: "F61" },
  ];
  ...
  const specifications = [
    ...
    "Finish: No.1 (Hot Rolled)",
    "Origin: Langley Alloys, Outokumpu, Jindal"
  ];

  return (
    <>
      <ProductSEO
        title="UNS S32550 Ferralium 255 Plates Supplier | Super Duplex Price"
        description="Certified UNS S32550 (Ferralium 255) Super Duplex Plates supplier in Mumbai. Specialized in high-corrosion resistant marine grade steel. High copper content for enhanced pitting resistance. Wholesale prices for global export."
        keywords="UNS S32550 plates, Ferralium 255 supplier, S32550 price India, super duplex F61 plates, S32550 chemical composition, marine grade super duplex Mumbai, ASTM A240 F61, Ferralium 255 stockist"
        category="Plates & Sheets"
        productName="UNS S32550 / Ferralium 255 Super Duplex Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/duplex-super-duplex/s32550-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-sans">
          <div className="container mx-auto px-4 py-4 font-sans font-sans">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 font-sans">
              ...
              <ArrowRight className="w-4 h-4 font-sans" />
              <Link href="/product/plates-sheets/duplex-super-duplex" className="hover:text-blue-600 transition-colors font-sans font-sans font-sans">Duplex & Super Duplex</Link>
              <ArrowRight className="w-4 h-4 font-sans" />
              <span className="text-blue-600 dark:text-blue-400 font-medium font-sans">S32550 Plates</span>
            </nav>
          </div>
        </div>

        <div className="container mx-auto px-4 py-6 font-sans">
          <Link href="/product/plates-sheets/duplex-super-duplex" className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:underline font-semibold group font-sans">
            <ArrowLeft className="w-5 h-5 mr-2 group-hover:-translate-x-1 transition-transform font-sans" />
            Back to Duplex & Super Duplex Plates
          </Link>
        </div>

        <div className="bg-gradient-to-br from-orange-950 via-orange-900 to-amber-950 text-white relative overflow-hidden shadow-2xl font-sans font-sans">
          <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/weave.png')] font-sans"></div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center font-sans">
              <div className="font-sans">
                <div className="flex items-center mb-6 font-sans">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold font-sans">Pitting Resistance Specialist</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight font-sans">
                  UNS S32550
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide font-sans">Ferralium 255 Super Duplex Plates</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light font-sans font-sans">
                  The original 25% Cr super duplex. Ferralium 255 (S32550) is unique for its high copper content, providing increased resistance to pitting and crevice corrosion in marine environments.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 font-sans">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group font-sans">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform font-sans" /> Request Ferralium Quote
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center font-sans font-sans">
                    <Phone className="w-5 h-5 mr-3 font-sans" /> Technical Material Advisory
                  </a>
                </div>
              </div>
              <div className="relative group font-sans">
                <div className="absolute -inset-1 bg-gradient-to-r from-orange-400 to-amber-600 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 font-sans"></div>
                <img src={ss_plate_img} alt="UNS S32550 Ferralium Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px] font-sans" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md font-sans">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest font-sans">Copper-Enhanced Alloy</p>
                  <p className="text-white font-black text-xl italic uppercase font-sans font-sans">MARINE • NAVAL • PUMPS</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto font-sans font-sans">
            <div className="grid lg:grid-cols-3 gap-12 mb-16 font-sans font-sans font-sans">
              <div className="lg:col-span-2 space-y-12 font-sans font-sans">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300 font-sans font-sans">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase tracking-tighter font-sans">
                    Grade Overview: UNS S32550 / Ferralium 255
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light font-sans font-sans">
                    UNS S32550, commonly known as Ferralium 255, is a 25% chromium super duplex stainless steel. It is distinguished from other super duplex alloys by its relatively high copper content (about 2.0%), which significantly improves corrosion resistance in various acids and sea water. It provides high strength and excellent resistance to erosion-corrosion and cavitation, making it a preferred choice for high-velocity marine components.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6 font-sans font-sans font-sans">
                    <div className="p-6 bg-orange-50 dark:bg-orange-900/20 rounded-xl border-t-4 border-orange-700 font-sans">
                      <Factory className="w-8 h-8 text-orange-700 mb-4 font-sans" />
                      <h4 className="font-bold text-navy-primary dark:text-orange-400 uppercase text-xs mb-2 tracking-widest font-sans">Enhanced Pitting PR</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Copper addition provides superior resistance to pitting in warm seawater.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-xs mb-2 tracking-widest font-sans font-sans">Erosion Shield</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Excellent resistance to cavitation and erosion-corrosion.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900 font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-xs mb-2 tracking-widest font-sans font-sans">Ultra-High Strength</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">High yield strength allows for significant component weight reduction.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans font-sans font-sans">
                  ...
                  <div className="overflow-x-auto font-sans">
                    <table className="w-full border-collapse font-sans font-sans font-sans">
                      <thead>
                        <tr className="bg-orange-800 text-white font-sans font-sans">
              ...
              <div className="space-y-8 font-sans font-sans">
                <div className="bg-orange-900 rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group font-sans">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm font-sans">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold font-sans">Max Thickness</p>
                    <p className="text-4xl font-black text-gold-primary italic font-sans font-sans">Up to 80mm</p>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans font-sans">
                  <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-navy-primary pb-2 inline-block tracking-widest font-sans font-sans font-sans">Global Standards</h3>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans">
                   <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-orange-600 pb-2 inline-block tracking-widest font-sans font-sans font-sans">Mechanical Data</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700 font-sans">
              <div className="flex items-center mb-10 font-sans font-sans">
                ...
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 tracking-tighter italic font-sans font-sans">Technical Applications</h3>
              </div>
            ...
            <div className="text-center bg-orange-950 p-16 rounded-3xl shadow-2xl relative overflow-hidden group font-sans">
               <div className="absolute inset-0 bg-gradient-to-r from-amber-600/20 to-transparent group-hover:opacity-75 transition-opacity duration-1000 font-sans"></div>
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase relative z-10 tracking-widest font-sans font-sans">Global Marine Supply • Ferralium 255</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light font-sans font-sans">As a leading stockist, Mamta Steel Traders provides genuine Ferralium 255 (S32550) plates for demanding naval and offshore projects. We offer specialized testing services including G48 testing to verify pitting resistance. Expert supply to international shipyards and petrochemical giants.</p>
              <div className="flex flex-col sm:flex-row gap-8 justify-center relative z-10 font-sans">
                ...
                <a href="tel:+919819322576" className="bg-white hover:bg-slate-100 text-navy-primary px-12 py-5 rounded-2xl font-black transition-all shadow-2xl hover:scale-110 flex items-center justify-center uppercase tracking-widest font-sans font-sans font-sans">
                  <Phone className="w-5 h-5 mr-3 font-sans font-sans" /> Consultancy
                </a>
              </div>
            </div>
          </div>
