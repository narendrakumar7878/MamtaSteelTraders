...
export default function DuplexS31803PlatesDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "—", max: "0.03" },
    { element: "Chromium (Cr)", min: "21.00", max: "23.00" },
    { element: "Nickel (Ni)", min: "4.50", max: "6.50" },
    { element: "Molybdenum (Mo)", min: "2.50", max: "3.50" },
    { element: "Manganese (Mn)", min: "—", max: "2.00" },
    { element: "Silicon (Si)", min: "—", max: "1.00" },
    { element: "Nitrogen (N)", min: "0.08", max: "0.20" },
    { element: "Phosphorus (P)", min: "—", max: "0.03" },
    { element: "Sulfur (S)", min: "—", max: "0.02" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa)", value: "620 (Min)" },
    { property: "Yield Strength (MPa)", value: "450 (Min)" },
    { property: "Elongation (%)", value: "25% (Min)" },
    { property: "Hardness (Brinell)", value: "293 (Max)" },
    { property: "PREN", value: "33 - 35" },
  ];

  const equivalentGrades = [
    { country: "UNS Number", grade: "UNS S31803" },
    { country: "EN Standard", grade: "1.4462" },
    { country: "Common Name", grade: "2205 Duplex" },
    { country: "DIN", grade: "X2CrNiMoN22-5-3" },
    { country: "AFNOR", grade: "Z3 CND 22.05 Az" },
  ];
  ...
  const specifications = [
    ...
    "Origin: SAIL, JSW, Jindal, Outokumpu, Aperam"
  ];

  return (
    <>
      <ProductSEO
        title="UNS S31803 Duplex Steel Plates Supplier | 2205 Plate Price"
        description="Premium UNS S31803 Duplex Stainless Steel Plates supplier in Mumbai. High-performance 2205 duplex plates for oil, gas, and chemical industries. ASTM A240 certified. Best wholesale prices for S31803 sheets in India."
        keywords="UNS S31803 plates, 2205 duplex steel sheet supplier, S31803 price India, duplex 2205 chemical composition, S31803 properties, standard duplex steel Mumbai, ASTM A240 S31803, industrial duplex plates"
        category="Plates & Sheets"
        productName="UNS S31803 Duplex Steel Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/duplex-super-duplex/s31803-plates"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-sans">
          <div className="container mx-auto px-4 py-4 font-sans font-sans">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 font-sans">
              ...
              <ArrowRight className="w-4 h-4 font-sans" />
              <Link href="/product/plates-sheets/duplex-super-duplex" className="hover:text-blue-600 transition-colors font-sans font-sans">Duplex & Super Duplex</Link>
              <ArrowRight className="w-4 h-4 font-sans" />
              <span className="text-blue-600 dark:text-blue-400 font-medium font-sans">S31803 Plates</span>
            </nav>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-indigo-950 via-navy-primary to-slate-900 text-white relative overflow-hidden shadow-2xl font-sans font-sans">
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center font-sans">
              <div className="font-sans">
                <div className="flex items-center mb-6 font-sans">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold font-sans">Standard Industry Grade</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight font-sans">
                  UNS S31803
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide font-sans">Standard Duplex Steel Plates</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light font-sans font-sans">
                  The workhorse of the duplex family. UNS S31803 (2205) provides a cost-effective balance of high strength and excellent corrosion resistance for hundreds of industrial applications.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 font-sans">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group font-sans">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform font-sans" /> Get Inventory Quote
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center font-sans font-sans">
                    <Phone className="w-5 h-5 mr-3 font-sans" /> Sales Advisory
                  </a>
                </div>
              </div>
              <div className="relative group font-sans">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-navy-secondary rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 font-sans"></div>
                <img src={ss_plate_img} alt="UNS S31803 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px] font-sans" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md font-sans">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest font-sans">Dual Phase Excellence</p>
                  <p className="text-white font-black text-xl italic uppercase font-sans font-sans">OIL & GAS • CHEMICAL</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto font-sans font-sans">
            <div className="grid lg:grid-cols-3 gap-12 mb-16 font-sans font-sans font-sans">
              <div className="lg:col-span-2 space-y-12 font-sans font-sans">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300 font-sans font-sans">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase tracking-tighter font-sans">
                    Grade Overview: UNS S31803
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light font-sans font-sans">
                    UNS S31803 is the original specification for 22% Cr duplex stainless steel. It features a micro-structure that consists of roughly equal parts of austenite and ferrite. This "dual phase" structure provides a significant improvement in strength over austenitic grades like 316L, while offering superior resistance to stress corrosion cracking and pitting. It is the most widely utilized duplex grade globally.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6 font-sans font-sans font-sans">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-xs mb-2 tracking-widest font-sans">High Yield Strength</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Yield strength is nearly twice that of conventional stainless steels.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-xs mb-2 tracking-widest font-sans font-sans">Corrosion Resistance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Outstanding performance in organic and inorganic acids.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900 font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-xs mb-2 tracking-widest font-sans font-sans">Cost Efficiency</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Lower nickel content makes it more price-stable than high-austenite alloys.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8 font-sans font-sans">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group font-sans">
                  ...
                  <h3 className="text-2xl font-bold mb-8 uppercase border-b-2 border-gold-primary pb-2 inline-block tracking-widest font-sans">Product Range</h3>
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm font-sans">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold font-sans">Available Thickness</p>
                    <p className="text-4xl font-black text-gold-primary italic font-sans font-sans">2.0 – 150mm</p>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans font-sans">
                  <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-navy-primary pb-2 inline-block tracking-widest font-sans font-sans font-sans">Industry Standards</h3>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans">
                   <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-blue-600 pb-2 inline-block tracking-widest font-sans font-sans font-sans">Mechanical Data</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700 font-sans">
              <div className="flex items-center mb-10 font-sans font-sans">
                ...
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 tracking-tighter italic font-sans font-sans">Common Applications</h3>
              </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group font-sans">
               <div className="absolute inset-0 bg-gradient-to-r from-blue-700/20 to-transparent group-hover:opacity-75 transition-opacity duration-1000 font-sans"></div>
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase relative z-10 tracking-widest font-sans font-sans">Ready-to-Ship Inventory</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light font-sans font-sans">Mamta Steel Traders maintains a comprehensive stock of S31803 duplex plates in all standard dimensions. We offer precision profile cutting (Plasma/Laser) to meet your exact project requirements. Immediate dispatch across India and overseas.</p>
              <div className="flex flex-col sm:flex-row gap-8 justify-center relative z-10 font-sans">
                ...
                <a href="tel:+919819322576" className="bg-white hover:bg-slate-100 text-navy-primary px-12 py-5 rounded-2xl font-black transition-all shadow-2xl hover:scale-110 flex items-center justify-center uppercase tracking-widest font-sans font-sans font-sans">
                  <Phone className="w-5 h-5 mr-3 font-sans font-sans" /> Expert Consultation
                </a>
              </div>
            </div>
          </div>
