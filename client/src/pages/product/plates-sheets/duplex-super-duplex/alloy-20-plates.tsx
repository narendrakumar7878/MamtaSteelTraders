...
export default function Alloy20PlatesDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", min: "32.00", max: "38.00" },
    { element: "Chromium (Cr)", min: "19.00", max: "21.00" },
    ...
    { element: "Copper (Cu)", min: "3.00", max: "4.00" },
    { element: "Columbium + Tantalum", min: "8xC", max: "1.00" },
    { element: "Iron (Fe)", min: "Remainder", max: "—" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa)", value: "550 (Min)" },
    { property: "Yield Strength (MPa)", value: "240 (Min)" },
    { property: "Elongation (%)", value: "30% (Min)" },
    { property: "Hardness (Rockwell B)", value: "95 (Max)" },
    { property: "Density (g/cm³)", value: "8.08" },
  ];

  const equivalentGrades = [
    { country: "UNS Number", grade: "UNS N08020" },
    { country: "EN Standard", grade: "2.4660" },
    { country: "ASTM", grade: "Alloy 20" },
    { country: "DIN", grade: "NiCr20CuMo" },
    { country: "Common Name", grade: "Carpenter 20 / 20Cb-3" },
  ];

  const applications = [
    "Sulfuric Acid Pickling Tanks",
    "Chemical and Petrochemical Processing",
    "Food and Dye Production",
    "Pharmaceutical Manufacturing",
    "Heat Exchangers & Mixing Tanks",
  ...
  const specifications = [
    ...
    "Finish: 2B, HR (No.1), BA",
    "Origin: VDM, Haynes, Carpenter, Special Metals"
  ];

  return (
    <>
      <ProductSEO
        title="Alloy 20 Plates Supplier | N08020 Sheets Price India"
        description="Leading Alloy 20 (UNS N08020) Plates supplier in Mumbai. Specialized in sulfuric acid resistant plates and sheets. High-quality Carpenter 20 material with Mill Test Certificates. Wholesale prices for industrial chemical processing."
        keywords="Alloy 20 plates, UNS N08020 supplier, Alloy 20 sheet price India, Carpenter 20 chemical composition, sulfuric acid resistant plates, Alloy 20 properties, Alloy 20 distributor Mumbai, ASTM B463 plates"
        category="Plates & Sheets"
        productName="Alloy 20 / UNS N08020 Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/duplex-super-duplex/alloy-20-plates"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-sans">
          <div className="container mx-auto px-4 py-4 font-sans font-sans">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 font-sans">
              ...
              <ArrowRight className="w-4 h-4 font-sans" />
              <Link href="/product/plates-sheets/duplex-super-duplex" className="hover:text-blue-600 transition-colors font-sans">Duplex & Super Duplex</Link>
              <ArrowRight className="w-4 h-4 font-sans" />
              <span className="text-blue-600 dark:text-blue-400 font-medium font-sans">Alloy 20 Plates</span>
            </nav>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-emerald-900 via-green-900 to-teal-950 text-white relative overflow-hidden shadow-2xl font-sans font-sans">
          <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/circuit-board.png')] font-sans"></div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center font-sans">
              <div className="font-sans">
                <div className="flex items-center mb-6 font-sans">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold font-sans">Acid Resistant Specialist</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight font-sans">
                  Alloy 20 / N08020
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide font-sans">Nickel-Alloy Plates & Sheets</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light font-sans font-sans">
                  Superior resistance to sulfuric acid and stress corrosion cracking. Alloy 20 is a "super-austenitic" nickel-chromium-molybdenum alloy developed for maximum corrosion resistance in challenging chemical environments.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 font-sans">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group font-sans">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform font-sans" /> Request Alloy 20 Quote
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center font-sans font-sans">
                    <Phone className="w-5 h-5 mr-3 font-sans" /> Contact Engineering
                  </a>
                </div>
              </div>
              <div className="relative group font-sans">
                <div className="absolute -inset-1 bg-gradient-to-r from-green-400 to-teal-600 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 font-sans"></div>
                <img src={ss_plate_img} alt="Alloy 20 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px] font-sans" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md font-sans">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest font-sans">Sulfuric Acid Grade</p>
                  <p className="text-white font-black text-xl italic uppercase font-sans font-sans">CHEMICAL • PHARMA</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto font-sans font-sans">
            <div className="grid lg:grid-cols-3 gap-12 mb-16 font-sans font-sans font-sans">
              <div className="lg:col-span-2 space-y-12 font-sans font-sans">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300 font-sans font-sans">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase tracking-tighter font-sans">
                    Grade Overview: Alloy 20 / N08020
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light font-sans font-sans">
                    Alloy 20 (UNS N08020) is a nickel-chromium-molybdenum alloy that was initially developed for use in sulfuric acid environments. It provides excellent resistance to general corrosion, pitting, and crevice corrosion in chemicals containing chlorides and sulfuric, phosphoric, and nitric acids. It also contains niobium for stabilization against sensitization and resultant intergranular corrosion.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6 font-sans font-sans font-sans">
                    <div className="p-6 bg-green-50 dark:bg-green-900/20 rounded-xl border-t-4 border-green-700 font-sans">
                      <Factory className="w-8 h-8 text-green-700 mb-4 font-sans" />
                      <h4 className="font-bold text-navy-primary dark:text-green-400 uppercase text-xs mb-2 tracking-widest font-sans">Acid Resistance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Specifically optimized for boiling sulfuric acid resistance.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-xs mb-2 tracking-widest font-sans font-sans">SCC Immunity</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Immune to chloride-induced stress corrosion cracking.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900 font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-xs mb-2 tracking-widest font-sans font-sans">Stabilized Grade</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Columbium stabilized to prevent intergranular corrosion after welding.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans font-sans font-sans">
                  ...
                  <div className="overflow-x-auto font-sans">
                    <table className="w-full border-collapse font-sans font-sans font-sans">
                      <thead>
                        <tr className="bg-green-700 text-white font-sans font-sans">
              ...
              <div className="space-y-8 font-sans font-sans">
                <div className="bg-green-800 rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group font-sans">
                  ...
                  <h3 className="text-2xl font-bold mb-8 uppercase border-b-2 border-gold-primary pb-2 inline-block tracking-widest font-sans">Product Dimensions</h3>
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm font-sans">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold font-sans">Standard Width</p>
                    <p className="text-4xl font-black text-gold-primary italic font-sans font-sans">1000 – 2500mm</p>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans font-sans">
                  <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-navy-primary pb-2 inline-block tracking-widest font-sans font-sans font-sans">Global Identifiers</h3>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans">
                   <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-emerald-600 pb-2 inline-block tracking-widest font-sans font-sans font-sans">Typical Properties</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700 font-sans">
              <div className="flex items-center mb-10 font-sans font-sans">
                ...
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 tracking-tighter italic font-sans font-sans">Primary Industries</h3>
              </div>
            ...
            <div className="text-center bg-green-900 p-16 rounded-3xl shadow-2xl relative overflow-hidden group font-sans">
               <div className="absolute inset-0 bg-gradient-to-r from-teal-600/20 to-transparent group-hover:opacity-75 transition-opacity duration-1000 font-sans"></div>
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase relative z-10 tracking-widest font-sans font-sans">Strategic Distribution • Chemical Excellence</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light font-sans font-sans">Mamta Steel Traders stocks prime Alloy 20 materials with full chemical traceability. We cater to critical sulfuric acid handling projects, offering custom sizing and rapid dispatch from our Mumbai facility. Global supply network covering Southeast Asia and the Middle East.</p>
              <div className="flex flex-col sm:flex-row gap-8 justify-center relative z-10 font-sans">
                ...
                <a href="tel:+919819322576" className="bg-white hover:bg-slate-100 text-navy-primary px-12 py-5 rounded-2xl font-black transition-all shadow-2xl hover:scale-110 flex items-center justify-center uppercase tracking-widest font-sans font-sans font-sans">
                  <Phone className="w-5 h-5 mr-3 font-sans font-sans" /> Speak to Consultant
                </a>
              </div>
            </div>
          </div>
