...
export default function DuplexS32205PlatesDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "—", max: "0.03" },
    { element: "Chromium (Cr)", min: "22.00", max: "23.00" },
    { element: "Nickel (Ni)", min: "4.50", max: "6.50" },
    { element: "Molybdenum (Mo)", min: "3.00", max: "3.50" },
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength (MPa)", value: "655 (Min)" },
    { property: "Yield Strength (MPa)", value: "450 (Min)" },
    { property: "Elongation (%)", value: "25% (Min)" },
    { property: "Hardness (Rockwell C)", value: "31 (Max)" },
    { property: "PREN", value: "≥ 35" },
  ];

  const equivalentGrades = [
    { country: "UNS Number", grade: "UNS S32205" },
    { country: "EN Standard", grade: "1.4462" },
    { country: "Common Name", grade: "2205 Enhanced" },
    { country: "ASTM", grade: "F60" },
  ...
  const specifications = [
    ...
    "Finish: No.1 (Hot Rolled), No.4 (Brushed)",
    "Origin: Jindal, SAIL, Outokumpu, Aperam"
  ];

  return (
    <>
      <ProductSEO
        title="UNS S32205 Duplex Steel Plates Supplier | 2205 Enhanced Price"
        description="Premium UNS S32205 Duplex Stainless Steel Plates supplier in Mumbai. Enhanced 2205 grade for superior pitting resistance. ASTM A240 compliant. Best wholesale prices for S32205 plates and sheets India."
        keywords="UNS S32205 plates, s32205 duplex sheet supplier, S32205 price India, duplex 2205 enhanced chemical composition, S32205 vs S31803, Mumbai duplex steel stockist, ASTM A240 S32205, premium duplex plates"
        category="Plates & Sheets"
        productName="UNS S32205 Enhanced Duplex Steel Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/duplex-super-duplex/s32205-plates"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-sans">
          <div className="container mx-auto px-4 py-4 font-sans font-sans">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 font-sans">
              ...
              <ArrowRight className="w-4 h-4 font-sans" />
              <span className="text-blue-600 dark:text-blue-400 font-medium font-sans">S32205 Plates</span>
            </nav>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-indigo-950 via-navy-primary to-blue-950 text-white relative overflow-hidden shadow-2xl font-sans font-sans">
          <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/grid-me.png')] font-sans"></div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center font-sans">
              <div className="font-sans">
                <div className="flex items-center mb-6 font-sans">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold font-sans">Premium Dual Phase</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight font-sans">
                  UNS S32205
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide font-sans">Enhanced Duplex Stainless Plates</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light font-sans font-sans">
                  The refined evolution of 2205 steel. UNS S32205 offers tighter control on chromium, molybdenum, and nitrogen to guarantee higher corrosion resistance than standard S31803 duplex.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 font-sans">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group font-sans">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform font-sans" /> Request S32205 Quote
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center font-sans font-sans">
                    <Phone className="w-5 h-5 mr-3 font-sans" /> Material Consultation
                  </a>
                </div>
              </div>
              <div className="relative group font-sans">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 to-indigo-600 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 font-sans"></div>
                <img src={ss_plate_img} alt="UNS S32205 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px] font-sans" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md font-sans">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest font-sans">Modern Industry Favorite</p>
                  <p className="text-white font-black text-xl italic uppercase font-sans font-sans">REFINERY • DESALINATION</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto font-sans font-sans">
              ...
              <div className="lg:col-span-2 space-y-12 font-sans font-sans">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300 font-sans font-sans">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase tracking-tighter font-sans">
                    Grade Overview: UNS S32205
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light font-sans font-sans">
                    UNS S32205 is a nitrogen enhanced duplex stainless steel alloy that was developed to combat common corrosion problems encountered with the 300 series stainless steels. "Duplex" describes a family of stainless steels that are neither fully austenitic, like 304 stainless, nor purely ferritic, like 430 stainless. The structure of S32205 duplex stainless steel consists of austenite pools surrounded by a continuous ferritic phase. In the annealed condition, S32205 contains approximately 40-50% ferrite.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6 font-sans font-sans font-sans">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-xs mb-2 tracking-widest font-sans">Superior Pitting</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Improved pitting and crevice corrosion resistance compared to S31803.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-xs mb-2 tracking-widest font-sans font-sans">Nitrogen Alloyed</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Nitrogen enhancement increases the alloy's structural stability and strength.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900 font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-xs mb-2 tracking-widest font-sans font-sans">Thermal Stability</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Low thermal expansion compared to austenitic stainless steels.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8 font-sans font-sans">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group font-sans">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm font-sans">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic font-sans font-sans">2.0 – 120mm</p>
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700 font-sans">
              <div className="flex items-center mb-10 font-sans font-sans">
                ...
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 tracking-tighter italic font-sans font-sans">Primary Industrial Usage</h3>
              </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group font-sans">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase relative z-10 tracking-widest font-sans font-sans">Global Hub • Prime S32205 Inventory</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light font-sans font-sans">Mamta Steel Traders is a key supplier of nitrogen-enhanced UNS S32205 duplex plates for the international refinery and desalination sectors. All our material is strictly sourced from Tier-1 mills with full EN 10204 3.1 certification. Large stock availability for rapid global dispatch.</p>
