...
export default function Duplex14410PlatesDetail() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength (MPa)", value: "790 (Min)" },
    { property: "Yield Strength (MPa)", value: "550 (Min)" },
    { property: "Elongation (%)", value: "25% (Min)" },
    { property: "Hardness (Brinell)", value: "290 (Max)" },
    { property: "PREN (Cr + 3.3Mo + 16N)", value: "≥ 41" },
  ];

  const equivalentGrades = [
    { country: "UNS Number", grade: "UNS S32750" },
    { country: "EN Standard", grade: "1.4410" },
    { country: "AFNOR", grade: "Z3 CN 25.06 Az" },
    { country: "DIN", grade: "X2CrNiMoN25-7-4" },
    { country: "Common Name", grade: "Super Duplex 2507" },
  ];

  const applications = [
    "Oil and Gas Subsea Equipment",
  ...
  const specifications = [
    ...
    "Finish: Hot Rolled (No.1), Cold Rolled (2B)",
    "Origin: Jindal, Outokumpu, Aperam, Nippon"
  ];

  return (
    <>
      <ProductSEO
        title="1.4410 Super Duplex Steel Plates Supplier | S32750 Price India"
        description="Premium 1.4410 (UNS S32750) Super Duplex Plates supplier in Mumbai. High-strength corrosion resistant plates for offshore and chemical industries. ASTM A240 certified. Best wholesale prices for Super Duplex 2507. Global export to Gulf and USA."
        keywords="1.4410 plates, UNS S32750 supplier, Super Duplex 2507 plates India, 1.4410 chemical composition, super duplex plate price Mumbai, ASTM A240 S32750, offshore steel plates, S32750 mechanical properties"
        category="Plates & Sheets"
        productName="1.4410 / UNS S32750 Super Duplex Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/duplex-super-duplex/1-4410-plates"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-sans">
          <div className="container mx-auto px-4 py-4 font-sans font-sans">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 font-sans">
              ...
              <ArrowRight className="w-4 h-4 font-sans" />
              <span className="text-blue-600 dark:text-blue-400 font-medium font-sans">1.4410 Plates</span>
            </nav>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-indigo-900 via-navy-primary to-indigo-950 text-white relative overflow-hidden shadow-2xl font-sans font-sans">
          <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] font-sans"></div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center font-sans">
              <div className="font-sans">
                <div className="flex items-center mb-6 font-sans">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold font-sans">Ultra-High Resistance</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight font-sans">
                  1.4410 / S32750
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide font-sans">Super Duplex Stainless Steel Plates</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light font-sans font-sans">
                  The ultimate solution for extreme corrosion. 1.4410 (S32750) offers exceptional resistance to pitting and crevice corrosion in seawater and other aggressive chloride-bearing environments.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 font-sans">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group font-sans">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform font-sans" /> Request Super Duplex Quote
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center font-sans font-sans">
                    <Phone className="w-5 h-5 mr-3 font-sans" /> Technical Support
                  </a>
                </div>
              </div>
              <div className="relative group font-sans">
                ...
                <img src={ss_plate_img} alt="1.4410 Super Duplex Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px] font-sans" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md font-sans">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest font-sans">Sea Water Ready</p>
                  <p className="text-white font-black text-xl italic uppercase font-sans font-sans">OFFSHORE • DESALINATION</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto font-sans font-sans">
              ...
              <div className="lg:col-span-2 space-y-12 font-sans font-sans">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300 font-sans font-sans">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase tracking-tighter font-sans">
                    Grade Overview: 1.4410 / S32750
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light font-sans font-sans">
                    1.4410 is a super duplex stainless steel with 25% chromium, 4% molybdenum, and 7% nickel designed for applications that require exceptional strength and corrosion resistance. The alloy has a PREN value of over 41, making it highly resistant to pitting and crevice corrosion in sea water and other chloride environments. It also exhibits high thermal conductivity and a low coefficient of thermal expansion.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6 font-sans font-sans font-sans">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-xs mb-2 tracking-widest font-sans">High Mechanical Strength</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Twice the yield strength of standard austenitic grades.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-xs mb-2 tracking-widest font-sans font-sans">Pitting Resistance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Excellent performance in aggressive acidic and chloride media.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900 font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-xs mb-2 tracking-widest font-sans font-sans">Erosion Resistance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Ideal for high-velocity liquid and gas handling systems.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8 font-sans font-sans">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group font-sans">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm font-sans">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic font-sans font-sans">3.0 – 100mm</p>
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700 font-sans">
              <div className="flex items-center mb-10 font-sans font-sans">
                ...
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 tracking-tighter italic font-sans font-sans">Critical Applications</h3>
              </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group font-sans">
               <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/20 to-transparent group-hover:opacity-75 transition-opacity duration-1000 font-sans"></div>
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase relative z-10 tracking-widest font-sans font-sans">Premium Supply • Offshore Excellence</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light font-sans font-sans">Mamta Steel Traders provides certified 1.4410 Super Duplex plates from world-class manufacturers. All materials are supplied with EN 10204 3.1 Mill Test Certificates. Specialized in supply for Norsok and NACE compliant projects worldwide.</p>
