...
export default function SS155PHPlatesDetail() {
  ...
  const equivalentGrades = [
    { country: "USA / AISI", grade: "15-5PH / S15500" },
    { country: "ASTM", grade: "ASTM A693" },
    { country: "AMS", grade: "AMS 5862" },
    { country: "Germany / W.Nr.", grade: "1.4548" },
    { country: "France / AFNOR", grade: "Z6CNU15-05" },
  ];

  const applications = [
    "Aerospace Structural Components",
    "High Pressure Valves & Fittings",
    "Gears & Shafts for Marine Use",
    "Chemical Processing Equipment",
    "Nuclear Reactor Components",
    "Fasteners & Bolts (High Strength)",
    "Pulp and Paper Mill Equipment",
    "Engine Components & Drive Shafts"
  ];
  ...
  const specifications = [
    ...
    "Condition: Solution Treated (A), Age Hardened (H900, H1025 etc)",
    "Hardness: High strength through precipitation hardening",
    "Edge: Precision Cut / Mill Edge"
  ];

  return (
    <>
      <ProductSEO
        title="15-5PH Stainless Steel Plates Supplier Mumbai India | Aerospace Grade S15500"
        description="Premium stockist of 15-5PH Stainless Steel Plates in Mumbai. High-strength precipitation hardening grade with excellent transverse toughness. UNS S15500 certified for aerospace and nuclear applications. Global delivery from Mamta Steel Traders."
        keywords="15-5PH plates, 15-5PH stainless steel price Mumbai, UNS S15500 plate properties, AMS 5862 supplier India, 15-5PH aerospace steel, high strength stainless steel"
        category="Plates & Sheets"
        productName="15-5PH Stainless Steel Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/15-5ph-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">15-5PH Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Aerospace Certified - Precipitation Hardened</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  15-5PH Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">UNS S15500 / High Strength Martensitic Stainless</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  A premium version of 17-4PH with better transverse toughness. Our 15-5PH plates provide the mechanical power required for critical aerospace and energy components.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Get High-Strength Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={alloySteelPlates} alt="15-5PH Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">Performance Class Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: 15-5PH / UNS S15500
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    15-5PH is a martensitic, precipitation-hardening stainless steel that provides high strength, excellent corrosion resistance, and good mechanical properties at temperatures up to 600°F (316°C). It is the Ferrite-free version of 17-4PH stainless steel. Both alloys are widely used in the aerospace, chemical, petrochemical, food processing, and general metalworking industries.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Hardness Apex</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional tensile and yield strength through aging heat treatment.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      <ShieldCheck className="w-8 h-8 text-gold-primary mb-4" />
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Transverse Power</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Better ductility and toughness in all directions compared to 17-4PH.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      <Factory className="w-8 h-8 text-slate-900 dark:text-gray-300 mb-4" />
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Aerospace DNA</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Specifically designed for complex aerospace structural forging.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Expert High-Strength Supply</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a leading specialist for 15-5PH Plates based in Mumbai. We provide fully documented supply for aerospace and nuclear infrastructure globally.</p>
