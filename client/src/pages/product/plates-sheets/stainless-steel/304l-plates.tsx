...
export default function SS304LPlatesDetail() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "485" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "170" },
    { property: "Elongation (% in 50mm) min", value: "40" },
    { property: "Hardness (Brinell) max", value: "201" },
    { property: "Hardness (Rockwell B) max", value: "92" },
  ];

  const equivalentGrades = [
    { country: "USA / AISI", grade: "304L / S30403" },
    { country: "Germany / DIN", grade: "1.4306" },
    { country: "Japan / JIS", grade: "SUS304L" },
    { country: "France / AFNOR", grade: "Z3CN19-09" },
    { country: "India / IS", grade: "03Cr18Ni10" },
  ];

  const applications = [
    "Welded Structures & Pressure Vessels",
    "Nuclear Power Components",
    "Coal Mining Equipment",
    "Chemical Processing Plants",
    "Brewery & Winemaking Equipment",
    "Cryogenic Vessels",
    "Soap & Dye Industry Tanks",
    "Marine Components in Low Salt Areas"
  ];
  ...
  const specifications = [
    ...
    "Finish: 2B, BA, No.4, No.8, Hairline",
    "Length: up to 12000mm",
    "Edge: Precision Slit, Mill Edge"
  ];

  return (
    <>
      <ProductSEO
        title="SS 304L Plates Supplier & Stockist in Mumbai India | Low Carbon ASTM A240 304L"
        description="Premium stockist of SS 304L Stainless Steel Plates in Mumbai. Excellent weldability and corrosion resistance. Sourced from high-quality mills with 3.1 MTC. Best rates for bulk orders at Mamta Steel Traders."
        keywords="SS 304L plates, 304L stainless steel sheet price India, ASTM A240 304L properties, SS 304L plate supplier Mumbai, low carbon stainless steel plate, SS 304L industrial applications"
        category="Plates & Sheets"
        productName="Stainless Steel 304L Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/304l-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 304L Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Weldable Grade - Global Shipping</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 304L Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A240 / Low Carbon Austenitic</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Highly weldable 304L grade stainless steel plates. Ideal for heavy-gauge components where intergranular corrosion resistance is critical after welding operations.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Inquiry For Bulk
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center">
                    <Phone className="w-5 h-5 mr-3" /> Technical Sales
                  </a>
                </div>
              </div>
              <div className="relative group">
                ...
                <img src={ss_plate_img} alt="SS 304L Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">Weld-Ready Inventory</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-12 mb-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Overview: SS 304L / UNS S30403
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    SS 304L is the extra low-carbon version of the 18-8 austenitic stainless steel (304). The lower carbon content in 304L minimizes harmful or critical carbide precipitation as a result of welding. 304L is therefore used 'as-welded' in severe corrosion environments and eliminates the need for annealing.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent performance in welded industrial constructions.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Corrosion Defense</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Superior resistance to intergranular corrosion.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Low Temp Edge</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Maintains toughness in cryogenic and low-temp apps.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <h3 className="text-2xl font-bold mb-8 uppercase border-b-2 border-gold-primary pb-2 inline-block italic tracking-widest">Mkt Presence</h3>
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic">0.1 – 100mm</p>
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700">
              <div className="flex items-center mb-10">
                ...
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 italic tracking-tighter">Application Scope</h3>
              </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Precision Sourcing & Supply</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Direct availability of SS 304L Plates in Mumbai. We provide precision cutting, grinding, and surface coating tailored to your project requirements. Worldwide shipping compliant with API and ASTM standards.</p>
