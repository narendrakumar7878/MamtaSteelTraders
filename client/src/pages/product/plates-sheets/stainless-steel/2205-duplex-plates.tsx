...
export default function SSDuplex2205PlatesDetail() {
  ...
  const mechanicalProperties = [
    ...
    { property: "Elongation (% in 50mm) min", value: "25" },
    { property: "Hardness (Brinell) max", value: "293" },
    { property: "Hardness (Rockwell C) max", value: "31" },
  ];

  const equivalentGrades = [
    { country: "USA / AISI", grade: "2205 / S31803 / S32205" },
    { country: "Germany / DIN", grade: "1.4462" },
    { country: "European", grade: "EN 1.4462" },
    { country: "Japan / JIS", grade: "SUS 329J3L" },
    { country: "India / IS", grade: "02Cr22Ni5Mo3N" },
  ];

  const applications = [
    "Chemical Process Vessels & Piping",
    "Oil & Gas Industry Heat Exchangers",
    "Seawater Handling & Desalination",
  ...
  const specifications = [
    ...
    "Microstructure: 50/50 Ferrite-Austenite",
  ...
  return (
    <>
      <ProductSEO
        title="Duplex 2205 Plates Supplier & Stockist in Mumbai India | S31803 / S32205 ASTM A240"
        description="Leading stockist of Duplex 2205 Stainless Steel Plates in Mumbai. High-strength dual-phase steel providing superior fatigue strength and SCC resistance. ASTM certified with 3.1 MTC. Best rates at Mamta Steel Traders."
        keywords="Duplex 2205 plates, S31803 plate price Mumbai, S32205 plate properties, ASTM A240 2205 supplier India, duplex stainless steel plate, corrosion resistant duplex"
        category="Plates & Sheets"
        productName="Duplex 2205 Stainless Steel Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/2205-duplex-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Duplex 2205 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Dual Phase Strength - Premier Inventory</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Duplex 2205 Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">UNS S31803 / S32205 High-Strength Logic</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  A high-efficiency dual-phase stainless steel combining the best properties of austenitic and ferritic grades. Half the weight of standard steel with twice the corrosion resistance.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={alloySteelPlates} alt="Duplex 2205 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">Dual Phase Mastery Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: Duplex 2205 / UNS S31803
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Duplex 2205 (UNS S31803/S32205) is a nitrogen enhanced duplex stainless steel alloy that was developed to combat common corrosion problems encountered with the 300 series stainless steels. "Duplex" describes a family of stainless steels that are neither fully austenitic, like 304 stainless, nor purely ferritic, like 430 stainless.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Strength King</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Yield strength is approximately double that of standard austenitic grades.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      <Gauge className="w-8 h-8 text-gold-primary mb-4" />
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">SCC Defense</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Outstanding resistance to stress corrosion cracking (SCC).</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      <Anchor className="w-8 h-8 text-slate-900 dark:text-gray-300 mb-4" />
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Pitting Apex</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Better pitting & crevice corrosion resistance in seawater applications.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Advanced Duplex Sourcing</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist for Duplex 2205 Plates based in Mumbai. We provide fully documented supply for oil, gas, and marine infrastructure globally.</p>
