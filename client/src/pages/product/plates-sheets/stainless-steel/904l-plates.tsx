...
export default function SS904LPlatesDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "—", max: "0.020" },
    { element: "Manganese (Mn)", min: "—", max: "2.00" },
    { element: "Silicon (Si)", min: "—", max: "1.00" },
    { element: "Chromium (Cr)", min: "19.00", max: "23.00" },
    { element: "Nickel (Ni)", min: "23.00", max: "28.00" },
    { element: "Molybdenum (Mo)", min: "4.00", max: "5.00" },
    { element: "Copper (Cu)", min: "1.00", max: "2.00" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "490" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "220" },
    { property: "Elongation (% in 50mm) min", value: "35" },
    { property: "Hardness (Brinell) max", value: "192" },
    { property: "Hardness (Rockwell B) max", value: "90" },
  ];

  const equivalentGrades = [
    { country: "USA / AISI", grade: "904L / N08904" },
    { country: "Germany / DIN", grade: "1.4539" },
    { country: "European", grade: "EN 1.4539" },
    { country: "Japan / JIS", grade: "SUS 890L" },
    { country: "India / IS", grade: "02Cr20Ni25Mo5Cu2" },
  ];
  ...
  const applications = [
    ...
    "Complex Organic Acid Environments"
  ];
  ...
  const specifications = [
    ...
    "Finish: No.1, 2B, BA",
    "Acid Resistance: Exceptional in Sulfuric Acid",
  ...
  return (
    <>
      <ProductSEO
        title="SS 904L Plates Supplier & Stockist in Mumbai India | Acid Grade S31254"
        description="Premium stockist of SS 904L Stainless Steel Plates in Mumbai. High-nickel super-austenitic grade designed for extreme corrosion resistance in sulfuric and phosphoric acids. ASTM certified with 3.1 MTC. Best rates at Mamta Steel Traders."
        keywords="SS 904L plates, 904L stainless steel sheet price Mumbai, ASTM A240 904L properties, SS 904L plate supplier India, super-austenitic stainless steel plate, 904L acid resistance"
        category="Plates & Sheets"
        productName="Stainless Steel 904L Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/904l-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 904L Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Acid Grade - Premier Sourcing</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 904L Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A240 / Super-Austenitic Acid Resistant</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  A non-stabilized austenitic stainless steel with low carbon content. It is designed to resist extreme chemical environments, including hot sulfuric and phosphoric acids.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Request Chemical Spec Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss304Plate} alt="SS 904L Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest">Inventory Edge</p>
                   <p className="text-white font-black text-xl italic uppercase">Ultimate Acid Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 904L / UNS N08904
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Stainless Steel 904L is a super-austenitic stainless steel that is designed for moderate to high corrosion resistance in a wide range of process environments. The combination of high chromium and nickel content, coupled with additions of molybdenum and copper, assure good to excellent corrosion resistance.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      <Beaker className="w-8 h-8 text-navy-primary mb-4" />
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Acid Mastery</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional performance in hot concentrated sulfuric acid.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      <Anchor className="w-8 h-8 text-gold-primary mb-4" />
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Copper Logic</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Copper addition significantly improves resistance to reducing acids.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Pitting Guard</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">High Mo content provides exceptional PREN for chloride service.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic">1000 – 2000mm</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Complex Chemical Logistics</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist for SS 904L Plates based in Mumbai. We provide rapid dispatch and technical verification for all critical chemical and offshore infrastructure globally.</p>
