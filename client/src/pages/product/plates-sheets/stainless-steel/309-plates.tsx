...
export default function SS309PlatesDetail() {
  const chemicalComposition = [
    ...
    { element: "Chromium (Cr)", min: "22.00", max: "24.00" },
    { element: "Nickel (Ni)", min: "12.00", max: "15.00" },
  ];
  ...
  const equivalentGrades = [
    { country: "USA / AISI", grade: "309 / S30900" },
    { country: "Germany / DIN", grade: "1.4828" },
    { country: "Japan / JIS", grade: "SUS309" },
    { country: "France / AFNOR", grade: "Z15CN2413" },
    { country: "India / IS", grade: "07Cr23Ni13" },
  ];

  const applications = [
    "Furnace Components & Annealing Boxes",
    "Heat Exchangers & Condensers",
    "Aircraft & Jet Engine Components",
    "Kiln Linings & Oven Baffles",
    "Steam Boilers & Thermowells",
    "Chemical Processing Equipment",
    "Soot Blowers & Fire Box Sheets",
  ...
  const specifications = [
    ...
    "Heat Resistance: High oxidation resistance",
    "Edge: Slit / Mill Edge"
  ];
  ...
  return (
    <>
      <ProductSEO
        title="SS 309 Plates Supplier & Stockist in Mumbai India | Heat Resistant ASTM A240 309"
        description="Leading stockist of SS 309 Stainless Steel Plates in Mumbai. Efficient heat resistant grade with excellent oxidation resistance and strength at high temperatures. ASTM A240 certified. Best prices and global delivery at Mamta Steel Traders."
        keywords="SS 309 plates, 309 stainless steel sheet supplier Mumbai, ASTM A240 309 properties, SS 309 plate price India, heat resistant 309 plate, SS 309 industrial use, Mumbai steel market"
        category="Plates & Sheets"
        productName="Stainless Steel 309 Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/309-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 309 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Heat Resistant Grade - Ready Stock</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 309 Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A240 / High-Heat Oxidation Resistant Austenitic</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  High-alloy 309 plates engineered for exceptional scaling resistance and mechanical strength at elevated temperatures. The definitive choice for fire boxes and high-heat furnace components.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Get Heat-Spec Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_plate_img} alt="SS 309 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">Thermal Stability Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">High-Heat Edge</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Maintains integrity under continuous thermal stress.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Corrosion Barrier</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent resistance against oxidizing liquids and gases.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Creep Resistance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Superior strength retention at extreme operating temps.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Specialized Industrial Sourcing</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a leading stockist for SS 309 Plates based in Mumbai. We provide rapid dispatch and documentation for all large-scale industrial inquiries worldwide.</p>
