...
export default function SS420J1PlatesDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "0.16", max: "0.25" },
    ...
    { element: "Nickel (Ni)", min: "—", max: "0.60" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "650" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "450" },
    { property: "Elongation (% in 50mm) min", value: "15" },
    { property: "Hardness (Brinell) max", value: "223" },
    { property: "Hardness (Rockwell C) after hardening", value: "40-45" },
  ];

  const equivalentGrades = [
    { country: "USA / AISI", grade: "420J1 / S42000" },
    { country: "Germany / DIN", grade: "1.4021" },
    { country: "Japan / JIS", grade: "SUS420J1" },
    { country: "France / AFNOR", grade: "Z20C13" },
    { country: "India / IS", grade: "20Cr13" },
  ];

  const applications = [
    "Cutlery & Knife Blades",
  ...
  const specifications = [
    ...
    "Finish: No.1, 2B, BA",
    "Condition: Annealed or Hardened/Tempered",
    "Edge: Slit / Mill Edge"
  ];
  ...
  return (
    <>
      <ProductSEO
        title="SS 420J1 Plates Supplier & Stockist in Mumbai India | Grade 420J1 ASTM A240"
        description="Premium stockist of SS 420J1 Stainless Steel Plates in Mumbai. Martensitic grade with high hardness and good corrosion resistance after heat treatment. Ideal for cutlery and tools. Best prices at Mamta Steel Traders."
        keywords="SS 420J1 plates, 420J1 stainless steel sheet price Mumbai, JIS G4304 420J1 properties, SS 420J1 plate supplier India, martensitic stainless steel plate, SS 420J1 knife steel"
        category="Plates & Sheets"
        productName="Stainless Steel 420J1 Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/420j1-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 420J1 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Hardness Grade - Precise Inventory</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 420J1 Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">JIS G4304 / Martensitic Hardening Steel</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Superior 420J1 martensitic plates engineered for high hardness and wear resistance. The definitive choice for precision cutlery, surgical tools, and mechanical drivetrain components.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Request Tooling Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={alloySteelPlates} alt="SS 420J1 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">Precision Hardness Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 420J1 / UNS S42000
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Stainless Steel 420J1 is a martensitic stainless steel with good corrosion resistance in relatively non-aggressive environments. It provides high strength and hardness when heat treated. It is essentially the medium-carbon version of Grade 410, providing higher hardness and wear resistance.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      <Gauge className="w-8 h-8 text-navy-primary mb-4" />
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Wear Resilience</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent resistance to abrasion and surface impact after tempering.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Heat Treatable</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Responsive to quenching and tempering for varied hardness levels.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Industrial DNA</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Reliable performance in turbine blades and high-stress valve parts.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic">0.5 – 100mm</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Precision Tooling Solutions</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist for SS 420J1 Plates based in Mumbai. We provide rapid dispatch and technical verification for all precision manufacturing and tooling inquiries globally.</p>
