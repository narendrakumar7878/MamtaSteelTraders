...
export default function SS321PlatesDetail() {
  const chemicalComposition = [
    ...
    { element: "Titanium (Ti)", min: "5*(C+N)", max: "0.70" },
  ...
  const equivalentGrades = [
    ...
    { country: "India / IS", grade: "06Cr18Ni11Ti" },
  ];

  const applications = [
    "Aircraft Exhaust Manifolds",
    "Heat Exchangers & Expansion Joints",
    "Furnace Components",
    "Jet Engine Parts",
    "Chemical Processing Equipment",
    "Pharmaceutical Production Lines",
    "Cryogenic Service Components",
    "Structural Applications in High Temps"
  ];
  ...
  const specifications = [
    ...
    "Coating: PVC Protection Film Available",
  ...
  return (
    <>
      <ProductSEO
        title="SS 321 Plates Supplier & Stockist in Mumbai India | Titanium Stabilized ASTM A240 321"
        description="Leading stockist of SS 321 Stainless Steel Plates in Mumbai. Titanium stabilized grade for excellent high temperature properties and intergranular corrosion resistance. ASTM certified with 3.1 MTC. Best rates at Mamta Steel Traders."
        keywords="SS 321 plates, 321 stainless steel sheet supplier Mumbai, ASTM A240 321 properties, SS 321 plate price India, titanium stabilized stainless steel, SS 321 industrial applications, SS 321 aircraft exhaust"
        category="Plates & Sheets"
        productName="Stainless Steel 321 Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/321-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 321 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Titanium Stabilized - Ready Stock</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 321 Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A240 / Stabilized High-Temp Grade</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Superior 321 stainless steel plates stabilized with Titanium to eliminate intergranular corrosion after welding. The premier choice for high-temperature exhaust and aerospace engineering.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Request Technical Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_plate_img} alt="SS 321 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">High-Heat Ready Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 321 / UNS S32100
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Stainless Steel 321 is similar to Grade 304, but with a titanium addition of at least five times the carbon content. This addition reduces or prevents carbide precipitation during welding and in service at 427-816°C. It is typically used for applications requiring intermittent heating within this critical range.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Ti-Stabilized</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Prevents intergranular corrosion in weld-affected zones.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Heat Prowess</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Maintains performance up to 816°C (1500°F).</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Aerospace Spec</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Certified for jet engine and exhaust manifold safety.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">Thickness Avail.</p>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders ensures 100% material certifiability for SS 321 Plates. Sourced from the world's leading mills, our plates meet the stringent demands of global aircraft and industrial sectors.</p>
