...
export default function SS410PlatesDetail() {
  const chemicalComposition = [
    ...
    { element: "Chromium (Cr)", min: "11.50", max: "13.50" },
  ];
  ...
  const mechanicalProperties = [
    ...
    { property: "Hardness (Rockwell B) max", value: "96" },
  ];

  const equivalentGrades = [
    { country: "USA / AISI", grade: "410 / S41000" },
    { country: "Germany / DIN", grade: "1.4006" },
    { country: "Japan / JIS", grade: "SUS410" },
    { country: "France / AFNOR", grade: "Z12C13" },
    { country: "India / IS", grade: "12Cr13" },
  ];

  const applications = [
    "Valve & Pump Parts",
    "Screws, Bolts & Bushings",
  ...
  return (
    <>
      <ProductSEO
        title="SS 410 Plates Supplier & Stockist in Mumbai India | Grade 410 ASTM A240"
        description="Leading stockist of SS 410 Stainless Steel Plates in Mumbai. General purpose martensitic grade with good corrosion resistance and high strength. ASTM certified with 3.1 MTC. Best rates at Mamta Steel Traders."
        keywords="SS 410 plates, 410 stainless steel sheet price Mumbai, ASTM A240 410 properties, SS 410 plate supplier India, martensitic stainless steel plate, SS 410 industrial uses"
        category="Plates & Sheets"
        productName="Stainless Steel 410 Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/410-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 410 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Standard Martensitic - Ready Stock</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 410 Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A240 / General Purpose Martensitic Grade</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Basic 410 plates providing excellent strength and moderate corrosion resistance. The industrial baseline for high-stress hardware and general utility components.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Bulk Inquiry Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_plate_img} alt="SS 410 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">General Purpose Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Strength Hub</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Capable of achieving high mechanical properties through heat treatment.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Utility Defense</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Sufficient corrosion resistance for mildly corrosive environments.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Versatile Edge</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">The standard choice for large-scale industrial hardware and turbine parts.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist for SS 410 Plates based in Mumbai. We provide rapid dispatch and documentation for all large-scale industrial inquiries worldwide.</p>
