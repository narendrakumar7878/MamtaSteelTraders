...
export default function SS304PlatesDetail() {
  ...
  const applications = [
    ...
    "Architectural Panelling & Railings",
  ...
  return (
    <>
      <ProductSEO
        title="SS 304 Plates Supplier & Stockist in Mumbai India | Best Price ASTM A240 304 Sheets"
        description="Leading stockist and supplier of SS 304 Stainless Steel Plates in Mumbai. High quality ASTM A240 TP 304 plates in multiple finishes like 2B, BA, No.1. Best prices, ready stock, and mill certified. Global delivery from Mamta Steel Traders."
        keywords="SS 304 plates, 304 stainless steel sheet supplier Mumbai, ASTM A240 304 price India, stainless steel 304 plate weight chart, SS 304 plate dimensions, SS 304 2B finish plate, SS 304 mirror finish plate, Mumbai steel market"
        category="Plates & Sheets"
        productName="Stainless Steel 304 Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/304-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 304 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">In Stock - Mumbai Stockyard</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 304 Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A240 / ASME SA240 Grade 304</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Premium austenitic 304 stainless steel plates offering exceptional corrosion resistance, superior formability, and durability for high-end industrial and architectural projects.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Request Price List
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_plate_img} alt="SS 304 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Overview: Stainless Steel 304
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Stainless Steel 304 is the most versatile and widely used grade in the stainless steel family. Known as 18/8 stainless steel due to its 18% chromium and 8% nickel content, it provides excellent resistance to corrosion from a wide range of atmospheric, chemical, textile, petroleum, and food industry exposures.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Industry Standard</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Standard choice for food grade and chemical containment applications.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Chemical Stability</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">High resistance to oxidation and intergranular corrosion.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Deep Drawing</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent formability and weldability for complex shapes.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Ready Stock for Immediate Dispatch</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders maintains an extensive inventory of SS 304 Plates in our 30,000 sq. ft. Mumbai warehouse. Fast global shipping to Europe, UAE, USA, and Southeast Asia.</p>
