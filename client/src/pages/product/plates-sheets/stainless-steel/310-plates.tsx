...
export default function SS310PlatesDetail() {
  ...
  const equivalentGrades = [
    { country: "USA / AISI", grade: "310 / S31000" },
    { country: "Germany / DIN", grade: "1.4841" },
    { country: "Japan / JIS", grade: "SUS310" },
    { country: "France / AFNOR", grade: "Z12CN25-20" },
    { country: "India / IS", grade: "07Cr25Ni20" },
  ];

  const applications = [
    "Furnace Components & Muffles",
    "Heat Exchanger Components",
    "Kiln Furniture & Retorts",
    "Annealing Covers & Boxes",
    "Steam Boilers & Thermowells",
    "Petroleum Refining Equipment",
    "Coal Gasifier Internal Components",
    "Food Processing Equipment (High Temp)"
  ];
  ...
  return (
    <>
      <ProductSEO
        title="SS 310 Plates Supplier & Stockist in Mumbai India | Heat Resistant ASTM A240 310"
        description="Premium stockist of SS 310 Stainless Steel Plates in Mumbai. High chromium-nickel grade with excellent oxidation resistance at elevated temperatures up to 1100°C. ASTM certified with mill test reports. Best prices at Mamta Steel Traders."
        keywords="SS 310 plates, 310 stainless steel sheet supplier Mumbai, ASTM A240 310 properties, SS 310 plate price India, heat resistant stainless steel plate, SS 310 industrial furnace applications"
        category="Plates & Sheets"
        productName="Stainless Steel 310 Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/310-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 310 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Ultra High Temp Grade - Ex-Stock</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 310 Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A240 / Superior Heat Resisting Austenitic</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  High-chromium 310 plates designed for extreme thermal stability. Maintaining mechanical integrity in temperatures up to 1100°C for the world's most demanding furnace environments.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Get High-Temp Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_plate_img} alt="SS 310 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">Furnace Ready Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 310 / UNS S31000
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Stainless Steel 310 is a high chromium-nickel austenitic stainless steel with excellent oxidation resistance at elevated temperatures up to 2010°F (1100°C) in dry air. Grade 310 combines high temperature properties with good ductility and weldability.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Heat Defiant</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Maintains strength and integrity in continuous high-heat environments.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Oxidation Proof</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Highly resistant to scaling and hot corrosion.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Weld Prowess</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent weldability for building complex thermal equipment.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">Max Temperature</p>
                    <p className="text-4xl font-black text-gold-primary italic">1100°C</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Specialized Thermal Solutions</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist for SS 310 Plates based in Mumbai. We provide rapid documentation and logistics for critical high-temperature industrial infrastructure globally.</p>
