...
export default function SS430PlatesDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "—", max: "0.12" },
  ...
  const mechanicalProperties = [
    ...
    { property: "Elongation (% in 50mm) min", value: "22" },
    { property: "Hardness (Brinell) max", value: "183" },
    { property: "Hardness (Rockwell B) max", value: "89" },
  ];

  const equivalentGrades = [
    { country: "USA / AISI", grade: "430 / S43000" },
    { country: "Germany / DIN", grade: "1.4016" },
    { country: "Japan / JIS", grade: "SUS430" },
    { country: "France / AFNOR", grade: "Z8C17" },
    { country: "India / IS", grade: "07Cr17" },
  ];

  const applications = [
    "Automotive Trim & Moldings",
    "Kitchenware & Catering Equipment",
    "Household Appliances (Washing Machines)",
    "Architectural Panelling",
    "Cabinet Hardware & Hinges",
    "Flue Liners & Chimney Parts",
    "Counter Tops & Table Surfaces",
  ...
  const specifications = [
    ...
    "Finish: 2B, BA, No.4, Mirror",
    "Magnetic Condition: Ferromagnetic (Magnetic)",
  ...
  return (
    <>
      <ProductSEO
        title="SS 430 Plates Supplier & Stockist in Mumbai India | Ferritic Grade 430 ASTM A240"
        description="Premium stockist of SS 430 Stainless Steel Plates in Mumbai. High-chromium ferritic grade with good corrosion resistance and formability. Magnetic grade suitable for decorative and automotive applications. Best prices at Mamta Steel Traders."
        keywords="SS 430 plates, 430 stainless steel sheet price Mumbai, ASTM A240 430 properties, SS 430 plate supplier India, ferritic stainless steel plate, SS 430 magnetic steel"
        category="Plates & Sheets"
        productName="Stainless Steel 430 Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/430-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 430 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Ferritic Magnetic - Value Driven</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 430 Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A240 / Non-Hardenable Ferritic Grade</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  A cost-effective ferritic 430 plate featuring high chromium for superior oxidation resistance. The industry standard for decorative trim and domestic appliance excellence.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Inquiry For High-Finish
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={carbonSteelPlates} alt="SS 430 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">Magnetic Mirror Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 430 / UNS S43000
                  </h2>
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Magnetic Base</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Fully magnetic grade ideal for induction and kitchen infrastructure.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Oxidation Pride</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent resistance to oxidation in intermittent service up to 870°C.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Formable Edge</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">High ductility for complex pressing and architectural bend operations.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic">0.3 – 100mm</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Direct Industrial Supply</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist for SS 430 Plates based in Mumbai. We provide rapid dispatch and documentation for all large-scale industrial inquiries worldwide.</p>
