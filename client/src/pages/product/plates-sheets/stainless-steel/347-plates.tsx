...
export default function SS347PlatesDetail() {
  const chemicalComposition = [
    ...
    { element: "Nickel (Ni)", min: "9.00", max: "13.00" },
    { element: "Niobium (Nb)", min: "10*C", max: "1.10" },
  ];
  ...
  const specifications = [
    ...
    "Finish: No.1, 2B, BA",
    "Stabilization: Niobium (Columbium)",
  ...
  return (
    <>
      <ProductSEO
        title="SS 347 Plates Supplier & Stockist in Mumbai India | Nb-Stabilized ASTM A240 347"
        description="Premium stockist of SS 347 Stainless Steel Plates in Mumbai. Niobium stabilized austenitic grade for high temperature and intergranular corrosion resistance. ASTM certified with mill test certificates. Best rates at Mamta Steel Traders."
        keywords="SS 347 plates, 347 stainless steel sheet price Mumbai, ASTM A240 347 properties, SS 347 plate supplier India, niobium stabilized steel, intergranular corrosion resistant"
        category="Plates & Sheets"
        productName="Stainless Steel 347 Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/347-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 347 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Niobium Stabilized - Industry Hub</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 347 Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A240 / High-Temp Nb-Stabilized Grade</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  A high chromium-nickel austenitic steel featuring Niobium micro-additions. Superior resistance to intergranular corrosion for critical welding and high-service-temp components.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Request Tech-Grade Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={chequeredPlates} alt="SS 347 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">Nb-Defense Ready Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 347 / UNS S34700
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Stainless Steel 347 is a columbium-stabilized austenitic chromium-nickel stainless steel with excellent resistance to intergranular corrosion. This grade is typically used for applications where continuous or intermittent heating between 800°F and 1500°F (427°C and 816°C) is occurring.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Nb-Stabilized</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Titanium or Niobium additions prevent carbide precipitation.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Corrosion Might</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Superior resistance to strong oxidizing acids and marine environments.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">High-Heat Edge</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Maintaining mechanical integrity in extreme thermal conditions.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Precision Sourcing Hub</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist for SS 347 Plates based in Mumbai. We provide rapid dispatch and documentation for all large-scale industrial inquiries worldwide.</p>
