...
export default function SS310SPlatesDetail() {
  ...
  const mechanicalProperties = [
    ...
    { property: "Hardness (Brinell) max", value: "225" },
    { property: "Hardness (Rockwell B) max", value: "95" },
  ];

  const equivalentGrades = [
    { country: "USA / AISI", grade: "310S / S31008" },
    { country: "Germany / DIN", grade: "1.4845" },
    { country: "Japan / JIS", grade: "SUS310S" },
    { country: "France / AFNOR", grade: "Z8CN25-20" },
    { country: "India / IS", grade: "07Cr25Ni20" },
  ];

  const applications = [
    "Furnace Parts & Muffles",
    "Heat Treatment Baskets & Fixtures",
    "Radiant Tubes & Retorts",
  ...
  const specifications = [
    ...
    "Finish: No.1, 2B, BA, No.4, Mirror",
    "Temp Resistance: Up to 1100°C (2010°F)",
    "Edge: Slit / Mill Edge"
  ];
  ...
  return (
    <>
      <ProductSEO
        title="SS 310S Plates Supplier & Stockist in Mumbai India | Heat Resistant ASTM A240 310S"
        description="Premium stockist of SS 310S Stainless Steel Plates in Mumbai. Low carbon version of 310 with excellent oxidation resistance at elevated temperatures up to 1100°C. ASTM certified with mill test reports. Best prices at Mamta Steel Traders."
        keywords="SS 310S plates, 310S stainless steel sheet supplier Mumbai, ASTM A240 310S properties, SS 310S plate price India, heat resistant stainless steel plate, SS 310S industrial furnace applications"
        category="Plates & Sheets"
        productName="Stainless Steel 310S Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/stainless-steel/310s-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 310S Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Ultra High Temp Grade - Low Carbon</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 310S Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A240 / UNS S31008 / Heat Resisting</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Low-carbon 310S plates for enhanced weldability and corrosion resistance in cyclic thermal environments up to 1100°C. Premier solution for high-heat industrial infrastructure.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Get Technical Quote
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center">
                    <Phone className="w-5 h-5 mr-3" /> Material Hub
                  </a>
                </div>
              </div>
              <div className="relative group">
                ...
                <img src={ss_plate_img} alt="SS 310S Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                   ...
                   <p className="text-white font-black text-xl italic uppercase">310S Stock Available</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-12 mb-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 310S / UNS S31008
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Stainless Steel 310S is the low-carbon version of SS 310. It is designed for applications where sensitization and subsequent corrosion by high-temperature gases or condensates may occur during service. Grade 310S offers superior weldability compared to 310 while maintaining identical oxidation resistance.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Low Carbon</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Reduces carbide precipitation during welding for better structural integrity.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Thermal Stability</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Maintains performance under cyclic heating and cooling.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      <ShieldCheck className="w-8 h-8 text-slate-900 dark:text-gray-300 mb-4" />
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Corrosion Lock</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">High Cr and Ni content ensures protection in moderately carburizing environments.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <h3 className="text-2xl font-bold mb-8 uppercase border-b-2 border-gold-primary pb-2 inline-block italic tracking-widest">Plate Specifications</h3>
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">Standard</p>
                    <p className="text-2xl font-black text-gold-primary italic">ASTM A240</p>
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700">
              <div className="flex items-center mb-10">
                <Factory className="w-10 h-10 text-gold-primary mr-4" />
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 italic tracking-tighter">Industry Utilization</h3>
              </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Certified 310S Supply</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier inventory holder for SS 310S Plates. We offer precision shearing, specialized packaging, and rapid shipping for industrial thermal projects across India and worldwide.</p>
              <div className="flex flex-col sm:flex-row gap-8 justify-center relative z-10">
                ...
                <a href="tel:+919819322576" className="bg-white hover:bg-slate-100 text-navy-primary px-12 py-5 rounded-2xl font-black transition-all shadow-2xl hover:scale-110 flex items-center justify-center uppercase tracking-widest">
                  <Phone className="w-5 h-5 mr-3" /> Sales Specialist
                </a>
              </div>
            </div>
          </div>
