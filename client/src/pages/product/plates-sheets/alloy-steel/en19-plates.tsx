...
export default function GradeEN19PlatesDetail() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "850 – 1000 (Condition T)" },
    { property: "Yield Strength (MPa) min", value: "680 (Condition T)" },
    { property: "Elongation (min %)", value: "13" },
    { property: "Hardness (HB)", value: "248 - 302" },
    { property: "Izod Impact (min J)", value: "54" },
  ];

  const equivalentGrades = [
    { country: "UK / BS", grade: "970:1991 708M40 / EN19" },
    { country: "USA / AISI", grade: "4140" },
    { country: "Germany / DIN", grade: "1.7225 / 42CrMo4" },
    { country: "Japan / JIS", grade: "SCM 440" },
    { country: "France / AFNOR", grade: "42CD4" },
  ];

  const applications = [
    "High Tensile Gears and Pinions",
    "Shafts and Axles",
  ...
  const specifications = [
    ...
    "Width: up to 2500mm",
    "Length: up to 6000mm",
    "Delivery Condition: Annealed, Quenched & Tempered (T, U, V)",
    "Certification: EN 10204 3.1 MTR"
  ];

  return (
    <>
      <ProductSEO
        title="EN19 Plates & Sheets (708M40) Supplier | High Tensile Steel Mumbai India"
        description="Premiun EN19 / 708M40 High Tensile Alloy Steel Plates supplier in Mumbai. Specialized 4140 equivalent steel for heavy engineering & gears. Complete mechanical properties (Condition T) and chemical specs. Global shipping from Mamta Steel Traders."
        keywords="EN19 plates, 708M40 steel price, EN19 chemical composition, 4140 alloy steel plates Mumbai, EN19 mechanical properties Condition T, high tensile steel supplier India, EN19 plate weight chart, Mamta Steel Mumbai"
        category="Plates & Sheets"
        productName="EN19 (708M40) Alloy Steel Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/alloy-steel/en19-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">EN19 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">High Tensile Strength - Condition T/U/V</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  EN19 / 708M40 Plates
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">AISI 4140 Equivalent / 1.7225 Alloy</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  A high-quality alloy steel known for its high tensile strength, good ductility, shock resistance, and wear resistance, making it ideal for the most demanding mechanical engineering applications.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Request Wholesale Pricing
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center">
                    <Phone className="w-5 h-5 mr-3" /> Technical Hotline
                  </a>
                </div>
              </div>
              <div className="relative group">
                ...
                <img src={ss304Plate} alt="EN19 High Tensile Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest">Tension Factor</p>
                  <p className="text-white font-black text-xl italic uppercase">Ultra Durable</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-12 mb-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Material Profile: EN19 (708M40)
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    EN19 is a high-grade alloy steel which provides good ductility and shock resistance combined with resistance to wear. It is widely used in the oil and gas industry as well as the automotive sector for its ability to maintain its mechanical properties even after extensive load. Often supplied in the hardened and tempered condition (T, U, or V), it is preferred for gear and engine components.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Engineering</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Standard choice for shafts, gears, and high-load axles.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Shock Proof</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent resistance to shock and sudden impact loading.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Response</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional response to heat treatment for varied hardness levels.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <h3 className="text-2xl font-bold mb-8 uppercase border-b-2 border-gold-primary pb-2 inline-block italic tracking-widest">Inventory Scope</h3>
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic">5.0 – 200.0mm</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Superior High-Tensile Steel Distribution</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel specializes in high-quality EN19 plates, offering custom cutting and finishing to meet your precise engineering drawings. Our Mumbai-based stockyard ensures rapid delivery across India and international ports.</p>
