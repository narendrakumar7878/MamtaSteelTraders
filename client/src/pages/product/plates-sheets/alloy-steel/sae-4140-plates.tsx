...
export default function GradeSAE4140PlatesDetail() {
  const chemicalComposition = [
    ...
    { element: "Sulfur (S) max", min: "—", max: "0.040" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "655" },
    { property: "Yield Strength (MPa) min", value: "415" },
    { property: "Elongation (min % in 50mm)", value: "25" },
    { property: "Reduction of Area (min %)", value: "54" },
    { property: "Hardness (Brinell HB)", value: "197 - 241" },
  ];

  const equivalentGrades = [
    { country: "USA / AISI", grade: "4140 / UNS G41400" },
    { country: "Germany / DIN", grade: "1.7225 / 42CrMo4" },
    { country: "Japan / JIS", grade: "SCM 440" },
    { country: "UK / BS", grade: "708M40 / EN19" },
    { country: "France / AFNOR", grade: "42CD4" },
  ];

  const applications = [
    "Machine Tool Bases and Bases",
    "Gears, Gear Racks and Pinions",
    "High Tensile Bolts & Nuts",
    "Oil & Gas Industry Fittings",
    "Mold Bases and Die Holders",
    "Automotive Shafts and Axles",
    "Conveyor Components",
    "Industrial Hydraulic Parts"
  ];
  ...
  const specifications = [
    ...
    "Finish: Hot Rolled, Annealed, Quenched & Tempered",
    "Certification: ISO 9001:2015, MTR Included"
  ];

  return (
    <>
      <ProductSEO
        title="SAE 4140 Plates Supplier & Stockist | AISI 4140 Alloy Steel Sheets Mumbai"
        description="Premiun SAE 4140 / AISI 4140 Alloy Steel Plates supplier in Mumbai, India. High strength, versatile alloy steel for gears, shafts & machinery parts. Technical data, mechanical properties & 4140 plate weight chart. Global delivery from Mamta Steel Traders."
        keywords="SAE 4140 plates, AISI 4140 steel price, 4140 alloy steel chemical composition, SAE 4140 mechanical properties, 4140 steel sheets Mumbai, AISI 4140 equivalent grades, alloy steel plate stockist India, Mamta Steel Traders"
        category="Plates & Sheets"
        productName="SAE 4140 (AISI 4140) Ally Steel Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/alloy-steel/sae-4140-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SAE 4140 Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Versatile Alloy Grade - In Stock</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SAE 4140 / AISI 4140 Plates
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">Cr-Mo High Tensile Alloy Steel</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  A chromium-molybdenum alloy steel used extensively in the oil and gas industry and for general engineering applications requiring high tensile strength and toughness.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Request Custom Profile
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={alloySteelPlates} alt="SAE 4140 Alloy Steel Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">High Yield Capacity</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Material Profile: SAE 4140 (AISI 4140)
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    SAE 4140 is a chromium-molybdenum alloy steel widely used in a variety of industries for its excellent strength, toughness, and wear resistance. Its versatility makes it the "go-to" grade for engineering applications that require a balance of mechanical properties. It is easily heat-treatable to achieve a wide range of hardness levels, ensuring it meets the specific needs of machinery and automotive components.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Readily weldable using standard techniques with proper pre/post heating.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Versatility</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Unmatched balance of toughness, strength, and ductile properties.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Hardening</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Uniformly deep hardened through simple oil quenching heat treat.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">Plate Thickness</p>
                    <p className="text-4xl font-black text-gold-primary italic">3.0 – 150.0mm</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Industry Standard 4140 Stockist in Mumbai</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel offers high-grade SAE 4140 plates with full mill certifications and complete traceability. From cut-to-size blanks to full industrial sheets, we cater to all your chromium-molly alloy requirements with rapid shipping.</p>
