...
export default function Grade174PHPlatesDetail() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "1103 (H900)" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "1000 (H900)" },
    { property: "Elongation (% in 50mm) min", value: "14" },
    { property: "Hardness (Rockwell C)", value: "40 - 47" },
  ];

  const equivalentGrades = [
    { country: "USA / AISI", grade: "17-4PH / S17400" },
    { country: "Germany / DIN", grade: "1.4542" },
    { country: "France / AFNOR", grade: "Z6CNU17-04" },
    { country: "Japan / JIS", grade: "SUS630" },
    { country: "AMS Specifications", grade: "AMS 5604" },
  ];
  ...
  const specifications = [
    ...
    "Width: up to 2500mm",
    "Finish: 2B, BA, No.1, No.4",
    "Heat Treatment: Solution Annealed, Aged (H900, H1025, H1150)",
    "Condition: Condition A, Condition H"
  ];

  return (
    <>
      <ProductSEO
        title="17-4 PH Plates Supplier & Stockist | ASTM A693 S17400 Stainless Steel Mumbai"
        description="Premium 17-4 PH / S17400 Stainless Steel Plates stockist in Mumbai, India. High strength precipitation hardening steel for aerospace & chemical industries. Technical specs for Kondition H900, H1025, H1150. Global supply at Mamta Steel Traders."
        keywords="17-4 PH plates, S17400 stainless steel price, ASTM A693 supplier Mumbai, 1.4542 steel sheets, 17-4PH mechanical properties, precipitation hardening stainless steel, 17-4PH H900 condition, aerospace grade stainless steel"
        category="Plates & Sheets"
        productName="17-4 PH (S17400) Plates"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/alloy-steel/17-4ph-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">17-4 PH Plates</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Precipitation Hardening - Grade 630</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  17-4 PH Plates & Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">UNS S17400 / DIN 1.4542 Alloy</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  A martensitic precipitation-hardening stainless steel providing an outstanding combination of high strength, good corrosion resistance, and good mechanical properties at temperatures up to 600°F (316°C).
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Request Technical MTR
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={carbonSteelPlates} alt="17-4 PH Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest">Hardness Factor</p>
                  <p className="text-white font-black text-xl italic uppercase">High Strength</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 italic">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-12 mb-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Overview: 17-4 PH (AISI 630)
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    17-4 PH (Precipitation Hardening) is a martensitic stainless steel that delivers high strength and hardness along with excellent corrosion resistance. It is often used in the aerospace, chemical, and food processing industries. The grade is capable of attaining a wide range of strength and toughness properties depending on the precipitation or age-hardening temperature used in heat treatment.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Hardening</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Simple low-temperature heat treatment prevents distortion and scaling.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Corrosion</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Corrosion resistance exceeds that of standard hardenable steels like 410.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Can be readily welded by common fusion and resistance methods.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <h3 className="text-2xl font-bold mb-8 uppercase border-b-2 border-gold-primary pb-2 inline-block italic tracking-widest">Stock Range</h3>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Ex-Stock Delivery in Mumbai & Beyond</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel is the primary stockist for 17-4 PH plates in Mumbai, supplying various conditions from solution annealed to H900, H1025, and H1150. We offer third-party inspection (TPI) and same-day dispatch.</p>
