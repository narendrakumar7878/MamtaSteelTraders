...
export default function Grade50CrV4SheetsDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "0.47", max: "0.55" },
    { element: "Manganese (Mn)", min: "0.70", max: "1.10" },
    { element: "Silicon (Si)", min: "0.15", max: "0.40" },
    { element: "Chromium (Cr)", min: "0.90", max: "1.20" },
    { element: "Vanadium (V)", min: "0.10", max: "0.25" },
    { element: "Phosphorus (P)", min: "—", max: "0.030" },
    { element: "Sulfur (S)", min: "—", max: "0.030" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa)", value: "850 – 1000 (Annealed)" },
    { property: "Yield Strength (MPa) min", value: "650" },
    { property: "Elongation (%) min", value: "12" },
    { property: "Hardness (HB) max", value: "248 (Annealed)" },
  ];

  const equivalentGrades = [
    { country: "DIN / EN", grade: "1.8159 / 50CrV4" },
    { country: "USA / AISI", grade: "SAE 6150" },
    { country: "UK / BS", grade: "735A51 / EN47" },
    { country: "Japan / JIS", grade: "SUP10" },
    { country: "France / AFNOR", grade: "50CV4" },
  ];

  const applications = [
    "High-Stress Automotive Springs",
    "Anti-Roll Bars & Suspension Parts",
    "Gears and Pinions",
  ...
  const specifications = [
    "EN 10083-3 / EN 10132-4",
    "Thickness: 0.5mm to 12mm (Sheets)",
    "Width: up to 1250mm",
    "Length: up to 4000mm",
    "Finish: Cold Rolled, Hot Rolled",
    "Edge: Slit or Mill Edge"
  ];

  return (
    <>
      <ProductSEO
        title="50CrV4 Sheets Supplier & Stockist | EN47 Spring Steel Plates Mumbai India"
        description="Premiun 50CrV4 (1.8159) / EN47 Spring Steel Sheets supplier in Mumbai. Specialized high-fatigue alloy steel for automotive springs & gears. Complete technical data, chemical composition & mechanical properties. Global delivery from Mamta Steel."
        keywords="50CrV4 sheets, EN47 steel plates price, 1.8159 spring steel supplier Mumbai, SAE 6150 sheets India, 50CrV4 chemical composition, spring steel sheet weight chart, automotive spring steel supplier, Mamta Steel Traders Mumbai"
        category="Plates & Sheets"
        productName="50CrV4 (EN47) Spring Steel Sheets"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/alloy-steel/50crv4-sheets"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">50CrV4 Sheets</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">High Tensile Spring Steel - EN47</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  50CrV4 / EN47 Sheets
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">DIN 1.8159 / SAE 6150 Spring Alloy</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  A chromium-vanadium alloyed spring steel that offers excellent toughness, high fatigue strength, and reliability for critical automotive and industrial suspension components.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Request Spring Steel Price List
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center">
                    <Phone className="w-5 h-5 mr-3" /> Metallurgy Support
                  </a>
                </div>
              </div>
              <div className="relative group">
                ...
                <img src={alloySteelPlates} alt="50CrV4 Spring Steel Sheets" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest">Fatigue Resistance</p>
                  <p className="text-white font-black text-xl italic uppercase">Spring Dynamic</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-12 mb-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Material Profile: 50CrV4 / 1.8159
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    50CrV4 is an oil-hardening chromium-vanadium steel with a high yield point, making it exceptionally suited for springs and other high-stress applications. Its excellent resistance to vibration and high fatigue strength allow for durable performance in mission-critical automotive and mechanical systems.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Durability</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional cyclic loading capacity for suspension systems.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Tempering</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Responds excellently to oil hardening and precise tempering cycles.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Wear Control</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Uniform hardness profile ensures consistent wear across components.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <h3 className="text-2xl font-bold mb-8 uppercase border-b-2 border-gold-primary pb-2 inline-block italic tracking-widest">Availability</h3>
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">Sheet Thickness</p>
                    <p className="text-4xl font-black text-gold-primary italic">0.5 – 12.0mm</p>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
                  <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-navy-primary pb-2 inline-block italic tracking-widest">Global Standards</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700">
              <div className="flex items-center mb-10">
                ...
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 italic tracking-tighter">Strategic Utilization</h3>
              </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Premium Spring Steel Stockist in Mumbai</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel offers high-grade 50CrV4 / EN47 sheets with precision slitting and blanking services. We are the preferred supplier for automotive OEM partners and specialized engineering firms across India.</p>
              <div className="flex flex-col sm:flex-row gap-8 justify-center relative z-10">
                ...
                <a href="tel:+919819322576" className="bg-white hover:bg-slate-100 text-navy-primary px-12 py-5 rounded-2xl font-black transition-all shadow-2xl hover:scale-110 flex items-center justify-center uppercase tracking-widest">
                  <Phone className="w-5 h-5 mr-3" /> Metallurgy Assistance
                </a>
              </div>
            </div>
          </div>
