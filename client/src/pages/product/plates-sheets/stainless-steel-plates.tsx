...
import ssPlate from "@/assets/SS PLATE  MAMTA STEEL TRADERS.jpg";
  ...
  const stainlessSteelGrades = [
    {
      ...
      chemicalComposition:
        "18-20% Chromium, 8-10.5% Nickel, ≤0.08% Carbon, ≤2% Manganese, ≤1% Silicon",
      applications: [
    ...
    },
    {
      ...
      chemicalComposition:
        "18-20% Chromium, 8-12% Nickel, ≤0.03% Carbon, ≤2% Manganese, ≤1% Silicon",
      applications: [
        "Pressure vessels",
        "Heat exchangers",
    ...
    },
    {
      ...
      chemicalComposition:
        "16-18% Chromium, 10-14% Nickel, 2-3% Molybdenum, ≤0.08% Carbon",
      applications: [
        "Marine equipment",
        "Chemical processing",
        "Medical implants",
    ...
    },
    {
      ...
      chemicalComposition:
        "16-18% Chromium, 10-14% Nickel, 2-3% Molybdenum, ≤0.03% Carbon",
      applications: [
    ...
    },
    {
      ...
      chemicalComposition:
        "18-20% Chromium, 11-15% Nickel, 3-4% Molybdenum, ≤0.03% Carbon",
      applications: [
        "Chemical processing",
    ...
    },
    {
      ...
      chemicalComposition:
        "17-19% Chromium, 9-12% Nickel, 5×C min Ti, ≤0.08% Carbon",
      applications: [
    ...
    },
    {
      ...
      chemicalComposition:
        "24-26% Chromium, 19-22% Nickel, ≤0.25% Carbon, ≤2% Manganese",
      applications: [
        "Furnace equipment",
    ...
    },
    {
      ...
      chemicalComposition:
        "22-24% Chromium, 12-15% Nickel, ≤0.20% Carbon, ≤2% Manganese",
      applications: [
        "Heat exchangers",
        "Furnace parts",
        "Aircraft components",
    ...
    },
    {
      ...
      chemicalComposition:
        "14-15.5% Chromium, 3.5-5.5% Nickel, 2.5-4.5% Copper, ≤0.07% Carbon",
      applications: [
    ...
    },
    {
      ...
      chemicalComposition:
        "15.5-17.5% Chromium, 3-5% Nickel, 3-5% Copper, 0.15-0.45% Niobium",
      applications: [
    ...
    },
    {
      ...
      chemicalComposition:
        "20-22% Chromium, 10-12% Nickel, 1.4-2.0% Silicon, 0.14-0.20% Nitrogen",
      applications: [
        "Power generation",
    ...
    },
    {
      ...
      chemicalComposition:
        "12-14% Chromium, ≤0.16% Carbon, ≤1% Manganese, ≤1% Silicon",
      applications: [
    ...
    },
    {
      ...
      chemicalComposition:
        "11.5-13.5% Chromium, ≤0.15% Carbon, ≤1% Manganese, ≤1% Silicon",
      applications: [
        "Pump shafts",
        "Bolts and nuts",
        "Valve trim",
    ...
    },
    {
      ...
      chemicalComposition:
        "16-18% Chromium, ≤0.12% Carbon, ≤1% Manganese, ≤1% Silicon",
      applications: [
        "Automotive trim",
        "Kitchen equipment",
        "Architectural applications",
    ...
    },
    {
      ...
      chemicalComposition:
        "19-23% Chromium, 23-28% Nickel, 4-5% Molybdenum, 1.5% Copper",
      applications: [
        "Chemical processing",
        "Oil and gas industry",
        "Pollution control",
    ...
    },
    {
      ...
      chemicalComposition:
        "17-19% Chromium, 9-13% Nickel, 10×C min Nb, ≤0.08% Carbon",
      applications: [
        "High temperature applications",
    ...
    },
    {
      ...
      chemicalComposition:
        "21-23% Chromium, 4.5-6.5% Nickel, 2.5-3.5% Molybdenum, 0.08-0.20% Nitrogen",
      applications: [
        "Oil and gas industry",
        "Chemical processing",
        "Marine applications",
    ...
    },
    {
      ...
      chemicalComposition:
        "24-26% Chromium, 6-8% Nickel, 3-5% Molybdenum, 0.24-0.32% Nitrogen",
      applications: [
  ...
  const features = [
    {
      ...
      desc: "Excellent resistance to corrosion in various environments",
    },
    {
      icon: TrendingUp,
      title: "High Strength",
      desc: "Superior mechanical properties and durability",
    },
    {
      icon: Award,
      title: "Multiple Finishes",
      desc: "2B, BA, No.1, No.4, HL, Mirror finish available",
    },
    {
      icon: CheckCircle,
      title: "Custom Sizes",
      desc: "Cut-to-size service available for specific requirements",
    },
  ];
  ...
  const finishTypes = [
    {
      name: "2B Finish",
      description:
        "Cold rolled, heat treated, pickled, and passed through polishing rolls",
    },
    {
      name: "BA Finish",
      description: "Bright annealed finish with a reflective surface",
    },
    {
      name: "No.4 Finish",
      description:
        "General purpose polished finish, one-directional satin finish",
    },
    {
      name: "HL Finish",
      description: "Hairline finish with continuous polishing marks",
    },
    {
      name: "Mirror Finish",
      description:
        "Highly reflective surface suitable for decorative applications",
    },
  ];
  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Comprehensive range of premium stainless steel plates in all standard and specialty grades",
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        >
          <div className="container mx-auto px-4">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <ArrowRight className="w-4 h-4" />
              <Link
                href="/product/plates-sheets"
                className="hover:text-navy-primary transition-colors"
                data-testid="breadcrumb-plates-sheets"
              >
                Plates & Sheets
              </Link>
              <ArrowRight className="w-4 h-4" />
        ...
        {/* Hero Section */}
        <section
          className="bg-gradient-to-r from-navy-primary to-navy-secondary text-white py-16"
          data-testid="hero-section"
        >
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1
                className="text-heading md:text-heading font-bold mb-6"
              ...
              >
                High-grade stainless steel plates in all standard grades and
                custom finishes
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/contact"
                  className="bg-gold-primary hover:bg-gold-secondary text-navy-primary font-semibold py-3 px-8 rounded-lg transition-colors duration-300"
                ...
                <a
                  ...
                  className="border-2 border-white text-white hover:bg-white hover:text-navy-primary font-semibold py-3 px-8 rounded-lg transition-colors duration-300"
        ...
        <section
          ...
          data-testid="grades-gallery-section"
        >
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <h2
                  className="text-2xl font-bold text-navy-primary mb-6"
                ...
                <p
                  ...
                  data-testid="grades-subtitle"
                >
                  Discover our comprehensive collection of premium stainless
                  steel plates in all standard and specialty grades. Each grade
                  is engineered for specific applications with detailed
                  technical specifications and superior quality assurance.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {stainlessSteelGrades.map((grade, index) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3
                        className="text-xl font-bold text-navy-primary mb-3 line-clamp-2"
                        data-testid={`grade-name-${grade.id}`}
                      >
                        {grade.name}
                      </h3>
                      ...
                      <p
                        ...
                        data-testid={`grade-description-${grade.id}`}
                      >
                        {grade.description}
                      </p>
                      ...
                      <div className="mb-4">
                        <h4 className="text-sm font-semibold text-navy-primary mb-2">
                          Chemical Composition:
                        </h4>
                        <p
                          className="text-xs text-gray-600 line-clamp-2"
                          data-testid={`grade-composition-${grade.id}`}
                        >
                          ...
                          {grade.applications
                            ...
                            .map((app, appIndex) => (
                              <li
                                ...
                                data-testid={`grade-app-${grade.id}-${appIndex}`}
                              >
                      ...
                      <div className="mb-4">
                        ...
                        <p
                          ...
                          data-testid={`grade-specs-${grade.id}`}
                        >
              ...
              <div className="mt-16 text-center bg-gray-50 p-8 rounded-lg">
                <h3
                  className="text-2xl font-bold text-navy-primary mb-4"
                  data-testid="enhanced-cta-title"
                >
                  Need Help Selecting the Right Grade?
                </h3>
                <p
                  className="text-gray-600 mb-6 max-w-3xl mx-auto"
                  data-testid="enhanced-cta-description"
                >
                  Our technical experts can help you choose the perfect
                  stainless steel grade for your specific application. Get
                  professional guidance on material selection, specifications,
        ...
        <section className="py-16 bg-white" data-testid="features-section">
          <div className="container mx-auto px-4">
            <h2
              className="text-2xl font-bold text-center text-navy-primary mb-12"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
                ...
                >
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50">
                      <td className="px-4 py-3 font-semibold text-navy-primary">
                        304
                      </td>
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                All compositions are in weight percentage. Balance is Iron (Fe)
                with trace elements as per ASTM standards.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div
                  ...
                  data-testid="specifications-standards"
                >
                  <h3 className="text-2xl font-semibold text-navy-primary mb-6">
                    Standards & Grades
                  </h3>
                ...
                <div
                  className="bg-gray-50 p-8 rounded-lg"
                  data-testid="specifications-applications"
                >
                  <h3 className="text-2xl font-semibold text-navy-primary mb-6">
                    Applications
                  </h3>
        ...
        {/* Contact CTA */}
        <section
          className="py-16 bg-navy-primary text-white"
        ...
        >
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <Link
                href="/contact"
                className="bg-gold-primary hover:bg-gold-secondary text-navy-primary font-semibold py-4 px-8 rounded-lg transition-colors duration-300 inline-block"
