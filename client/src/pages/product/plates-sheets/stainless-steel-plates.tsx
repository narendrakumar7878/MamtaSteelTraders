          ...
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-2xl font-bold text-navy-primary mb-6" data-testid="grades-title">
        ...
        <section className="py-16 bg-gray-50" data-testid="finishes-section">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-2xl font-bold text-center text-navy-primary mb-12" data-testid="finishes-title">
