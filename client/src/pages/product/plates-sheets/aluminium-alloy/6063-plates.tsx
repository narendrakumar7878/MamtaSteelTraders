...
export default function Aluminium6063PlatesDetail() {
  const chemicalComposition = [
    { element: "Magnesium (Mg)", min: "0.45", max: "0.90" },
    { element: "Silicon (Si)", min: "0.20", max: "0.60" },
    ...
    { element: "Titanium (Ti)", min: "—", max: "0.10" },
    { element: "Aluminium (Al)", min: "Remainder", max: "—" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa)", value: "130 - 245" },
    { property: "Yield Strength (MPa)", value: "50 - 215" },
    { property: "Elongation (%)", value: "8 - 18" },
    { property: "Hardness (Brinell)", value: "42 - 73" },
    { property: "Modulus of Elasticity (GPa)", value: "69" },
  ];

  const equivalentGrades = [
    { country: "USA / ASTM", grade: "6063" },
    { country: "Germany / DIN", grade: "AlMgSi0.5 / 3.3206" },
    { country: "UK / BS", grade: "6063 / H9" },
    { country: "Japan / JIS", grade: "A6063" },
    { country: "France / AFNOR", grade: "AGS" },
  ];

  const applications = [
    "Architectural Extrusions & Sections",
    "Window & Door Frames",
    "Curtain Walling & Roof Structures",
    "Railings & Balustrades",
    "Furniture & Interior Fittings",
    "Irrigation Pipes & Tubing",
    "Heat Sinks & Components",
  ...
  const specifications = [
    ...
    "Length: up to 6000mm",
    "Temper: O, T4, T5, T6",
    "Finish: Anodizing Quality, Mill Finish"
  ];

  return (
    <>
      <ProductSEO
        title="Aluminium 6063 Plates & Sheets Supplier | Architectural Grade 6063 T6 Price"
        description="Premium Aluminium 6063 Plates and Sheets supplier in Mumbai. High-quality architectural Al-Mg-Si alloy with excellent finish and corrosion resistance. Best prices for ASTM B209 6063 T6 plates. Exporting to UAE, USA, and global architectural markets."
        keywords="Aluminium 6063 plates, 6063 aluminium sheet supplier, 6063 T6 price India, ASTM B209 6063 properties, 6063 aluminium chemical composition, architectural aluminium 6063, Mumbai aluminium stockist, wholesale aluminium 6063"
        category="Plates & Sheets"
        productName="Aluminium 6063 Plates & Sheets"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/aluminium-alloy/6063-plates"
      />

      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-sans font-sans font-sans">
          <div className="container mx-auto px-4 py-4 font-sans font-sans font-sans">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 font-sans font-sans font-sans">
              ...
              <ArrowRight className="w-4 h-4 font-sans" />
              <span className="text-blue-600 dark:text-blue-400 font-medium font-sans">Aluminium 6063</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center font-sans">
              <div className="font-sans">
                <div className="flex items-center mb-6 font-sans font-sans font-sans">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold font-sans">Premium Architectural Grade</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight font-sans">
                  Aluminium 6063
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide font-sans">ASTM B209 / Architectural T6 Plates</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light font-sans">
                  The standard for architectural excellence. Aluminium 6063 T6 offers an exceptional surface finish and superior resistance to environmental corrosion, making it the industry hallmark for high-end frames and extrusions.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 font-sans">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group font-sans">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform font-sans" /> Get Architectural Quote
                  </Link>
              ...
              <div className="relative group font-sans font-sans font-sans">
                ...
                <img src={ss_plate_img} alt="Aluminium 6063 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px] font-sans" />
        ...
        <div className="container mx-auto px-4 py-16 font-sans font-sans font-sans">
          <div className="max-w-7xl mx-auto font-sans font-sans">
              ...
              <div className="lg:col-span-2 space-y-12 font-sans font-sans">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300 font-sans font-sans font-sans">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase tracking-tighter font-sans">
                    Grade Overview: Aluminium 6063
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light font-sans">
                    Aluminium 6063 is an alloy often referred to as architectural aluminium. It has high corrosion resistance and an excellent surface finish, which makes it particularly suitable for architectural applications such as window frames and door frames. It is also heat treatable and has good weldability. While its mechanical properties are slightly lower than 6061, its ability to produce intricate architectural extrusions makes it a preferred material for interior and exterior design elements.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6 font-sans">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary font-sans font-sans">
                      <Factory className="w-8 h-8 text-navy-primary mb-4 font-sans" />
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-xs mb-2 tracking-widest font-sans">Architectural Grade</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Standard for aesthetic extrusions and high-end frames.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-xs mb-2 tracking-widest font-sans">Surface Quality</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Exceptional finish for powder coating and anodizing.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900 font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-xs mb-2 tracking-widest font-sans">Formability</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Excellent extrudability for complex architectural profiles.</p>
                    </div>
                  </div>
                </div>
                    ...
                    <table className="w-full border-collapse font-sans font-sans">
                      <thead>
                        <tr className="bg-navy-primary text-white font-sans">
                          ...
                          <th className="px-6 py-4 text-center uppercase text-xs font-bold tracking-widest font-sans font-sans font-sans">Max %</th>
                        </tr>
                      </thead>
              ...
              <div className="space-y-8 font-sans font-sans font-sans">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group font-sans">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm font-sans">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic font-sans font-sans">1.0 – 50mm</p>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans">
                  <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-navy-primary pb-2 inline-block tracking-widest font-sans font-sans font-sans font-sans font-sans">Global Equivalents</h3>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans">
                   <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-green-600 pb-2 inline-block tracking-widest font-sans font-sans font-sans font-sans font-sans">Mechanical Properties</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700 font-sans">
              <div className="flex items-center mb-10 font-sans font-sans font-sans font-sans">
                ...
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 tracking-tighter italic font-sans font-sans font-sans font-sans">Architectural Utilization</h3>
              </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group font-sans">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase relative z-10 tracking-widest font-sans">Wholesale Inventory • Export Specialist</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light font-sans">Mamta Steel Traders is a trusted premier stockist of 6063 Aluminium plates and extrusions in Mumbai. We maintain mill-certified inventories for rapid global shipping. Fast export services to architectural and construction sectors in UAE, USA, Europe, and GCC. Competitive wholesale rates for bulk decorative projects.</p>
