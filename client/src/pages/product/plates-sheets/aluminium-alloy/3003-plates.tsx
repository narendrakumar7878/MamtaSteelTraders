...
export default function Aluminium3003PlatesDetail() {
  const chemicalComposition = [
    { element: "Manganese (Mn)", min: "1.00", max: "1.50" },
    { element: "Copper (Cu)", min: "0.05", max: "0.20" },
    { element: "Iron (Fe)", min: "—", max: "0.70" },
    { element: "Silicon (Si)", min: "—", max: "0.60" },
    { element: "Zinc (Zn)", min: "—", max: "0.10" },
    { element: "Aluminium (Al)", min: "Remainder", max: "—" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa)", value: "110 - 200" },
    { property: "Yield Strength (MPa)", value: "35 - 185" },
    { property: "Elongation (%)", value: "8 - 30" },
    { property: "Hardness (Brinell)", value: "28 - 55" },
    { property: "Modulus of Elasticity (GPa)", value: "69" },
  ];

  const equivalentGrades = [
    { country: "USA / ASTM", grade: "3003" },
    { country: "Germany / DIN", grade: "AlMn1 / 3.0515" },
    { country: "UK / BS", grade: "3003 / N3" },
    { country: "Japan / JIS", grade: "A3003" },
    { country: "France / AFNOR", grade: "AM1" },
  ];
  ...
  const specifications = [
    ...
    "Finish: Mill Finish, Stucco Embossed"
  ];

  return (
    <>
      <ProductSEO
        title="Aluminium 3003 Plates & Sheets Supplier | Best Price 3003 H14 India"
        description="Premium Aluminium 3003 Plates and Sheets supplier in Mumbai. High-quality Al-Mn alloy with excellent formability and corrosion resistance. Best wholesale prices for ASTM B209 3003 plates. Global delivery to UAE, USA, and GCC countries."
        keywords="Aluminium 3003 plates, 3003 aluminium sheet supplier, 3003 H14 price India, ASTM B209 3003 properties, 3003 aluminium chemical composition, aluminium alloy 3003 stockist, Mumbai aluminium market, wholesale aluminium 3003"
        category="Plates & Sheets"
        productName="Aluminium 3003 Plates & Sheets"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/aluminium-alloy/3003-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 font-sans">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium">Aluminium 3003</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold font-sans">Industrial Workhorse Grade</span>
                </div>
                ...
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light font-sans">
                  The most widely used of all aluminium alloys. 3003 is a commercially pure aluminium with the addition of manganese, which increases strength while maintaining excellent formability and corrosion resistance.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 font-sans">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group font-sans">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Get Industrial Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_plate_img} alt="Aluminium 3003 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md font-sans">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest">Global Stockist</p>
                  <p className="text-white font-black text-xl italic uppercase font-sans">Mumbai • UAE • Gulf</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase tracking-tighter font-sans">
                    Grade Overview: Aluminium 3003
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light font-sans">
                    Aluminium 3003 is an alloy with very good corrosion resistance and moderate strength. It is not heat treatable and develops strength from cold working only. It has excellent machinability and formability, and is commonly used for chemical equipment, ductwork, and general sheet metal work. Its manganese content effectively increases the strength compared to the 1000 series while retaining high ductility.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6 font-sans">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-xs mb-2 tracking-widest font-sans">Corrosion Expert</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Outstanding resistance to chemical and atmospheric erosion.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-xs mb-2 tracking-widest font-sans">Formability</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Ideal for spinning, drawing, and complex sheet metal work.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Good machinability for a wide range of industrial components.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8 font-sans">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm font-sans">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold font-sans">Standard Widths</p>
                    <p className="text-4xl font-black text-gold-primary italic font-sans">1000 – 1500mm</p>
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700 font-sans">
              <div className="flex items-center mb-10 font-sans">
                ...
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 tracking-tighter italic font-sans">Industrial Scope</h3>
              </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group font-sans">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase relative z-10 tracking-widest font-sans">Premium Quality • Wholesale Rates</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light font-sans">Mamta Steel Traders is one of India's leading stockists of Aluminium 3003 plates. We maintain deep inventories of H14 and O tempers for immediate dispatch. Fast export shipping to UAE, USA, Europe and African nations.</p>
