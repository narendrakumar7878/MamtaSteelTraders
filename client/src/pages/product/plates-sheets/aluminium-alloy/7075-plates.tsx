...
export default function Aluminium7075PlatesDetail() {
  const chemicalComposition = [
    { element: "Zinc (Zn)", min: "5.10", max: "6.10" },
    { element: "Magnesium (Mg)", min: "2.10", max: "2.90" },
    { element: "Copper (Cu)", min: "1.20", max: "2.00" },
    { element: "Chromium (Cr)", min: "0.18", max: "0.28" },
    { element: "Iron (Fe)", min: "—", max: "0.50" },
    { element: "Silicon (Si)", min: "—", max: "0.40" },
    { element: "Manganese (Mn)", min: "—", max: "0.30" },
    { element: "Titanium (Ti)", min: "—", max: "0.20" },
    { element: "Aluminium (Al)", min: "Remainder", max: "—" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa)", value: "510 - 570" },
    { property: "Yield Strength (MPa)", value: "430 - 505" },
    { property: "Elongation (%)", value: "5 - 11" },
    { property: "Hardness (Brinell)", value: "150" },
    { property: "Modulus of Elasticity (GPa)", value: "72" },
  ];

  const equivalentGrades = [
    { country: "USA / ASTM", grade: "7075" },
    { country: "Germany / DIN", grade: "AlZnMgCu1.5 / 3.4365" },
    { country: "UK / BS", grade: "7075 / 2L95" },
    { country: "Japan / JIS", grade: "A7075" },
    { country: "France / AFNOR", grade: "AZ5GU" },
  ];

  const applications = [
    "Aircraft Structural Parts & Fuselages",
    "High-Stress Aerospace Fittings",
    "Military Aircraft Components",
    "Highly Stressed Gears & Shafts",
    "Missile Components",
    "Regulating Valve Parts",
    "Precision Mold Making & Tools",
    "Sporting Goods (High-end Bicycle Parts)"
  ];
  ...
  return (
    <>
      <ProductSEO
        title="Aluminium 7075 T6 Plates & Sheets Supplier | Ultra-High Strength Aerospace Grade"
        description="Premier supplier of Aluminium 7075 Plates in Mumbai. Ultra-high strength aerospace grade comparable to steel. Best prices for AMS-QQ-A-250/12 7075 T6 plates. Exporting to UAE, USA, Europe, and Global Defense markets."
        keywords="Aluminium 7075 plates, 7075 T6 aluminium sheet, aerospace structural plates, AMS-QQ-A-250/12 aluminum, 7075 aluminium chemical composition, ultra high strength aluminium supplier Mumbai, wholesale 7075 aluminium, mold making aluminium plates"
        category="Plates & Sheets"
        productName="Aluminium 7075 Plates & Sheets"
        specifications={specifications}
        canonicalUrl="/product/plates-sheets/aluminium-alloy/7075-plates"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-sans">
          <div className="container mx-auto px-4 py-4 font-sans">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 font-sans font-sans">
              ...
              <ArrowRight className="w-4 h-4 font-sans font-sans" />
              <span className="text-blue-600 dark:text-blue-400 font-medium font-sans font-sans">Aluminium 7075</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center font-sans font-sans">
              <div className="font-sans font-sans font-sans">
                <div className="flex items-center mb-6 font-sans font-sans">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold font-sans font-sans">The Aerospace Strength Titan</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight font-sans font-sans font-sans">
                  Aluminium 7075
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide font-sans font-sans">AMS-QQ-A-250/12 • Ultra Strength T6</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light font-sans font-sans font-sans">
                  Unrivaled strength for critical missions. Aluminium 7075 is one of the highest strength aluminium alloys available, offering mechanical properties comparable to steel. It is the primary choice for aircraft structural parts and high-stress industrial applications.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 font-sans font-sans">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group font-sans font-sans">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform font-sans font-sans" /> Request Critical Quote
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center font-sans font-sans font-sans">
                    <Phone className="w-5 h-5 mr-3 font-sans font-sans font-sans" /> Technical Specialist
                  </a>
                </div>
              </div>
              <div className="relative group font-sans font-sans">
                ...
                <img src={ss_plate_img} alt="Aluminium 7075 Plates" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px] font-sans font-sans font-sans" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md font-sans font-sans">
                  ...
                  <p className="text-white font-black text-xl italic uppercase font-sans font-sans font-sans font-sans">USA • GCC • EUROPE</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16 font-sans font-sans">
          <div className="max-w-7xl mx-auto font-sans font-sans font-sans">
              ...
              <div className="lg:col-span-2 space-y-12 font-sans font-sans font-sans">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300 font-sans font-sans font-sans">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase tracking-tighter font-sans">
                    Grade Overview: Aluminium 7075
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light font-sans font-sans font-sans">
                    Aluminium alloy 7075 is an ultra-high strength alloy with Zinc as the primary alloying element. It is very strong, with strength comparable to many steels. It also possesses good fatigue strength and average machinability. Its relatively high cost limits its use to applications where cheaper alloys are not suitable. 7075 is widely used in airframe structures and high-stress components. It is also a preferred material for high-quality mold tool making in the plastic and aerospace industries.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6 font-sans">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary font-sans font-sans font-sans">
                      <Factory className="w-8 h-8 text-navy-primary mb-4 font-sans font-sans" />
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-xs mb-2 tracking-widest font-sans font-sans">Steel-Like Strength</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Incredible strength-to-weight ratio for critical airframes.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary font-sans font-sans font-sans">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-xs mb-2 tracking-widest font-sans font-sans">Fatigue Peak</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Excellent resistance to cyclic stress and high-load fatigue.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900 font-sans font-sans font-sans">
                      <Zap className="w-8 h-8 text-slate-900 dark:text-gray-300 mb-4 font-sans font-sans font-sans">
                        <path d="M13 10V3L4 14h7v7l9-11h-7z" />
                      </Zap>
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-xs mb-2 tracking-widest font-sans font-sans">Mold Specialist</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium font-sans">Preferred material for high-tolerance industrial mold making.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 font-sans font-sans">
                  ...
                  <div className="overflow-x-auto font-sans font-sans font-sans font-sans">
                    <table className="w-full border-collapse font-sans font-sans font-sans">
                      <thead>
                        <tr className="bg-navy-primary text-white font-sans font-sans">
                          <th className="px-6 py-4 text-left uppercase text-xs font-bold tracking-widest font-sans border-r border-white/10 font-sans">Element</th>
                          <th className="px-6 py-4 text-center uppercase text-xs font-bold tracking-widest font-sans border-r border-white/10 font-sans">Min %</th>
                      ...
                      <tbody className="divide-y divide-gray-100 dark:divide-gray-700 font-sans font-sans">
                        {chemicalComposition.map((c, i) => (
                          <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors font-sans">
                            <td className="px-6 py-4 font-bold text-gray-700 dark:text-gray-300 uppercase text-xs tracking-tight font-sans border-r border-gray-50 dark:border-gray-600 font-sans">{c.element}</td>
                            <td className="px-6 py-4 text-center font-mono text-lg text-navy-primary dark:text-blue-400 font-bold font-sans border-r border-gray-50 dark:border-gray-600 font-sans font-sans">{c.min}</td>
              ...
              <div className="space-y-8 font-sans font-sans font-sans font-sans">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group font-sans">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm font-sans font-sans">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic font-sans font-sans font-sans">0.5 – 200mm</p>
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-16 border border-gray-100 dark:border-gray-700 font-sans font-sans">
              <div className="flex items-center mb-10 font-sans font-sans font-sans font-sans font-sans">
                <Anchor className="w-10 h-10 text-gold-primary mr-4 font-sans font-sans font-sans" />
                <h3 className="text-3xl font-bold text-navy-primary dark:text-white uppercase border-l-8 border-gold-primary pl-4 tracking-tighter italic font-sans font-sans font-sans">Aerospace & Defense Specialty</h3>
              </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group font-sans font-sans">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase relative z-10 tracking-widest font-sans font-sans font-sans">Premium Global Supply Chain</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light font-sans font-sans font-sans">Mamta Steel Traders is a trusted premier stockist of 7075 Aluminium plates in Mumbai. We maintain mill-certified inventories for rapid global shipping. Fast export services to aerospace and defense sectors in USA, Europe, GCC, and Southeast Asia. Competitive wholesale rates for bulk high-performance projects.</p>
