...
const alloySteelGrades = [
  {
    ...
    chemicalComposition:
      "C: 0.12-0.18%, Cr: 1.25-1.50%, Mo: 0.80-1.00%, V: 0.20-0.30%, Mn: 0.80-1.10%, Si: ≤0.20%",
    applications: [
  ...
  },
  {
    ...
    chemicalComposition:
      "C: ≤0.07%, Cr: 15.00-17.50%, Ni: 3.00-5.00%, Cu: 3.00-5.00%, Nb/Ta: 0.15-0.45%",
    applications: [
      "Aerospace parts",
  ...
  },
  {
    ...
    chemicalComposition:
      "C: 0.50-0.55%, Cr: 1.00-1.20%, V: 0.15-0.25%, Mn: 0.70-0.80%, Si: 0.20-0.35%",
    applications: [
      "Springs",
      "Gears and pinions",
      "Shafts and axles",
  ...
  },
  {
    ...
    chemicalComposition:
      "Varies by grade - Typical: C: 0.05-0.20%, Cr: 0.50-9.00%, Mo: 0.45-1.10% (Grade dependent)",
    applications: [
      "Boilers",
      "Pressure vessels",
      "Oil & gas industry",
    ...
    specifications:
      "ASTM A387, ASME SA387, Multiple grades (5, 9, 11, 12, 22, 91)",
  },
  {
    id: "EN19",
    name: "EN19 Plates",
    ...
    chemicalComposition:
      "C: 0.38-0.43%, Cr: 0.80-1.10%, Mo: 0.15-0.25%, Mn: 0.75-1.00%, Si: 0.15-0.30%",
    applications: [
      "Gears and pinions",
      "Shafts and spindles",
      "Oil & gas equipment",
  ...
  },
  {
    ...
    chemicalComposition:
      "C: 0.38-0.43%, Cr: 0.80-1.10%, Mo: 0.15-0.25%, Mn: 0.75-1.00%, Si: 0.15-0.35%",
    applications: [
...
const features = [
  {
    ...
    description:
      "Superior tensile strength and toughness for demanding applications",
  },
  {
    icon: Factory,
    title: "Heat Treatable",
    description:
      "Excellent response to heat treatment for optimized properties",
  },
  {
    icon: Award,
    title: "Corrosion Resistant",
    description:
      "Enhanced corrosion and oxidation resistance in harsh environments",
  },
  {
    icon: Truck,
    title: "Versatile Applications",
    description:
      "Suitable for aerospace, oil & gas, automotive, and general engineering",
  },
];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Premium range of specialized alloy steel plates for aerospace, industrial, and engineering applications",
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <Link
                ...
                className="hover:text-blue-600"
                data-testid="link-plates-sheets"
              >
                Plates & Sheets
              </Link>
              <ArrowRight className="w-4 h-4" />
        ...
        <section className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Comprehensive range of high-grade alloy steel plates including
                aerospace, spring steel, precipitation hardening, and chrome
                moly grades for specialized industrial applications.
              </p>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              >
                Our alloy steel plates combine superior mechanical properties
                with proven reliability for critical applications.
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2
                className="text-2xl font-bold text-gray-900 mb-4"
                data-testid="heading-grades"
              >
                Alloy Steel Plate Grades
              </h2>
              <p
                className="text-lg text-gray-600 max-w-3xl mx-auto"
                data-testid="text-grades-description"
              >
                We supply premium alloy steel plates in various grades optimized
                for specific applications including aerospace, automotive, oil &
                gas, and general engineering.
              </p>
            </div>
              ...
              {alloySteelGrades.map((grade) => (
                ...
                >
                  <div className="relative">
                    ...
                    />
                    <Badge
                      className="absolute top-4 left-4 bg-blue-600"
                  ...
                  <CardHeader>
                    <CardTitle
                      ...
                      data-testid={`text-grade-name-${grade.id}`}
                    >
                      {grade.name}
                    </CardTitle>
                  </CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    <p
                      ...
                      data-testid={`text-grade-description-${grade.id}`}
                    >
                      {grade.description}
                    </p>
                    ...
                    <div>
                      <h4
                        ...
                        data-testid={`text-composition-title-${grade.id}`}
                      >
                        Chemical Composition:
                      </h4>
                      <p
                        className="text-sm text-gray-600 bg-gray-50 p-2 rounded"
                        data-testid={`text-composition-${grade.id}`}
                      >
                    ...
                    <div>
                      <h4
                        className="font-semibold text-gray-900 mb-2"
                        data-testid={`text-applications-title-${grade.id}`}
                      >
                        Key Applications:
                      </h4>
                      <div className="flex flex-wrap gap-1">
                        {grade.applications.slice(0, 3).map((app, idx) => (
                          <Badge
                            ...
                            variant="outline"
                            className="text-xs"
                            data-testid={`badge-application-${grade.id}-${idx}`}
                          >
                            {app}
                          </Badge>
                        ))}
                        {grade.applications.length > 3 && (
                          <Badge
                            variant="outline"
                            className="text-xs"
                            data-testid={`badge-more-${grade.id}`}
                          >
                    ...
                    <div>
                      <h4
                        ...
                        data-testid={`text-standards-title-${grade.id}`}
                      >
                        Standards:
                      </h4>
                      <p
                        className="text-sm text-gray-600"
                        data-testid={`text-standards-${grade.id}`}
                      >
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2
                className="text-2xl font-bold text-gray-900 mb-4"
                data-testid="heading-composition-table"
              >
                Chemical Composition Reference
              </h2>
              <p
                className="text-lg text-gray-600 max-w-2xl mx-auto"
                data-testid="text-composition-table-description"
              >
                Detailed chemical composition ranges for our alloy steel plate
                grades
              </p>
            </div>
              ...
              >
                <thead>
                  <tr className="bg-gray-50">
                    ...
                    <th
                      className="border border-gray-300 px-4 py-3 text-left font-semibold"
                      data-testid="header-carbon"
                    >
                      Carbon (C)
                    </th>
                    <th
                      className="border border-gray-300 px-4 py-3 text-left font-semibold"
                      data-testid="header-chromium"
                    >
                      Chromium (Cr)
                    </th>
                    <th
                      className="border border-gray-300 px-4 py-3 text-left font-semibold"
                      data-testid="header-molybdenum"
                    >
                      Molybdenum (Mo)
                    </th>
                    <th
                      className="border border-gray-300 px-4 py-3 text-left font-semibold"
                      data-testid="header-other"
                    >
                      Other Elements
                    </th>
                  </tr>
                ...
                <tbody>
                  <tr data-testid="row-15cdv6">
                    <td
                      ...
                      data-testid="cell-15cdv6-grade"
                    >
                      15CDV6
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-15cdv6-carbon"
                    >
                      0.12-0.18%
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-15cdv6-chromium"
                    >
                      1.25-1.50%
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-15cdv6-molybdenum"
                    >
                      0.80-1.00%
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-15cdv6-other"
                    >
                      V: 0.20-0.30%, Mn: 0.80-1.10%
                    </td>
                  </tr>
                  <tr className="bg-gray-50" data-testid="row-17-4ph">
                    <td
                      className="border border-gray-300 px-4 py-3 font-medium"
                      data-testid="cell-17-4ph-grade"
                    >
                      17-4 PH
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-17-4ph-carbon"
                    >
                      ≤0.07%
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-17-4ph-chromium"
                    >
                      15.00-17.50%
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-17-4ph-molybdenum"
                    >
                      -
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-17-4ph-other"
                    >
                      Ni: 3.00-5.00%, Cu: 3.00-5.00%
                    </td>
                  </tr>
                  <tr data-testid="row-50crv4">
                    <td
                      className="border border-gray-300 px-4 py-3 font-medium"
                      data-testid="cell-50crv4-grade"
                    >
                      50CrV4
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-50crv4-carbon"
                    >
                      0.50-0.55%
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-50crv4-chromium"
                    >
                      1.00-1.20%
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-50crv4-molybdenum"
                    >
                      -
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-50crv4-other"
                    >
                      V: 0.15-0.25%, Mn: 0.70-0.80%
                    </td>
                  </tr>
                  <tr className="bg-gray-50" data-testid="row-en19">
                    <td
                      className="border border-gray-300 px-4 py-3 font-medium"
                      data-testid="cell-en19-grade"
                    >
                      EN19/SAE 4140
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-en19-carbon"
                    >
                      0.38-0.43%
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-en19-chromium"
                    >
                      0.80-1.10%
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-en19-molybdenum"
                    >
                      0.15-0.25%
                    </td>
                    <td
                      className="border border-gray-300 px-4 py-3"
                      data-testid="cell-en19-other"
                    >
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              >
                Our alloy steel plates serve critical applications across
                diverse industries
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card
                ...
                data-testid="card-aerospace"
              >
                <CardHeader>
                  <CardTitle
                    className="text-xl text-blue-600"
                    data-testid="title-aerospace"
                  >
                    Aerospace & Defense
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-gray-600">
                    <li data-testid="item-aerospace-1">
                      • Aircraft structural components
                    </li>
                    <li data-testid="item-aerospace-2">• Landing gear parts</li>
                    <li data-testid="item-aerospace-3">
              ...
              <Card
                className="hover:shadow-lg transition-shadow"
                data-testid="card-oil-gas"
              >
                <CardHeader>
                  <CardTitle
                    className="text-xl text-blue-600"
                    data-testid="title-oil-gas"
                  >
                    Oil & Gas
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-gray-600">
                    ...
                    <li data-testid="item-oil-gas-3">
                      • Petrochemical equipment
                    </li>
                    <li data-testid="item-oil-gas-4">
                      • High-temperature service parts
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              >
                ...
                <CardContent>
                  <ul className="space-y-2 text-gray-600">
                    <li data-testid="item-automotive-1">
                      • Gears and transmission parts
                    </li>
                    <li data-testid="item-automotive-2">
                      • Shafts and spindles
                    </li>
                    <li data-testid="item-automotive-3">• Spring components</li>
                    <li data-testid="item-automotive-4">
                      • Machine tool parts
                    </li>
                  </ul>
                </CardContent>
        ...
        <section className="py-16 bg-blue-900 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              Contact our steel experts for technical specifications, pricing,
