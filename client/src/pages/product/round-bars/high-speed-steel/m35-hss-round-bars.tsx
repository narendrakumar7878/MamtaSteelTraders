...
export default function M35HSSRoundBarsDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.80 – 0.95%" },
    { element: "Cobalt (Co)", value: "4.50 – 5.50%" },
    { element: "Tungsten (W)", value: "5.75 – 6.75%" },
    { element: "Molybdenum (Mo)", value: "4.75 – 5.50%" },
  ...
  const thermalSpecs = [
    { process: "Hardening", temp: "1190 – 1230°C", desc: "Oil quench or gas quench in vacuum furnace. Cobalt content allows for higher working temperatures." },
    { process: "Tempering", temp: "540 – 580°C", desc: "Triple tempering is mandatory. Cobalt enhances the tempering resistance and hot hardness." },
    { process: "Annealing", temp: "830 – 860°C", desc: "Slow furnace cooling (10-20°C/hr) to 600°C, then air cooling. Brinell hardness max 269 HB." }
  ];

  return (
    <>
      <ProductSEO
        title="M35 High Speed Steel Round Bars | Cobalt HSS | HSS M35 Supplier Mumbai"
        description="Premium M35 Cobalt High Speed Steel round bars. 5% Cobalt alloyed HSS with superior red hardness and wear resistance for heavy-duty cutting tools."
        keywords="m35 hss round bars, cobalt hss supplier mumbai, hss m35 bars, heavy duty cutting tool steel, m35 tool steel india"
        canonicalUrl="/product/round-bars/high-speed-steel/m35-hss-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-black h-fit" />
                 <span className="text-navy-primary dark:text-gold-primary italic uppercase underline decoration-navy-primary decoration-2 underline-offset-4 tracking-tighter italic">HSS M35 (Cobalt Alloyed)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4 text-black">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden h-fit">
          <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
            <div className="max-w-4xl h-fit overflow-hidden">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg underline decoration-navy-primary decoration-4 h-fit overflow-hidden italic">The Cobalt Performance Specialist</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none h-fit overflow-hidden underline decoration-gold-primary decoration-4 underline-offset-[12px] italic">M35 High Speed Steel</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase h-fit overflow-hidden italic">5% Cobalt-alloyed High Speed Steel engineered for superior red hardness and resistance to tempering in high-heat machining.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 h-fit overflow-hidden">
              <div className="lg:col-span-2 space-y-12 h-fit overflow-hidden">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden text-black h-fit">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6 h-fit overflow-hidden h-fit italic">Metallurgical Profile (M35)</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter h-fit overflow-hidden italic">HSS M35 is a cobalt-alloyed variety of M2 HSS. The addition of 5% Cobalt significantly improves its red hardness (hardness at high temperatures) and tempering resistance. This makes M35 ideal for cutting materials that have high hardness or generate significant heat during machining, such as stainless steels and Nimonic alloys. Mamta Steel Traders supplies M35 bars specifically for the manufacture of heavy-duty drills and hobs.</p>
                   ...
                   <div className="relative z-10 h-fit overflow-hidden text-white h-fit">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 h-fit h-fit overflow-hidden text-white h-fit overflow-hidden h-fit h-fit">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit italic">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic h-fit overflow-hidden italic tracking-tighter italic">Red Hardness</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden italic tracking-tighter italic underline decoration-gold-primary decoration-2 h-fit overflow-hidden">5% Cobalt Boost</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit italic">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic h-fit overflow-hidden italic tracking-tighter italic">Working Hardness</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden italic tracking-tighter italic underline decoration-gold-primary decoration-2 h-fit overflow-hidden">65 - 67 HRC</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit h-fit overflow-hidden text-black h-fit">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit h-fit overflow-hidden italic">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic">
                      {["Heavy Duty Drills", "Milling Cutters", "Gear Hobs", "End Mills", "Forming Tools", "Cold Extrusion Tools"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden h-fit h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic">
           <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden text-black h-fit">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic tracking-tighter italic underline decoration-gold-primary decoration-4 underline-offset-8 italic">Direct Supplier: M35 Cobalt HSS Bars</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic tracking-tighter italic">Mamta Steel Traders delivers ready-to-dispatch HSS M35 (Cobalt Alloyed) round bars for extreme cutting performance. Full NABL certification and rapid mobilization.</p>
