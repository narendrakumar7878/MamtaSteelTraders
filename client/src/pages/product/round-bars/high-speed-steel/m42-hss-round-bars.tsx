...
export default function M42HSSRoundBarsDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "1.05 – 1.15%" },
    { element: "Cobalt (Co)", value: "7.75 – 8.75%" },
    { element: "Molybdenum (Mo)", value: "9.00 – 10.00%" },
    { element: "Chromium (Cr)", value: "3.50 – 4.25%" },
    { element: "Tungsten (W)", value: "1.35 – 1.85%" },
    { element: "Vanadium (V)", value: "0.95 – 1.35%" },
    { element: "Silicon (Si)", value: "0.45% max" },
    { element: "Manganese (Mn)", value: "0.40% max" }
  ];

  const thermalSpecs = [
    { process: "Hardening", temp: "1170 – 1190°C", desc: "Oil quench or vacuum cooling. High molybdenum and cobalt content allows for extreme hardness." },
    { process: "Tempering", temp: "540 – 560°C", desc: "Triple tempering at 2-hour intervals is essential to reach 67-69 HRC safely." },
    { process: "Annealing", temp: "830 – 860°C", desc: "Slow cooling in furnace at 10°C per hour down to 600°C. Max hardness 280 HB." }
  ];

  return (
    <>
      <ProductSEO
        title="M42 High Speed Steel Round Bars | Super Cobalt HSS | HSS M42 Supplier Mumbai"
        description="Premium M42 Super Cobalt High Speed Steel round bars. 8% Cobalt alloyed HSS with extreme hardness up to 70 HRC. Ideal for cutting superalloys and hard metals."
        keywords="m42 hss round bars, super cobalt hss supplier mumbai, hss m42 bars, cutting superalloys tool steel, m42 high speed steel india"
        canonicalUrl="/product/round-bars/high-speed-steel/m42-hss-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black">
                 ...
                 <Link href="/product/round-bars/high-speed-steel" className="text-gray-600 dark:text-gray-400 hover:text-navy-primary uppercase italic">HSS Series</Link>
                 <ArrowRight className="w-4 h-4 text-gray-400 font-black h-fit" />
                 <span className="text-navy-primary dark:text-gold-primary italic uppercase underline decoration-navy-primary decoration-2 underline-offset-4 tracking-tighter italic">HSS M42 (Super Cobalt)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4 text-black">
           <Link href="/product/round-bars/high-speed-steel" className="inline-flex items-center text-navy-primary dark:text-gold-primary hover:underline font-black uppercase text-xs h-fit overflow-hidden">
              <ArrowLeft className="w-3 h-3 mr-2 h-fit overflow-hidden" /> Back to HSS Hub
           </Link>
        </div>
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden h-fit">
          <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
            <div className="max-w-4xl h-fit overflow-hidden">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg underline decoration-navy-primary decoration-4 h-fit overflow-hidden italic">The Superalloy Specialist</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none h-fit overflow-hidden underline decoration-gold-primary decoration-4 underline-offset-[12px] italic">M42 High Speed Steel</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase h-fit overflow-hidden italic">Premium 8% Cobalt Super High Speed Steel designed for extreme hardness and superior cutting performance in the toughest superalloys.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 h-fit overflow-hidden">
              <div className="lg:col-span-2 space-y-12 h-fit overflow-hidden">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden text-black h-fit">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6 h-fit overflow-hidden h-fit italic">Metallurgical Profile (M42)</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter h-fit overflow-hidden italic">HSS M42 is a molybdenum-base super high speed tool steel with high cobalt. Its exceptional red hardness and wear resistance allow for higher speeds and feeds in the machining of hard and difficult-to-cut materials like Inconel, Titanium, and Stainless Steel. With the ability to reach a working hardness of 67-69 HRC, M42 is the ultimate choice for heavy-duty tool manufacturing. Mamta Steel Traders is a key supplier of M42 for Mumbai's aerospace and defense manufacturing sectors.</p>
                   ...
                   <div className="relative z-10 h-fit overflow-hidden text-white h-fit">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 h-fit h-fit overflow-hidden text-white h-fit overflow-hidden h-fit h-fit">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit italic">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic h-fit overflow-hidden italic tracking-tighter italic">Extreme Hardness</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden italic tracking-tighter italic underline decoration-gold-primary decoration-2 h-fit overflow-hidden">Up to 70 HRC</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit italic">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic h-fit overflow-hidden italic tracking-tighter italic">Cobalt Rich</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden italic tracking-tighter italic underline decoration-gold-primary decoration-2 h-fit overflow-hidden">8.25% Cobalt</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit h-fit overflow-hidden text-black h-fit">
                <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 h-fit h-fit overflow-hidden text-black h-fit overflow-hidden h-fit italic">
                  <h3 className="text-xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase border-b border-gold-primary pb-2 h-fit overflow-hidden h-fit italic tracking-tighter italic">Thermal Specs</h3>
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit h-fit overflow-hidden italic">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic">
                      {["End Mills", "Form Cutters", "Broaches", "Gear Hobs", "Space-grade Fasteners", "Medical Tooling"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden h-fit h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic">
           <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden text-black h-fit">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic tracking-tighter italic underline decoration-gold-primary decoration-4 underline-offset-8 italic">Direct Supplier: M42 Super Cobalt HSS Bars</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic tracking-tighter italic">Mamta Steel Traders delivers ready-to-dispatch HSS M42 (Super Cobalt) round bars for the most extreme cutting demands. Aerospace-certified metallurgy and rapid logistics.</p>
