...
export default function EN1ALeadedDetail() {
  const chemicalComposition = [
    ...
    { element: "Lead (Pb)", value: "0.15 – 0.35%" }
  ];

  const thermalSpecs = [
    { process: "Bright Drawing", temp: "Cold", desc: "Reduces diameter while increasing tensile strength and surface finish." },
    { process: "Machinability", temp: "Excellent", desc: "Lead creates internal lubrication for high-speed chip breaking." },
    { process: "Toxicity", temp: "N/A", desc: "Handle with care during welding due to lead vapor emission." }
  ];

  return (
    <>
      <ProductSEO
        title="EN1A Leaded Round Bars | EN1APb Free Cutting Steel Supplier Mumbai"
        description="Premium EN1A leaded (EN1APb) free machining steel round bars. Superior machinability for high-speed CNC parts. Certified BS 970 standard."
        keywords="en1a leaded round bars, en1apb steel supplier, free cutting steel mumbai, bright drawn en1a leaded, 230M07Pb steel"
        canonicalUrl="/product/round-bars/en-series/en1a-leaded"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary">EN1A Leaded (EN1APb)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block">Free Machining Champion</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none">EN1A Leaded (EN1APb)</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase">The ultimate free-cutting steel for precision high-speed automatic machining of complex components.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6">Grade Profile</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter">EN1A leaded is specifically formulated for parts produced on multi-spindle and CNC machines. The addition of lead acts as an internal lubricant, reducing friction at the tool edge, lowering power consumption, and ensuring the highest quality surface finish.</p>
                   ...
                   <div className="relative z-10">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic">Ductility</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic">Limited - Optimized for Machining</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic">Weldability</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic">Poor (Due to lead content)</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8">
                <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700">
                  <h3 className="text-xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase border-b border-gold-primary pb-2">Thermal Processing</h3>
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden">
                   <h3 className="text-2xl font-black mb-6 italic tracking-tighter uppercase">Common Applications</h3>
                   <div className="space-y-4 font-black italic uppercase tracking-tighter">
                      {["Automotive Fasteners", "Hydraulic Fittings", "Precision Precision Hubs", "CNC Turn Parts", "Bushings", "Specialty Screws"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden">
           <div className="container mx-auto px-4 relative z-10">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase">Direct-From-Stock EN1A Leaded</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase">Mamta Steel Traders maintains the largest inventory of bright drawn EN1A leaded round bars in Mumbai. Every batch is certified for high-precision CNC manufacturing standards.</p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                 <Link href="/contact" className="bg-navy-primary text-white px-12 py-5 rounded-3xl font-black hover:bg-navy-secondary transition-all shadow-xl italic tracking-tighter uppercase">Request Custom Cut</Link>
                 <a href="mailto:naren@mamtasteel.com" className="border-4 border-navy-primary text-navy-primary px-12 py-5 rounded-3xl font-black hover:bg-gray-50 transition-all italic tracking-tighter uppercase">Technical Data Sheet</a>
              </div>
           </div>
