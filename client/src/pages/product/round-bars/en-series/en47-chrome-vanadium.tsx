...
export default function EN47ChromeVanadiumDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.45 – 0.55%" },
    { element: "Silicon (Si)", value: "0.10 – 0.50%" },
    { element: "Manganese (Mn)", value: "0.50 – 0.80%" },
    { element: "Chromium (Cr)", value: "0.80 – 1.20%" },
    { element: "Vanadium (V)", value: "0.15% min" },
    { element: "Sulphur (S)", value: "0.05% max" },
    { element: "Phosphorus (P)", value: "0.05% max" }
  ];

  const thermalSpecs = [
    { process: "Forgeability", temp: "1050 – 850°C", desc: "Chromium-Vanadium alloy requires slow, controlled cooling to avoid stress cracks." },
    { process: "Hardening", temp: "830 – 860°C", desc: "Quench in oil. Vanadium ensures a fine grain structure and high fatigue limit." },
    { process: "Tempering", temp: "450 – 600°C", desc: "Achieve the ultimate balance of hardness and resilience for heavy duty springs." }
  ];

  return (
    <>
      <ProductSEO
        title="EN47 Chrome Vanadium Spring Steel Round Bars | Mumbai India"
        description="Premium EN47 chromium-vanadium alloy spring steel round bars. Exceptional fatigue resistance and high pressure endurance for critical automotive springs. Certified BS 970."
        keywords="en47 spring steel, en47 round bars mumbai, chrome vanadium steel supplier, automotive spring steel, en series round bars"
        canonicalUrl="/product/round-bars/en-series/en47-chrome-vanadium"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black">
                 ...
                 <Link href="/product/round-bars/en-series" className="text-gray-600 dark:text-gray-400 hover:text-navy-primary uppercase italic">EN Series</Link>
                 <ArrowRight className="w-4 h-4 text-gray-400 font-black h-fit" />
                 <span className="text-navy-primary dark:text-gold-primary italic uppercase">EN47 (Chrome Vanadium Spring)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden h-fit">
          <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
            <div className="max-w-4xl h-fit overflow-hidden">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg underline decoration-navy-primary decoration-4 h-fit overflow-hidden">The fatigue endurance Hero</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none h-fit overflow-hidden h-fit overflow-hidden">EN47 Chrome Vanadium</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase h-fit overflow-hidden h-fit overflow-hidden">High-grade Chromium-Vanadium alloy delivering absolute structural integrity and maximum fatigue resistance for arduous valve springs.</p>
              <div className="flex flex-wrap gap-4 h-fit h-fit overflow-hidden">
            ...
            <div className="grid lg:grid-cols-3 gap-12 h-fit overflow-hidden">
              <div className="lg:col-span-2 space-y-12 h-fit overflow-hidden">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden text-black h-fit">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6 h-fit overflow-hidden text-black h-fit">Metallurgical Profile (EN47)</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter h-fit overflow-hidden">EN47 is a high-grade chromium-vanadium spring steel. The addition of vanadium ensures a very fine grain structure, which drastically improves the steel's fatigue limit and resistance to impact. It is the premier choice for critical high-performance valve springs, fuel injector springs, and heavy-duty industrial components in Mumbai's automotive and aerospace engineering sectors.</p>
                ...
                <div className="bg-navy-primary text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group h-fit overflow-hidden text-white">
                   <div className="relative z-10 h-fit overflow-hidden text-white h-fit h-fit">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 h-fit h-fit overflow-hidden text-white h-fit overflow-hidden h-fit h-fit">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden">48 – 54 HRC (Tempered)</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic h-fit overflow-hidden">Fatigue Strength</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden">Record Endurance Limit</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit h-fit overflow-hidden text-black h-fit">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit h-fit overflow-hidden">
                   <h3 className="text-2xl font-black mb-6 italic tracking-tighter uppercase h-fit overflow-hidden">Critical Applications</h3>
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden">
                      {["High Performance Valve Springs", "Fuel Injector Springs", "Heavy Duty Chassis Springs", "Induction Hardened Pinions", "Extreme Load Clutch Plates", "Agricultural Tines"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden h-fit h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden">
           <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden text-black h-fit">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden">Direct Supplier: EN47 Chrome Vanadium</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase h-fit overflow-hidden h-fit overflow-hidden">Mamta Steel Traders delivers ready-to-dispatch EN47 round bars for the world's most arduous wear projects. Certified to BS 970 standards with guaranteed chemical integrity and extreme fatigue endurance.</p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center h-fit overflow-hidden h-fit h-fit overflow-hidden">
           ...
           <Settings className="absolute left-[-5%] bottom-[-5%] w-64 h-64 text-gray-100 dark:text-gray-700/50 rotate-45 pointer-events-none h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden" />
        </section>
      </div>
    </>
  );
