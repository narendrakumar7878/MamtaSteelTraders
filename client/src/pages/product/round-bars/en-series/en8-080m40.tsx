...
export default function EN8080M40Detail() {
  ...
  const thermalSpecs = [
    { process: "Hardening", temp: "830 – 860°C", desc: "Quench in oil or water depending on section size." },
    { process: "Tempering", temp: "550 – 660°C", desc: "Air cool after tempering to achieve specific tensile ranges." },
    { process: "Normalizing", temp: "830 – 860°C", desc: "Cool in still air to refine grain structure." }
  ];

  return (
    <>
      <ProductSEO
        title="EN8 Round Bars | 080M40 Medium Carbon Steel | BS 970 | Mumbai"
        description="Premium EN8 (080M40) medium carbon steel round bars and bright bars. Excellent strength and machinability for gears, shafts, and bolts. Certified BS 970 standard."
        keywords="en8 round bars, 080m40 steel supplier, en8 bright bars mumbai, medium carbon steel, en series round bars"
        canonicalUrl="/product/round-bars/en-series/en8-080m40"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary">EN8 (080M40)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block">The Machining Standard</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none">EN8 (080M40)</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase">Our highest-volume medium carbon steel, engineered for superior strength, machinability, and fatigue endurance.</p>
              <div className="flex flex-wrap gap-4">
                <Link href="/contact" className="bg-gold-primary hover:bg-white text-navy-primary px-10 py-4 rounded-2xl font-black transition-all shadow-xl italic tracking-tighter uppercase">Request Batch Pricing</Link>
                <a href="tel:+919819322576" className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-10 py-4 rounded-2xl font-bold transition-all backdrop-blur-sm italic tracking-tighter uppercase">Consult Metallurgy</a>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 h-fit">
          <div className="container mx-auto px-4 text-black h-fit">
            <div className="grid lg:grid-cols-3 gap-12 h-fit">
              <div className="lg:col-span-2 space-y-12 h-fit">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter">EN8 (080M40) is an unalloyed medium carbon steel grade with good tensile strength. It is ideally suited for the manufacture of parts such as general-purpose axles and shafts, gears, bolts and studs. It can be further surface-hardened typically to 50-55 HRC by induction processes, producing components with enhanced wear resistance.</p>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6 h-fit">
                ...
                <div className="bg-navy-primary text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group h-fit">
                   <div className="relative z-10 h-fit">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 h-fit h-fit">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic">Tensile Strength</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic">550 – 850 MPa (Depending on Section)</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic">Hardness</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic">150 – 255 HB</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit">
                <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden h-fit">
                  <h3 className="text-xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase border-b border-gold-primary pb-2">Treatment Guide</h3>
                  <div className="space-y-6 h-fit overflow-hidden h-fit">
                    {thermalSpecs.map((eq, i) => (
                      <div key={i} className="space-y-1 h-fit overflow-hidden h-fit">
                        <div className="flex justify-between items-center h-fit overflow-hidden h-fit">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit overflow-hidden">
                      {["Engine Crankshafts", "Connecting Rods", "General Shafting", "Gears and Gearboxes", "Bolts and Studs", "Machine Tool Shapers"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden h-fit">
           <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase h-fit overflow-hidden">Premium EN8 Stockist Mumbai</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase h-fit overflow-hidden">Mamta Steel Traders stocks massive volumes of EN8 (080M40) round bars, bright bars, and square sections. Mill test certificates provided with every batch.</p>
