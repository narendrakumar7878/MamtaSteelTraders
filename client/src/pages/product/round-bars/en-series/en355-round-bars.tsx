...
export default function EN355RoundBarsDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.12 – 0.20%" },
    { element: "Silicon (Si)", value: "0.10 – 0.35%" },
    { element: "Manganese (Mn)", value: "0.40 – 0.70%" },
    { element: "Chromium (Cr)", value: "1.40 – 1.80%" },
    { element: "Nickel (Ni)", value: "1.80 – 2.20%" },
    { element: "Molybdenum (Mo)", value: "0.15 – 0.25%" }
  ];

  const thermalSpecs = [
    { process: "Carburizing", temp: "880 – 930°C", desc: "Allows for deep, durable case depth while maintaining exceptionally high core toughness." },
  ...
  return (
    <>
      <ProductSEO
        title="EN355 Round Bars | 2% Nickel-Chrome-Moly Case Hardening Steel | Mumbai"
        description="Premium EN355 alloy case-hardening steel round bars. Record core toughness and fatigue resistance for heavy-duty transmission. Certified BS 970 standard."
        keywords="en355 round bars, en355 steel supplier mumbai, 2% nickel case hardening steel, heavy duty gear steel, en series round bars"
        canonicalUrl="/product/round-bars/en-series/en355-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-black h-fit" />
                 <span className="text-navy-primary dark:text-gold-primary italic uppercase">EN355 (2% Nickel Case Hardening)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden h-fit">
          <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
            <div className="max-w-4xl h-fit overflow-hidden">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg underline decoration-navy-primary decoration-4 h-fit overflow-hidden">The Ultimate transmission alloy</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none h-fit overflow-hidden">EN355 (Ni-Cr-Mo)</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase h-fit overflow-hidden">2% Nickel alloy delivering the world's highest core integrity and maximum fatigue resistance for heavy-duty industrial transmission.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 h-fit overflow-hidden">
              <div className="lg:col-span-2 space-y-12 h-fit overflow-hidden">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden text-black h-fit">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6 h-fit overflow-hidden h-fit">Metallurgical Integrity (EN355)</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter h-fit overflow-hidden">EN355 is a high-grade 2% nickel chromium molybdenum alloy case-hardening steel. It is specifically designed for applications where high surface hardness is required alongside exceptionally high core toughness and fatigue resistance. Its superior alloy content prevents core embrittlement during the lengthy carburizing cycles required for deep industrial cases, making it the premier choice for heavy-duty transmission gears and aircraft components in Mumbai's aerospace sector.</p>
                   ...
                   <div className="relative z-10 h-fit overflow-hidden text-white h-fit">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 h-fit h-fit overflow-hidden text-white h-fit overflow-hidden h-fit h-fit">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic h-fit overflow-hidden">Record Core Tensile</p>
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden h-fit h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden">
           <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden text-black h-fit">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase h-fit overflow-hidden h-fit overflow-hidden">Direct Supplier: EN355 High Performance Alloys</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase h-fit overflow-hidden h-fit overflow-hidden">Mamta Steel Traders delivers ready-to-dispatch EN355 (Ni-Cr-Mo) round bars for the world's most demanding engineering projects. Certified to BS 970 standards with guaranteed chemical integrity and record case hardenability.</p>
