...
export default function EN354RoundBarsDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.10 – 0.20%" },
    { element: "Silicon (Si)", value: "0.10 – 0.35%" },
    { element: "Manganese (Mn)", value: "0.50 – 0.80%" },
    { element: "Chromium (Cr)", value: "0.75 – 1.10%" },
    { element: "Nickel (Ni)", value: "1.50 – 2.00%" },
    { element: "Molybdenum (Mo)", value: "0.10 – 0.20%" }
  ];

  const thermalSpecs = [
    { process: "Carburizing", temp: "880 – 930°C", desc: "Allows for deep, durable case depth while maintaining high core toughness." },
    { process: "Core Refining", temp: "840 – 870°C", desc: "Oil quench to achieve superior structural integrity and shock loading resistance." },
    { process: "Case Hardening", temp: "780 – 810°C", desc: "Final oil quench to achieve 58-62 HRC surface hardness for arduous wear." }
  ];

  return (
    <>
      <ProductSEO
        title="EN354 Round Bars | High Nickel Ni-Cr-Mo Case Hardening Steel | Mumbai"
        description="Premium EN354 high nickel chromium molybdenum alloy case-hardening steel round bars. Extreme core strength and wear endurance for heavy-duty industrial gears. Certified BS 970."
        keywords="en354 round bars, en354 steel supplier mumbai, high nickel case hardening steel, heavy duty transmission steel, en series round bars"
        canonicalUrl="/product/round-bars/en-series/en354-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-black h-fit" />
                 <span className="text-navy-primary dark:text-gold-primary italic uppercase">EN354 (High Nickel Case Hardening)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden h-fit">
          <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
            <div className="max-w-4xl h-fit overflow-hidden">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg underline decoration-navy-primary decoration-4 h-fit overflow-hidden">The High-Nickel specialist alloy</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none h-fit overflow-hidden">EN354 (Ni-Cr-Mo)</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase h-fit overflow-hidden">2% Nickel-Chromium-Molybdenum alloy delivering the world's highest core integrity and maximum fatigue resistance for heavy-duty transmission.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 h-fit overflow-hidden">
              <div className="lg:col-span-2 space-y-12 h-fit overflow-hidden">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden text-black h-fit">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6 h-fit overflow-hidden h-fit">Metallurgical Integrity (EN354)</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter h-fit overflow-hidden">EN354 is a specialized high-nickel chromium molybdenum alloy case-hardening steel. With a 2% nickel content, it provides significantly higher core tensile strength and impact resistance than standard case-hardening grades. It is the premier choice for heavy-duty gearboxes, high-torque transmission components, and arduous industrial machinery in Mumbai's automotive and aerospace engineering sectors.</p>
                   ...
                   <div className="relative z-10 h-fit overflow-hidden text-white h-fit">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 h-fit h-fit overflow-hidden text-white h-fit overflow-hidden h-fit h-fit">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic h-fit overflow-hidden">Core Tensile Strength</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden">1000 – 1250 MPa</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit">
              ...
              <div className="space-y-8 h-fit h-fit overflow-hidden text-black h-fit">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit h-fit overflow-hidden">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden">
                      {["Heavy Duty Gearboxes", "High Torque Transmission Gears", "Aerospace Transmission Parts", "Arduous Industrial Rollers", "Deep Carburized Pinions", "Extreme Load Couplings"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden h-fit h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden">
           <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden text-black h-fit">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase h-fit overflow-hidden h-fit overflow-hidden">Direct Supplier: EN354 High Nickel Alloys</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase h-fit overflow-hidden h-fit overflow-hidden">Mamta Steel Traders delivers ready-to-dispatch EN354 (High Nickel) round bars for the world's most demanding engineering projects. Certified to BS 970 standards with guaranteed chemical integrity and extreme case hardenability.</p>
           ...
           <Settings className="absolute left-[-5%] bottom-[-5%] w-64 h-64 text-gray-100 dark:text-gray-700/50 rotate-45 pointer-events-none h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden" />
        </section>
      </div>
    </>
  );
