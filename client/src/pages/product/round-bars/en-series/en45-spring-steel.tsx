...
export default function EN45SpringSteelDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.50 – 0.60%" },
    { element: "Silicon (Si)", value: "1.50 – 2.00%" },
    { element: "Manganese (Mn)", value: "0.70 – 1.00%" },
    { element: "Sulphur (S)", value: "0.05% max" },
    { element: "Phosphorus (P)", value: "0.05% max" }
  ];

  const thermalSpecs = [
    { process: "Forgeability", temp: "1100 – 850°C", desc: "Forging must be done within this window; avoid rapid cooling to prevent cracks." },
    { process: "Hardening", temp: "870 – 900°C", desc: "Quench in oil to achieve high spring tempered hardness and resilience." },
  ...
  return (
    <>
      <ProductSEO
        title="EN45 Spring Steel Round Bars | Silico-Manganese Steel | Mumbai India"
        description="Premium EN45 silico-manganese spring steel round bars. Exceptional resilience and fatigue resistance for leaf springs and heavy-duty industrial springs. Certified BS 970."
        keywords="en45 spring steel, en45 round bars mumbai, silico manganese steel supplier, leaf spring steel bars, en series round bars"
        canonicalUrl="/product/round-bars/en-series/en45-spring-steel"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-black h-fit" />
                 <span className="text-navy-primary dark:text-gold-primary italic uppercase">EN45 (Silico-Manganese Spring)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden h-fit">
          <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
            <div className="max-w-4xl h-fit overflow-hidden">
              ...
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none h-fit overflow-hidden uppercase">EN45 Spring Steel</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase h-fit overflow-hidden uppercase">Silico-Manganese alloy delivering exceptional resilience and high fatigue endurance for the most demanding industrial leaf springs.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 h-fit overflow-hidden h-fit">
              <div className="lg:col-span-2 space-y-12 h-fit overflow-hidden h-fit">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden text-black h-fit">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6 h-fit overflow-hidden h-fit uppercase">Material Profile (EN45)</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter h-fit overflow-hidden uppercase">EN45 is a silicon-manganese spring steel grade specifically designed for leaf springs and heavy-duty industrial springs. Its high silicon content provides excellent resilience and resilience to sagging, allowing it to achieve the high levels of fatigue endurance and shock loading resistance required for heavy-duty vehicle suspension and engine components in Mumbai's heavy-duty engineering sectors.</p>
                   ...
                   <div className="relative z-10 h-fit overflow-hidden text-white h-fit">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 h-fit h-fit overflow-hidden text-white h-fit overflow-hidden h-fit h-fit">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit uppercase">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden h-fit">40 – 48 HRC (Spring Temper)</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic h-fit overflow-hidden h-fit">Fatigue Limit</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden h-fit">Extremely High</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit h-fit overflow-hidden text-black h-fit">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit h-fit overflow-hidden">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden">
                      {["Heavy Duty Leaf Springs", "Industrial Coiled Springs", "Agricultural Blades", "High-Stress Washers", "Railway Suspension Springs", "Extreme Load Clips"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden h-fit h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden uppercase h-fit overflow-hidden">
           <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden text-black h-fit">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase h-fit overflow-hidden h-fit">Direct Supplier: EN45 Spring Steel</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden">Mamta Steel Traders delivers ready-to-dispatch EN45 round bars for the world's most arduous wear projects. Certified to BS 970 standards with guaranteed chemical integrity and extreme resilience.</p>
