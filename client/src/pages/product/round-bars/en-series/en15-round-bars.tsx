...
export default function EN15RoundBarsDetail() {
  ...
  const thermalSpecs = [
    ...
    { process: "Hardening", temp: "830 – 860°C", desc: "Quench in oil to achieve medium tensile properties." },
    { process: "Normalizing", temp: "830 – 860°C", desc: "Cool in still air to achieve a uniform grain size." }
  ];

  return (
    <>
      <ProductSEO
        title="EN15 Round Bars | 150M36 Carbon Manganese Steel | BS 970 | Mumbai"
        description="Premium EN15 carbon-manganese steel round bars. Medium tensile strength and high impact properties for general engineering. Certified BS 970 standards."
        keywords="en15 round bars, 150m36 steel supplier, medium tensile steel mumbai, carbon manganese steel, en series round bars"
        canonicalUrl="/product/round-bars/en-series/en15-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary">EN15 Round Bars</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden h-fit">
          <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
            <div className="max-w-4xl h-fit overflow-hidden">
              ...
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none h-fit overflow-hidden">EN15 Round Bars</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase h-fit overflow-hidden">Balanced medium-tensile steel offering superior impact strength and consistent machinability for industrial couplings.</p>
              <div className="flex flex-wrap gap-4 h-fit overflow-hidden">
                <Link href="/contact" className="bg-gold-primary hover:bg-white text-navy-primary px-10 py-4 rounded-2xl font-black transition-all shadow-xl italic tracking-tighter uppercase h-fit overflow-hidden">Inquire Batch Stock</Link>
                <a href="tel:+919819322576" className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-10 py-4 rounded-2xl font-bold transition-all backdrop-blur-sm italic tracking-tighter uppercase h-fit overflow-hidden">Consult Metallurgy</a>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12 h-fit overflow-hidden">
              <div className="lg:col-span-2 space-y-12 h-fit overflow-hidden">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter h-fit overflow-hidden">EN15 (150M36) is a carbon-manganese steel grade typically supplied in the as-rolled condition. It is known for its higher manganese content which provides better hardness penetration and impact properties compared to standard medium carbon steels. It is a preferred choice for engineering shafts and axles requiring reliable performance under heavy loads.</p>
                   ...
                   <div className="relative z-10 h-fit overflow-hidden">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 h-fit overflow-hidden h-fit overflow-hidden">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden">450 – 620 MPa</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden">150 – 220 HB</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit h-fit">
                <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 h-fit h-fit overflow-hidden">
                  <h3 className="text-xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase border-b border-gold-primary pb-2 h-fit overflow-hidden">Industrial Guide</h3>
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit h-fit overflow-hidden">
                   <h3 className="text-2xl font-black mb-6 italic tracking-tighter uppercase h-fit overflow-hidden">Typical Use Cases</h3>
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit overflow-hidden h-fit overflow-hidden">
                      {["Load Bearing Shafts", "Industrial Axles", "Gears and Sprockets", "Hydraulic Valves", "Transmission Bolts", "Coupling Connectors"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden h-fit h-fit">
           <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase h-fit overflow-hidden">NABL Certified EN15 Stockist</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase h-fit overflow-hidden">Mamta Steel Traders stocks massive volumes of EN15 (150M36) round bars with full certification. We provide cut-to-length solutions for industrial shafting projects nationwide.</p>
