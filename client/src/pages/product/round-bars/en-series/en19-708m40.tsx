...
export default function EN19708M40Detail() {
  ...
  const thermalSpecs = [
    ...
    { process: "Tempering", temp: "550 – 700°C", desc: "Cool in still air. Higher tempering temperatures increase ductility." }
  ];

  return (
    <>
      <ProductSEO
        title="EN19 Round Bars | 708M40 Chrome Moly Steel | BS 970 | Mumbai India"
        description="Premium EN19 (708M40) chromium-molybdenum steel round bars. High tensile strength and impact resistance for heavy duty engineering. Certified BS 970 standard."
        keywords="en19 round bars, 708m40 steel supplier, chrome moly steel mumbai, high stress en series, en series round bars"
        canonicalUrl="/product/round-bars/en-series/en19-708m40"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-black italic">EN19 (708M40)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden h-fit">
          <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
            <div className="max-w-4xl h-fit overflow-hidden">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg underline decoration-navy-primary decoration-4 h-fit overflow-hidden">The Chrome-Moly Powerhouse</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none h-fit overflow-hidden">EN19 (708M40)</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase h-fit overflow-hidden">High-grade Chromium-Molybdenum alloy steel delivering absolute structural integrity for high-stress gears and crankshafts.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 h-fit overflow-hidden">
              <div className="lg:col-span-2 space-y-12 h-fit overflow-hidden">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6 h-fit overflow-hidden">Metallurgical Profile (EN19)</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter h-fit overflow-hidden">EN19 (708M40) is a high-quality alloy steel with excellent tensile and impact properties. It is a preferred choice for heavy-duty applications such as gears, pinions, crankshafts, and shafts in the automotive and general engineering sectors. Its high chromium and molybdenum content provides excellent hardenability and strength through large sections.</p>
                   ...
                   <div className="relative z-10 h-fit overflow-hidden">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 h-fit h-fit overflow-hidden text-white h-fit overflow-hidden">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic h-fit overflow-hidden">Yield Strength (U/V)</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden">700 – 900 MPa</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden">50 – 70 J (Min)</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit h-fit overflow-hidden">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit h-fit overflow-hidden">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit overflow-hidden h-fit overflow-hidden">
                      {["Heavy Duty Gears", "Automotive Crankshafts", "Tractor Connecting Rods", "Stub Axles", "Induction Hardened Pinions", "Machine Tool Spindles"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden h-fit h-fit overflow-hidden">
           <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase h-fit overflow-hidden">Direct Supplier: EN19 Chrome-Moly Bars</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase h-fit overflow-hidden">Mamta Steel Traders delivers ready-to-dispatch EN19 (708M40) round bars for the world's most demanding engineering projects. Certified to BS 970 standards with guaranteed chemical integrity.</p>
