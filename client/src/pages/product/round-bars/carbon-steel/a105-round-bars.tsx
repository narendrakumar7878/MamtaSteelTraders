...
export default function GradeA105RoundBars() {
  ...
  const mechanicalProperties = [
    ...
    { property: "Yield Strength", value: "250 MPa min" },
    { property: "Elongation (in 50mm)", value: "22% min" },
    { property: "Reduction of Area", value: "30% min" },
    { property: "Hardness (HB)", value: "187 max" }
  ];

  return (
    <>
      <ProductSEO
        title="ASTM A105 Carbon Steel Round Bars | Forging Grade | Mumbai Supplier | Mamta Steel Traders"
        description="Premium ASTM A105 Carbon Steel round bars. High-quality forging grade for pressure systems and ambient/higher temperature service. Certified A105 hot rolled bars available in Mumbai."
        keywords="ASTM A105 round bar, A105 forging steel, carbon steel A105 properties, A105 bar Mumbai supplier, pressure vessel steel"
        canonicalUrl="/product/round-bars/carbon-steel/a105-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">ASTM A105 Forging Grade</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic">High-Performance Forging Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">ASTM A105 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">The industry benchmark for forged carbon steel components used in pressure systems and high-temperature industrial pipelines.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Request MTC & Pricing</Link>
