...
export default function GradeSAE4340RoundBar() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", value: "1.65 – 2.00%" },
    { element: "Chromium (Cr)", value: "0.70 – 0.90%" },
    { element: "Molybdenum (Mo)", value: "0.20 – 0.30%" },
    { element: "Carbon (C)", value: "0.38 – 0.43%" },
    { element: "Manganese (Mn)", value: "0.60 – 0.80%" },
    { element: "Silicon (Si)", value: "0.15 – 0.35%" }
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength", value: "930 – 1080 MPa" },
    { property: "Yield Strength", value: "785 MPa min" },
    { property: "Elongation (A5)", value: "12% min" },
    { property: "Hardness (HB)", value: "280 – 320" }
  ];

  return (
    <>
      <ProductSEO
        title="SAE 4340 Alloy Steel Round Bars | AMS 6415 | 1.6511 | Mumbai Supplier"
        description="Premium SAE 4340 (AISI 4340) Alloy Steel round bars. Ultra-high strength nickel-chromium-molybdenum steel for critical aerospace and structural applications. Equivalent to 1.6511. Mumbai stockist."
        keywords="SAE 4340 round bar, AISI 4340 steel, SAE 4340 properties, SAE 4340 bar price Mumbai, nickel chrome moly steel"
        canonicalUrl="/product/round-bars/carbon-steel/sae-4340-round-bar"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">SAE 4340 (AISI 4340)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">Ultra-High Strength Ni-Cr-Mo Alloy Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">SAE 4340 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Achieve maximum toughness and exceptional fatigue strength with SAE 4340 (AISI 4340). This deep-hardening nickel-chromium-molybdenum alloy is the global standard for critical aerospace shafts, gears, and structural components requiring high performance under extreme stress.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get 4340 Quote</Link>
