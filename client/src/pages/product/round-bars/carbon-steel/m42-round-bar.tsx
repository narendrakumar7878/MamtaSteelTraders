...
export default function GradeM42RoundBars() {
  const chemicalComposition = [
    { element: "Cobalt (Co)", value: "7.75 – 8.50%" },
    { element: "Tungsten (W)", value: "1.40 – 1.80%" },
    { element: "Molybdenum (Mo)", value: "9.00 – 10.0%" },
    { element: "Chromium (Cr)", value: "3.50 – 4.25%" },
    { element: "Vanadium (V)", value: "0.90 – 1.25%" },
    { element: "Carbon (C)", value: "1.05 – 1.15%" }
  ];

  const mechanicalProperties = [
    { property: "Hardness (HRC)", value: "66 – 70" },
    { property: "Density", value: "7.81 g/cm³" },
    { property: "Compressive Strength", value: "3200 MPa min" },
    { property: "Red Hardness", value: "Exceptional" }
  ];

  const equivalentGrades = [
    { country: "USA (AISI)", grade: "M42" },
    { country: "European (EN)", grade: "1.3247 / HS2-9-1-8" },
    { country: "Japan (JIS)", grade: "SKH59" },
    { country: "German (DIN)", grade: "S2-10-1-8 / 1.3247" },
    { country: "India (IS)", grade: "8W2Cr4VMo10Co8" }
  ];

  return (
    <>
      <ProductSEO
        title="M42 Cobalt High-Speed Steel Round Bars | 1.3247 | SKH59 | Mamta Steel Traders"
        description="Premium M42 Cobalt High-Speed Tool Steel round bars. Highest red hardness and superior abrasion resistance. Equivalent to 1.3247, SKH59. Ideal for high-performance end mills and broaches."
        keywords="M42 round bar, 1.3247 steel, M42 cobalt steel properties, high speed steel Mumbai, SKH59 equivalent"
        canonicalUrl="/product/round-bars/carbon-steel/m42-round-bar"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">M42 Cobalt HSS</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic italic">Superhard Cobalt High-Speed Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">M42 Cobalt HSS</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">The ultimate Cobalt-alloyed High-Speed Tool Steel. M42 provides the highest red hardness in the industry, making it the premier choice for cutting super-alloys and high-hardness materials.</p>
          ...
          <div className="container mx-auto px-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="grid lg:grid-cols-2 gap-12 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                ...
                <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   ...
                   <div className="space-y-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic text-sm">
