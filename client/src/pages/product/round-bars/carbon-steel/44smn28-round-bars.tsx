...
export default function Grade44SMn28RoundBars() {
  ...
  return (
    <>
      <ProductSEO
        title="44SMn28 Free Cutting Steel Round Bars | 1.0762 | Mumbai Supplier"
        description="Premium 44SMn28 Free Cutting Steel round bars. High manganese, high sulfur grade for superior high-speed machining. Equivalent to 1.0762. Certified 44SMn28 bars available in Mumbai."
        keywords="44SMn28 round bar, 1.0762 steel, 44SMn28 properties, 44SMn28 bar price Mumbai, high machinability steel"
        canonicalUrl="/product/round-bars/carbon-steel/44smn28-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">44SMn28 Free Cutting</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">High-Speed High-Efficiency Machining Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">44SMn28 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">The ultimate high-manganese free-cutting grade 1.0762. 44SMn28 is engineered for mass production of precision components requiring high mechanical strength and exceptional surface finish at rapid production speeds.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get 44SMn28 Quote</Link>
