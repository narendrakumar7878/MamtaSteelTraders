...
export default function Grade20MnCr5RoundBars() {
  ...
  const equivalentGrades = [
    { country: "European (EN)", grade: "1.7147 / 20MnCr5" },
    { country: "USA (AISI/SAE)", grade: "5120" },
    { country: "Japan (JIS)", grade: "SCr420" },
    { country: "India (IS)", grade: "20Cr|20MnCr5" }
  ];

  return (
    <>
      <ProductSEO
        title="20MnCr5 Case Hardening Steel Round Bars | 1.7147 | High Strength | Mamta Steel Traders"
        description="Premium 20MnCr5 Case Hardening Steel round bars. Superior core strength and high fatigue resistance. Optimized for heavy-duty transmission gears and mechanical parts."
        keywords="20MnCr5 round bar, 1.7147 steel, case hardening gear steel, 5120 steel equivalent, transmission steel supplier"
        canonicalUrl="/product/round-bars/carbon-steel/20mncr5-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">20MnCr5 Grade Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic">Tough Core Case Hardening Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic">20MnCr5 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic">Exceptional hardenability and weldability for heavy-duty drive components and mission-critical engineering.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic">Check Stock Availability</Link>
                   <a href="tel:+919819322576" className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-8 py-3 rounded-xl font-bold transition-all backdrop-blur-sm italic italic"><Phone className="w-5 h-5 inline mr-2" /> Talk to Expert</a>
                </div>
             </div>
          </div>
        </section>
             ...
             <div className="grid lg:grid-cols-3 gap-8 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                <div className="lg:col-span-2 space-y-12 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic">
                       ...
                       <div className="grid grid-cols-2 md:grid-cols-3 gap-6 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                       <h2 className="text-3xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-l-4 border-gold-primary pl-4 font-bold tracking-tighter italic italic italic italic">Equivalent Grades Map</h2>
                       <div className="overflow-x-auto font-bold tracking-tighter italic font-bold tracking-tighter italic">
                          <table className="w-full text-left font-bold tracking-tighter italic font-bold tracking-tighter italic">
                             <thead>
                                <tr className="bg-navy-primary text-white italic italic italic font-bold tracking-tighter italic">
                                   <th className="p-4 rounded-tl-xl text-xs uppercase italic italic font-bold font-bold tracking-tighter italic">Standard / Country</th>
                ...
                <div className="space-y-6 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic italic font-bold tracking-tighter italic">
                      <h3 className="text-xl font-bold mb-6 text-navy-primary dark:text-gray-100 italic italic font-bold tracking-tighter italic">High-Impact Applications</h3>
                      <div className="space-y-4 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                         {["Heavy-Duty Driving Gears", "Clutch Components", "Main Shafts", "Bushing Sleeves", "Crankshaft Pins", "Mechanical Joints"].map((app, i) => (
                            <div key={i} className="flex items-center text-sm p-3 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-100 font-bold tracking-tighter italic italic font-bold tracking-tighter italic">
                               <ArrowRight className="w-4 h-4 text-gold-primary mr-3 italic font-bold tracking-tighter italic" /> {app}
                            </div>
                         ))}
                      </div>
                   </div>
