...
export default function GradeA182F11RoundBars() {
  const chemicalComposition = [
    { element: "Chromium (Cr)", value: "1.00 – 1.50%" },
    ...
    { element: "Sulphur (S)", value: "0.030% max" }
  ];
  ...
  const mechanicalProperties = [
    ...
    { property: "Brinell Hardness", value: "143 – 209 HBW" }
  ];

  const keyApplications = [
     "Power Plant Piping Systems",
     "Pressure Vessel Components",
     "Oil & Gas Distillation Units",
  ...
  return (
    <>
      <ProductSEO
        title="ASTM A182 F11 Alloy Steel Round Bars | Forged Fittings | Mumbai Supplier"
        description="Premium ASTM A182 F11 Alloy Steel round bars. Chromium-Molybdenum low-alloy steel for elevated temperature service. Certified F11 forged bars for pressure systems. Available in Mumbai."
        keywords="ASTM A182 F11 round bar, F11 alloy steel properties, cr-mo steel Mumbai, F11 forged bars price, high temperature pressure steel"
        canonicalUrl="/product/round-bars/carbon-steel/astm-a182-f11-round-bars"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">ASTM A182 F11 Cr-Mo</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">1.25% Chromium High-Temperature Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">ASTM A182 F11 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Premium Grade F11 low-alloy steel specifically designed for superior creep resistance and thermal stability in high-temperature pressure vessel and piping systems.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get Pressure-Grade Quote</Link>
        ...
        <section className="py-16 bg-white dark:bg-gray-800 font-bold tracking-tighter italic font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
              <h2 className="text-3xl font-bold text-navy-primary dark:text-gray-100 mb-12 border-l-4 border-gold-primary pl-4 font-bold tracking-tighter italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic">Industrial Applications</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                 {keyApplications.map((app, i) => (
                    <div key={i} className="flex items-start p-6 bg-gray-50 dark:bg-gray-700 rounded-3xl border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                       <CheckCircle className="w-6 h-6 text-gold-primary mr-4 mt-1 flex-shrink-0 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic" />
                       <span className="text-lg font-bold text-navy-primary dark:text-gray-100 italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">{app}</span>
                    </div>
                 ))}
              </div>
           </div>
