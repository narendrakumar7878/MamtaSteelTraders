...
export default function GradeEN36CRoundBar() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", value: "3.00 – 3.75%" },
    { element: "Chromium (Cr)", value: "0.70 – 1.10%" },
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength", value: "850 – 1100 MPa" },
    { property: "Yield Strength", value: "650 MPa min" },
    { property: "Elongation (A5)", value: "10% min" },
    { property: "Impact Strength", value: "40 Joules min" }
  ];

  return (
    <>
      <ProductSEO
        title="EN36C Alloy Steel Round Bars | Case Hardening Steel | 1.6773 | Mumbai Supplier"
        description="Premium EN36C (832M13) Alloy Steel round bars. 3% Nickel-Chromium case hardening steel for heavy-duty gears and shafts. Exceptional impact strength and core toughness. Equivalent to 1.6773."
        keywords="EN36C round bar, 832M13 steel, EN36C properties, EN36C bar price Mumbai, nickel chromium case hardening steel"
        canonicalUrl="/product/round-bars/carbon-steel/en36c-round-bar"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">EN36C (832M13) Case Hardening</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">Heavy-Duty 3% Nickel Case Hardening Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">EN36C Round Bar</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Achieve unparalleled core toughness and extreme impact strength with EN36C (832M13). This 3% nickel-chromium alloy is the premier choice for heavy-duty gears, crankshafts, and shafts in high-performance automotive and heavy machinery sectors.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get High-Strength Quote</Link>
