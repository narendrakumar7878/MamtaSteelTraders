...
export default function GradeEN9RoundBars() {
  ...
  const mechanicalProperties = [
    ...
    { property: "Elongation", value: "14% min" },
    { property: "Hardness (HB)", value: "201 – 255" }
  ];

  const equivalentGrades = [
    { country: "British (BS)", grade: "070M55 | EN9" },
    { country: "USA (AISI/SAE)", grade: "1055" },
    { country: "European (EN)", grade: "1.0535 / C55E" },
    { country: "Japan (JIS)", grade: "S55C" },
    { country: "German (DIN)", grade: "CK55" }
  ];

  return (
    <>
      <ProductSEO
        title="EN9 Round Bars | 070M55 | High Carbon Steel | Mumbai Stockist | Mamta Steel Traders"
        description="Premium EN9 High Carbon Steel round bars. Superior wear resistance and hardenable properties. Equivalent to 070M55, AISI 1055. Ideal for cams, cylinders, and machine tools."
        keywords="EN9 round bar, 070M55 steel, EN9 steel properties, high carbon steel Mumbai, EN9 bright bars price"
        canonicalUrl="/product/round-bars/carbon-steel/en9-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">EN9 Grade Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic font-bold tracking-tighter italic">Wear Resistant Carbon Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">EN9 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic">A medium to high carbon steel grade providing higher tensile strength and wear resistance after hardening compared to EN8.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic">Order EN9 Stock</Link>
          ...
          <div className="container mx-auto px-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="grid lg:grid-cols-2 gap-12 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                ...
                <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <h2 className="text-3xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-l-4 border-gold-primary pl-4 font-bold tracking-tighter italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic">Equivalence Table</h2>
                   <div className="overflow-x-auto font-bold tracking-tighter italic font-bold tracking-tighter italic">
                      <table className="w-full text-left font-bold tracking-tighter italic font-bold tracking-tighter italic">
                         <thead>
                            <tr className="bg-navy-primary text-white italic italic font-bold tracking-tighter italic italic font-bold tracking-tighter italic">
                               <th className="p-4 rounded-tl-xl text-xs uppercase italic italic font-bold font-bold tracking-tighter italic">Standard</th>
