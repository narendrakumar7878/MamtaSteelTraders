...
export default function Grade38MnVS6RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.34 – 0.41%" },
    { element: "Manganese (Mn)", value: "1.20 – 1.60%" },
    { element: "Silicon (Si)", value: "0.150 – 0.80%" },
    { element: "Vanadium (V)", value: "0.08 – 0.20%" },
    { element: "Sulphur (S)", value: "0.02 – 0.06%" },
    { element: "Chromium (Cr)", value: "0.30% max" }
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength", value: "800 – 950 MPa" },
    { property: "Yield Strength", value: "520 MPa min" },
    { property: "Elongation (A5)", value: "12% min" },
    { property: "Hardness (HB)", value: "240 – 285" }
  ];

  return (
    <>
      <ProductSEO
        title="38MnVS6 Micro-Alloyed Steel Round Bars | 1.1303 | Mumbai Supplier"
        description="Premium 38MnVS6 Micro-Alloyed Steel round bars. Vanadium-alloyed medium carbon steel with excellent machinability and fatigue strength. Equivalent to 1.1303. High-quality 38MnVS6 bars in Mumbai."
        keywords="38MnVS6 round bar, 1.1303 steel, 38MnVS6 properties, 38MnVS6 bar price Mumbai, micro-alloyed steel"
        canonicalUrl="/product/round-bars/carbon-steel/38mnvs6-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">38MnVS6 (1.1303)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">Vanadium Micro-Alloyed Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">38MnVS6 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Experience superior fatigue strength and exceptional machinability with 38MnVS6 (1.1303). This micro-alloyed medium carbon steel is the premium choice for components requiring high strength without heat treatment after machining.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get 38MnVS6 quote</Link>
