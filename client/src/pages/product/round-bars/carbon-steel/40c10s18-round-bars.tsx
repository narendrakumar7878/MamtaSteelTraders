...
export default function Grade40C10S18RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.35 – 0.45%" },
    { element: "Manganese (Mn)", value: "0.80 – 1.20%" },
    { element: "Silicon (Si)", value: "0.10 – 0.35%" },
    { element: "Sulphur (S)", value: "0.15 – 0.25%" },
    { element: "Phosphorus (P)", value: "0.060% max" }
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength", value: "540 – 660 MPa" },
    { property: "Yield Strength", value: "345 MPa min" },
    { property: "Elongation (A5)", value: "15% min" },
    { property: "Hardness (HB)", value: "155 – 207" }
  ];

  return (
    <>
      <ProductSEO
        title="40C10S18 Free Cutting Steel Round Bars | IS 4431 | Mumbai Supplier"
        description="Premium 40C10S18 Free Cutting Steel round bars. Indian Standard (IS 4431) grade for high-speed machining and precision components. Exceptional tool life and surface finish. Available in Mumbai."
        keywords="40C10S18 round bar, IS 4431 steel, 40C10S18 free cutting steel, 40C10S18 bar price Mumbai, machining steel"
        canonicalUrl="/product/round-bars/carbon-steel/40c10s18-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">40C10S18 Free Cutting</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">IS 4431 Precision Machining Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">40C10S18 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Engineered for high-volume automated production. 40C10S18 free-cutting steel offers exceptional chip breaking, superior surface finish, and extended tool life for complex precision parts.</p>
