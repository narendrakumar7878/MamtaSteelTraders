...
export default function GradeT1RoundBars() {
  const chemicalComposition = [
    { element: "Tungsten (W)", value: "17.5 – 18.5%" },
    { element: "Chromium (Cr)", value: "3.80 – 4.50%" },
    { element: "Vanadium (V)", value: "1.00 – 1.20%" },
    { element: "Carbon (C)", value: "0.73 – 0.83%" },
    { element: "Manganese (Mn)", value: "0.40% max" },
    { element: "Silicon (Si)", value: "0.40% max" }
  ];

  const mechanicalProperties = [
    { property: "Hardness (HRC)", value: "62 – 65" },
    { property: "Density", value: "8.67 g/cm³" },
    { property: "Compressive Strength", value: "2800 MPa min" },
    { property: "Thermal Conductivity", value: "24 W/m·K" }
  ];

  const equivalentGrades = [
    { country: "USA (AISI)", grade: "T1" },
    { country: "European (EN)", grade: "1.3355 / HS18-0-1" },
    { country: "Japan (JIS)", grade: "SKH2" },
    { country: "German (DIN)", grade: "S18-0-1 / 1.3355" },
    { country: "India (IS)", grade: "XT72Cr4V1" }
  ];

  return (
    <>
      <ProductSEO
        title="T1 High-Speed Tool Steel Round Bars | 1.3355 | Tungsten Steel | Mamta Steel Traders"
        description="Premium T1 High-Speed Tool Steel round bars. High tungsten content for exceptional red hardness and wear resistance. Equivalent to 1.3355, SKH2. Ideal for broaches, cutters, and high-speed tools."
        keywords="T1 round bar, 1.3355 steel, high speed tool steel T1, tungsten tool steel Mumbai, SKH2 steel equivalent"
        canonicalUrl="/product/round-bars/carbon-steel/t1-round-bar"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">T1 High-Speed Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic">High-Tungsten Red Hardness Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">T1 High-Speed Steel</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">A legendary Tungsten-based high-speed steel alloy providing unmatched red hardness and wear resistance, specifically designed for high-performance cutting tools.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get Technical Pricing</Link>
          ...
          <div className="container mx-auto px-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="grid lg:grid-cols-2 gap-12 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                ...
                <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <h2 className="text-3xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-l-4 border-gold-primary pl-4 font-bold tracking-tighter italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">Thermal Specifications</h2>
