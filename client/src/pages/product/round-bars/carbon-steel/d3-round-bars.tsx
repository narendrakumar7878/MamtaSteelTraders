...
export default function GradeD3RoundBars() {
  ...
  const mechanicalProperties = [
    { property: "Hardness (HRC)", value: "58 – 64" },
    { property: "Density", value: "7.70 g/cm³" },
    { property: "Compressive Strength", value: "2300 MPa min" },
    { property: "Thermal Conductivity", value: "20 W/m·K" }
  ];

  const equivalentGrades = [
    { country: "USA (AISI)", grade: "D3" },
    { country: "European (EN)", grade: "1.2080 / X210Cr12" },
    { country: "Japan (JIS)", grade: "SKD1" },
    { country: "German (DIN)", grade: "X210Cr12 / 1.2080" },
    { country: "India (IS)", grade: "T215Cr12" }
  ];

  return (
    <>
      <ProductSEO
        title="D3 Cold Work Tool Steel Round Bars | 1.2080 | SKD1 | Mamta Steel Traders"
        description="Premium D3 Tool Steel round bars. High carbon, high chromium alloy with excellent surface hardness and wear resistance. Equivalent to 1.2080, SKD1. Ideal for heavy-duty blanking and forming dies."
        keywords="D3 round bar, 1.2080 steel, D3 tool steel properties, Mumbai supplier D3 steel, SKD1 equivalent"
        canonicalUrl="/product/round-bars/carbon-steel/d3-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">D3 Cold Work Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">Extreme Carbon Cold-Work Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">D3 Cold Work Steel</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Recognized for its massive carbon content, D3 steel provides the ultimate abrasion resistance and surface hardness for long-run production tooling.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get Precision Quote</Link>
