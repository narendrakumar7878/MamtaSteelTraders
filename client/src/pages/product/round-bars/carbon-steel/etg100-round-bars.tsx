...
export default function GradeETG100RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.40 – 0.48%" },
    { element: "Manganese (Mn)", value: "1.30 – 1.70%" },
    { element: "Sulphur (S)", value: "0.24 – 0.33%" },
    { element: "Silicon (Si)", value: "0.10 – 0.30%" },
    { element: "Phosphorus (P)", value: "0.040% max" }
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength", value: "960 – 1100 MPa" },
    { property: "Yield Strength", value: "860 MPa min" },
    { property: "Elongation (A5)", value: "6% min" },
  ...
  return (
    <>
      <ProductSEO
        title="ETG 100 High-Strength Steel Round Bars | Free Machining | Mumbai Supplier"
        description="Premium ETG 100 (1.1301) High-Strength Free Cutting Steel round bars. Exceptional core toughness and machining speed without heat treatment. Equivalent to 100Cr6 variations. Mumbai stockist."
        keywords="ETG 100 round bar, ETG 100 properties, high strength steel Mumbai, ETG 100 bar price Mumbai, precision machining steel"
        canonicalUrl="/product/round-bars/carbon-steel/etg100-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">ETG 100 High-Strength</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">The Premier High-Strength High-Machinability Solution</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">ETG 100 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Eliminate heat treatment after machining with ETG 100 (1.1301). This high-tensile resulfurized carbon steel offers the exceptional mechanical properties of quenched and tempered steel with the rapid production speeds of free-cutting grades.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get ETG 100 Quote</Link>
