...
export default function GradeSAE4140RoundBars() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength", value: "650 – 880 MPa" },
    { property: "Yield Strength", value: "415 MPa min" },
    { property: "Hardness (HRC)", value: "28 – 32 (Pre-hardened)" },
    { property: "Impact Strength", value: "54 J min" }
  ];

  return (
    <>
      <ProductSEO
        title="SAE 4140 Alloy Steel Round Bars | AISI 4140 | 1.7225 | Mamta Steel Traders"
        description="Premium SAE 4140 Chrome-Moly Alloy Steel round bars. High-strength, versatile alloy for oil/gas and automotive sectors. Available in annealed and pre-hardened (V) conditions in Mumbai."
        keywords="SAE 4140 round bar, AISI 4140 steel properties, 4140 chromoly steel Mumbai, SAE 4140 pre-hardened bars, 1.7225 equivalent"
        canonicalUrl="/product/round-bars/carbon-steel/sae-4140-round-bar"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">SAE 4140 Chromoly</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">High-Tensile Chrome-Moly Alloy</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">SAE 4140 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Engineered for extreme performance in oil/gas drilling, automotive suspension, and heavy-duty machinery. SAE 4140 provides the perfect balance of toughness and wear resistance.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic">Get 4140 Quote</Link>
          ...
          <div className="container mx-auto px-4 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="grid lg:grid-cols-2 gap-12 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                ...
                <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   ...
                   <div className="space-y-4 font-bold tracking-tighter italic font-bold tracking-tighter italic text-sm">
