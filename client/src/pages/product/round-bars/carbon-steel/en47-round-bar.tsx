...
export default function GradeEN47RoundBar() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength", value: "700 – 1050 MPa" },
    { property: "Yield Strength", value: "460 MPa min" },
    { property: "Elongation (A5)", value: "15% min" },
    { property: "Hardness (HB)", value: "220 – 310" }
  ];

  return (
    <>
      <ProductSEO
        title="EN47 Spring Steel Round Bars | Cr-V Alloy Steel | Mumbai Supplier"
        description="Premium EN47 Chromium-Vanadium alloyed spring steel round bars. Exceptional toughness and fatigue resistance for heavy-duty springs and shafts. High-quality EN47 bars in Mumbai."
        keywords="EN47 round bar, EN47 steel properties, spring steel Mumbai, EN47 bar price Mumbai, chromium vanadium steel"
        canonicalUrl="/product/round-bars/carbon-steel/en47-round-bar"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">EN47 Chromium-Vanadium Spring Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">High Fatigue-Resistant Cr-V Spring Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">EN47 Round Bar</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Experience exceptional toughness and high elastic limit with EN47. This Chromium-Vanadium alloy steel is the premier choice for heavy-duty springs, gears, and structural components subjected to high cyclic stress and vibration.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get Spring Steel Quote</Link>
