...
export default function GradeEN353RoundBars() {
  const chemicalComposition = [
    { element: "Chromium (Cr)", value: "0.70 – 1.00%" },
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength", value: "700 – 950 MPa" },
    { property: "Yield Strength", value: "480 MPa min" },
    { property: "Elongation (A5)", value: "12% min" },
    { property: "Hardness (HB)", value: "220 – 280 (Core)" }
  ];

  return (
    <>
      <ProductSEO
        title="EN353 Case Hardening Steel Round Bars | Gear Steel | Mumbai Supplier"
        description="Premium EN353 Case Hardening Alloy Steel round bars. Chromium-Nickel-Molybdenum steel for high-performance gears, shafts, and pinions. Exceptional core toughness. High-quality EN353 bars in Mumbai."
        keywords="EN353 round bar, EN353 steel properties, case hardening steel Mumbai, EN353 bar price Mumbai, gear steel"
        canonicalUrl="/product/round-bars/carbon-steel/en353-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">EN353 Case Hardening Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">High-Performance Ni-Cr-Mo Gear Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">EN353 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Experience exceptional core toughness and superior case wear resistance with EN353. This chromium-nickel-molybdenum alloy is the premier choice for high-stress gears, shafts, and pinions in the automotive and aerospace industries.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get gear steel Quote</Link>
