...
export default function GradeD2RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "1.40 – 1.60%" },
    { element: "Chromium (Cr)", value: "11.0 – 13.0%" },
    { element: "Molybdenum (Mo)", value: "0.70 – 1.20%" },
    { element: "Vanadium (V)", value: "0.50 – 1.10%" },
    { element: "Manganese (Mn)", value: "0.60% max" },
    { element: "Silicon (Si)", value: "0.60% max" }
  ];

  const mechanicalProperties = [
    { property: "Hardness (HRC)", value: "58 – 62" },
    { property: "Density", value: "7.70 g/cm³" },
    { property: "Compressive Strength", value: "2200 MPa min" },
    { property: "Machinability", value: "Annealed 85%" }
  ];

  const equivalentGrades = [
    { country: "USA (AISI)", grade: "D2" },
    { country: "European (EN)", grade: "1.2379 / X153CrMoV12" },
    { country: "Japan (JIS)", grade: "SKD11" },
    { country: "German (DIN)", grade: "X155CrVMo12-1" },
    { country: "Russia (GOST)", grade: "Kh12MF" }
  ];

  return (
    <>
      <ProductSEO
        title="D2 Cold Work Tool Steel Round Bars | 1.2379 | SKD11 | Mamta Steel Traders"
        description="Premium D2 Tool Steel round bars. High carbon, high chromium alloy for exceptional wear resistance and dimensional stability. Equivalent to 1.2379, SKD11. Ideal for stamping dies and shear blades."
        keywords="D2 round bar, 1.2379 steel, D2 tool steel properties, cold work steel Mumbai, SKD11 equivalent"
        canonicalUrl="/product/round-bars/carbon-steel/d2-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">D2 Cold Work Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">High-Carbon High-Chromium Tool Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">D2 Cold Work Steel</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">The industry standard for cold work tooling. D2 steel offers exceptional wear resistance, high compressive strength, and excellent dimensional stability during heat treatment.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get Die Steel Quote</Link>
          ...
          <div className="container mx-auto px-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="grid lg:grid-cols-2 gap-12 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                ...
                <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <h2 className="text-3xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-l-4 border-gold-primary pl-4 font-bold tracking-tighter italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">Tooling Specifications</h2>
