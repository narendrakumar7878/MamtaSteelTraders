...
export default function GradeA182F22RoundBars() {
  const chemicalComposition = [
    { element: "Chromium (Cr)", value: "2.00 – 2.50%" },
    { element: "Molybdenum (Mo)", value: "0.87 – 1.13%" },
  ...
  const mechanicalProperties = [
    ...
    { property: "Brinell Hardness", value: "156 – 207 HBW" }
  ];
  ...
  return (
    <>
      <ProductSEO
        title="ASTM A182 F22 Alloy Steel Round Bars | 2.25Cr-1Mo | Mumbai Stockist"
        description="Premium ASTM A182 F22 Alloy Steel round bars. 2.25% Chromium and 1% Molybdenum steel for high-temperature and high-pressure service. Certified F22 forged bars. Available in Mumbai."
        keywords="ASTM A182 F22 round bar, F22 alloy steel properties, 2.25cr-1mo steel Mumbai, F22 forged bars price, high pressure alloy steel"
        canonicalUrl="/product/round-bars/carbon-steel/astm-a182-f22-round-bars"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">ASTM A182 F22 (2.25Cr-1Mo)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">2.25% Chromium - 1% Molybdenum Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">ASTM A182 F22 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">The industry standard for severe high-temperature service. F22 alloy steel provides exceptional oxidation resistance and creep strength for critical refinery and chemical processing environments.</p>
        ...
        <section className="py-16 bg-white dark:bg-gray-800 font-bold tracking-tighter italic font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
              <h2 className="text-3xl font-bold text-navy-primary dark:text-gray-100 mb-12 border-l-4 border-gold-primary pl-4 font-bold tracking-tighter italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic">Performance Benefits</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                 {coreBenefits.map((benefit, i) => (
                    <div key={i} className="flex items-start p-6 bg-gray-50 dark:bg-gray-700 rounded-3xl border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                       ...
                       <span className="text-lg font-bold text-navy-primary dark:text-gray-100 italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">{benefit}</span>
                    </div>
                 ))}
              </div>
           </div>
