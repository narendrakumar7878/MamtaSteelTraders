...
export default function Grade805M20RoundBars() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", value: "0.40 – 0.70%" },
    { element: "Chromium (Cr)", value: "0.40 – 0.60%" },
    { element: "Molybdenum (Mo)", value: "0.15 – 0.25%" },
    { element: "Carbon (C)", value: "0.17 – 0.23%" },
    { element: "Manganese (Mn)", value: "0.60 – 0.95%" },
    { element: "Silicon (Si)", value: "0.10 – 0.35%" }
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength", value: "700 – 900 MPa" },
    { property: "Yield Strength", value: "450 MPa min" },
    { property: "Elongation (A5)", value: "12% min" },
    { property: "Hardness (HB)", value: "200 – 260" }
  ];

  return (
    <>
      <ProductSEO
        title="805M20 Alloy Steel Round Bars | 1.6523 | 20NiCrMo2-2 | Mumbai Supplier"
        description="Premium 805M20 Alloy Steel round bars. Nickel-Chromium-Molybdenum case hardening steel with exceptional core toughness. Equivalent to 1.6523, SAE 8620. High-quality 805M20 bars in Mumbai."
        keywords="805M20 round bar, 1.6523 steel, 805M20 properties, 805M20 bar price Mumbai, nickel chrome moly steel"
        canonicalUrl="/product/round-bars/carbon-steel/805m20-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">805M20 (1.6523) Alloy Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">Nickel-Chrome-Moly Case Hardening Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">805M20 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Achieve superior core toughness and exceptional wear resistance with 805M20 (1.6523). This nickel-chromium-molybdenum alloy is the premier choice for high-stress gears, shafts, and mechanical components requiring severe case hardening.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get 805M20 Quote</Link>
