...
export default function Grade51CrV4RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.47 – 0.55%" },
    { element: "Chromium (Cr)", value: "0.90 – 1.20%" },
    { element: "Vanadium (V)", value: "0.10 – 0.25%" },
    { element: "Manganese (Mn)", value: "0.70 – 1.10%" },
    { element: "Silicon (Si)", value: "0.40% max" },
    { element: "Sulphur (S)", value: "0.035% max" }
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength", value: "700 – 1100 MPa" },
    { property: "Yield Strength", value: "450 MPa min" },
    { property: "Elastic Limit", value: "Very High" },
    { property: "Hardness (HB)", value: "220 – 300" }
  ];

  return (
    <>
      <ProductSEO
        title="51CrV4 Spring Steel Round Bars | 1.8159 | 6150 Steel | Mumbai Supplier"
        description="Premium 51CrV4 Chromium-Vanadium alloyed spring steel round bars. Exceptional toughness and fatigue resistance. Equivalent to 1.8159, AISI 6150. High-quality 51CrV4 bars in Mumbai."
        keywords="51CrV4 round bar, 1.8159 steel, 51CrV4 spring steel properties, 51CrV4 bar price Mumbai, chromium vanadium steel"
        canonicalUrl="/product/round-bars/carbon-steel/51crv4-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">51CrV4 (1.8159) Spring Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">High Fatigue-Resistant Spring Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">51CrV4 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Experience exceptional toughness and high elastic limit with 51CrV4 (1.8159). This Chromium-Vanadium alloy steel is the premier choice for heavy-duty springs, gears, and structural components subjected to high cyclic stress.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get 51CrV4 Quote</Link>
