...
export default function GradeSCM420RoundBars() {
  const chemicalComposition = [
    { element: "Chromium (Cr)", value: "0.90 – 1.20%" },
    { element: "Molybdenum (Mo)", value: "0.150 – 0.30%" },
    { element: "Carbon (C)", value: "0.18 – 0.23%" },
    { element: "Manganese (Mn)", value: "0.60 – 0.85%" },
    { element: "Silicon (Si)", value: "0.150 – 0.35%" },
    { element: "Sulphur (S)", value: "0.030% max" }
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength", value: "835 MPa min" },
    { property: "Yield Strength", value: "635 MPa min" },
    { property: "Elongation (A5)", value: "15% min" },
    { property: "Hardness (HB)", value: "235 – 321" }
  ];

  return (
    <>
      <ProductSEO
        title="SCM420 Alloy Steel Round Bars | JIS G 4105 | 18CrMo4 | Mumbai Supplier"
        description="Premium SCM420 Alloy Steel round bars. Japanese standard JIS G 4105 Chromium-Molybdenum case hardening steel for gears and shafts. Equivalent to 1.7243, 18CrMo4. High-quality SCM420 bars in Mumbai."
        keywords="SCM420 round bar, JIS G 4105 steel, SCM420 properties, SCM420 bar price Mumbai, chromium molybdenum steel"
        canonicalUrl="/product/round-bars/carbon-steel/scm420-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">SCM420 (JIS G 4105) Alloy Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">Japanese Standard Cr-Mo Case Hardening Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">SCM420 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Experience superior core toughness and exceptional case wear resistance with SCM420. This JIS G 4105 chromium-molybdenum alloy is the premier choice for high-stress gears, shafts, and pinions in the automotive and machinery manufacturing industries.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get SCM420 Quote</Link>
