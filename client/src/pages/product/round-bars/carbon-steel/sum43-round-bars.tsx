...
export default function GradeSUM43RoundBars() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength", value: "640 – 780 MPa" },
    { property: "Yield Strength", value: "370 MPa min" },
    { property: "Elongation (A5)", value: "12% min" },
    { property: "Hardness (HB)", value: "190 – 240" }
  ];

  return (
    <>
      <ProductSEO
        title="SUM43 Free Cutting Steel Round Bars | JIS G 4804 | Mumbai Supplier"
        description="Premium SUM43 Free Cutting Steel round bars. Japanese standard JIS G 4804 resulfurized grade for superior machining and precision components. Equivalent to 1144, 44SMn28. High-quality SUM43 bars in Mumbai."
        keywords="SUM43 round bar, JIS G 4804 steel, SUM43 properties, SUM43 bar price Mumbai, free cutting steel"
        canonicalUrl="/product/round-bars/carbon-steel/sum43-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">SUM43 (JIS G 4804) Free Cutting</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">Japanese Standard High-Machinability Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">SUM43 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Experience exceptional drillability and superior surface finish with SUM43. This JIS G 4804 resulfurized carbon steel is the premier choice for high-volume automated production of precision machine parts, motor shafts, and high-strength mechanical components.</p>
