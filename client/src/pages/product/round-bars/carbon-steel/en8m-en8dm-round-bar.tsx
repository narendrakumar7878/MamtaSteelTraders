...
export default function GradeEN8M_EN8DMRoundBar() {
  ...
  const mechanicalProperties = [
    ...
    { property: "Hardness (HB)", value: "160 – 210" }
  ];

  return (
    <>
      <ProductSEO
        title="EN8M / EN8DM Free Cutting Carbon Steel Round Bars | Mumbai Supplier"
        description="Premium EN8M and EN8DM Free Cutting Carbon Steel round bars. Medium carbon, free-machining grade for high-performance automotive and precision components. Superior tool life. Available in Mumbai."
        keywords="EN8M round bar, EN8DM steel properties, free cutting carbon steel Mumbai, EN8M bar price Mumbai, 212M44 equivalent"
        canonicalUrl="/product/round-bars/carbon-steel/en8m-en8dm-round-bar"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">EN8M / EN8DM Free Cutting</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">Medium-Carbon High-Machinability Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">EN8M / EN8DM Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Experience the ultimate balance of strength and machinability with EN8M / EN8DM. This medium-carbon resulfurized steel is engineered for mass production of precision shafts, motor components, and high-performance mechanical parts.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get High-Volume Quote</Link>
