...
export default function Grade20C8RoundBars() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength", value: "440 – 560 MPa" },
    { property: "Yield Strength", value: "275 MPa min" },
    { property: "Elongation (A5)", value: "20% min" },
    { property: "Hardness (HB)", value: "125 – 165" }
  ];

  return (
    <>
      <ProductSEO
        title="20C8 Carbon Steel Round Bars | IS 1570 20C8 | Mumbai Stockist"
        description="Premium 20C8 Carbon Steel round bars. IS 1570 grade for case hardening and general engineering. Superior weldability and machinability. Certified 20C8 bars available in Mumbai."
        keywords="20C8 round bar, IS 1570 20C8 steel, 20C8 carbon steel properties, 20C8 bar price Mumbai, low carbon steel"
        canonicalUrl="/product/round-bars/carbon-steel/20c8-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">20C8 Carbon Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">IS 1570 Specification Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">20C8 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">High-performance low carbon steel 20C8, optimized for case hardening, structural components, and precision machining with excellent welding characteristics.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get 20C8 Quote</Link>
