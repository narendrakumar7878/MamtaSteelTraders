...
export default function GradeC40RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.37 – 0.44%" },
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength", value: "580 MPa min" },
    { property: "Yield Strength", value: "330 MPa min" },
    { property: "Elongation", value: "16% min" },
    { property: "Hardness (HB)", value: "170 – 210" }
  ];

  return (
    <>
      <ProductSEO
        title="C40 Medium Carbon Steel Round Bars | EN8 Equivalent | Machinable | Mamta Steel Traders"
        description="Premium C40 Medium Carbon Steel round bars. Excellent balance of strength and ductility. Ideal for shafts, axles, and general engineering components. Stock available in Mumbai."
        keywords="C40 round bar, medium carbon steel, C40 steel properties, EN8 equivalent steel, C40 machining steel"
        canonicalUrl="/product/round-bars/carbon-steel/c40-round-bar"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-bold tracking-tighter italic font-bold tracking-tighter italic" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">C40 Grade Steel</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic font-bold tracking-tighter italic">Versatile Medium Carbon Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic font-bold tracking-tighter italic">C40 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Optimized medium carbon steel offering superior machinability and consistent through-hardenability for general engineering.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic">Request Bulk Quote</Link>
                   <a href="tel:+919819322576" className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-8 py-3 rounded-xl font-bold transition-all backdrop-blur-sm italic italic italic italic italic"><Phone className="w-5 h-5 inline mr-2" /> Technical Support</a>
                </div>
             </div>
          </div>
        </section>
                   ...
                   <div className="grid grid-cols-2 md:grid-cols-3 gap-6 font-bold tracking-tighter italic">
                      {chemicalComposition.map((item, i) => (
                         <div key={i} className="p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                            <p className="text-xs text-gray-500 uppercase font-bold tracking-tighter italic italic">{item.element}</p>
                   ...
                   <div className="space-y-4 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                      {mechanicalProperties.map((prop, i) => (
                         <div key={i} className="flex justify-between items-center p-3 border-b dark:border-gray-700 font-bold tracking-tighter italic font-bold tracking-tighter italic text-sm">
                            ...
                            <span className="font-bold text-navy-primary dark:text-gold-primary italic italic font-bold tracking-tighter italic italic">{prop.value}</span>
                         </div>
                      ))}
                   </div>
                </div>
