...
export default function GradeM35RoundBars() {
  const chemicalComposition = [
    { element: "Cobalt (Co)", value: "4.50 – 5.00%" },
    { element: "Tungsten (W)", value: "6.00 – 6.70%" },
    { element: "Molybdenum (Mo)", value: "4.70 – 5.20%" },
    { element: "Chromium (Cr)", value: "3.80 – 4.50%" },
    { element: "Vanadium (V)", value: "1.70 – 2.00%" },
    { element: "Carbon (C)", value: "0.80 – 0.94%" }
  ];

  const mechanicalProperties = [
    { property: "Hardness (HRC)", value: "64 – 67" },
    { property: "Density", value: "8.25 g/cm³" },
    { property: "Compressive Strength", value: "3000 MPa min" },
    { property: "Bending Strength", value: "4500 MPa min" }
  ];

  const equivalentGrades = [
    { country: "USA (AISI)", grade: "M35" },
    { country: "European (EN)", grade: "1.3243 / HS6-5-2-5" },
    { country: "Japan (JIS)", grade: "SKH55" },
    { country: "German (DIN)", grade: "S6-5-2-5" },
    { country: "France (AFNOR)", grade: "Z85WDKCV 06-05-05-04-02" }
  ];

  return (
    <>
      <ProductSEO
        title="M35 Cobalt High-Speed Tool Steel Round Bars | 1.3243 | SKH55 | Mamta Steel Traders"
        description="Premium M35 Cobalt-alloyed High-Speed Tool Steel round bars. Exceptional heat resistance and cutting performance. Equivalent to 1.3243, SKH55. Ideal for stainless steel cutting and heavy-duty drilling."
        keywords="M35 round bar, 1.3243 steel, cobalt high speed steel Mumbai, M35 steel properties, SKH55 equivalent"
        canonicalUrl="/product/round-bars/carbon-steel/m35-round-bar"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">M35 Cobalt HSS</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">Super Cobalt High-Speed Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">M35 Cobalt HSS</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">The elite Cobalt-alloyed High-Speed Tool Steel engineered for superior red hardness and exceptional performance in cutting difficult-to-machine materials like stainless steel.</p>
          ...
          <div className="container mx-auto px-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="grid lg:grid-cols-2 gap-12 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                ...
                <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <h2 className="text-3xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-l-4 border-gold-primary pl-4 font-bold tracking-tighter italic italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">Physical Specifications</h2>
        ...
        <section className="py-16 bg-white dark:bg-gray-800 font-bold tracking-tighter italic font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
              <h2 className="text-3xl font-bold text-center text-navy-primary dark:text-gray-100 mb-12 italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">Equivalent Grading Overview</h2>
                 ...
                 <table className="w-full text-left font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                    <thead>
                       <tr className="bg-navy-primary text-white italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                          <th className="p-4 rounded-tl-xl italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">Region / Standard</th>
