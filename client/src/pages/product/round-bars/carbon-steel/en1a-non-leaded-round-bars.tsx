...
export default function GradeEN1ANonLeadedRoundBars() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength", value: "370 – 520 MPa" },
    { property: "Yield Strength", value: "240 MPa min" },
    { property: "Elongation (A5)", value: "22% min" },
    { property: "Machinability Index", value: "100 (Standard)" }
  ];

  return (
    <>
      <ProductSEO
        title="EN1A Non-Leaded Round Bars | Free Cutting Steel | Mumbai Supplier"
        description="Premium EN1A Non-Leaded Free Cutting Steel round bars. Standard resulfurized grade for general machining and precision turning. Superior surface finish and tool life. High-quality EN1A bars in Mumbai."
        keywords="EN1A round bar, EN1A non leaded properties, free cutting steel Mumbai, EN1A bar price Mumbai, 1.0715 steel"
        canonicalUrl="/product/round-bars/carbon-steel/en1a-non-leaded-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">EN1A Non-Leaded</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic font-bold tracking-tighter italic">
             <div className="max-w-4xl font-bold tracking-tighter italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic italic">The Reliable Multi-Purpose Machining Steel</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic">EN1A Non-Leaded Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic">Experience consistent and dependable high-speed machining with EN1A Non-Leaded (1.0715). This standard resulfurized free-cutting grade provides the ideal balance of tool life, surface finish, and mechanical strength for general engineering components.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-3 rounded-xl font-bold transition-all shadow-xl hover:scale-105 italic italic italic font-bold tracking-tighter italic">Get Standard Machining Quote</Link>
