...
export default function GradeC45RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.42 – 0.50%" },
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength", value: "630 – 780 MPa" },
    { property: "Yield Strength", value: "370 – 490 MPa" },
    { property: "Elongation (A5)", value: "14 – 16%" },
    { property: "Impact Strength (KV)", value: "25 – 35 J" }
  ];

  const equivalentGrades = [
    { country: "India (IS)", grade: "C45 | EN8D" },
    { country: "European (EN)", grade: "1.0503 / C45" },
    { country: "USA (AISI/SAE)", grade: "1045" },
    { country: "Japan (JIS)", grade: "S45C" },
    { country: "German (DIN)", grade: "CK45" }
  ];

  return (
    <>
      <ProductSEO
        title="C45 Round Bars | EN8D | 1045 | JSW & SAIL Stock | Mamta Steel Traders"
        description="Premium C45 Medium Carbon Steel round bars. High tensile strength and excellent machinability. Equivalent to EN8D, AISI 1045. JSW and SAIL make stock available in Mumbai."
        keywords="C45 round bar, EN8D steel, 1045 carbon steel, S45C steel equivalent, C45 bright bars Mumbai, JSW C45 stockist"
        canonicalUrl="/product/round-bars/carbon-steel/c45-round-bars"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-bold tracking-tighter italic">
           <div className="container mx-auto px-4 py-4 font-bold tracking-tighter italic font-bold tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1 font-bold tracking-tighter italic italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-bold tracking-tighter italic" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic font-bold tracking-tighter italic">C45 / EN8D Bar</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-bold tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 font-bold tracking-tighter italic italic">
             <div className="max-w-4xl font-bold tracking-tighter italic italic">
                <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider mb-6 inline-block font-bold tracking-tighter italic italic">Most Popular Engineering Grade</span>
                <h1 className="text-5xl md:text-6xl font-extrabold mb-6 italic italic italic italic italic font-bold tracking-tighter italic italic">C45 Round Bars</h1>
                <p className="text-xl text-gray-200 mb-8 leading-relaxed italic italic font-bold tracking-tighter italic italic">The industry standard medium carbon steel grade combining high strength, toughness, and superior wear resistance for generic mechanical components.</p>
                <div className="flex flex-wrap gap-4 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   ...
                   <a href="tel:+919819322576" className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-8 py-3 rounded-xl font-bold transition-all backdrop-blur-sm italic italic italic italic font-bold tracking-tighter italic"><Phone className="w-5 h-5 inline mr-2" /> Call Expert</a>
                </div>
             </div>
          </div>
        </section>
             ...
             <div className="grid lg:grid-cols-3 gap-8 font-bold tracking-tighter italic">
                <div className="lg:col-span-2 space-y-12 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                       ...
                       <div className="grid grid-cols-2 md:grid-cols-3 gap-6 font-bold tracking-tighter italic">
                          {chemicalComposition.map((item, i) => (
                             <div key={i} className="p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                                <p className="text-xs text-gray-500 uppercase font-bold tracking-tighter italic italic font-bold tracking-tighter italic">{item.element}</p>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                       <h2 className="text-3xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-l-4 border-gold-primary pl-4 font-bold tracking-tighter italic italic font-bold tracking-tighter italic">Global Standards Map</h2>
                       <div className="overflow-x-auto font-bold tracking-tighter italic">
                          <table className="w-full text-left font-bold tracking-tighter italic">
                             <thead>
                                <tr className="bg-navy-primary text-white italic italic font-bold tracking-tighter italic">
                                   <th className="p-4 rounded-tl-xl text-xs uppercase font-bold tracking-tighter italic italic">Standard / Region</th>
                                   <th className="p-4 rounded-tr-xl text-xs uppercase font-bold tracking-tighter italic italic">Equivalent Grade</th>
                                </tr>
                             </thead>
                ...
                <div className="space-y-6 font-bold tracking-tighter italic font-bold tracking-tighter italic">
                   <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 font-bold tracking-tighter italic">
                      <h3 className="text-xl font-bold mb-6 text-navy-primary dark:text-gray-100 italic italic font-bold tracking-tighter italic">Applications</h3>
                      <div className="space-y-4 font-bold tracking-tighter italic">
                         {["Transmission Shafts", "Connecting Rods", "Hydraulic Pistons", "Axle Spindles", "Large Gear Wheels", "Machine Tool Fixtures"].map((app, i) => (
