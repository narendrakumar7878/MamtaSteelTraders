...
export default function TitaniumGrade7Detail() {
  const chemicalComposition = [
    { element: "Titanium (Ti)", value: "Balance" },
    { element: "Palladium (Pd)", value: "0.12 – 0.25%" },
  ...
  const physicalProperties = [
    ...
    { property: "Yield Strength (0.2%)", value: "275 MPa (40 ksi)" },
  ...
  return (
    <>
      <ProductSEO
        title="Titanium Grade 7 Round Bars | UNS R52400 | Palladium Enhanced Titanium Supplier"
        description="Premium Titanium Grade 7 (UNS R52400) round bars. Palladium-enhanced titanium for superior corrosion resistance in reducing and mildly oxidizing environments. Ideal for chemical processing."
        keywords="titanium grade 7 round bars, uns r52400 supplier mumbai, titanium palladium alloy price, grade 7 titanium chemical composition, corrosion resistant titanium rods"
        canonicalUrl="/product/round-bars/titanium/titanium-grade-7"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black font-black uppercase tracking-tighter italic">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase font-black uppercase tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">Titanium Grade 7 (+Pd)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden text-white font-black uppercase tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 text-white font-black uppercase tracking-tighter italic">
            <div className="max-w-4xl text-white font-black uppercase">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic overflow-hidden scale-105">Palladium Defensive Shield</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100 italic">Grade 7</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105 italic font-black">Titanium Grade 7 is the most corrosion-resistant titanium grade, achieved through a small addition of Palladium. It is excels in reduced and mildly oxidizing acid environments where standard CP Grades may fail.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black font-black uppercase tracking-tighter italic">
              <div className="lg:col-span-2 space-y-12 text-black font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black font-black uppercase tracking-tighter italic">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md italic">Titanium Grade 7 (UNS R52400) is a commercially pure titanium grade with a small addition of palladium (0.12% to 0.25%). This strategic alloying provides superior corrosion resistance, particularly in reducing and mildly oxidizing environments. It has physical and mechanical properties equivalent to Grade 2, but with much improved crevice corrosion resistance. Mamta Steel Traders supplies primary Grade 7 bars for chemical processing, hydrocarbon production, and brine processing systems.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase tracking-tighter italic">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">275 MPa (Min)</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase font-black">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Palladium additive</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">0.2% Pd Enhanced</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black font-black uppercase tracking-tighter italic">
                    ...
                    {physicalProperties.map((prop, i) => (
                      <div key={i} className="space-y-1 font-black">
                        <div className="flex justify-between items-center px-2 py-1 border-b border-navy-primary/10 hover:bg-gray-50 transition-colors rounded-lg">
                          <span className="text-xs text-gray-400 uppercase font-extrabold italic tracking-tighter font-black">{prop.property}</span>
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black font-black uppercase tracking-tighter italic">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
                      {["Chemical Process Piping", "Brine Processing", "Hydrocarbon Systems", "Pharmaceutical Batching", "Heat Exchangers", "Aggressive Media Tanks"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic text-black font-black uppercase tracking-tighter italic">
           <div className="container mx-auto px-4 relative z-10 text-black font-black uppercase tracking-tighter italic">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic font-black italic uppercase italic">Direct Supplier: Grade 7 Titanium</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch Grade 7 (UNS R52400) titanium round bars for extremely corrosive chemical and industrial sectors. Certified palladium-enhanced performance for global process engineering. Global export support.</p>
