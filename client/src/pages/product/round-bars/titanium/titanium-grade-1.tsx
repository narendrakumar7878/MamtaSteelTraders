...
export default function TitaniumGrade1Detail() {
  const chemicalComposition = [
    { element: "Titanium (Ti)", value: "Balance" },
    { element: "Iron (Fe)", value: "0.20% max" },
    { element: "Oxygen (O)", value: "0.18% max" },
  ...
  const physicalProperties = [
    ...
    { property: "Tensile Strength (min)", value: "240 MPa (35 ksi)" },
    { property: "Yield Strength (0.2%)", value: "170 MPa (25 ksi)" },
    { property: "Elongation (min)", value: "24%" }
  ];

  return (
    <>
      <ProductSEO
        title="Titanium Grade 1 Round Bars | UNS R50250 | Commercially Pure Titanium Supplier"
        description="Premium Titanium Grade 1 (UNS R50250) round bars. Highest ductility commercially pure titanium with excellent cold formability and corrosion resistance. Ideal for chemical processing and marine engineering."
        keywords="titanium grade 1 round bars, uns r50250 supplier mumbai, cp titanium grade 1 price, titanium grade 1 chemical composition, ductile titanium rods"
        canonicalUrl="/product/round-bars/titanium/titanium-grade-1"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">Titanium Grade 1</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10 text-white font-black uppercase tracking-tighter italic">
            <div className="max-w-4xl text-white">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic overflow-hidden scale-105">Purest Industrial Titanium</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100 italic">Grade 1</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105 italic">The softest and most ductile grade of Commercially Pure (CP) Titanium, offering exceptional cold formability and superior corrosion resistance in oxidizing environments.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black">
              <div className="lg:col-span-2 space-y-12 text-black font-black uppercase tracking-tighter italic">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md italic">Titanium Grade 1 (UNS R50250) is the first of four commercially pure titanium grades. It is the softest and has the highest ductility, making it easy to form even when cold. It possesses excellent corrosion resistance in highly oxidizing and mildly reducing environments, including chlorides. Mamta Steel Traders supplies Grade 1 titanium bars primarily for chemical processing infrastructure, desalination plants, and marine engineering where maximum ductility is required.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline font-black">Tensile Strength</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">240 MPa (Min)</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase font-black">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Purity Level</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">Alpha Phase Pure</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black font-black uppercase tracking-tighter italic">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline font-black uppercase tracking-tighter italic">
                      {["Chemical Processing", "Desalination Plants", "Heat Exchangers", "Marine Components", "Architectural Structure", "Surgical Implants"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic text-black font-black uppercase tracking-tighter italic">
           <div className="container mx-auto px-4 relative z-10 text-black">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic font-black italic">Direct Supplier: Grade 1 Titanium</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch CP Grade 1 (UNS R50250) titanium round bars for critical chemical and marine sectors. Precision sizing and certified compliance for global industrial engineering. Global export support.</p>
