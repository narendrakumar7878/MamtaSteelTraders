...
export default function TitaniumGrade3Detail() {
  const chemicalComposition = [
    { element: "Titanium (Ti)", value: "Balance" },
    { element: "Iron (Fe)", value: "0.35% max" },
    { element: "Oxygen (O)", value: "0.35% max" },
  ...
  const physicalProperties = [
    ...
    { property: "Melting Point", value: "1660°C (3020°F)" },
    { property: "Tensile Strength (min)", value: "450 MPa (65 ksi)" },
    { property: "Yield Strength (0.2%)", value: "380 MPa (55 ksi)" },
  ...
  return (
    <>
      <ProductSEO
        title="Titanium Grade 3 Round Bars | UNS R50550 | Commercially Pure Titanium Supplier"
        description="Premium Titanium Grade 3 (UNS R50550) round bars. High-strength commercially pure titanium for pressure vessels and aerospace structures. Excellent corrosion resistance with increased mechanical performance."
        keywords="titanium grade 3 round bars, uns r50550 supplier mumbai, cp titanium grade 3 price, titanium grade 3 chemical composition, aerospace titanium rods"
        canonicalUrl="/product/round-bars/titanium/titanium-grade-3"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">Titanium Grade 3</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10 text-white font-black uppercase tracking-tighter italic">
            <div className="max-w-4xl text-white">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic overflow-hidden scale-105">High-Strength CP Specialist</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100 italic">Grade 3</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105 italic">Offering significantly higher strength than Grades 1 and 2 while maintaining similar corrosion resistance, Grade 3 is specified for high-performance pressure vessels and aerospace components.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black font-black uppercase tracking-tighter italic">
              <div className="lg:col-span-2 space-y-12 text-black font-black uppercase tracking-tighter italic">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md italic">Titanium Grade 3 (UNS R50550) is the third grade of commercially pure titanium. It is stronger than Grades 1 and 2, and slightly less formable, but it features much higher mechanical properties. Grade 3 is used when high strength and moderate formability are required, along with the corrosion resistance of unalloyed titanium. Mamta Steel Traders supplies Grade 3 bars for pressure vessels, chemical process equipment, and aircraft engine components where consistent performance is critical.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline font-black">Yield (0.2%)</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">380 MPa (Min)</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase font-black">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Purity Spec</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">ASTM B348 Grade 3</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black font-black uppercase tracking-tighter italic">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline font-black uppercase tracking-tighter italic">
                      {["Pressure Vessels", "Heat Exchangers", "Aerospace Structures", "Medical Devices", "Desalination Brines", "Chemical Scrubbers"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic text-black font-black uppercase tracking-tighter italic">
           <div className="container mx-auto px-4 relative z-10 text-black">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic font-black italic">Direct Supplier: Grade 3 Titanium</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch CP Grade 3 (UNS R50550) titanium round bars for critical high-pressure engineering. Enhanced mechanical strength and certified compliance for aerospace and chemical processing. Global export support.</p>
