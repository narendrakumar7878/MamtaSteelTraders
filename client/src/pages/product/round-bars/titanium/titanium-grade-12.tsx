...
export default function TitaniumGrade12Detail() {
  const chemicalComposition = [
    { element: "Titanium (Ti)", value: "Balance" },
    { element: "Molybdenum (Mo)", value: "0.2 – 0.4%" },
    { element: "Nickel (Ni)", value: "0.6 – 0.9%" },
  ...
  const physicalProperties = [
    { property: "Density", value: "4.51 g/cm³" },
    { property: "Melting Point", value: "1665°C (3029°F)" },
    { property: "Tensile Strength (min)", value: "480 MPa (70 ksi)" },
    { property: "Yield Strength (0.2%)", value: "345 MPa (50 ksi)" },
    { property: "Elongation (min)", value: "18%" }
  ];

  return (
    <>
      <ProductSEO
        title="Titanium Grade 12 Round Bars | UNS R53400 | Ti-0.3Mo-0.8Ni Alloy Supplier"
        description="Premium Titanium Grade 12 (UNS R53400) round bars. High-strength titanium alloy with excellent resistance to crevice corrosion in hot brines and reducing environments. Ideal for geothermal and chemical process."
        keywords="titanium grade 12 round bars, uns r53400 supplier mumbai, titanium grade 12 price, titanium grade 12 chemical composition, crevice corrosion resistant titanium"
        canonicalUrl="/product/round-bars/titanium/titanium-grade-12"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black font-black uppercase tracking-tighter italic">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase font-black uppercase tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">Titanium Grade 12 (Mo-Ni)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4 text-black font-black uppercase tracking-tighter italic">
           <Link href="/product/round-bars/titanium" className="inline-flex items-center text-navy-primary dark:text-gold-primary hover:underline font-black uppercase text-xs">
              <ArrowLeft className="w-3 h-3 mr-2 font-black" /> Back to Titanium Hub
           </Link>
        </div>
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden text-white font-black uppercase tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 text-white font-black uppercase tracking-tighter italic">
            <div className="max-w-4xl text-white font-black uppercase">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic overflow-hidden scale-105">The Hot Brine Specialist</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100 italic">Grade 12</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105 italic font-black">Titanium Grade 12 (UNS R53400) is a highly durable alloy featuring small additions of Molybdenum and Nickel, providing superior strength and exceptional crevice-corrosion resistance at elevated temperatures.</p>
              <div className="flex flex-wrap gap-4 overflow-hidden font-black uppercase tracking-tighter italic">
                ...
                <a href="tel:+919819322576" className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-10 py-4 rounded-2xl font-bold transition-all backdrop-blur-sm italic tracking-tighter uppercase text-xl transform hover:scale-105 text-center shadow-lg italic font-black uppercase">Consult Expert</a>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black font-black uppercase tracking-tighter italic">
              <div className="lg:col-span-2 space-y-12 text-black font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black font-black uppercase tracking-tighter italic">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md italic">Titanium Grade 12 (UNS R53400) is an alloy grade containing molybdenum and nickel. It is characterized by high strength and excellent resistance to crevice corrosion in hot brines and mildly reducing conditions. Grade 12 has better weldability than standard CP grades and is often used in chemical processing at higher temperatures. Mamta Steel Traders supplies primary Grade 12 bars for geothermal wells, heat exchangers, and marine desalination components where temperature and corrosion act concurrently.</p>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6 font-semibold uppercase tracking-tighter italic text-black font-black uppercase tracking-tighter italic">
                    {chemicalComposition.map((item, i) => (
                      <div key={i} className="p-5 bg-gray-50 dark:bg-gray-700/50 rounded-3xl border border-gray-100 dark:border-gray-600 group hover:border-gold-primary transition-all border-2 border-transparent shadow-sm hover:shadow-lg transform hover:-translate-y-1 font-black italic">
                        <p className="text-[10px] text-gray-500 uppercase font-black mb-1 italic tracking-tighter font-black">{item.element}</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase tracking-tighter italic">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase font-black uppercase tracking-tighter italic">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">345 MPa (Min)</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase font-black">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Mo-Ni Alloy</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">Hot Brine Resistant</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black font-black uppercase tracking-tighter italic">
                    ...
                    {physicalProperties.map((prop, i) => (
                      <div key={i} className="space-y-1 font-black">
                        <div className="flex justify-between items-center px-2 py-1 border-b border-navy-primary/10 hover:bg-gray-50 transition-colors rounded-lg">
                          <span className="text-xs text-gray-400 uppercase font-extrabold italic tracking-tighter font-black font-black">{prop.property}</span>
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black font-black uppercase tracking-tighter italic">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
                      {["Geothermal Wells", "Hot Brine Processing", "Desalination Evaporators", "Chemical Reactors", "Oil Recovery Piping", "Offshore Infrastructure"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic text-black font-black uppercase tracking-tighter italic">
           <div className="container mx-auto px-4 relative z-10 text-black font-black uppercase tracking-tighter italic">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic font-black italic uppercase italic">Direct Supplier: Grade 12 Titanium</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch Grade 12 (UNS R53400) titanium round bars for high-temperature and extremely corrosive brine environments. Certified Mo-Ni alloyed performance for global energy and desalination projects. Global export support.</p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center overflow-hidden font-black font-black uppercase tracking-tighter italic">
