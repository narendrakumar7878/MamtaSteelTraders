...
export default function Grade254SMODetail() {
  const chemicalComposition = [
    { element: "Chromium (Cr)", value: "19.5 – 20.5%" },
    { element: "Nickel (Ni)", value: "17.5 – 18.5%" },
    { element: "Molybdenum (Mo)", value: "6.0 – 6.5%" },
    { element: "Nitrogen (N)", value: "0.18 – 0.22%" },
    { element: "Copper (Cu)", value: "0.50 – 1.00%" },
    { element: "Carbon (C)", value: "0.02% max" }
  ];

  const mechanicalProperties = [
    { prop: "Tensile Strength", value: "650 – 850 MPa" },
    { prop: "Yield Strength (0.2%)", value: "300 MPa min" },
    { prop: "Elongation (in 2\")", value: "35% min" },
    { prop: "Hardness (Brinell)", value: "210 HB max" },
    { prop: "PREN (Pitting Resistance)", value: ">42.5" },
    { prop: "Thermal Conductivity", value: "10 W/m·K" }
  ];

  const thermalSpecs = [
    { process: "Solution Annealing", temp: "1150 – 1200°C", desc: "Required to dissolve intermetallic phases; must be followed by water quench." },
    { process: "Hot Working", temp: "1200 – 1000°C", desc: "Forging must be completed above 1000°C to avoid cracking." },
    { process: "Machinability", temp: "Moderate", desc: "Can be machined but work-hardens rapidly; use sharp tools and slow speeds." },
    { process: "Weldability", temp: "Excellent", desc: "Best results with over-alloyed filler metal (e.g., Alloy 625)." }
  ];

  return (
    <>
      <ProductSEO
        title="254 SMO Round Bars | UNS S31254 | 6% Moly Super Austenitic | Mumbai"
        description="Premium 254 SMO (UNS S31254) Round Bar supplier in Mumbai India. High nitrogen and 6% molybdenum for supreme resistance to pitting and crevice corrosion. PREN > 42."
        keywords="254 smo round bars, uns s31254 stainless steel price mumbai, 6% moly steel supplier india, super austenitic stainless steel 254 smo, pitting resistant alloy, industrial steel mumbai"
        canonicalUrl="/product/round-bars/duplex-super-duplex/254-smo"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic tracking-wider">254 SMO (UNS S31254)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg underline decoration-navy-primary decoration-4">Ultimate 6% Moly Protection</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none">254 SMO</h1>
              <p className="text-xl text-gray-200 mb-8 leading-relaxed max-w-2xl opacity-90 italic font-medium uppercase tracking-tight italic tracking-tighter italic">A high-molybdenum and nitrogen-enhanced super austenitic grade that outperforms conventional stainless steels in harsh chloride environments.</p>
              <div className="flex flex-wrap gap-4">
                <Link href="/contact" className="bg-gold-primary hover:bg-white text-navy-primary px-10 py-4 rounded-2xl font-black transition-all shadow-xl italic tracking-tighter uppercase">Request Expert Quote</Link>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 text-black">
            <div className="grid lg:grid-cols-3 gap-12 text-black h-fit">
              <div className="lg:col-span-2 space-y-12 text-black h-fit overflow-hidden">
                {/* Tech Profile Card */}
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6">Super Austenitic Metallurgy</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed italic font-medium italic mb-8 italic italic tracking-tighter shadow-sm p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl italic tracking-tighter underline underline-offset-8 decoration-gold-primary decoration-4">254 SMO (UNS S31254) is a super austenitic stainless steel containing 6% molybdenum and augmented by nitrogen. It was developed specifically for service in seawater and other aggressive chloride-bearing media. It offers exceptional resistance to pitting and crevice corrosion, combined with high ductility and impact strength.</p>
                ...
                <div className="bg-navy-primary text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group h-fit overflow-hidden">
                   <div className="relative z-10 h-fit overflow-hidden">
                      <h2 className="text-3xl font-black mb-8 italic tracking-tighter uppercase flex items-center gap-4 h-fit">
                         ...
                         Marine Pitting Resistance (254 SMO)
                      </h2>
              ...
              <div className="space-y-8 h-fit overflow-hidden text-black">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary h-fit group overflow-hidden">
                   <h3 className="text-2xl font-black mb-6 italic tracking-tighter uppercase italic tracking-tighter italic">Key Applications</h3>
                   <div className="space-y-4 h-fit overflow-hidden">
                      {["Flue Gas Desulfurization Towers", "Pulp Mill Bleach Plants", "Sea Water Desalination Tanks", "Seawater Handling Piping", "Hydraulic Oil Filtration Equipment", "Saltwater Distillation Units"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 overflow-hidden relative h-fit overflow-hidden">
           <div className="container mx-auto px-4 text-center relative z-10 h-fit overflow-hidden">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase italic tracking-tighter italic h-fit">The Global Gold Standard for Chloride Environments</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic italic tracking-tighter italic h-fit">Mamta Steel Traders is a key supplier of 254 SMO (UNS S31254) round bars, serving global maritime and industrial energy hubs from Mumbai. EN 10204 3.1 certified metallurgy.</p>
