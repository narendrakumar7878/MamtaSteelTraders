...
export default function Alloy825RoundBarsDetail() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength", value: "590 MPa min" },
    { property: "Yield Strength (0.2% Offset)", value: "240 MPa min" },
    { property: "Elongation (in 50mm)", value: "30% min" },
    { property: "Hardness (Brinell)", value: "150 – 210 HB" },
  ...
  return (
    <>
      <ProductSEO
        title="Alloy 825 Round Bars | UNS N08825 | Incoloy 825 Supplier Mumbai"
        description="Premium Alloy 825 (UNS N08825) round bars. Exceptional resistance to both reducing and oxidizing acids. High-performance nickel alloy for chemical processing and oil and gas."
        keywords="alloy 825 round bars, uns n08825 supplier mumbai, incoloy 825 bars price, alloy 825 chemical composition, acid resistant nickel alloy bars"
        canonicalUrl="/product/round-bars/nickel-alloy/alloy-825"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black font-black uppercase tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">Alloy 825 (UNS N08825)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10 text-white">
            <div className="max-w-4xl text-white">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic overflow-hidden scale-105">The Acid Attack Defense</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100 italic">Alloy 825</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105">Nickel-iron-chromium-molybdenum alloy with additions of copper and titanium, designed for exceptional resistance to both reducing and oxidizing acids.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black">
              <div className="lg:col-span-2 space-y-12 text-black">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md italic">Alloy 825 (UNS N08825) is a nickel-iron-chromium alloy with additions of molybdenum, copper, and titanium. It is designed to provide exceptional resistance to many corrosive environments, both oxidizing and reducing. The nickel content is sufficient for resistance to chloride-ion stress-corrosion cracking. The nickel, in conjunction with molybdenum and copper, also gives outstanding resistance to reducing environments such as those containing sulfuric and phosphoric acids. Mamta Steel Traders supplies primary Alloy 825 bars for oil and gas production, chemical processing, and nuclear fuel reprocessing.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Acid Defense</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">Oxidizing & Reducing</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Cracking Resist</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">Chloride-Ion SCC</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline">
                      {["Oil-Well Components", "Nuclear Fuel Reprocessing", "Acid Production", "Heaters & Evaporators", "Pollution Control", "Petrochemical Piping"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic text-black">
           <div className="container mx-auto px-4 relative z-10 text-black">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic">Direct Supplier: Alloy 825 Bars</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch Alloy 825 (UNS N08825) round bars for the world's most aggressive acid and gas environments. Certified metallurgical integrity for high-stress operations. Global export ready.</p>
