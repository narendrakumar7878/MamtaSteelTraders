...
export default function Alloy800RoundBarsDetail() {
  const chemicalComposition = [
    ...
    { element: "Aluminum (Al)", value: "0.15 – 0.60%" },
    { element: "Titanium (Ti)", value: "0.15 – 0.60%" },
    { element: "Manganese (Mn)", value: "1.5% max" }
  ];

  const thermalProperties = [
    { property: "Density", value: "7.94 g/cm³" },
    { property: "Melting Point", value: "1357 – 1385°C" },
    { property: "Tensile Strength (Annealed)", value: "520 MPa min" },
  ...
  return (
    <>
      <ProductSEO
        title="Alloy 800 Round Bars | UNS N08800 | Incoloy 800 Supplier Mumbai"
        description="Premium Alloy 800 (UNS N08800) round bars. High-temperature nickel-iron-chromium alloy with excellent resistance to oxidation and carburization. Ideal for heat treating and power generation."
        keywords="alloy 800 round bars, uns n08800 supplier mumbai, incoloy 800 bars price, alloy 800 chemical composition, high temperature nickel alloy bars"
        canonicalUrl="/product/round-bars/nickel-alloy/alloy-800"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase">
                 ...
                 <Link href="/product/round-bars/nickel-alloy" className="text-gray-600 dark:text-gray-400 hover:text-navy-primary underline decoration-navy-primary/20 transition-colors italic tracking-tighter uppercase">Nickel Alloy Series</Link>
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">Alloy 800 (UNS N08800)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4 text-black">
           <Link href="/product/round-bars/nickel-alloy" className="inline-flex items-center text-navy-primary dark:text-gold-primary hover:underline font-black uppercase text-xs">
              <ArrowLeft className="w-3 h-3 mr-2" /> Back to Nickel Hub
           </Link>
        </div>
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10 text-white">
            <div className="max-w-4xl">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic">The Oxidation Specialist</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100">Alloy 800</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105">Nickel-iron-chromium alloy specifically engineered for high-temperature strength and superior resistance to oxidation and carburization.</p>
              <div className="flex flex-wrap gap-4 overflow-hidden">
                <Link href="/contact" className="bg-gold-primary hover:bg-white text-navy-primary px-10 py-4 rounded-2xl font-black transition-all shadow-xl italic tracking-tighter uppercase text-xl transform hover:scale-105 text-center">Inquire Technical Batch</Link>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black">
              <div className="lg:col-span-2 space-y-12 text-black font-black uppercase tracking-tighter italic">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md">Alloy 800 (UNS N08800) is a widely used material of construction for equipment that must have high-temperature strength and resist corrosion, oxidation, carburization, and other harmful effects of high-temperature exposure. The chromium in the alloy imparts resistance to both oxidation and corrosion. The high percentage of nickel maintains a stable austenitic structure. Mamta Steel Traders supplies primary Alloy 800 for heat-exchangers, power generation, and industrial heating equipment where thermal stability is critical.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Thermo-Stability</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">High Heat Endurance</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Cr & Ni Stabilized</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">Oxidation Resistant</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black">
                <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 h-fit italic border-2 border-navy-primary/5 hover:border-gold-primary/20 transition-all font-black text-black font-black uppercase tracking-tighter italic">
                  <h3 className="text-xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase border-b-2 border-gold-primary pb-2 underline decoration-gold-primary/10 transition-all transform hover:translate-x-2 font-black italic">Thermal Features</h3>
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline">
                      {["Heat-Exchangers", "Industrial Heating", "Furnace Components", "Power Generation", "Petrochemical Piping", "Thermal Processing"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic">
           <div className="container mx-auto px-4 relative z-10 text-black">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic">Direct Supplier: Alloy 800 Bars</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch Alloy 800 (UNS N08800) round bars for thermal-intensive operations. Certified metallurgical stability for high-stress furnace environments. Global export ready.</p>
