...
export default function Alloy20RoundBarsDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", value: "32.0 – 38.0%" },
    { element: "Chromium (Cr)", value: "19.0 – 21.0%" },
    { element: "Copper (Cu)", value: "3.0 – 4.0%" },
    { element: "Molybdenum (Mo)", value: "2.0 – 3.0%" },
    { element: "Manganese (Mn)", value: "2.0% max" },
    { element: "Niobium (Nb) + Tantalum", value: "8 x C min – 1.0%" },
  ...
  const mechanicalProperties = [
    ...
    { property: "Hardness (Brinell)", value: "217 HB max" },
  ...
  return (
    <>
      <ProductSEO
        title="Alloy 20 Round Bars | UNS N08020 | Carpenter 20 Supplier Mumbai"
        description="Premium Alloy 20 (UNS N08020) round bars. Excellent resistance to sulfuric acid and chloride stress corrosion cracking. High-performance nickel alloy for chemical and pharmaceutical industries."
        keywords="alloy 20 round bars, uns n08020 supplier mumbai, carpenter 20 bars price, alloy 20 chemical composition, sulfuric acid resistant bars"
        canonicalUrl="/product/round-bars/nickel-alloy/alloy-20"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">Alloy 20 (UNS N08020)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4 text-black">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10 text-white">
            <div className="max-w-4xl">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic">The Sulfuric Acid Specialist</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px]">Alloy 20</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter">Nickel-iron-chromium austenitic alloy designed for maximum resistance to acid attack, specifically sulfuric acid environments.</p>
              <div className="flex flex-wrap gap-4 overflow-hidden">
                <Link href="/contact" className="bg-gold-primary hover:bg-white text-navy-primary px-10 py-4 rounded-2xl font-black transition-all shadow-xl italic tracking-tighter uppercase text-xl text-center">Request Technical Quote</Link>
                <a href="tel:+919819322576" className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-10 py-4 rounded-2xl font-bold transition-all backdrop-blur-sm italic tracking-tighter uppercase text-xl text-center shadow-lg">Consult Expert</a>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black">
              <div className="lg:col-span-2 space-y-12 text-black">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black font-black uppercase tracking-tighter italic">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md">Alloy 20 (UNS N08020), also known as Carpenter 20, is a "super" stainless steel designed specifically for maximum resistance to acid attack. Its unique chemistry—combining nickel, chromium, molybdenum, and copper—provides exceptional resistance to general corrosion, pitting, and crevice corrosion in chemicals containing chlorides and sulfuric, phosphoric, and nitric acids. It also contains Niobium for stabilization against sensitization and resultant intergranular corrosion. Mamta Steel Traders supplies Alloy 20 bars extensively for chemical and petrochemical processing, as well as pharmaceutical and food equipment.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">High Conc. H2SO4</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Stabilization</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">Niobium Stabilized</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline">
                      {["Sulfuric Acid Mixing", "Pickling Equipment", "Pharmaceutical Mfg", "Chemical Processing", "Synthetic Rubber Production", "Pollution Control"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic">
           <div className="container mx-auto px-4 relative z-10 text-black">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic">Direct Supplier: Alloy 20 Bars</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch Alloy 20 (UNS N08020) round bars for critical acid-handling infrastructure. ISO certified quality with superior resistance to sulfuric acid stress. Global export ready.</p>
