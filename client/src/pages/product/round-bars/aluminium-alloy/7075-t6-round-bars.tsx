...
export default function Alu7075RoundBars() {
  ...
  const equivalentGrades = [
    { country: "W.Nr. / DIN", grade: "3.4365 / AlZnMgCu1.5" },
    { country: "USA / AISI / AA", grade: "7075 / A97075" },
    { country: "ISO", grade: "Al Zn5.5MgCu" },
    { country: "Japan / JIS", grade: "A7075" },
    { country: "France / AFNOR", grade: "A-Z5GU" }
  ];

  const applications = [
    "Aerospace fuselage and wing skins",
    "High-pressure hydraulic fittings",
    "Military vehicle structural parts",
    "High-end bicycle frames and components",
    "Rock climbing equipment and carabiners",
    "Precision gears and shafts",
    "Satellite and spacecraft components",
    "High-stress structural engineering parts"
  ];

  return (
    <>
      <ProductSEO
        title="Aluminium 7075 T6 Round Bars - Highest Strength Alloy | Mumbai Supplier | Mamta Steel Traders"
        description="Premium 7075 T6 aluminium round bars. Ultra-high strength alloy comparable to steel. Excellent fatigue resistance for aerospace and defense. ASTM B211 certified. Leading supplier in Mumbai."
        keywords="7075 t6 aluminium round bars, aluminum 7075 t6 rods price, aircraft grade aluminum 7075, 7075 t6 mechanical properties, highest strength aluminum alloy, ASTM B221 7075, buy 7075 aluminum bars India"
        canonicalUrl="/product/round-bars/aluminium-alloy/7075-t6-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium">7075 T6 Round Bars</span>
            </nav>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Aluminium 7075 T6 Round Bars
                <span className="block text-2xl text-gold-primary font-normal mt-2">Ultra-High Strength Comparable to Structural Steel</span>
              </h1>
              <p className="text-xl mb-8 text-gray-200 max-w-2xl mx-auto">One of the strongest aluminium alloys available, 7075 T6 is specifically engineered for ultra-high stress applications in aerospace, defense, and high-end automotive engineering.</p>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
              <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">Grade 7075 T6 – Material Overview</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
                <strong>Aluminium 7075</strong> is an aluminium-zinc alloy with magnesium and copper. It is one of the highest strength aluminium alloys available, often compared to high-tensile steels in terms of structural performance. The <strong>T6 temper</strong> indicates it has been solution heat-treated and artificially aged to achieve peak mechanical properties. It offers excellent fatigue resistance but lower corrosion resistance than 5xxx and 6xxx series alloys.
              </p>
              <div className="grid sm:grid-cols-2 gap-4 mt-6">
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-gold-primary mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">Ultra-high tensile strength (~572 MPa)</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-gold-primary mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">Exceptional fatigue and stress-corrosion resistance</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-gold-primary mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">Highly responsive to high-stress industrial forge</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-gold-primary mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">Ideal for high-end aerospace/defense components</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                ...
                <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                  <li className="flex items-start text-base"><Shield className="w-5 h-5 text-navy-primary mr-2 flex-shrink-0" /><span>Certification: AMS 4123, AMS 7075, ASTM B211</span></li>
                  <li className="flex items-start text-base"><Shield className="w-5 h-5 text-navy-primary mr-2 flex-shrink-0" /><span>Tempers: T6, T651, T7351, O (Annealed)</span></li>
                  <li className="flex items-start text-base"><Shield className="w-5 h-5 text-navy-primary mr-2 flex-shrink-0" /><span>Testing: Ultrasonic Class A Certified for Internal Soundness</span></li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-navy-primary via-navy-secondary to-slate-800 rounded-xl p-8 text-white mb-12 shadow-xl">
              <h3 className="text-2xl font-bold mb-8 text-center flex items-center justify-center">
                ...
                Industry Applications: Alu 7075
              </h3>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-8 mb-12">
              ...
              <div className="flex flex-wrap gap-2 text-xs">
                {["7075 t6 aluminum round bar supplier", "highest strength aircraft aluminum", "AMS 4123 aluminum specification", "7075 t6 mechanical properties", "7075 aluminum bar vs steel", "DIN 3.4365 aluminum equivalent", "buy 7075 bars Mumbai", "7075 aluminum stockist India"].map((kw, i) => (
            ...
            <div className="text-center bg-white dark:bg-gray-800 p-10 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700">
              <h3 className="text-3xl font-bold text-slate-800 dark:text-gray-100 mb-2">Request 7075 T6 Technical Quote</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-8">Stocking premium quality 7075 bars from world-renowned producers. Certified and dispatch ready.</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
