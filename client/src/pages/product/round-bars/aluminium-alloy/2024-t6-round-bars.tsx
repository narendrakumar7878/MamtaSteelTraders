...
export default function Alu2024RoundBars() {
  ...
  const equivalentGrades = [
    { country: "W.Nr. / DIN", grade: "3.1355 / AlCuMg2" },
    { country: "USA / AISI / AA", grade: "2024 / A92024" },
    { country: "ISO", grade: "Al Cu4Mg1" },
    { country: "Japan / JIS", grade: "A2024" },
    { country: "France / AFNOR", grade: "AU4G1" }
  ];

  const applications = [
    "Aircraft structural members (Wings & Fuselage)",
    "Aerospace fasteners and hardware",
    "High-tension structural parts",
    "Computer chassis and scientific instruments",
    "Truck wheels and transportation components",
    "Veterinary and orthopedic equipment",
    "Gears and cylinder pistons",
    "Shafts and hydraulic valve bodies"
  ];

  return (
    <>
      <ProductSEO
        title="Aluminium 2024 T351/T4 Round Bars - Aircraft Grade | Mumbai Supplier | Mamta Steel Traders"
        description="Premium Aluminium 2024 T351 / T4 round bars. Superior fatigue resistance for aircraft structural applications. ASTM B211 certified. Specialized aerospace aluminum stockist in Mumbai."
        keywords="aluminium 2024 t351 round bars, 2024 t4 aluminum bars, aircraft grade aluminum 2024, 2024 aluminum price Mumbai, aerospace aluminum suppliers India, AMS 4339 aluminum, ASTM B211 2024, aluminum copper alloy 2024"
        canonicalUrl="/product/round-bars/aluminium-alloy/2024-t6-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium">2024 T351 Round Bars</span>
            </nav>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Aluminium 2024 T351 / T4 Round Bars
                <span className="block text-2xl text-gold-primary font-normal mt-2">The Standard Aircraft Structural Alloy</span>
              </h1>
              <p className="text-xl mb-8 text-gray-200 max-w-2xl mx-auto">Renowned for its superior fatigue resistance and high strength-to-weight ratio, 2024 is the primary choice for aircraft fuselage and wing structures under tension.</p>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
              <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">Alu 2024 – Aerospace Excellence</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
                <strong>Aluminium 2024</strong> is an aluminium-copper alloy often referred to as "aircraft aluminium" due to its high strength and excellent fatigue resistance. The <strong>T351 temper</strong> (solution heat treated, cold worked, and naturally aged) provides exceptional dimensional stability and mechanical durability for precision aerospace components.
              </p>
              <div className="grid sm:grid-cols-2 gap-4 mt-6">
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-gold-primary mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">Exceptional fatigue strength under cyclic loading</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-gold-primary mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">High yield strength (~324 MPa)</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-gold-primary mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">Good machinability with fair surface finish</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-gold-primary mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">Excellent strength-to-weight ratio for flight</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                ...
                <div className="p-4 bg-gradient-to-r from-navy-primary to-navy-secondary text-white rounded-lg mb-6 text-center shadow-md">
                  ...
                  <p className="text-3xl font-bold text-gold-primary">6.35mm – 350mm</p>
                </div>
                <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                  <li className="flex items-start text-base"><Shield className="w-5 h-5 text-navy-primary mr-2 flex-shrink-0" /><span>Certification: AMS 4112, AMS 4339, ASTM B211</span></li>
                  <li className="flex items-start text-base"><Shield className="w-5 h-5 text-navy-primary mr-2 flex-shrink-0" /><span>Tempers: T351, T4, T3, T851</span></li>
                  <li className="flex items-start text-base"><Shield className="w-5 h-5 text-navy-primary mr-2 flex-shrink-0" /><span>Testing: LPI & Ultrasonic tested for aerospace safety</span></li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-navy-primary via-navy-secondary to-slate-800 rounded-xl p-8 text-white mb-12 shadow-xl">
              <h3 className="text-2xl font-bold mb-8 text-center flex items-center justify-center">
                ...
                Industry Applications: Alu 2024
              </h3>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-8 mb-12">
              ...
              <div className="flex flex-wrap gap-2 text-xs">
                {["2024 t351 aluminum bar stock", "aircraft structural aluminum rods", "MS 4112 aluminum specification", "2024 vs 7075 aluminum", "2024 aluminum fatigue strength", "where to buy 2024 aluminum Mumbai", "AMS 4339 round bar", "2024 t4 mechanical properties"].map((kw, i) => (
            ...
            <div className="text-center bg-white dark:bg-gray-800 p-10 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700">
              <h3 className="text-3xl font-bold text-slate-800 dark:text-gray-100 mb-2">Order Aerospace Grade Alu 2024</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-8">Direct from mill stockist. We provide cut-to-length services for all aircraft grades.</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
