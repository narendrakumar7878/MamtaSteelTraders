...
export default function AISID2ToolSteelDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "1.40 – 1.60%" },
    { element: "Chromium (Cr)", value: "11.00 – 13.00%" },
    { element: "Molybdenum (Mo)", value: "0.70 – 1.20%" },
    { element: "Vanadium (V)", value: "0.20 – 1.00%" },
  ...
  const thermalProperties = [
    ...
    { property: "Tempered Hardness", value: "58 – 62 HRC" },
    { property: "Critical Temp (Ac1)", value: "815°C" },
  ...
  return (
    <>
      <ProductSEO
        title="AISI D2 Tool Steel Round Bars | UNS T30402 | High Carbon High Chrome Die Steel"
        description="Premium AISI D2 (UNS T30402 / DIN 1.2379) tool steel round bars. High carbon, high chromium cold work tool steel with exceptional wear resistance and air-hardening properties."
        keywords="aisi d2 tool steel round bars, uns t30402 supplier mumbai, d2 die steel price, d2 tool steel chemical composition, high chrome cold work steel"
        canonicalUrl="/product/round-bars/tool-steel/aisi-d2-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase tracking-tighter italic">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase font-black italic">AISI D2 Tool Steel</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden font-black italic text-white uppercase tracking-tighter italic">
          <div className="container mx-auto px-4 relative z-10 text-white font-black italic uppercase tracking-tighter italic">
            <div className="max-w-4xl text-white font-black italic uppercase italic">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic overflow-hidden scale-105 font-black italic">The Gold Standard for Wear Resistance</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100 italic font-black">AISI D2 STEEL</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105 italic font-black">A high-carbon, high-chromium cold work tool steel alloyed with molybdenum and vanadium. Known for its high wear resistance, excellent air-hardening properties, and dimensional stability during heat treatment.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
              <div className="lg:col-span-2 space-y-12 text-black font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black font-black uppercase tracking-tighter italic">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md italic font-black uppercase tracking-tighter italic">AISI D2 (UNS T30402 / DIN 1.2379) is the premier air-hardening, high-carbon, high-chromium tool steel. It offers excellent resistance to abrasion and wear, while providing good toughness and dimensional stability. The high chromium content provides a degree of corrosion resistance in the hardened condition. Mamta Steel Traders supplies primary D2 bars for blanking dies, forming rolls, and long-run stamping dies where uncompromising tool life is required.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic text-white">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic text-white">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all font-black uppercase tracking-tighter italic">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black uppercase tracking-tighter italic">58 – 62 HRC</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline font-black uppercase tracking-tighter italic">Cold Work Grade</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black uppercase tracking-tighter italic">High Carbon Chrome</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
                      {["Blanking & Stamping Dies", "Slitting Cutters", "Forming Rolls", "Cold Extrusion Dies", "Woodworking Cutters", "Thread Rolling Dies"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic text-black font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
           <div className="container mx-auto px-4 relative z-10 text-black font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic font-black italic font-black uppercase tracking-tighter italic">Direct Supplier: AISI D2 Tool Steel</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">Mamta Steel Traders delivers ready-to-dispatch AISI D2 (UNS T30402) tool steel round bars for high-precision cold work tooling. Precision sizing and certified compliance for global industrial engineering. Global export support.</p>
