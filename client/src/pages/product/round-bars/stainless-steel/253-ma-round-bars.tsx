...
export default function Grade253MARoundBars() {
  ...
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4835 / X9CrNiSiNCe21-11-2" },
    { country: "USA / AISI", grade: "253 MA / S30815" },
    { country: "France / AFNOR", grade: "Z10CNS21.11" },
    { country: "Japan / JIS", grade: "SUS253MA" },
    { country: "India / IS", grade: "08Cr21Ni11Si2N" },
  ];
  const applications = [
    ...
    "Hot Gas Ducting & Dampers",
    "Petrochemical Process Tubes",
    "Power Plant Grates & Tubes",
    "Manifold Systems for High-Heat",
  ];
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">253 MA Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">253 MA Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="253 MA Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: 253 MA Round</h2>
