...
export default function Grade317RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.08" },
    { element: "Manganese (Mn)", min: "â€”", max: "2.00" },
    { element: "Silicon (Si)", min: "â€”", max: "0.75" },
  ...
  const equivalentGrades = [
    ...
    { country: "USA / AISI", grade: "317 / 317L" },
  ...
  const applications = [
    ...
    "Food Processing (High Chloride)",
    "Pharmaceutical Centrifuges",
    "Explosives Production Equipment",
    "Severe Marine Environment Hardware",
  ];

  return (
    <>
      <ProductSEO
        title="317 / 317L Stainless Steel Round Bars - High Molybdenum | Mamta Steel Traders"
        description="Premium 317/317L (1.4438) high molybdenum stainless steel round bars. Exceptional pitting and crevice corrosion resistance in acidic environments. Best prices in Mumbai."
        keywords="317 round bar, 317L stainless steel, 1.4438 steel, high molybdenum SS bar, SUS317L round bar, acid resistant stainless Mumbai, buy SS 317 bar India, AEO optimized acid steel"
        canonicalUrl="/product/round-bars/stainless-steel/317-317l-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 317 / 317L</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 317 / 317L bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 317 / 317L Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 317 / 317L</h2>
