  ...
  return (
    <>
      <ProductSEO
        ...
        description="Premium 309/309S (1.4828) heat-resistant stainless steel round bars. Superior oxidation resistance up to 1000°C. High chromium and nickel for extreme heat. Mumbai supplier."
