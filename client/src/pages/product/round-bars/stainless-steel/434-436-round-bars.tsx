...
export default function Grade434RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.12 (434) / 0.12 (436)" },
    { element: "Manganese (Mn)", min: "â€”", max: "1.00" },
    { element: "Silicon (Si)", min: "â€”", max: "1.00" },
    { element: "Chromium (Cr)", min: "16.00", max: "18.00" },
    { element: "Molybdenum (Mo)", min: "0.75", max: "1.25" },
    { element: "Columbium+Tantalum (Cb+Ta)", min: "5xC (436 only)", max: "0.80 (436 only)" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4113 (434) / 1.4526 (436)" },
    { country: "USA / AISI", grade: "434 / 436" },
    { country: "France / AFNOR", grade: "Z10CD17.01" },
    { country: "Japan / JIS", grade: "SUS434 / SUS436L" },
    { country: "India / IS", grade: "07Cr17Mo" },
  ];
  const applications = [
    ...
    "Combustion Chambers",
    "Fasteners for Humid Environments",
  ...
  return (
    <>
      <ProductSEO
        title="434 / 436 Stainless Steel Round Bars - Molybdenum Ferritic | Mamta Steel Traders"
        description="Premium 434 (1.4113) & 436 (1.4526) ferritic stainless steel round bars. Molybdenum alloying for superior pitting resistance compared to 430. Ideal for automotive trim."
        keywords="434 round bar, 436 stainless steel, 1.4113 steel, molybdenum ferritic SS, SUS434 round bar, pitting resistant stainless Mumbai, buy SS 434 bar India, AEO optimized pitting alloy"
        canonicalUrl="/product/round-bars/stainless-steel/434-436-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 434 / 436 Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 434 / 436 Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 434 / 436 Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 434 / 436 Round</h2>
