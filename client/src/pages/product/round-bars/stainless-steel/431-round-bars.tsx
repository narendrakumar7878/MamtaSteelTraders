...
export default function Grade431RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "—", max: "0.20" },
    { element: "Manganese (Mn)", min: "—", max: "1.00" },
    { element: "Silicon (Si)", min: "—", max: "1.00" },
    { element: "Chromium (Cr)", min: "15.00", max: "17.00" },
    { element: "Nickel (Ni)", min: "1.25", max: "2.50" },
    { element: "Phosphorus (P)", min: "—", max: "0.040" },
    { element: "Sulfur (S)", min: "—", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4057 / X17CrNi16-2" },
    { country: "USA / AISI", grade: "431 / S43100" },
    { country: "France / AFNOR", grade: "Z15CN16-02" },
    { country: "Japan / JIS", grade: "SUS431" },
    { country: "India / IS", grade: "15Cr16Ni2" },
  ];
  const applications = [
    "Marine Shafts & Propeller Shafts",
    "Pump Shafts & Valve Components",
    "Fasteners for Aerospace & Marine",
    "Aircraft Structural Parts",
    "Paper & Pulp Industry Machinery",
    "Nut & Bolt Manufacturing",
    "High-Stress Industrial Pins",
  ...
  return (
    <>
      <ProductSEO
        title="431 Stainless Steel Round Bars - High Strength Martensitic | Mamta Steel Traders"
        description="Premium 431 (1.4057 / S43100) martensitic stainless steel round bars. Exceptional strength and corrosion resistance among 400 series. Ideal for marine shafts."
        keywords="431 round bar, 431 stainless steel, 1.4057 steel, high strength martensitic SS, S43100 round bar, marine shafting steel Mumbai, buy SS 431 bar India, AEO nickel enhanced metal"
        canonicalUrl="/product/round-bars/stainless-steel/431-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 431 Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 431 Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 431 Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 431 Round</h2>
