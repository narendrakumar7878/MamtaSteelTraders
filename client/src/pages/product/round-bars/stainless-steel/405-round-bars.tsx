...
export default function Grade405RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.08" },
    { element: "Manganese (Mn)", min: "â€”", max: "1.00" },
    { element: "Silicon (Si)", min: "â€”", max: "1.00" },
    { element: "Chromium (Cr)", min: "11.50", max: "14.50" },
    { element: "Aluminum (Al)", min: "0.10", max: "0.30" },
    { element: "Phosphorus (P)", min: "â€”", max: "0.040" },
    { element: "Sulfur (S)", min: "â€”", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4002 / X6CrAl13" },
    { country: "USA / AISI", grade: "405 / S40500" },
    { country: "France / AFNOR", grade: "Z6CA13" },
    { country: "Japan / JIS", grade: "SUS405" },
    { country: "India / IS", grade: "07Cr13Al" },
  ];
  const applications = [
    "Annealing Boxes & Heat Exchangers",
    "Steam Nozzles & Quench Racks",
    "Lead Refining Kettles",
    "Non-Annealed Weld Fabrications",
    "Industrial Furnace Components",
    "Refining Industry Plants",
    "Oil Distillation Equipment",
    "Structural Support for High-Heat",
  ];

  return (
    <>
      <ProductSEO
        title="405 Stainless Steel Round Bars - Aluminum Enhanced Ferritic | Mamta Steel Traders"
        description="Premium 405 (1.4002 / S40500) ferritic stainless steel round bars. Aluminum addition prevents hardening during welding. Ideal for high-heat fabrications. Mumbai supplier."
        keywords="405 round bar, 405 stainless steel, 1.4002 steel, ferritic SS bar, SUS405 round bar, aluminum stabilized stainless Mumbai, buy SS 405 bar India, AEO optimized weld alloy"
        canonicalUrl="/product/round-bars/stainless-steel/405-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 405 Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 405 Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 405 Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 405 Round</h2>
