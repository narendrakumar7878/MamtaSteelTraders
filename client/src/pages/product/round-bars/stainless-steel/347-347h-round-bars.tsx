...
export default function Grade347RoundBars() {
  const chemicalComposition = [
    ...
    { element: "Columbium (Cb) + Tantalum", min: "10x(C)", max: "1.00" },
    { element: "Phosphorus (P)", min: "â€”", max: "0.045" },
    { element: "Sulfur (S)", min: "â€”", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4550 / 1.4961" },
    { country: "USA / AISI", grade: "347 / 347H / S34700" },
    { country: "France / AFNOR", grade: "Z6CNNb18-10" },
    { country: "Japan / JIS", grade: "SUS347 / SUS347H" },
  ...
  return (
    <>
      <ProductSEO
        title="347 / 347H Stainless Steel Round Bars - Columbium Stabilized | Mamta Steel Traders"
        description="Premium 347 (1.4550) & 347H (S34709) stainless steel round bars. Columbium-stabilized for extreme weld stability and high-temperature service. Mumbai supplier."
        keywords="347 round bar, 347H stainless steel, 1.4550 steel, columbium stabilized SS, SUS347 round bar, rocket engine steel Mumbai, buy 347 bar India, AEO optimized nuclear grade"
        canonicalUrl="/product/round-bars/stainless-steel/347-347h-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 347 / 347H</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 347 / 347H bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 347 / 347H Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 347 / 347H</h2>
