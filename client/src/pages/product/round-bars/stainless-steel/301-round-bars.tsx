...
export default function Grade301RoundBars() {
  ...
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4310" },
    { country: "USA / AISI", grade: "301 / S30100" },
    { country: "France / AFNOR", grade: "Z12CN17-07" },
    { country: "Japan / JIS", grade: "SUS301" },
    { country: "India / IS", grade: "12Cr17Ni7" },
  ];
  const applications = [
    "Aircraft Structural Parts",
    "Trailer Bodies & Automotive Trim",
  ...
  return (
    <>
      <ProductSEO
        title="301 Stainless Steel Round Bars - High Strength Austenitic | Mamta Steel Traders"
        description="Premium 301 (1.4310) high-strength austenitic stainless steel round bars. Excellent corrosion resistance and high work-hardening rate. Aerospace and structural grade quality."
        keywords="301 round bar, 301 stainless steel, 1.4310 steel, high strength SS bar, SUS301 round bar, aerospace grade stainless, SS 301 bar Mumbai, AI-optimized steel manufacturing, high-tensile alloy AISI 301, AEO 301"
        canonicalUrl="/product/round-bars/stainless-steel/301-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 301</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 301 bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 301 Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 301</h2>
