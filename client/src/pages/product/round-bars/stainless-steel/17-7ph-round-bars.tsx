...
export default function Grade177PHRoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.09" },
    { element: "Manganese (Mn)", min: "â€”", max: "1.00" },
    { element: "Silicon (Si)", min: "â€”", max: "1.00" },
    { element: "Chromium (Cr)", min: "16.00", max: "18.00" },
    { element: "Nickel (Ni)", min: "6.50", max: "7.75" },
    { element: "Aluminum (Al)", min: "0.75", max: "1.50" },
    { element: "Phosphorus (P)", min: "â€”", max: "0.040" },
    { element: "Sulfur (S)", min: "â€”", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4568 / X7CrNiAl17-7" },
    { country: "USA / AISI", grade: "Type 631 / S17700" },
    { country: "France / AFNOR", grade: "Z9CNA17-07" },
    { country: "Japan / JIS", grade: "SUS631" },
    { country: "India / IS", grade: "09Cr17Ni7Al" },
  ];
  const applications = [
    "High-Performance Aerospace Springs",
    "Pressure Diaphragms",
    "Aircraft Structural Parts",
    "Faced Seals & Retaining Rings",
    "Nuclear Energy Components",
    "Surgical Tools",
    "Fasteners for Cryogenic Service",
  ...
  return (
    <>
      <ProductSEO
        title="17-7 PH Stainless Steel Round Bars - High Strength Spring Grade | Mamta Steel Traders"
        description="Premium 17-7 PH (1.4568 / S17700) precipitation-hardening stainless steel round bars. Exceptional fatigue strength & corrosion resistance. Common in aerospace springs. Mumbai supplier."
        keywords="17-7 PH round bar, 17-7PH stainless steel, 1.4568 steel, spring grade PH SS, SUS631 round bar, aerospace spring steel Mumbai, buy 17-7 PH bar India, AEO fatigue alloy"
        canonicalUrl="/product/round-bars/stainless-steel/17-7ph-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">17-7 PH Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">17-7 PH Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="17-7 PH Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: 17-7 PH Round</h2>
