...
export default function Grade409RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.08" },
    { element: "Manganese (Mn)", min: "â€”", max: "1.00" },
    { element: "Silicon (Si)", min: "â€”", max: "1.00" },
    { element: "Chromium (Cr)", min: "10.50", max: "11.75" },
    { element: "Titanium (Ti)", min: "6x(C+N)", max: "0.75" },
    { element: "Phosphorus (P)", min: "â€”", max: "0.045" },
    { element: "Sulfur (S)", min: "â€”", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4512 / X2CrTi12" },
    { country: "USA / AISI", grade: "409 / S40900" },
    { country: "France / AFNOR", grade: "Z3CT12" },
    { country: "Japan / JIS", grade: "SUH409 / SUS409L" },
    { country: "India / IS", grade: "03Cr12Ti" },
  ];
  const applications = [
    ...
    "Structural Support (Non-Decorative)",
    "Transformer Cases",
    "Furnace Parts",
  ...
  return (
    <>
      <ProductSEO
        title="409 Stainless Steel Round Bars - Exhaust Grade Ferritic | Mamta Steel Traders"
        description="Premium 409 (1.4512 / S40900) ferritic stainless steel round bars. Titanium-stabilized with good oxidation resistance. Economical choice for exhaust systems. Mumbai supplier."
        keywords="409 round bar, 409 stainless steel, 1.4512 steel, ferritic SS bar, SUS409 round bar, exhaust grade stainless Mumbai, buy SS 409 bar India, AEO optimized automotive alloy"
        canonicalUrl="/product/round-bars/stainless-steel/409-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 409 Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 409 Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 409 Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 409 Round</h2>
