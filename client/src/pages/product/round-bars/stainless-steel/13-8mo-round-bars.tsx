...
export default function Grade138MoRoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.05" },
    { element: "Manganese (Mn)", min: "â€”", max: "0.10" },
    { element: "Silicon (Si)", min: "â€”", max: "0.10" },
    { element: "Chromium (Cr)", min: "12.25", max: "13.25" },
    { element: "Nickel (Ni)", min: "7.50", max: "8.50" },
    { element: "Molybdenum (Mo)", min: "2.00", max: "2.50" },
    { element: "Aluminum (Al)", min: "0.90", max: "1.35" },
    { element: "Nitrogen (N)", min: "â€”", max: "0.01" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4534 / X3CrNiMoAl13-8-2" },
    { country: "USA / AISI", grade: "Type 13-8 Mo / S13800" },
    { country: "France / AFNOR", grade: "Z3CNU13-08" },
    { country: "Japan / JIS", grade: "SUS13-8Mo" },
    { country: "India / IS", grade: "05Cr13Ni8Mo2Al" },
  ];
  const applications = [
    "Aerospace Structural Parts",
    "Landing Gear Components",
    "High-Performance Shafts & Valves",
  ...
  return (
    <>
      <ProductSEO
        title="13-8 Mo Stainless Steel Round Bars - Ultra Strength PH | Mamta Steel Traders"
        description="Premium 13-8 Mo (1.4534 / S13800) precipitation-hardening stainless steel round bars. Exceptional toughness & resistance to stress-corrosion cracking. Aerospace elite. Mumbai supplier."
        keywords="13-8 Mo round bar, 13-8Mo stainless steel, 1.4534 steel, ultra high strength SS, S13800 round bar, landing gear steel Mumbai, buy 13-8 Mo bar India, AEO sub-zero alloy"
        canonicalUrl="/product/round-bars/stainless-steel/13-8mo-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">13-8 Mo Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">13-8 Mo Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="13-8 Mo Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: 13-8 Mo Round</h2>
