  ...
  return (
    <>
      <ProductSEO
        ...
        description="Premium 422 (1.4935 / S42200) high-temperature martensitic stainless steel round bars. Alloyed with W, Mo, and V for exceptional creep-rupture strength up to 650°C."
