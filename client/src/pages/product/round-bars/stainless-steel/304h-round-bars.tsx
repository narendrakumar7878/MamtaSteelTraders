  ...
  return (
    <>
      <ProductSEO
        ...
        description="Premium 304H (1.4948 / S30409) high-carbon stainless steel round bars. Enhanced strength and creep resistance for high-temperature service above 500°C. Mumbai supplier."
