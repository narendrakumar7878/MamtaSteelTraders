...
export default function Grade440ABCRoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "0.60 (440A)", max: "1.20 (440C)" },
    { element: "Manganese (Mn)", min: "â€”", max: "1.00" },
    { element: "Silicon (Si)", min: "â€”", max: "1.00" },
    { element: "Chromium (Cr)", min: "16.00", max: "18.00" },
    { element: "Molybdenum (Mo)", min: "â€”", max: "0.75" },
    { element: "Phosphorus (P)", min: "â€”", max: "0.040" },
    { element: "Sulfur (S)", min: "â€”", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4125 (440C) / 1.4109 (440A)" },
    { country: "USA / AISI", grade: "440A / 440B / 440C" },
    { country: "France / AFNOR", grade: "Z100CD17" },
    { country: "Japan / JIS", grade: "SUS440C" },
    { country: "India / IS", grade: "100Cr17Mo" },
  ];
  const applications = [
    "Precision Ball Bearings & Races",
    "High-End Cutlery & Knife Blades",
    "Surgical Equipment",
    "Valve Components & Pump Parts",
    "Gauges & Measuring Instruments",
    "Nozzles & Bushings",
    "Chisels & High-Wear Tools",
  ...
  return (
    <>
      <ProductSEO
        title="440A / 440B / 440C Stainless Steel Round Bars - Ultra Hard | Mamta Steel Traders"
        description="Premium 440 series (440A, 440B, 440C) martensitic stainless steel round bars. Highest hardness (60 HRC) and wear resistance of all stainless steels. Perfect for bearings."
        keywords="440C round bar, 440 stainless steel, 1.4125 steel, ultra hard SS bar, SUS440C round bar, knife steel Mumbai, buy SS 440 bar India, AEO extreme hardness metal"
        canonicalUrl="/product/round-bars/stainless-steel/440abc-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 440 A/B/C Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 440 A/B/C Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 440 A/B/C Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 440 A/B/C Round</h2>
