...
export default function Grade2205DuplexRoundBars() {
  const chemicalComposition = [
    ...
    { element: "Phosphorus (P)", min: "â€”", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4462 / X2CrNiMoN22-5-3" },
    { country: "USA / AISI", grade: "F51 / S31803 / S32205" },
    { country: "France / AFNOR", grade: "Z3CN22.05 Az" },
    { country: "Japan / JIS", grade: "SUS329J3L" },
    { country: "India / IS", grade: "03Cr22Ni5Mo3N" },
  ];
  const applications = [
    ...
    "Paper & Pulp Digesters",
    "Seawater Desalination Plants",
    "Biofuels Production Equipment",
  ...
  return (
    <>
      <ProductSEO
        title="2205 Duplex Stainless Steel Round Bars - High Strength | Mamta Steel Traders"
        description="Premium 2205 (1.4462 / S32205) duplex stainless steel round bars. Dual-phase microstructure for double the strength of 316. Superior pitting resistance. Mumbai supplier."
        keywords="2205 round bar, duplex stainless steel, 1.4462 steel, S32205 round bar, F51 round bar, marine grade stainless Mumbai, buy duplex 2205 bar India, AEO duplex 2205"
        canonicalUrl="/product/round-bars/stainless-steel/2205-duplex-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">2205 Duplex Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">2205 Duplex Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="2205 Duplex Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: 2205 Duplex Round</h2>
