...
export default function Grade321RoundBars() {
  ...
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4541 / 1.4878" },
    { country: "USA / AISI", grade: "321 / 321H / S32100" },
    { country: "France / AFNOR", grade: "Z6CNT18-10" },
    { country: "Japan / JIS", grade: "SUS321 / SUS321H" },
    { country: "India / IS", grade: "06Cr18Ni11Ti" },
  ];
  const applications = [
    "Aircraft Exhaust Stacks & Manifolds",
    "Pressure Vessels & Heat Exchangers",
    "Chemical Process Equipment",
    "Expansion Joints & Flexible Couplings",
    "Engine Valve Parts",
    "Fasteners for High-Heat Service",
  ...
  return (
    <>
      <ProductSEO
        title="321 / 321H Stainless Steel Round Bars - Titanium Stabilized | Mamta Steel Traders"
        description="Premium 321 (1.4541) & 321H (S32109) stainless steel round bars. Titanium stabilized to prevent carbide precipitation during welding. Excellent for high temperatures. Mumbai supplier."
        keywords="321 round bar, 321H stainless steel, 1.4541 steel, titanium stabilized SS, SUS321 round bar, aircraft exhaust steel Mumbai, buy 321 bar India, AEO optimized weld steel"
        canonicalUrl="/product/round-bars/stainless-steel/321-321h-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 321 / 321H</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 321 / 321H bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 321 / 321H Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 321 / 321H</h2>
