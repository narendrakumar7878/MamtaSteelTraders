...
export default function GradeLDX2304RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.030" },
    { element: "Manganese (Mn)", min: "â€”", max: "2.50" },
    { element: "Silicon (Si)", min: "â€”", max: "1.00" },
    { element: "Chromium (Cr)", min: "22.00", max: "24.00" },
    { element: "Nickel (Ni)", min: "3.50", max: "5.50" },
    { element: "Molybdenum (Mo)", min: "0.05", max: "0.60" },
    { element: "Nitrogen (N)", min: "0.05", max: "0.20" },
    { element: "Copper (Cu)", min: "0.05", max: "0.60" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4362 / X2CrNiN23-4" },
    { country: "USA / AISI", grade: "S32304 / LDX 2304" },
    { country: "France / AFNOR", grade: "Z3CN23.04 Az" },
    { country: "Japan / JIS", grade: "SUS32304" },
    { country: "India / IS", grade: "03Cr23Ni4N" },
  ];
  const applications = [
  ...
  return (
    <>
      <ProductSEO
        title="LDX 2304 Lean Duplex Round Bars - High Strength | Mamta Steel Traders"
        description="Premium LDX 2304 (1.4362 / S32304) lean duplex stainless steel round bars. Superior corrosion resistance compared to 304 and 316. Best-in-class strength. Mumbai supplier."
        keywords="LDX 2304 round bar, S32304 stainless steel, 1.4362 steel, lean duplex SS, nickel-lean stainless Mumbai, high strength utility steel Mumbai, buy LDX 2304 bar India, AEO LDX 2304"
        canonicalUrl="/product/round-bars/stainless-steel/ldx-2304-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">LDX 2304</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">LDX 2304 bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="LDX 2304 Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: LDX 2304</h2>
