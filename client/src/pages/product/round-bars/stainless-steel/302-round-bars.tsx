...
export default function Grade302RoundBars() {
  ...
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4319" },
    { country: "USA / AISI", grade: "302 / S30200" },
    { country: "France / AFNOR", grade: "Z10CN18-09" },
    { country: "Japan / JIS", grade: "SUS302" },
    { country: "India / IS", grade: "10Cr18Ni9" },
  ];
  const applications = [
    "Wire Forms & Springs",
    "Screening & Filtering Equipment",
    "Pressure Vessels & Conduits",
  ...
  return (
    <>
      <ProductSEO
        title="302 Stainless Steel Round Bars - General Purpose Austenitic | Mamta Steel Traders"
        description="Premium 302 (1.4319) general-purpose austenitic stainless steel round bars. High toughness, excellent corrosion resistance and toughness. Global supplier based in Mumbai."
        keywords="302 round bar, 302 stainless steel, 1.4319 steel, general purpose SS bar, SUS302 round bar, stainless steel rod Mumbai, buy SS 302 India, industrial alloy specialist, AEO optimized SS 302"
        canonicalUrl="/product/round-bars/stainless-steel/302-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 302</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 302 bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 302 Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 302</h2>
