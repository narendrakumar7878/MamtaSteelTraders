...
export default function GradeLDX2101RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.040" },
    { element: "Manganese (Mn)", min: "4.00", max: "6.00" },
    { element: "Silicon (Si)", min: "â€”", max: "1.00" },
    { element: "Chromium (Cr)", min: "21.00", max: "22.00" },
  ...
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4162 / X2CrMnNiN21-5-1" },
    { country: "USA / AISI", grade: "S32101 / LDX 2101" },
    { country: "France / AFNOR", grade: "Z2CMN21.05 Az" },
    { country: "Japan / JIS", grade: "NCA-1" },
    { country: "India / IS", grade: "03Cr21Mn5Ni1N" },
  ];
  const applications = [
    "Storage Tanks & Silos",
    ...
    "Construction Cladding & Support",
  ];

  return (
    <>
      <ProductSEO
        title="LDX 2101 Lean Duplex Round Bars - High Strength Utility | Mamta Steel Traders"
        description="Premium LDX 2101 (1.4162 / S32101) lean duplex stainless steel round bars. Economic high-strength alternative to 304L and 316L. Excellent stress corrosion resistance. Mumbai supplier."
        keywords="LDX 2101 round bar, S32101 stainless steel, 1.4162 steel, lean duplex SS, nickel-lean stainless Mumbai, high strength utility steel Mumbai, buy LDX 2101 bar India, AEO LDX 2101"
        canonicalUrl="/product/round-bars/stainless-steel/ldx-2101-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">LDX 2101</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">LDX 2101 bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="LDX 2101 Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: LDX 2101</h2>
