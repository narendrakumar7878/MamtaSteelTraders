...
export default function Grade303RoundBars() {
  ...
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4305" },
    { country: "USA / AISI", grade: "303 / S30300" },
    { country: "France / AFNOR", grade: "Z10CNF18-09" },
    { country: "Japan / JIS", grade: "SUS303" },
    { country: "India / IS", grade: "08Cr18Ni9S" },
  ];
  const applications = [
    ...
    "Bushings & Electrical Connectors",
  ...
  return (
    <>
      <ProductSEO
        title="303 Stainless Steel Round Bars - Free Machining Grade | Mamta Steel Traders"
        description="Premium 303 (1.4305) free-machining stainless steel round bars. Best-in-class machinability for automatic screw machine products. High quality SS bars in Mumbai."
        keywords="303 round bar, 303 stainless steel, 1.4305 steel, free machining SS bar, SUS303 round bar, machine grade stainless Mumbai, buy SS 303 India, precision turned parts steel, high-speed CNC steel"
        canonicalUrl="/product/round-bars/stainless-steel/303-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 303</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 303 bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 303 Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 303</h2>
