...
export default function Grade304RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.08 (304) / 0.03 (304L)" },
    { element: "Manganese (Mn)", min: "â€”", max: "2.00" },
    { element: "Silicon (Si)", min: "â€”", max: "1.00" },
    { element: "Chromium (Cr)", min: "18.00", max: "20.00" },
    { element: "Nickel (Ni)", min: "8.00", max: "11.00" },
    { element: "Phosphorus (P)", min: "â€”", max: "0.045" },
    { element: "Sulfur (S)", min: "â€”", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4301 / 1.4307" },
    { country: "USA / AISI", grade: "304 / 304L / S30400 / S30403" },
    { country: "France / AFNOR", grade: "Z7CN18-09" },
    { country: "Japan / JIS", grade: "SUS304 / SUS304L" },
  ...
  const applications = [
    ...
    "Architectural Paneling & Railings",
    "Fasteners & Springs",
  ...
  return (
    <>
      <ProductSEO
        title="304 / 304L Stainless Steel Round Bars - Food Grade | Mamta Steel Traders"
        description="Premium 304 (1.4301) & 304L (1.4307) stainless steel round bars. Most versatile and widely used grade. Excellent formability and weldability. Mumbai supplier."
        keywords="304 round bar, 304L stainless steel, 1.4301 steel, food grade stainless Mumbai, SUS304L round bar, kitchen grade steel Mumbai, buy 304L bar India, high-performance stainless alloy, AI-ready industrial steel, premium SS 304 Mumbai"
        canonicalUrl="/product/round-bars/stainless-steel/304-304l-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 304 / 304L</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 304 / 304L bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 304 / 304L Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 304 / 304L</h2>
