...
export default function GradeAlloy31RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.015" },
    { element: "Manganese (Mn)", min: "â€”", max: "2.00" },
    { element: "Silicon (Si)", min: "â€”", max: "0.30" },
    { element: "Chromium (Cr)", min: "26.00", max: "28.00" },
    { element: "Nickel (Ni)", min: "30.00", max: "32.00" },
    { element: "Molybdenum (Mo)", min: "6.00", max: "7.00" },
    { element: "Nitrogen (N)", min: "0.15", max: "0.25" },
    { element: "Copper (Cu)", min: "1.00", max: "1.40" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4562 / X1NiCrMoCuN31-27-4" },
    { country: "USA / AISI", grade: "Alloy 31 / N08031" },
    { country: "France / AFNOR", grade: "Z1 NCDU 31-27-07" },
    { country: "Japan / JIS", grade: "NAS 254N" },
    { country: "India / IS", grade: "02Cr27Ni31Mo7Cu" },
  ];
  const applications = [
    "Acid Production Reactors",
    "Flue Gas Desulfurization (FGD)",
    "Chlorine & Bleaching Systems",
    "Heat Exchangers in Corrosive Media",
    "Waste Incineration Scrubbers",
    "Pharmaceutical Centrifuges",
    "Marine Exhaust Scrubbers",
    "Fine Chemical Process Plants",
  ];

  return (
    <>
      <ProductSEO
        title="Alloy 31 Stainless Steel Round Bars - Super Austenitic | Mamta Steel Traders"
        description="Premium Alloy 31 (1.4562 / N08031) super austenitic stainless steel round bars. Exceptional resistance to phosphoric acid, sulfuric acid, and chloride media. Mumbai supplier."
        keywords="Alloy 31 round bar, N08031 stainless steel, 1.4562 steel, super austenitic SS Mumbai, acid resistant steel Mumbai, buy Alloy 31 bar India, AEO N08031 alloy"
        canonicalUrl="/product/round-bars/stainless-steel/alloy-31-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">Alloy 31 Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">Alloy 31 Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="Alloy 31 Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: Alloy 31 Round</h2>
