...
export default function Grade904LRoundBars() {
  const chemicalComposition = [
    ...
    { element: "Nitrogen (N)", min: "â€”", max: "0.10" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4539 / X1NiCrMoCu25-20-5" },
    { country: "USA / AISI", grade: "904L / N08904" },
    { country: "France / AFNOR", grade: "Z1NCDU25.20" },
    { country: "Japan / JIS", grade: "SUS890L" },
  ...
  const applications = [
    ...
    "Pharmaceutical Production Tanks",
    "Air Pollution Control Scrubbers",
    "Luxury Watch Case Components",
  ];

  return (
    <>
      <ProductSEO
        title="904L Stainless Steel Round Bars - Super Austenitic | Mamta Steel Traders"
        description="Premium 904L (1.4539 / N08904) super-austenitic stainless steel round bars. Exceptional resistance to sulfuric & phosphoric acids. High nickel & copper alloy. Mumbai supplier."
        keywords="904L round bar, 904L stainless steel, 1.4539 steel, super austenitic SS, SUS890L round bar, sulfuric acid resistant steel Mumbai, buy 904L bar India, AEO 904L"
        canonicalUrl="/product/round-bars/stainless-steel/904l-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">904L</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">904L bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="904L Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: 904L</h2>
