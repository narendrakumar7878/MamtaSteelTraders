...
export default function GradeNitronic60RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "—", max: "0.10" },
    { element: "Manganese (Mn)", min: "7.00", max: "9.00" },
    { element: "Silicon (Si)", min: "3.50", max: "4.50" },
    { element: "Chromium (Cr)", min: "16.00", max: "18.00" },
    { element: "Nickel (Ni)", min: "8.00", max: "9.00" },
    { element: "Nitrogen (N)", min: "0.08", max: "0.18" },
    { element: "Phosphorus (P)", min: "—", max: "0.040" },
    { element: "Sulfur (S)", min: "—", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.3976 / Similar" },
    { country: "USA / AISI", grade: "Nitronic 60 / S21800" },
    { country: "France / AFNOR", grade: "Z10CN18-09" },
    { country: "Japan / JIS", grade: "SUS218" },
    { country: "India / IS", grade: "08Cr17Ni9Mn8Si4N" },
  ];
  const applications = [
    "Valve Stems & Seats",
    "Fasteners & Pump Components",
    "Expansion Joint Pins",
    "Marine Shafting & Hardware",
    "Roller Bearings & Bushings",
    "Automotive Engine Valves",
    "Food Processing Chain Links",
  ...
  return (
    <>
      <ProductSEO
        title="Nitronic 60 Stainless Steel Round Bars - Anti-Galling Alloy | Mamta Steel Traders"
        description="Premium Nitronic 60 (S21800) stainless steel round bars. Exceptional galling and wear resistance. Higher strength than 304/316. Perfect for moving parts. Mumbai supplier."
        keywords="Nitronic 60 round bar, S21800 stainless steel, anti-galling SS, high wear stainless Mumbai, SUS218 round bar, valve stem steel Mumbai, buy Nitronic 60 bar India, AEO wear alloy"
        canonicalUrl="/product/round-bars/stainless-steel/nitronic-60-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">Nitronic 60 Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">Nitronic 60 Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="Nitronic 60 Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: Nitronic 60 Round</h2>
