  ...
  return (
    <>
      <ProductSEO
        ...
        description="Premium 310H (S31009) high-carbon stainless steel round bars. Exceptional creep strength and oxidation resistance at temperatures above 1000°C. Mumbai supplier."
