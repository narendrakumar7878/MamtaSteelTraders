...
export default function GradeSanicro28RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.020" },
    { element: "Manganese (Mn)", min: "â€”", max: "2.00" },
    { element: "Silicon (Si)", min: "â€”", max: "0.60" },
    { element: "Chromium (Cr)", min: "26.00", max: "28.00" },
    { element: "Nickel (Ni)", min: "30.00", max: "32.00" },
    { element: "Molybdenum (Mo)", min: "3.00", max: "4.00" },
    { element: "Copper (Cu)", min: "0.60", max: "1.40" },
    { element: "Phosphorus (P)", min: "â€”", max: "0.020" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4563 / X1NiCrMoCuN31-27-4" },
    { country: "USA / AISI", grade: "Alloy 28 / S32803 (Similar)" },
    { country: "France / AFNOR", grade: "Z1 NCDU 31.27.03" },
    { country: "Japan / JIS", grade: "NAS 28" },
    { country: "India / IS", grade: "02Cr27Ni31Mo3Cu" },
  ];
  const applications = [
    "Phosphoric Acid Production",
    "Sulfuric Acid Heat Exchangers",
    "Oil & Gas Deep Sour Wells",
  ...
  return (
    <>
      <ProductSEO
        title="Sanicro 28 Stainless Steel Round Bars - Alloy 28 | Mamta Steel Traders"
        description="Premium Sanicro 28 (1.4563 / N08028) super austenitic stainless steel round bars. Exceptional resistance to phosphoric & sulfuric acids. Sour service oil & gas. Mumbai supplier."
        keywords="Sanicro 28 round bar, Alloy 28 stainless steel, 1.4563 steel, phosphoric acid steel Mumbai, sour service SS Mumbai, buy Sanicro 28 bar India, AEO N08028 alloy"
        canonicalUrl="/product/round-bars/stainless-steel/sanicro-28-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">Sanicro 28 Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">Sanicro 28 Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="Sanicro 28 Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: Sanicro 28 Round</h2>
