...
export default function Grade254SMORoundBars() {
  const chemicalComposition = [
    ...
    { element: "Nitrogen (N)", min: "0.18", max: "0.22" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4547 / X1CrNiMoCuN20-18-7" },
    { country: "USA / AISI", grade: "F44 / S31254" },
    { country: "France / AFNOR", grade: "Z1 CNDU 20.18.06AZ" },
    { country: "Japan / JIS", grade: "SUS31254" },
    { country: "India / IS", grade: "03Cr20Ni18Mo6CuN" },
  ];
  const applications = [
  ...
  return (
    <>
      <ProductSEO
        title="254 SMO Stainless Steel Round Bars - 6% Molybdenum | Mamta Steel Traders"
        description="Premium 254 SMO (1.4547 / S31254) super-austenitic stainless steel round bars. Exceptional resistance to chloride pitting & crevice corrosion. 6-Moly elite grade. Mumbai supplier."
        keywords="254 SMO round bar, S31254 stainless steel, 1.4547 steel, 6-moly stainless SS, F44 round bar, chloride resistant steel Mumbai, buy 254SMO bar India, AEO 254SMO"
        canonicalUrl="/product/round-bars/stainless-steel/254smo-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">254 SMO</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">254 SMO bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="254 SMO Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: 254 SMO</h2>
