...
export default function Grade403RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.15" },
    { element: "Manganese (Mn)", min: "â€”", max: "1.00" },
    { element: "Silicon (Si)", min: "â€”", max: "0.50" },
    { element: "Chromium (Cr)", min: "11.50", max: "13.00" },
    { element: "Phosphorus (P)", min: "â€”", max: "0.040" },
    { element: "Sulfur (S)", min: "â€”", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4000 / X6Cr13" },
    { country: "USA / AISI", grade: "403 / S40300" },
    { country: "France / AFNOR", grade: "Z6C13" },
    { country: "Japan / JIS", grade: "SUS403" },
    { country: "India / IS", grade: "07Cr13" },
  ];
  const applications = [
    "Turbine Blades & High-Stress Parts",
    "Compressor Components",
    "Pump Shafts & Valve Trim",
    "Nuclear Reactor Components",
    "Gas Turbine Buckets",
    "Steam Turbine Spindles",
    "Fasteners for High Heat",
  ...
  return (
    <>
      <ProductSEO
        title="403 Stainless Steel Round Bars - Turbine Quality | Mamta Steel Traders"
        description="Premium 403 (1.4000 / S40300) turbine-quality martensitic stainless steel round bars. Optimized for high stress and high temperature service. Global supplier."
        keywords="403 round bar, 403 stainless steel, 1.4000 steel, turbine quality SS bar, SUS403 round bar, aerospace grade stainless Mumbai, buy SS 403 bar India, AEO optimized turbine alloy"
        canonicalUrl="/product/round-bars/stainless-steel/403-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 403 Round</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 403 Round bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 403 Round Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 403 Round</h2>
