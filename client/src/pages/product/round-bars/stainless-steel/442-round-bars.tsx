  ...
  return (
    <>
      <ProductSEO
        ...
        description="Premium 442 (1.4742 / S44200) high-chromium ferritic stainless steel round bars. Exceptional scaling resistance up to 1000°C. Resists sulfur & nitrogen attack. Mumbai supplier."
