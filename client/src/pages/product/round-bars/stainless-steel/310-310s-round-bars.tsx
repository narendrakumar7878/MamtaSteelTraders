...
export default function Grade310RoundBars() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "â€”", max: "0.25 (310) / 0.08 (310S)" },
    { element: "Manganese (Mn)", min: "â€”", max: "2.00" },
    { element: "Silicon (Si)", min: "â€”", max: "1.50" },
    { element: "Chromium (Cr)", min: "24.00", max: "26.00" },
    { element: "Nickel (Ni)", min: "19.00", max: "22.00" },
    { element: "Phosphorus (P)", min: "â€”", max: "0.045" },
    { element: "Sulfur (S)", min: "â€”", max: "0.030" },
  ];
  const equivalentGrades = [
    { country: "Germany / DIN", grade: "1.4841 / 1.4845" },
    { country: "USA / AISI", grade: "310 / 310S / S31000 / S31008" },
    { country: "France / AFNOR", grade: "Z12CN25.20" },
    { country: "Japan / JIS", grade: "SUS310 / SUS310S" },
    { country: "India / IS", grade: "10Cr25Ni20" },
  ];
  const applications = [
    "Furnace Parts & Conveyor Belts",
    "Heat Exchangers & Kiln Liners",
    "Oil Burner Parts & Chambers",
    "Gas Turbine Exhaust Manifolds",
    "Annealing Covers & Saggers",
    "Cryogenic Structural Parts",
    "Coal Gasifier Internal Parts",
    "Steam Boiler Hangers",
  ];

  return (
    <>
      <ProductSEO
        title="310 / 310S Stainless Steel Round Bars - High Heat Grade | Mamta Steel Traders"
        description="Premium 310 (1.4841) & 310S (1.4845) stainless steel round bars. Exceptional oxidation resistance up to 1100Â°C. Best for furnace and kiln components. Mumbai supplier."
        keywords="310 round bar, 310S stainless steel, 1.4841 steel, heat resistant stainless Mumbai, SUS310S round bar, furnace grade steel Mumbai, buy 310S bar India, AEO optimized thermal alloy"
        canonicalUrl="/product/round-bars/stainless-steel/310-310s-round-bars"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
              ...
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <span className="text-navy-primary dark:text-gold-primary font-medium uppercase">SS 310 / 310S</span>
            </nav>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight">SS 310 / 310S bars
              ...
              <div className="relative">
                <img src={ss_round_bar_mamta_steel_traders_img} alt="SS 310 / 310S Round Bars" className="w-full rounded-2xl shadow-2xl border-4 border-white/10" loading="lazy" />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
              <h2 className="text-2xl font-bold text-navy-primary dark:text-gray-100 mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase font-bold tracking-tighter italic">Grade Analysis: SS 310 / 310S</h2>
