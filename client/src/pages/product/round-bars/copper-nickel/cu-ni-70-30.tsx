...
export default function CuNi7030() {
  const chemicalComposition = [
    { element: "Copper (Cu)", value: "66.50% min" },
    { element: "Nickel (Ni)", value: "29.00 – 33.00%" },
    { element: "Iron (Fe)", value: "0.40 – 1.00%" },
    { element: "Manganese (Mn)", value: "1.00% max" },
    { element: "Zinc (Zn)", value: "1.00% max" },
    { element: "Lead (Pb)", value: "0.05% max" }
  ];

  const mechanicalProperties = [
    { prop: "Tensile Strength", value: "345 – 515 MPa" },
    { prop: "Yield Strength (0.2%)", value: "125 – 345 MPa" },
    { prop: "Elongation (in 2\")", value: "30 – 45%" },
    { prop: "Hardness (Brinell)", value: "80 – 110 HB" },
    { prop: "Thermal Conductivity", value: "29 W/m·K" },
    { prop: "Erosion Resistance", value: "Excellent" }
  ];

  const thermalSpecs = [
    { process: "Hot Working", temp: "870 – 1040°C", desc: "Best-in-class hot forming for complex marine systems." },
    { process: "Annealing", temp: "650 – 815°C", desc: "Ensures uniform grain structure for high-pressure durability." },
    { process: "Stress Relieving", temp: "300 – 400°C", desc: "Critical for preventing stress corrosion in high-velocity lines." },
    { process: "Cold Working", temp: "Good", desc: "Suitable for bending and expanding in condenser tube manifolds." }
  ];

  return (
    <>
      <ProductSEO
        title="Cu-Ni 70/30 Copper Nickel Round Bars | C71500 | Marine Grade | Mumbai India"
        description="Premium Cu-Ni 70/30 (C71500) Copper Nickel supplier in Mumbai. Superior erosion and corrosion resistance for high-pressure marine piping. ASTM B122 certified."
        keywords="Cu-Ni 70/30, copper nickel 70/30 round bars, C71500 copper nickel mumbai, marine grade cu-ni supplier, high pressure marine piping, seawater erosion resistant alloy"
        canonicalUrl="/product/round-bars/copper-nickel/cu-ni-70-30"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic tracking-wider">Cu-Ni 70/30 (C71500)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg underline decoration-navy-primary decoration-4">Maximum Erosion Resistance</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none">Cu-Ni 70/30 (C71500)</h1>
              <p className="text-xl text-gray-200 mb-8 leading-relaxed max-w-2xl opacity-90 italic font-medium uppercase tracking-tight italic tracking-tighter italic">Engineered for high-velocity seawater environments and critical high-pressure naval engineering.</p>
              <div className="flex flex-wrap gap-4">
                ...
                <a href="tel:+919819322576" className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-10 py-4 rounded-2xl font-bold transition-all backdrop-blur-sm italic tracking-tighter">Talk to Naval Expert</a>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black">
              <div className="lg:col-span-2 space-y-12">
                ...
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6">Technical Standards</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed italic font-medium italic mb-8 italic italic tracking-tighter shadow-sm p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl italic tracking-tighter underline underline-offset-8 decoration-gold-primary decoration-4">Cu-Ni 70/30 (C71500) represents the pinnacle of copper-nickel metallurgy for maritime use. With a 30% nickel content, it offers significantly better erosion resistance than the 90/10 grade, allowing for higher fluid velocities in piping systems and condensers without compromising the protective oxide layer.</p>
                ...
                <div className="bg-navy-primary text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group h-fit overflow-hidden">
                   <div className="relative z-10 h-fit overflow-hidden">
                      <h2 className="text-3xl font-black mb-8 italic tracking-tighter uppercase flex items-center gap-4 h-fit">
                         ...
                         Marine Grade Architecture (70/30)
                      </h2>
              ...
              <div className="space-y-8 h-fit overflow-hidden">
                ...
                <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden">
                  <h3 className="text-xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase border-b border-gold-primary pb-2 underline tracking-wider italic">Naval Cycle Guide</h3>
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary h-fit group overflow-hidden">
                   <h3 className="text-2xl font-black mb-6 italic tracking-tighter uppercase italic tracking-tighter italic">High-Pressure Applications</h3>
                   <div className="space-y-4">
                      {["High-Pressure Saltwater Piping", "Distilling Plant Components", "Vessel Hull Cladding", "Desalination Systems", "Sanitary Systems Offshore", "Fire Protection Lines"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 overflow-hidden relative">
           <div className="container mx-auto px-4 text-center relative z-10">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase italic tracking-tighter italic">Build Your Fleet with High-Performance Cu-Ni 70/30</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic italic tracking-tighter italic">Mamta Steel Traders is a key supplier of C71500 (70/30) Copper Nickel round bars, serving global shipbuilders and offshore energy projects with certified maritime metallurgy. Every batch includes full chemical and mechanical reporting.</p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                 <Link href="/contact" className="bg-navy-primary text-white px-12 py-5 rounded-3xl font-black hover:bg-navy-secondary transition-all shadow-xl italic tracking-tighter uppercase italic tracking-tighter italic">Request Naval Estimate</Link>
