...
export default function C70600CopperNickel9010() {
  ...
  const mechanicalProperties = [
    { prop: "Tensile Strength", value: "300 – 400 MPa" },
    { prop: "Yield Strength (0.2%)", value: "100 – 300 MPa" },
    { prop: "Elongation (in 2\")", value: "30 – 40%" },
    { prop: "Hardness (Brinell)", value: "70 – 100 HB" },
    { prop: "Density", value: "8.94 g/cm³" },
    { prop: "Thermal Conductivity", value: "45 W/m·K" }
  ];

  const thermalSpecs = [
    { process: "Hot Working", temp: "815 – 955°C", desc: "Excellent hot workability for large marine components." },
    { process: "Annealing", temp: "590 – 815°C", desc: "Soaking time depends on section thickness." },
    { process: "Stress Relieving", temp: "260 – 370°C", desc: "Recommended after cold forming to prevent stress corrosion." },
    { process: "Cold Working", temp: "Excellent", desc: "High ductility allows for deep drawing and complex bending." }
  ];

  return (
    <>
      <ProductSEO
        title="C70600 Copper Nickel 90/10 Round Bars | Marine Grade | ASTM B151 | Mumbai India"
        description="Premium C70600 Copper Nickel 90/10 supplier in Mumbai. High-resistance marine grade alloy for seawater piping and heat exchangers. ASTM B151, DIN 2.0872 certified."
        keywords="C70600 copper nickel, 90/10 cu-ni round bars, marine grade copper nickel Mumbai, ASTM B151 C70600, seawater resistant alloy, copper nickel supplier India"
        canonicalUrl="/product/round-bars/copper-nickel/c70600-copper-nickel-90-10"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic tracking-wider">C70600 Copper Nickel 90/10</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block">The Marine Industry Standard</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none">C70600 Cu-Ni 90/10</h1>
              <p className="text-xl text-gray-200 mb-8 leading-relaxed max-w-2xl opacity-90 italic font-medium uppercase tracking-tight italic tracking-tighter italic">Superior seawater corrosion resistance and anti-fouling performance for offshore and maritime infrastructure.</p>
              <div className="flex flex-wrap gap-4">
                <Link href="/contact" className="bg-gold-primary hover:bg-white text-navy-primary px-10 py-4 rounded-2xl font-black transition-all shadow-xl italic tracking-tighter uppercase">Get Maritime Quote</Link>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2 space-y-12">
                ...
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed italic font-medium italic mb-8 italic italic tracking-tighter shadow-sm p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl italic tracking-tighter underline underline-offset-8 decoration-gold-primary">C70600 (Copper Nickel 90/10) is a premier marine alloy prized for its inherent resistance to bio-fouling and stress-corrosion cracking in seawater. The addition of iron and manganese significantly enhances its erosion resistance, making it essential for critical fluid handling in maritime and desalination plants.</p>
                ...
                <div className="bg-navy-primary text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
                   <div className="relative z-10">
                      <h2 className="text-3xl font-black mb-8 italic tracking-tighter uppercase flex items-center gap-4 h-fit">
                         ...
                         Marine Protection Architecture (C70600)
                      </h2>
                      <div className="grid md:grid-cols-2 gap-6">
                         {mechanicalProperties.map((spec, i) => (
                            <div key={i} className="flex justify-between items-center p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 h-fit">
                  <h3 className="text-xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase border-b border-gold-primary pb-2 underline tracking-wider italic">Hot & Cold Fabrication</h3>
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary h-fit group">
                   <h3 className="text-2xl font-black mb-6 italic tracking-tighter uppercase italic tracking-tighter italic">Critical Marine Segments</h3>
                   <div className="space-y-4">
                      {["Seawater Piping Systems", "Heat Exchanger Components", "Marine Condensers", "Desalination Plants", "Offshore Platforms", "Ship Hull Cladding"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 overflow-hidden relative">
           <div className="container mx-auto px-4 text-center relative z-10">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase italic tracking-tighter italic">Build Your Fleet with Certified Cu-Ni Alloys</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic italic tracking-tighter italic">Mamta Steel Traders is a trusted supplier of C70600 (Cu-Ni 90/10) round bars, providing third-party inspection and mill certificates with every order. Expert technical support for maritime engineering projects.</p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                 <Link href="/contact" className="bg-navy-primary text-white px-12 py-5 rounded-3xl font-black hover:bg-navy-secondary transition-all shadow-xl italic tracking-tighter uppercase italic tracking-tighter italic">Instant Maritime Quote</Link>
