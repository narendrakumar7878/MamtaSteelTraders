...
export default function C18150ChromiumZirconiumCopper() {
  const chemicalComposition = [
    { element: "Chromium (Cr)", value: "0.50 – 1.50%" },
    { element: "Zirconium (Zr)", value: "0.05 – 0.25%" },
  ...
  const mechanicalProperties = [
    { prop: "Tensile Strength", value: "440 – 540 MPa" },
    { prop: "Yield Strength", value: "380 – 480 MPa" },
    { prop: "Hardness (Rockwell B)", value: "65 – 85 HRB" },
    { prop: "Electrical Conductivity", value: "80% IACS min" },
    { prop: "Thermal Conductivity", value: "320 W/m·K" },
    { prop: "Elongation", value: "15 – 25%" }
  ];

  const thermalSpecs = [
    { process: "Solution Treatment", temp: "950 – 1000°C", desc: "Rapid water quench to freeze chromium in solution." },
    { process: "Aging Treatment", temp: "450 – 500°C", desc: "Precipitation hardening for optimal hardness/conductivity." },
    { process: "Softening Temperature", temp: "525°C", desc: "Maintains mechanical integrity under thermal load." },
    { process: "Cold Workability", temp: "Excellent", desc: "Allows for complex forging and shaping before aging." }
  ];

  return (
    <>
      <ProductSEO
        title="C18150 Chromium Zirconium Copper Round Bars | RWMA Class 2 | CuCrZr Alloy | Mumbai India"
        description="Premium C18150 Chromium Zirconium Copper supplier in Mumbai. RWMA Class 2 alloy with superior electrical conductivity for spot welding and continuous casting. ISO certified."
        keywords="C18150 chromium zirconium copper, CuCrZr alloy round bars, RWMA Class 2 copper, spot welding electrodes, high conductivity copper alloy, C18150 supplier Mumbai"
        canonicalUrl="/product/round-bars/copper-nickel/c18150-chromium-zirconium-copper"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic tracking-wider">C18150 Chromium Zirconium Copper (CuCrZr)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block">Industrial RWMA Class 2 Standard</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none">C18150 CuCrZr Copper</h1>
              <p className="text-xl text-gray-200 mb-8 leading-relaxed max-w-2xl opacity-90 italic font-medium uppercase tracking-tight italic tracking-tighter italic">High-conductivity chromium zirconium copper engineered for heavy-duty resistance welding electrodes.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2 space-y-12">
                ...
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed italic font-medium italic mb-8 italic italic tracking-tighter shadow-sm p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl italic tracking-tighter underline underline-offset-8 decoration-gold-primary">C18150 (Chromium Zirconium Copper) is the definitive alloy for RWMA Class 2 welding requirements. Its dual-precipitation hardening mechanism (Cr and Zr) provides an exceptional combination of high electrical conductivity and superior mechanical strength, especially at elevated temperatures used in spot and seam welding.</p>
                ...
                <div className="bg-navy-primary text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
                   <div className="relative z-10">
                      <h2 className="text-3xl font-black mb-8 italic tracking-tighter uppercase flex items-center gap-4 h-fit">
                         ...
                         Performance Engineering (C18150)
                      </h2>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary h-fit group">
                   <h3 className="text-2xl font-black mb-6 italic tracking-tighter uppercase italic tracking-tighter italic">Precision Industrial Use</h3>
                   <div className="space-y-4">
                      {["Spot Welding Tips", "Seam Welding Wheels", "Continuous Casting Molds", "Electrical Power Connections", "Heat Sink Elements", "Electronic Lead Frames"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 overflow-hidden relative">
           <div className="container mx-auto px-4 text-center relative z-10">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase italic tracking-tighter italic">Enhance Your Welding Durability</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic italic tracking-tighter italic">Mamta Steel Traders provides C18150 (CuCrZr) round bars with certified 80% IACS conductivity levels. Maximize your electrode life with our premium metallurgical solutions.</p>
