...
export default function MonelK500RoundBarsDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni) + Cobalt (Co)", value: "63.0% min" },
    { element: "Copper (Cu)", value: "27.0 – 33.0%" },
    { element: "Aluminum (Al)", value: "2.3 – 3.15%" },
    { element: "Titanium (Ti)", value: "0.35 – 0.85%" },
    { element: "Iron (Fe)", value: "2.0% max" },
    { element: "Manganese (Mn)", value: "1.5% max" },
    { element: "Silicon (Si)", value: "0.5% max" }
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (Age Hardened)", value: "965 MPa min" },
    { property: "Yield Strength (Age Hardened)", value: "690 MPa min" },
    { property: "Elongation", value: "20% min" },
    { property: "Hardness (Rockwell C)", value: "28 HRC min" },
    { property: "Curie Temperature", value: "-100°C" }
  ];

  return (
    <>
      <ProductSEO
        title="Monel K-500 Round Bars | UNS N05500 | Alloy K-500 Supplier Mumbai"
        description="Premium Monel K-500 (UNS N05500) round bars. Age-hardenable nickel-copper alloy with superior strength and hardness. Non-magnetic and seawater resistant."
        keywords="monel k-500 round bars, alloy k-500 supplier mumbai, uns n05500 bars, age hardenable monel k-500, non magnetic monel rods"
        canonicalUrl="/product/round-bars/monel/monel-k500-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">Monel K-500 (UNS N05500)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10 text-white">
            <div className="max-w-4xl text-white">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic">The High-Strength Super-Alloy</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100">Monel K-500</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105">Age-hardenable Nickel-Copper alloy combining the excellent corrosion resistance of Monel 400 with the added advantages of greater strength and hardness.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black">
              <div className="lg:col-span-2 space-y-12 text-black">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md">Monel K-500 (UNS N05500) is a precipitation-hardenable nickel-copper alloy that combines the excellent corrosion resistance characteristic of Monel 400 with the added advantage of greater strength and hardness. These amplified properties, strength and hardness, are obtained by adding aluminum and titanium to the nickel-copper base and by processing under controlled conditions so that submicroscopic particles of Ni3 (Ti, Al) are precipitated throughout the matrix. Mamta Steel Traders delivers ready-to-dispatch Monel K-500 bars specifically for high-strength marine fasteners and pump components. Non-magnetic performance is guaranteed.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">965 MPa (Aged)</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Magnetic Perm</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">Virtually Non-Mag</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline">
                      {["Pump Shafts & Impellers", "Oil-Well Drilling Tools", "Marine Fasteners", "Electronic Components", "Doctor Blades & Scrapers", "Valve Components"].map((use, i) => (
                         <div key={i} className="flex items-center gap-3 text-sm group/item transition-all hover:bg-white/20 p-2 rounded-2xl transform hover:translate-x-2 transition-all font-black uppercase tracking-tighter italic underline">
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic">
           <div className="container mx-auto px-4 relative z-10 text-black">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic">Direct Supplier: Monel K-500 Bars</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch Monel K-500 (UNS N05500) round bars with extreme tensile strength and superior corrosion resistance. Precipitation hardened for heavy-duty marine and drilling operations. Global export certified.</p>
