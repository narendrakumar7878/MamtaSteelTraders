...
export default function HastelloyC276RoundBarsDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", value: "Balance (~57%)" },
    { element: "Molybdenum (Mo)", value: "15.00 – 17.00%" },
    { element: "Chromium (Cr)", value: "14.50 – 16.50%" },
    { element: "Iron (Fe)", value: "4.00 – 7.00%" },
    { element: "Tungsten (W)", value: "3.00 – 4.50%" },
  ...
  const thermalSpecs = [
    { process: "Annealing", temp: "1120°C (2050°F)", desc: "Solution annealing followed by rapid quench to ensure maximum corrosion resistance of welds." },
    { process: "Hot Working", temp: "955 – 1230°C", desc: "Forging must be done within this window; avoid working below 955°C to prevent cracks." },
    { process: "Forming", temp: "Excellent", desc: "Work hardens readily but remains ductile enough for significant cold forming operations." }
  ];

  return (
    <>
      <ProductSEO
        title="Hastelloy C276 Round Bars | UNS N10276 | DIN 2.4819 | Mumbai"
        description="Premium Hastelloy C276 (Alloy C276, UNS N10276) nickel-molybdenum-chromium alloy round bars. Exceptional corrosion resistance in severe chemical environments."
        keywords="hastelloy c276 round bars, alloy c276 supplier mumbai, uns n10276 steel, din 2.4819 bars, chemical resistant alloy"
        canonicalUrl="/product/round-bars/hastelloy/hastelloy-c276-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-black h-fit" />
                 <span className="text-navy-primary dark:text-gold-primary italic uppercase underline decoration-navy-primary decoration-2 underline-offset-4 tracking-tighter italic">Hastelloy C276 (UNS N10276)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4">
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden h-fit">
          <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden">
            <div className="max-w-4xl h-fit overflow-hidden">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg underline decoration-navy-primary decoration-4 h-fit overflow-hidden italic">The Severe Corrosion Specialist</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none h-fit overflow-hidden underline decoration-gold-primary decoration-4 underline-offset-[12px] italic">Hastelloy C276</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase h-fit overflow-hidden italic">Nickel-Molybdenum-Chromium alloy with exceptional resistance to pitting and stress-corrosion cracking in the most severe chemical media.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 h-fit overflow-hidden">
              <div className="lg:col-span-2 space-y-12 h-fit overflow-hidden">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 h-fit overflow-hidden text-black h-fit">
                  <h2 className="text-3xl font-black text-navy-primary dark:text-white mb-8 italic tracking-tighter uppercase border-l-8 border-gold-primary pl-6 h-fit overflow-hidden h-fit italic">Metallurgical Profile (C276)</h2>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter h-fit overflow-hidden italic">Hastelloy C276 (UNS N10276) is a nickel-molybdenum-chromium-tungsten alloy that is universally considered the most corrosion-resistant alloy available today. It provides excellent resistance to pitting and crevice corrosion, and is particularly effective in resisting both oxidizing and reducing media. Its exceptional stability during welding makes it suitable for major chemical process applications in the as-welded condition, specifically for Mumbai's heavy infrastructure projects.</p>
                   ...
                   <div className="relative z-10 h-fit overflow-hidden text-white h-fit">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 h-fit h-fit overflow-hidden text-white h-fit overflow-hidden h-fit h-fit">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit italic">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic h-fit overflow-hidden italic tracking-tighter italic">Pitting Resistance</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden italic tracking-tighter italic underline decoration-gold-primary decoration-2 h-fit overflow-hidden">Maximum Yield</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors h-fit text-white h-fit overflow-hidden text-white h-fit italic">
                             ...
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase italic h-fit overflow-hidden italic tracking-tighter italic underline decoration-gold-primary decoration-2 h-fit overflow-hidden">Ni-Mo-Cr-W</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit h-fit overflow-hidden text-black h-fit">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit h-fit overflow-hidden italic">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic">
                      {["Flue Gas Desulfurization", "Chemical Reactors", "Pollution Control Ducts", "Nuclear Waste Processing", "Pulp and Paper Production", "Marine Engineering Components"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden h-fit h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic">
           <div className="container mx-auto px-4 relative z-10 h-fit overflow-hidden text-black h-fit">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic tracking-tighter italic underline decoration-gold-primary decoration-4 underline-offset-8 italic">Direct Supplier: Hastelloy C276 Severe Duty Alloy</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic tracking-tighter italic uppercase h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden h-fit overflow-hidden italic tracking-tighter italic">Mamta Steel Traders delivers ready-to-dispatch Hastelloy C276 (UNS N10276) round bars for the world's most severe corrosive environments. Full metallurgical traceability and global logistics.</p>
