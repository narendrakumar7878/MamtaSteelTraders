...
export default function Grade18CrNiMo76RoundBars() {
    const comp = [
    ...
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "18CrNiMo7-6 / 1.6587" },
        { country: "USA / AISI", grade: "4320 / 8620 (nearest)" },
        { country: "Japan / JIS", grade: "SNCM420 (nearest)" },
        { country: "Standard", grade: "EN ISO 683-17 / 10084" },
    ];
    const apps = ["Large industrial gear wheels", "Wind turbine main gear stages", "High-load transmission shafts", "Mining mill pinions", "Marine gearbox components", "Paper mill gear rings", "Cement kiln drive gears", "Power station gear drives"];
    return (
        <>
            <ProductSEO
                title="18CrNiMo7-6 Round Bars (1.6587) – High Performance Gear Steel | Mamta Steel Traders"
                description="Buy 18CrNiMo7-6 / 1.6587 case hardening Ni-Cr-Mo steel round bars for large gear wheels, wind turbines, and industrial drives. EN 10084 certified. Mumbai supplier and worldwide exporter."
                keywords="18CrNiMo7-6 round bar, 18CrNiMo7-6 1.6587, large gear steel, wind turbine gear, 18CrNiMo7-6 chemical composition, Ni-Cr-Mo case hardening steel, 18CrNiMo7-6 supplier India"
                canonicalUrl="/product/round-bars/alloy-steel-round/18crni-mo7-6-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">18CrNiMo7-6 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">18CrNiMo7-6 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.6587 – Premium Gear Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">High-performance Ni-Cr-Mo case hardening steel for wind turbine gears, large industrial gearboxes, and heavy-duty transmission components.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="18CrNiMo7-6 Round Bar 1.6587 Gear Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">18CrNiMo7-6 / 1.6587 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300 mb-4"><strong>18CrNiMo7-6</strong> (1.6587) is Europe's premier gear steel for large, heavily loaded gear wheels. It is closely related to 17CrNiMo6 but with slightly higher chromium content for improved hardenability in large cross-sections. Wind turbine OEMs, paper mills, and mining equipment manufacturers routinely specify this grade for its deep case depth capability and excellent core toughness at all section sizes.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 18CrNiMo7-6</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["18CrNiMo7-6 round bar", "1.6587 steel", "18CrNiMo7-6 chemical composition", "wind turbine gear steel India", "18CrNiMo7-6 vs 17CrNiMo6", "large gear steel supplier Mumbai", "18CrNiMo7-6 case hardening", "buy 18CrNiMo7-6 bar", "18CrNiMo7-6 hardness", "1.6587 supplier India"].map((kw, i) => (
