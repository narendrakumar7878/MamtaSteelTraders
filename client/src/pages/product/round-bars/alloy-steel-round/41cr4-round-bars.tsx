...
export default function Grade41Cr4RoundBars() {
    const comp = [
    ...
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "41Cr4 / 1.7035" },
        { country: "USA / AISI", grade: "5140 / 5145" },
        { country: "Japan / JIS", grade: "SCr440" },
        { country: "UK / BS", grade: "527M20 (nearest)" },
        { country: "India / IS", grade: "40Cr1" },
    ];
    const apps = ["Automotive steering and suspension components", "Gear wheels and pinion shafts", "Shafts, axles and spindles", "Fasteners and bolts", "Agricultural machinery parts", "Mining and rock drilling rods", "Machine tool components", "Ball bearing steel substitute"];
    return (
        <>
            <ProductSEO
                title="41Cr4 Round Bars (1.7035 / 5140 / SCr440) – Chrome Steel | Mamta Steel Traders"
                description="Buy 41Cr4 / 1.7035 / AISI 5140 chromium alloy steel round bars for gears, shafts, and automotive components. EN 10083-3 standard. 6mm–500mm dia. Mumbai supplier worldwide."
                keywords="41Cr4 round bar, 1.7035 steel, AISI 5140 equivalent, SCr440, 41Cr4 chemical composition, chrome steel bar, 41Cr4 supplier India, buy 41Cr4 Mumbai, 5140 equivalent"
                canonicalUrl="/product/round-bars/alloy-steel-round/41cr4-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">41Cr4 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">41Cr4 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.7035 / AISI 5140 / SCr440 – Chrome Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Chromium alloy steel for gears, shafts, automotive steering and suspension components.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="41Cr4 Round Bar 1.7035 Chrome Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">41Cr4 / 1.7035 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>41Cr4</strong> (1.7035) is a medium-carbon chromium steel equivalent to <strong>AISI 5140</strong> and <strong>SCr440 (JIS)</strong>. The chromium addition provides good hardenability and tensile strengths of 750–1000 MPa in the Q+T condition. It is widely used for automotive steering parts, gear wheels, and machine shafts where the chrome content is sufficient without the need for more expensive Ni or Mo additions.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 41Cr4 (1.7035)</h3>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                                ...
                                <div className="mt-4 p-4 bg-gradient-to-r from-navy-primary to-navy-secondary text-white rounded-lg text-center">
                                    <p className="font-bold">Size: 6mm – 500mm dia</p>
                                </div>
                            </div>
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["41Cr4 round bar", "1.7035 steel", "AISI 5140 equivalent", "SCr440 bar", "41Cr4 chemical composition", "41Cr4 supplier India", "41Cr4 vs 42CrMo4", "chrome steel bar Mumbai", "buy 41Cr4 bar", "41Cr4 price per kg"].map((kw, i) => (
