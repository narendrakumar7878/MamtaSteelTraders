...
export default function SNCM420RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.17", max: "0.23" },
        { element: "Silicon (Si)", min: "0.15", max: "0.35" },
        { element: "Manganese (Mn)", min: "0.40", max: "0.70" },
        { element: "Nickel (Ni)", min: "1.60", max: "2.00" },
        { element: "Chromium (Cr)", min: "0.40", max: "0.65" },
        { element: "Molybdenum (Mo)", min: "0.15", max: "0.30" },
    ];
    const equivGrades = [
        { country: "Japan / JIS", grade: "SNCM420" },
        { country: "Germany / DIN / EN", grade: "21NiCrMo2 / 1.6523" },
        { country: "USA / AISI", grade: "8620 / 8617" },
        { country: "Standard", grade: "JIS G4103" },
    ];
    const apps = ["Japanese automotive case-hardened gears", "Transmission shaft and gear sets", "Large-scale case-hardened pinions", "Side and ring gears", "Agricultural and construction vehicle drive gears", "Differential case and ring gear", "High-impact engineering parts", "Motorcycle and small engine gears"];
    return (
        <>
            <ProductSEO
                title="SNCM420 Round Bars (JIS G4103 / 8620 / 21NiCrMo2) – Japanese Ni-Cr-Mo Case Hardening Steel | Mamta Steel"
                description="Buy JIS SNCM420 / 21NiCrMo2 / SAE 8620 case hardening Ni-Cr-Mo alloy steel round bars for automotive gears, transmission shafts, and case-hardened components. Mumbai supplier worldwide."
                keywords="SNCM420 round bar, JIS SNCM420, 8620 equivalent Japan, 21NiCrMo2 equivalent, SNCM420 chemical composition, case hardening steel Japan, SNCM420 supplier India, buy SNCM420 Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/sncm420-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">SNCM420 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">SNCM420 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">JIS G4103 / SAE 8620 / 21NiCrMo2 – Ni-Cr-Mo Case Hardening</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Japanese-standard Ni-Cr-Mo case hardening steel for automotive transmission gears, ring gears, and case-hardened components.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="SNCM420 Round Bar JIS G4103 Ni-Cr-Mo Case Hardening Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                                <div className="absolute -top-4 -right-4 bg-gold-primary text-navy-primary px-4 py-2 rounded-lg font-bold shadow-xl">JIS G4103</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">SNCM420 / JIS G4103 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>JIS SNCM420</strong> is the Japanese equivalent of <strong>SAE 8620</strong> and European <strong>21NiCrMo2 (1.6523)</strong>. A nickel-chromium-molybdenum case hardening steel with approximately 1.8% Ni for superior core toughness. Widely used by Toyota, Nissan, Honda, and other Japanese OEMs for high-volume automotive gear sets, differential ring gears, and case-hardened shafts.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of SNCM420</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["SNCM420 round bar", "JIS SNCM420", "8620 Japanese equivalent", "21NiCrMo2 JIS", "SNCM420 chemical composition", "SNCM420 supplier India", "buy SNCM420 Mumbai", "JIS G4103 steel", "SNCM420 vs 8620", "SNCM420 case hardening"].map((kw, i) => (
