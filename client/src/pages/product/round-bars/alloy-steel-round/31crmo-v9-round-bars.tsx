...
export default function Grade31CrMoV9RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.27", max: "0.34" },
        { element: "Silicon (Si)", min: "0.15", max: "0.40" },
        { element: "Manganese (Mn)", min: "0.40", max: "0.70" },
        { element: "Chromium (Cr)", min: "2.30", max: "2.70" },
        { element: "Molybdenum (Mo)", min: "0.15", max: "0.25" },
        { element: "Vanadium (V)", min: "0.10", max: "0.20" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "31CrMoV9 / 1.8519" },
        { country: "USA", grade: "Grade 41L50 (nearest)" },
        { country: "Standard", grade: "EN 10085 – Nitriding Steels" },
        { country: "Also Known As", grade: "32CrMoV12-28" },
    ];
    const apps = ["Extrusion screws and barrel liners", "Gear wheels with high surface hardness (nitriding)", "Hydraulic press cylinder rods", "Crankshafts for diesel engines", "Spindles and guides for machine tools", "High-wear pump shafts", "Plastics processing machinery screws", "Injection moulding machines"];
    return (
        <>
            <ProductSEO
                title="31CrMoV9 Round Bars (1.8519) – Nitriding Steel | Mamta Steel Traders"
                description="Buy 31CrMoV9 / 1.8519 nitriding alloy steel round bars for extrusion screws, gear wheels, hydraulic rods, and machine spindles. EN 10085 nitriding standard. Mumbai supplier worldwide."
                keywords="31CrMoV9 round bar, 1.8519 steel, nitriding steel, 31CrMoV9 chemical composition, extrusion screw steel, 31CrMoV9 supplier India, EN 10085 nitriding bar, buy 31CrMoV9 Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/31crmo-v9-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">31CrMoV9 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">31CrMoV9 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.8519 – Nitriding Chromium Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Premium nitriding steel for extrusion screws, machine spindles, and gear wheels requiring ultra-hard nitrided surfaces.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="31CrMoV9 Round Bar 1.8519 Nitriding Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">31CrMoV9 / 1.8519 – Nitriding Steel Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>31CrMoV9</strong> (1.8519) is a chromium-molybdenum-vanadium nitriding steel (EN 10085). Its high chromium content enables exceptional surface hardness (1000–1200 HV) after gas or plasma nitriding without significant dimensional distortion. It is the preferred steel for precision extrusion screws, plastics machinery components, and high-wear machine spindles where surface hardness and corrosion resistance are paramount.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 31CrMoV9</h3>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                                ...
                                <div className="mt-4 p-4 bg-gradient-to-r from-navy-primary to-navy-secondary text-white rounded-lg text-center">
                                    <p className="font-bold">Size: 20mm – 500mm dia</p>
                                    <p className="text-gold-primary">EN 10085 Nitriding Standard</p>
                                </div>
                            </div>
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["31CrMoV9 round bar", "1.8519 nitriding steel", "31CrMoV9 chemical composition", "EN 10085 nitriding bar India", "31CrMoV9 vs 40CrAlMo7", "nitriding steel bar supplier Mumbai", "buy 31CrMoV9 bar", "31CrMoV9 extrusion screw steel", "1.8519 equivalent", "nitriding steel hardness"].map((kw, i) => (
