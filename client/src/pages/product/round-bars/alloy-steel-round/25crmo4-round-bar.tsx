...
export default function Grade25CrMo4RoundBar() {
    const comp = [
        { element: "Carbon (C)", min: "0.22", max: "0.29" },
    ...
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "25CrMo4 / 1.7218" },
        { country: "USA / AISI", grade: "4130" },
        { country: "Japan / JIS", grade: "SCM425" },
        { country: "France / AFNOR", grade: "25CD4" },
        { country: "UK / BS", grade: "708M25" },
    ];
    const apps = ["Automotive suspension and chassis components", "Cardan and propeller shafts", "Gear wheels and gearbox components", "Fluid coupling components", "Lifting equipment hooks and shackles", "Hydraulic press components", "Agricultural machinery", "General structural applications"];
    return (
        <>
            <ProductSEO
                title="25CrMo4 Round Bar (1.7218 / 4130) – Chrome Molybdenum Alloy Steel | Mamta Steel Traders"
                description="Buy 25CrMo4 / 1.7218 / AISI 4130 alloy steel round bars for automotive, structural, and engineering applications. EN 10083-3 standard. 6mm–500mm diameter. Mumbai supplier worldwide."
                keywords="25CrMo4 round bar, 1.7218 steel, AISI 4130 equivalent, SCM425, 25CrMo4 chemical composition, chrome moly steel bar, 25CrMo4 supplier India, buy 25CrMo4 Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/25crmo4-round-bar"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">25CrMo4 Round Bar</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">25CrMo4 Round Bar
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.7218 / AISI 4130 – Chrome Moly Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Weldable chromium-molybdenum alloy steel for automotive chassis, gear wheels, and structural applications.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="25CrMo4 Round Bar 1.7218 Chrome Moly Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">25CrMo4 / 1.7218 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>25CrMo4</strong> (1.7218) is a chromium-molybdenum low-alloy steel equivalent to <strong>AISI 4130</strong>. With lower carbon than 42CrMo4, it is more weldable and suitable for both quenched & tempered structural parts and case-hardened components. Tensile strengths of 700–900 MPa are typically achieved.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 25CrMo4</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["25CrMo4 round bar", "1.7218 steel bar", "AISI 4130 equivalent", "SCM425 equivalent", "25CrMo4 chemical composition", "25CrMo4 supplier India", "25CrMo4 vs 42CrMo4", "708M25 steel", "buy 25CrMo4 Mumbai", "25CrMo4 weldability"].map((kw, i) => (
