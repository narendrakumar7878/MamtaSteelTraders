...
export default function Grade16MnCr5RoundBar() {
    const comp = [
        { element: "Carbon (C)", min: "0.14", max: "0.19" },
        { element: "Silicon (Si)", min: "0.15", max: "0.40" },
        { element: "Manganese (Mn)", min: "1.00", max: "1.30" },
        { element: "Chromium (Cr)", min: "0.80", max: "1.10" },
        { element: "Sulfur (S)", min: "—", max: "0.035" },
        { element: "Phosphorus (P)", min: "—", max: "0.025" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "16MnCr5 / 1.7131" },
        { country: "USA / AISI", grade: "5115 / 5120" },
        { country: "Japan / JIS", grade: "SCr415 / SCr420" },
        { country: "India / IS", grade: "15Cr65" },
        { country: "Sweden / SS", grade: "2127" },
    ];
    const apps = [
        "Automotive transmission gears (high volume)", "Camshafts and valve timing components",
        "Case-hardened small gears and pinions", "Splined shafts and coupling parts",
        "Gudgeon (wrist) pins and bolts", "Piston pins and small shafts",
        "Roller chain components", "Case-hardened instrument parts",
    ];
    return (
        <>
            <ProductSEO
                title="16MnCr5 Round Bar (1.7131 / 5115) – Case Hardening Chrome Steel | Mamta Steel Traders"
                description="Buy 16MnCr5 / 1.7131 / AISI 5115 case hardening steel round bars for automotive gears, camshafts, and splined shafts. EN 10084 standard. 6mm–350mm dia. Mumbai supplier worldwide."
                keywords="16MnCr5 round bar, 1.7131 steel, AISI 5115 equivalent, SCr415, SCr420 equivalent, 16MnCr5 chemical composition, case hardening steel, automotive gear steel bars India, buy 16MnCr5 Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/16mncr5-round-bar"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">16MnCr5 Round Bar</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">16MnCr5 Round Bar
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.7131 / AISI 5115 – Case Hardening Chrome Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">High volume automotive case hardening steel for transmission gears, camshafts, and precision components.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="16MnCr5 Round Bar 1.7131 Case Hardening Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">16MnCr5 / 1.7131 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300 mb-4"><strong>16MnCr5</strong> (EN 10084, 1.7131) is one of Europe's most used case-hardening steels, equivalent to <strong>AISI 5115/5120</strong> and <strong>SCr415/420 (JIS)</strong>. The manganese addition increases hardenability while chromium helps achieve high surface hardness after carburising and hardening. Typical case hardness 60–64 HRC with a tough core of 300–450 HB.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 16MnCr5 (1.7131)</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["16MnCr5 round bar", "1.7131 steel", "AISI 5115 equivalent", "SCr420 bar", "16MnCr5 chemical composition", "case hardening chrome steel", "16MnCr5 vs 20MnCr5", "16MnCr5 supplier India", "buy 16MnCr5 Mumbai", "case depth 16MnCr5"].map((kw, i) => (
