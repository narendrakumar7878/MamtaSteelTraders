...
export default function Grade39NiCrMo3RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.35", max: "0.43" },
        { element: "Silicon (Si)", min: "0.15", max: "0.40" },
        { element: "Manganese (Mn)", min: "0.50", max: "0.80" },
        { element: "Nickel (Ni)", min: "0.70", max: "1.00" },
        { element: "Chromium (Cr)", min: "0.60", max: "1.00" },
        { element: "Molybdenum (Mo)", min: "0.15", max: "0.25" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "39NiCrMo3 / 1.6510" },
        { country: "France / AFNOR", grade: "40NCD3" },
        { country: "USA / AISI", grade: "9840 (nearest)" },
        { country: "Standard", grade: "EN ISO 683-2" },
    ];
    const apps = ["Medium-duty crankshafts", "Connecting rods and piston rods", "Drive shafts and propeller shafts", "Hydraulic cylinder rods", "Automotive transmission shafts", "General engineering components", "Mining and oil field shafts", "Machine tool components"];
    return (
        <>
            <ProductSEO
                title="39NiCrMo3 Round Bars (1.6510 / 40NCD3) – Ni-Cr-Mo Alloy Steel | Mamta Steel Traders"
                description="Buy 39NiCrMo3 / 1.6510 / 40NCD3 alloy steel round bars for crankshafts, prop shafts, and connecting rods. EN ISO 683-2 standard. Mumbai supplier and worldwide exporter."
                keywords="39NiCrMo3 round bar, 1.6510 steel, 40NCD3 equivalent, 39NiCrMo3 chemical composition, Ni-Cr-Mo steel, crankshaft steel India, 39NiCrMo3 supplier Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/39nicr-mo3-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">39NiCrMo3 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">39NiCrMo3 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.6510 / 40NCD3 – Ni-Cr-Mo Alloy Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Nickel-chromium-molybdenum steel for medium-duty crankshafts, connecting rods, and drive shafts requiring good strength and toughness.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="39NiCrMo3 Round Bar 1.6510 Alloy Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">39NiCrMo3 / 1.6510 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>39NiCrMo3</strong> (1.6510) is a nickel-chromium-molybdenum alloy steel known as <strong>40NCD3</strong> in France. It sits between EN19 and EN24 in terms of strength class, making it suitable for medium-to-high tensile applications such as crankshafts, connecting rods, prop shafts, and hydraulic cylinder rods.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 39NiCrMo3</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["39NiCrMo3 round bar", "1.6510 steel", "40NCD3 equivalent", "39NiCrMo3 chemical composition", "39NiCrMo3 supplier India", "39NiCrMo3 vs 36CrNiMo4", "buy 39NiCrMo3 Mumbai", "Ni-Cr-Mo steel bar India", "39NiCrMo3 hardness", "crankshaft steel 39NiCrMo3"].map((kw, i) => (
