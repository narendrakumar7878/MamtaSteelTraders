...
// Combined pages for remaining specific grades

export default function Grade905M39RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.35", max: "0.43" },
        { element: "Silicon (Si)", min: "0.10", max: "0.35" },
        { element: "Manganese (Mn)", min: "0.45", max: "0.70" },
        { element: "Nickel (Ni)", min: "3.00", max: "3.75" },
        { element: "Chromium (Cr)", min: "1.00", max: "1.40" },
        { element: "Molybdenum (Mo)", min: "0.20", max: "0.35" },
    ];
    const equivGrades = [
        { country: "Germany / DIN", grade: "36NiCrMo4 / 1.6511 (nearest)" },
        { country: "USA / AISI", grade: "9840 (nearest)" },
        { country: "UK / BS", grade: "905M39 / EN30B" },
        { country: "Standard", grade: "BS 970: 1991" },
    ];
    const apps = ["High-strength crankshafts and cam shafts", "Propeller shafts and propulsion drive shafts", "Aerospace structural loads", "High-strength fasteners", "Defence ordnance components", "Heavy turbine rotors", "Marine drive shafts", "Highly stressed components in automotive engineering"];
    return (
        <>
            <ProductSEO
                title="905M39 Round Bars (EN30B / 36NiCrMo4) – High Tensile Chrome Nickel Steel | Mamta Steel Traders"
                description="Buy 905M39 / EN30B high tensile nickel-chromium-molybdenum steel round bars for crankshafts, propulsion shafts, and defence applications. BS 970. Mumbai supplier worldwide."
                keywords="905M39 round bar, EN30B steel, 905M39 chemical composition, 36NiCrMo4 equivalent, high tensile Ni-Cr-Mo steel, 905M39 supplier India, BS 970 905M39, buy 905M39 Mumbai, EN30B bar"
                canonicalUrl="/product/round-bars/alloy-steel-round/905m39-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">905M39 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">905M39 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">EN30B / BS 970 – High Tensile Ni-Cr-Mo Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Ultra-high tensile Ni-Cr-Mo steel for propulsion shafts, crankshafts, and defence-grade high-strength applications.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="905M39 Round Bar EN30B High Tensile Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">905M39 / EN30B Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>905M39</strong> (BS 970, EN30B) is a high-nickel chromium-molybdenum steel with approximately 3% Ni, offering deep hardenability through large cross-sections and tensile strengths in excess of 1000 MPa. It is widely used in the UK and export markets for propulsion shafts, heavy duty engineering, and defence ordnance where ultra-high strength is essential.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 905M39 (EN30B)</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["905M39 round bar", "EN30B steel bar", "905M39 chemical composition", "36NiCrMo4 equivalent", "905M39 supplier India", "EN30B tensile strength", "buy 905M39 Mumbai", "905M39 vs EN24", "EN30B hardness", "high nickel alloy steel India"].map((kw, i) => (
