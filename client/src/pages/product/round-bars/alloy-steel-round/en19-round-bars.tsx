...
export default function GradeEN19RoundBars() {
    ...
    const equivalentGrades = [
        ...
        { country: "UK / BS", grade: "708M40" },
    ];
    const applications = [
        "Automotive crankshafts and gearbox components", "High-strength bolts and fasteners (ASTM A193 B7)",
        "Oil and gas drilling components", "Heavy-duty gears and pinions",
        "Hydraulic cylinder and actuator rods", "Mining and rock-drilling equipment",
        "Power transmission shafts", "Injection moulding machine parts",
    ];
    return (
        <>
            <ProductSEO
                title="EN19 Round Bars (42CrMo4 / 4140 / 1.7225 / 709M40) – High Tensile Steel | Mamta Steel Traders"
                description="Buy EN19 / 42CrMo4 / 4140 high tensile alloy steel round bars. Chromium-molybdenum steel for automotive, oil & gas, and heavy engineering. 6mm–500mm dia. Mumbai supplier & worldwide exporter."
                keywords="EN19 round bar, 42CrMo4 equivalent, 4140 steel, 1.7225, 709M40, high tensile alloy steel, EN19 chemical composition, EN19 supplier India, buy EN19 bar Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/en19-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">EN19 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">EN19 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">709M40 / 42CrMo4 / AISI 4140 / 1.7225</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">High tensile chromium-molybdenum alloy steel – the global workhorse for demanding engineering applications.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="EN19 Round Bar 42CrMo4 4140 High Tensile Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">EN19 / 42CrMo4 / 4140 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300 mb-4"><strong>EN19</strong> (BS 970: 709M40) is the British designation for the globally renowned <strong>42CrMo4 / AISI 4140</strong> chromium-molybdenum alloy steel. Available in annealed condition for machining or quenched & tempered for tensile strengths from 700 to over 1000 MPa.</p>
                            <p className="text-gray-700 dark:text-gray-300">It is extensively used in oil & gas drilling tools, automotive cranks and gearboxes, and high-strength fasteners. Mamta Steel Traders stocks EN19 in multiple sizes with mill test certificates.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of EN19 (709M40)</h3>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                                <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">EN19 Equivalent Grades Worldwide</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["EN19 round bar price", "EN19 vs EN24", "42CrMo4 vs EN19", "EN19 tensile strength", "EN19 hardness HRC", "EN19 for gearbox", "buy EN19 bar India", "EN19 Mumbai stockist", "709M40 supplier", "EN19 annealed bar"].map((kw, i) => (
