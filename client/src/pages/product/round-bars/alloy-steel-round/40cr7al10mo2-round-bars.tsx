...
export default function Grade40Cr7Al10Mo2RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.35", max: "0.45" },
        { element: "Silicon (Si)", min: "0.15", max: "0.35" },
        { element: "Manganese (Mn)", min: "0.30", max: "0.60" },
        { element: "Chromium (Cr)", min: "1.50", max: "1.80" },
        { element: "Aluminium (Al)", min: "0.90", max: "1.30" },
        { element: "Molybdenum (Mo)", min: "0.18", max: "0.28" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "41CrAlMo7 / 1.8509" },
        { country: "USA / AISI", grade: "Nitralloy 135M (nearest)" },
        { country: "Trade Name", grade: "Nitralloy" },
        { country: "Standard", grade: "EN 10085 (Nitriding Steels)" },
    ];
    const apps = ["Extrusion barrel and screw liners", "Precision nitrided gear wheels", "Die casting die components", "Machine tool spindles requiring surface hardness", "Crankshafts and bearings (nitrided)", "Plastics processing machine barrels", "High-wear hydraulic valve components", "Precision gauges and measuring tools"];
    return (
        <>
            <ProductSEO
                title="40Cr7Al10Mo2 Round Bars (41CrAlMo7 / 1.8509 / Nitralloy) – Nitriding Steel | Mamta Steel Traders"
                description="Buy 40Cr7Al10Mo2 / 41CrAlMo7 / 1.8509 / Nitralloy 135M nitriding steel round bars for extrusion screws, gear wheels, die casting, and high-wear components. EN 10085. Mumbai supplier worldwide."
                keywords="40Cr7Al10Mo2 round bar, 41CrAlMo7 steel, 1.8509 steel, Nitralloy 135M, nitriding steel bar, 40Cr7Al10Mo2 chemical composition, EN 10085 nitriding steel, 40Cr7Al10Mo2 supplier India"
                canonicalUrl="/product/round-bars/alloy-steel-round/40cr7al10mo2-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">40Cr7Al10Mo2 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">40Cr7Al10Mo2 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">41CrAlMo7 / 1.8509 / Nitralloy – Nitriding Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Aluminium-bearing nitriding steel for extrusion barrels, precision gear wheels, and die casting components requiring ultra-hard nitrided surfaces.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="40Cr7Al10Mo2 Round Bar 41CrAlMo7 Nitriding Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                                <div className="absolute -top-4 -right-4 bg-gold-primary text-navy-primary px-4 py-2 rounded-lg font-bold shadow-xl">EN 10085</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">40Cr7Al10Mo2 / 41CrAlMo7 / 1.8509 – Nitriding Steel Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>40Cr7Al10Mo2</strong> (also known as <strong>41CrAlMo7</strong>, DIN 1.8509, or Nitralloy 135M) is the premier aluminium-bearing nitriding steel. The 1% aluminium forms Al-N compounds during nitriding, delivering exceptionally hard surface zones (1100–1200 HV) with high white-layer uniformity. This steel is especially suitable for extrusion barrel liners, gear wheels, and precision spindles where both corrosion resistance and maximum surface hardness are required.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 40Cr7Al10Mo2</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["40Cr7Al10Mo2 round bar", "41CrAlMo7 steel", "1.8509 nitriding steel", "Nitralloy 135M equivalent", "nitriding steel bar India", "40Cr7Al10Mo2 chemical composition", "40Cr7Al10Mo2 supplier Mumbai", "buy nitriding steel bar", "EN 10085 nitriding bar", "40Cr7Al10Mo2 vs 31CrMoV9"].map((kw, i) => (
