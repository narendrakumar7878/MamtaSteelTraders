...
export default function Grade12L14RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.10", max: "0.15" },
        { element: "Manganese (Mn)", min: "0.85", max: "1.15" },
        { element: "Phosphorus (P)", min: "0.04", max: "0.09" },
        { element: "Sulfur (S)", min: "0.26", max: "0.35" },
        { element: "Lead (Pb)", min: "0.15", max: "0.35" },
    ];
    const equivGrades = [
        { country: "USA / AISI / SAE", grade: "12L14" },
        { country: "Germany / DIN", grade: "9SMnPb28 / 1.0718" },
        { country: "UK / BS", grade: "240M07 (nearest)" },
        { country: "Japan / JIS", grade: "SUM24L" },
        { country: "Standard", grade: "ASTM A108" },
    ];
    const apps = ["Precision turned parts (CNC turning)", "Automatic screw machine products", "Hydraulic fittings and connectors", "Instrument and instrument housings", "Calibre screw machine fittings", "Electronic component hardware", "Dowel pins and precision pins", "Miniature high-volume components"];
    return (
        <>
            <ProductSEO
                title="12L14 Round Bars (9SMnPb28 / SUM24L) – Lead Added Free Machining Steel | Mamta Steel Traders"
                description="Buy 12L14 / 9SMnPb28 / SUM24L free machining leaded steel round bars for highest-speed automatic screw machine, CNC turning, and precision turned parts. Mumbai supplier worldwide."
                keywords="12L14 round bar, 9SMnPb28 steel, SUM24L equivalent, 12L14 free machining steel, leaded steel bar, 12L14 chemical composition, automatic screw machine steel, buy 12L14 Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/12l14-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">12L14 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">12L14 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">9SMnPb28 / SUM24L – Free Machining Leaded Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Highest machinability free-cutting steel with lead addition for high-speed CNC turning, automatic screw machines, and precision hardware.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="12L14 Round Bar 9SMnPb28 Free Machining Leaded Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                                <div className="absolute -top-4 -right-4 bg-gold-primary text-navy-primary px-4 py-2 rounded-lg font-bold shadow-xl">ASTM A108</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">12L14 / 9SMnPb28 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>12L14</strong> (9SMnPb28 / SUM24L) is the premier free machining steel with lead addition, offering machining speed improvements of 50–100% over standard steel grades. The lead (0.15–0.35%) acts as a lubricant within the steel matrix, dramatically improving chip breaking, surface finish, and tool life in high-speed automatic screw machine and CNC turning operations. Widely used for high-volume precision turned hardware.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 12L14</h3>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                                ...
                                <div className="mt-4 p-4 bg-gradient-to-r from-navy-primary to-navy-secondary text-white rounded-lg text-center">
                                    <p className="font-bold">Size: 5mm – 150mm dia</p>
                                    <p className="text-gold-primary">Bright Cold-Drawn / Turned</p>
                                </div>
                            </div>
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["12L14 round bar", "9SMnPb28 steel", "SUM24L equivalent", "12L14 free machining steel", "12L14 vs 1215", "leaded steel bar India", "buy 12L14 Mumbai", "12L14 CNC turning", "12L14 chemical composition", "automatic screw machine steel India"].map((kw, i) => (
