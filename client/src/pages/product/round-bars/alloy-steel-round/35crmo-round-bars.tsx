...
export default function Grade35CrMoRoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.32", max: "0.40" },
        { element: "Silicon (Si)", min: "0.17", max: "0.37" },
    ...
    const equivGrades = [
        { country: "China / GB Standard", grade: "35CrMo" },
        { country: "Germany / DIN / EN", grade: "34CrMo4 / 1.7220" },
        { country: "USA / AISI", grade: "4135 / 4140 (nearest)" },
        { country: "Japan / JIS", grade: "SCM435" },
        { country: "UK / BS", grade: "709M40 (nearest)" },
    ];
    const apps = ["Automotive crankshafts and axles (Chinese OEM)", "Gear wheels and pinion shafts", "Hydraulic cylinder rods", "High-strength bolts and fasteners", "Mining and drilling equipment", "Agricultural machinery axles", "Power transmission shafts", "General engineering components"];
    return (
        <>
            <ProductSEO
                title="35CrMo Round Bars (34CrMo4 / SCM435) – Chrome Moly Steel (Chinese Standard) | Mamta Steel Traders"
                description="Buy 35CrMo / 34CrMo4 / SCM435 chromium-molybdenum alloy steel round bars for automotive, mining, and engineering applications. GB/EN/JIS standard. Mumbai supplier worldwide."
                keywords="35CrMo round bar, 34CrMo4 equivalent, SCM435 equivalent, 35CrMo chemical composition, China GB steel, chrome moly steel bar India, 35CrMo supplier Mumbai, buy 35CrMo bar"
                canonicalUrl="/product/round-bars/alloy-steel-round/35crmo-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">35CrMo Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">35CrMo Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">34CrMo4 / SCM435 – Chrome Molybdenum Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Chinese-standard chrome moly steel for automotive crankshafts, gear wheels, hydraulic rods, and general engineering applications.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="35CrMo Round Bar 34CrMo4 Chrome Moly Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                                <div className="absolute -top-4 -right-4 bg-gold-primary text-navy-primary px-4 py-2 rounded-lg font-bold shadow-xl">GB/T 3077</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">35CrMo / 34CrMo4 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>35CrMo</strong> per Chinese GB/T 3077 standard is equivalent to <strong>34CrMo4 (EN)</strong>, <strong>SCM435 (JIS)</strong>, and close to <strong>AISI 4135/4140</strong>. Widely used by Chinese automotive OEMs, this medium-carbon chrome moly steel achieves tensile strengths of 700–900 MPa in Q+T condition and is suitable for crankshafts, thick-wall hydraulic cylinders, gear wheels, and high-strength fasteners.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 35CrMo</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["35CrMo round bar", "34CrMo4 equivalent", "SCM435 bar", "GB/T 3077 steel", "35CrMo chemical composition", "35CrMo supplier India", "35CrMo vs 42CrMo4", "buy 35CrMo bar Mumbai", "35CrMo tensile strength", "Chinese chrome moly steel"].map((kw, i) => (
