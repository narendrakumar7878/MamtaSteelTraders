...
export default function Grade40CrMoV46RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.37", max: "0.44" },
        { element: "Silicon (Si)", min: "0.15", max: "0.40" },
        { element: "Manganese (Mn)", min: "0.50", max: "0.80" },
        { element: "Chromium (Cr)", min: "1.00", max: "1.30" },
        { element: "Molybdenum (Mo)", min: "0.50", max: "0.65" },
        { element: "Vanadium (V)", min: "0.15", max: "0.25" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "40CrMoV4-6 / 40CrMoV13" },
        { country: "USA", grade: "AISI H42 / H10 (hot work nearest)" },
        { country: "Standard", grade: "EN ISO 683-2" },
    ];
    const apps = ["Hot work die blocks (limited use)", "Forging dies for moderate temperature service", "Pressure die casting dies", "Extrusion press die holders", "Hot forming tools and punches", "High-temperature structural components", "Tooling for warm forging", "Machine components in elevated temperature service"];
    return (
        <>
            <ProductSEO
                title="40CrMoV4-6 Round Bars – Cr-Mo-V Tool and Structural Steel | Mamta Steel Traders"
                description="Buy 40CrMoV4-6 chromium-molybdenum-vanadium alloy steel round bars for hot work dies, forging dies, and high-temperature structural applications. Mumbai supplier and worldwide exporter."
                keywords="40CrMoV4-6 round bar, 40CrMoV13 steel, Cr-Mo-V alloy steel, 40CrMoV chemical composition, hot work die steel, 40CrMoV4-6 supplier India, buy 40CrMoV steel bar Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/40crmo-v4-6-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">40CrMoV4-6 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">40CrMoV4-6 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">Cr-Mo-V Alloy Steel for Tooling & Elevated Temperature Use</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Chromium-molybdenum-vanadium alloy steel for hot work dies, forging dies, and high-temperature structural components.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="40CrMoV4-6 Round Bar Cr-Mo-V Alloy Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">40CrMoV4-6 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>40CrMoV4-6</strong> is a chromium-molybdenum-vanadium alloy steel with high molybdenum (0.5–0.65%) and vanadium (0.15–0.25%) additions that improve hot strength and temper resistance. It is used in hot die and tooling applications requiring strength at moderate elevated temperatures and/or as a structural bar where creep resistance is valuable.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 40CrMoV4-6</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["40CrMoV4-6 round bar", "40CrMoV13 steel", "Cr-Mo-V alloy steel India", "40CrMoV4-6 chemical composition", "40CrMoV4-6 supplier Mumbai", "hot work die steel bar India", "buy 40CrMoV bar", "40CrMoV vs H13", "40CrMoV hot strength", "vanadium alloy steel India"].map((kw, i) => (
