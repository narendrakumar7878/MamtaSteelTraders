...
export default function Grade20NiCrMo22RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.17", max: "0.23" },
        { element: "Silicon (Si)", min: "0.15", max: "0.40" },
        { element: "Manganese (Mn)", min: "0.65", max: "0.95" },
        { element: "Nickel (Ni)", min: "0.40", max: "0.70" },
        { element: "Chromium (Cr)", min: "0.35", max: "0.65" },
        { element: "Molybdenum (Mo)", min: "0.15", max: "0.25" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "20NiCrMo2-2 / 1.6523" },
        { country: "USA / AISI", grade: "8620" },
        { country: "Japan / JIS", grade: "SNCM220" },
        { country: "Italy / UNI", grade: "20NiCrMo2" },
    ];
    const apps = ["Automotive gears and differential components", "Case-hardened shafts and axles", "Transmission pinion gears", "Camshafts and valve trains", "Worm gears", "Small machine components", "Splined shafts", "Agricultural drive components"];
    return (
        <>
            <ProductSEO
                title="20NiCrMo2-2 Round Bars (1.6523 / SAE 8620) – Case Hardening Ni-Cr-Mo Steel | Mamta Steel Traders"
                description="Buy 20NiCrMo2-2 / 1.6523 / AISI 8620 case hardening Ni-Cr-Mo alloy steel round bars for automotive gears, transmission components, and case-hardened shafts. EN 10084. Mumbai supplier."
                keywords="20NiCrMo2-2 round bar, 1.6523 steel, SAE 8620 equivalent, SNCM220, 20NiCrMo2-2 chemical composition, case hardening steel India, buy 20NiCrMo2-2 Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/20nicrmo2-2-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">20NiCrMo2-2 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">20NiCrMo2-2 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.6523 / SAE 8620 – Ni-Cr-Mo Case Hardening Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Leading case hardening Ni-Cr-Mo steel for automotive gears, differential components, and transmission shafts.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="20NiCrMo2-2 Round Bar SAE 8620 Case Hardening Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">20NiCrMo2-2 / 1.6523 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>20NiCrMo2-2</strong> (1.6523) is the European equivalent of <strong>SAE/AISI 8620</strong> and <strong>SNCM220 (JIS)</strong>. The nickel addition enhances core toughness while chromium and molybdenum ensure good hardenability and surface hardness after carburising. Typical applications include automotive transmission and differential gears, camshafts, and splined shafts.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 20NiCrMo2-2</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["20NiCrMo2-2 round bar", "1.6523 steel", "8620 equivalent Europe", "SNCM220 equivalent", "20NiCrMo2-2 chemical composition", "case hardening steel supplier India", "buy 20NiCrMo2-2 Mumbai", "20NiCrMo2-2 gear steel", "EN 10084 steel", "20NiCrMo2-2 hardness"].map((kw, i) => (
