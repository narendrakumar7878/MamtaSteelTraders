...
export default function Grade36NiCrMo4RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.32", max: "0.40" },
        { element: "Silicon (Si)", min: "0.15", max: "0.40" },
        { element: "Manganese (Mn)", min: "0.50", max: "0.80" },
        { element: "Nickel (Ni)", min: "0.90", max: "1.20" },
        { element: "Chromium (Cr)", min: "0.60", max: "1.00" },
        { element: "Molybdenum (Mo)", min: "0.15", max: "0.25" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "36NiCrMo4 / 1.6511" },
        { country: "USA / AISI", grade: "9840 (nearest)" },
        { country: "France / AFNOR", grade: "35NCD4" },
        { country: "UK / BS", grade: "816M40 (nearest)" },
        { country: "Standard", grade: "EN ISO 683-2" },
    ];
    const apps = ["Crankshafts for medium-duty engines", "Connecting rods and piston rods", "Drive shafts and propeller shafts", "Structural components requiring good toughness", "Mining and quarrying equipment shafts", "Hydraulic cylinder rods", "Automotive half-shafts and axles", "General machine components"];
    return (
        <>
            <ProductSEO
                title="36NiCrMo4 Round Bars (1.6511 / 35NCD4) – Ni-Cr-Mo Alloy Steel | Mamta Steel Traders"
                description="Buy 36NiCrMo4 / 1.6511 / 35NCD4 high-strength nickel-chromium-molybdenum alloy steel round bars for crankshafts, drive shafts, and hydraulic rods. EN ISO 683-2. Mumbai supplier worldwide."
                keywords="36NiCrMo4 round bar, 1.6511 steel, 35NCD4 equivalent, 36NiCrMo4 chemical composition, Ni-Cr-Mo alloy steel, 36NiCrMo4 supplier India, buy 36NiCrMo4 Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/36nicrmo4-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">36NiCrMo4 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">36NiCrMo4 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.6511 / 35NCD4 – Ni-Cr-Mo Alloy Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Nickel-chromium-molybdenum steel for crankshafts, propulsion shafts, and high-strength structural applications.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="36NiCrMo4 Round Bar 1.6511 High Strength Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">36NiCrMo4 / 1.6511 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>36NiCrMo4</strong> (1.6511) is a Ni-Cr-Mo alloy steel known as <strong>35NCD4</strong> in France. With ~1% Ni, 0.8% Cr, and 0.2% Mo, it is a medium-high tensile grade (900–1100 MPa in Q+T condition) suitable for drive shafts, crankshafts, and connecting rods in medium-duty applications where a balance of strength, ductility, and impact resistance is needed.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 36NiCrMo4</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["36NiCrMo4 round bar", "1.6511 steel", "35NCD4 equivalent", "36NiCrMo4 chemical composition", "36NiCrMo4 vs 34CrNiMo6", "36NiCrMo4 supplier India", "buy 36NiCrMo4 Mumbai", "Ni-Cr-Mo shaft steel", "36NiCrMo4 tensile strength", "1.6511 steel bar India"].map((kw, i) => (
