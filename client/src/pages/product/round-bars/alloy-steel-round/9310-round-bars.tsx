...
export default function Grade9310RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.08", max: "0.13" },
        { element: "Silicon (Si)", min: "0.15", max: "0.35" },
        { element: "Manganese (Mn)", min: "0.45", max: "0.65" },
        { element: "Nickel (Ni)", min: "3.00", max: "3.50" },
        { element: "Chromium (Cr)", min: "1.00", max: "1.40" },
        { element: "Molybdenum (Mo)", min: "0.08", max: "0.15" },
    ];
    const equivGrades = [
        { country: "Specification", grade: "AMS 6265 / SAE 9310" },
        { country: "Germany / DIN (nearest)", grade: "15NiCr13 / 1.5752" },
        { country: "Japan / JIS (nearest)", grade: "SNC815" },
        { country: "UK / BS (nearest)", grade: "835M15" },
    ];
    const apps = ["Aerospace transmission gear sets", "Helicopter gearbox components", "Aviation power transmission", "High-toughness case-hardened shafts", "Military aircraft gears", "Race car differential gears", "High-impact engineering components", "Ring gears for aerospace drivetrains"];
    return (
        <>
            <ProductSEO
                title="9310 Round Bars (SAE 9310 / AMS 6265) – Aerospace High-Nickel Case Hardening Steel | Mamta Steel Traders"
                description="Buy SAE 9310 / AMS 6265 high-nickel case hardening steel round bars for aerospace transmission gears, helicopter components, and high-impact applications. Mumbai supplier and worldwide exporter."
                keywords="9310 round bar, SAE 9310, AMS 6265, 9310 aerospace steel, 9310 chemical composition, high nickel case hardening steel, 9310 supplier India, 9310 helicopter steel, buy 9310 bar"
                canonicalUrl="/product/round-bars/alloy-steel-round/9310-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">9310 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">9310 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">SAE 9310 / AMS 6265 – Aerospace Ni-Cr-Mo Gear Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">High-nickel aerospace case hardening steel for helicopter gearboxes, aircraft transmission gears, and high-impact critical components.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="9310 Round Bar SAE 9310 AMS 6265 Aerospace Gear Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                                <div className="absolute -top-4 -right-4 bg-gold-primary text-navy-primary px-4 py-2 rounded-lg font-bold shadow-xl">AMS 6265</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">SAE 9310 / AMS 6265 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>SAE 9310</strong> (AMS 6265) is a high-nickel (3–3.5%) Ni-Cr-Mo case hardening steel designed specifically for aerospace transmission and gearbox gears. Its exceptional core impact toughness (due to high nickel content) combined with achievable case hardnesses of 60–64 HRC makes it indispensable for helicopter gearboxes, fighter aircraft drivetrains, and critical aerospace gear applications where reliability is life-critical.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of SAE 9310</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["9310 round bar", "SAE 9310", "AMS 6265 steel", "9310 aerospace gear", "9310 vs 8620", "9310 helicopter gearbox", "9310 chemical composition", "9310 supplier India", "high nickel gear steel", "buy 9310 bar Mumbai"].map((kw, i) => (
