...
export default function Grade30CrNiMo8RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.26", max: "0.34" },
        { element: "Silicon (Si)", min: "0.15", max: "0.40" },
        { element: "Manganese (Mn)", min: "0.30", max: "0.60" },
        { element: "Nickel (Ni)", min: "1.80", max: "2.20" },
        { element: "Chromium (Cr)", min: "1.80", max: "2.20" },
        { element: "Molybdenum (Mo)", min: "0.30", max: "0.50" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "30CrNiMo8 / 1.6580" },
        { country: "USA / AISI", grade: "4330 / 4340 (nearest)" },
        { country: "Japan / JIS", grade: "SNCM447 (nearest)" },
        { country: "Standard", grade: "EN ISO 683-2" },
    ];
    const apps = ["Very large crankshafts for marine engines", "Nuclear reactor pressure vessel components", "Heavy-duty aerospace and defence parts", "Turbine rotors and generator shafts", "Large hydraulic press components", "Mining and quarrying heavy machinery", "Power station generator components", "Submarine drive components"];
    return (
        <>
            <ProductSEO
                title="30CrNiMo8 Round Bars (1.6580) – Ultra High Tensile Ni-Cr-Mo Steel | Mamta Steel Traders"
                description="Buy 30CrNiMo8 / 1.6580 ultra high tensile Ni-Cr-Mo alloy steel round bars for marine crankshafts, nuclear components, and heavy engineering. EN ISO 683-2. Mumbai supplier worldwide."
                keywords="30CrNiMo8 round bar, 1.6580 steel, 30CrNiMo8 chemical composition, ultra high tensile steel, marine crankshaft steel, nuclear steel bar, 30CrNiMo8 supplier India, buy 30CrNiMo8 bar"
                canonicalUrl="/product/round-bars/alloy-steel-round/30crni-mo8-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">30CrNiMo8 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">30CrNiMo8 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.6580 – Ultra High Tensile Ni-Cr-Mo Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Ultra-high tensile nickel-chromium-molybdenum steel for marine crankshafts, nuclear components, and the heaviest engineering applications.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="30CrNiMo8 Round Bar 1.6580 Ultra High Tensile Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                                <div className="absolute -top-4 -right-4 bg-gold-primary text-navy-primary px-4 py-2 rounded-lg font-bold shadow-xl">EN ISO 683</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">30CrNiMo8 / 1.6580 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>30CrNiMo8</strong> (1.6580) is an ultra-high-strength nickel-chromium-molybdenum steel that can reach tensile strengths in excess of 1200 MPa in the Q+T condition. Its very high alloy content (2% Ni, 2% Cr, 0.4% Mo) provides exceptional hardenability through very large cross-sections, making it suitable for marine engine crankshafts, large forged pressure vessels, and military components.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 30CrNiMo8</h3>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                                ...
                                <div className="mt-4 p-4 bg-gradient-to-r from-navy-primary to-navy-secondary text-white rounded-lg text-center">
                                    <p className="font-bold">Size: 50mm – 1000mm dia</p>
                                    <p className="text-gold-primary">EN ISO 683-2</p>
                                </div>
                            </div>
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["30CrNiMo8 round bar", "1.6580 steel", "30CrNiMo8 chemical composition", "ultra high tensile steel India", "marine crankshaft steel", "30CrNiMo8 supplier Mumbai", "30CrNiMo8 vs 34CrNiMo6", "buy 30CrNiMo8 bar", "1.6580 price", "30CrNiMo8 forged bar"].map((kw, i) => (
