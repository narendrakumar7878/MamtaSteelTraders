...
export default function SCM440RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.38", max: "0.43" },
        { element: "Silicon (Si)", min: "0.15", max: "0.35" },
        { element: "Manganese (Mn)", min: "0.60", max: "0.85" },
    ...
    const equivGrades = [
        ...
        { country: "USA / AISI", grade: "4140 / 4142" },
        { country: "UK / BS", grade: "708M40 / EN19" },
        { country: "China / GB", grade: "42CrMo" },
    ];
    const apps = ["Japanese automotive sector gears and shafts", "JIS-spec crankshafts and connecting rods", "Hydraulic cylinders and piston rods", "Die blocks and forging components", "Machine tool spindles and guides", "Drill collars and oil field equipment", "High-torque bolts and fasteners", "Structural engineering shafts"];
    return (
        <>
            <ProductSEO
                title="SCM440 Round Bars (JIS G4105 / 42CrMo4 / 4140) – Japanese Chrome Moly Steel | Mamta Steel Traders"
                description="Buy JIS SCM440 / 42CrMo4 / AISI 4140 chrome molybdenum alloy steel round bars for Japanese-spec automotive, oil field, and CNC engineering applications. Mumbai supplier worldwide."
                keywords="SCM440 round bar, JIS SCM440, SCM440 chemical composition, 42CrMo4 equivalent, 4140 equivalent Japan, SCM440 supplier India, buy SCM440 bar Mumbai, JIS G4105 steel"
                canonicalUrl="/product/round-bars/alloy-steel-round/scm440-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">SCM440 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">SCM440 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">JIS G4105 / 42CrMo4 / 4140 – Chrome Moly Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Japanese-standard chrome molybdenum steel equivalent to 42CrMo4 and AISI 4140 for automotive, oil field, and machine components.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="SCM440 Round Bar JIS G4105 Chrome Moly Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                                <div className="absolute -top-4 -right-4 bg-gold-primary text-navy-primary px-4 py-2 rounded-lg font-bold shadow-xl">JIS G4105</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">SCM440 / JIS G4105 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>JIS SCM440</strong> is Japan's premier chrome molybdenum alloy steel, closely equivalent to <strong>42CrMo4 (EN)</strong> and <strong>AISI 4140</strong>. The 440 designation refers to the targeted tensile strength class (440 HB quenched and tempered). It is widely specified by Japanese automotive OEMs for crankshafts, connecting rods, and transmission shafts, and is also used globally in JIS-specified oil field and machinery applications.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of SCM440</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["SCM440 round bar", "JIS SCM440", "SCM440 chemical composition", "42CrMo4 equivalent Japan", "4140 JIS equivalent", "SCM440 supplier India", "buy SCM440 bar Mumbai", "JIS G4105 steel bar", "SCM440 vs 42CrMo4", "SCM440 hardness"].map((kw, i) => (
