...
export default function Grade15CDV6RoundBars() {
    const comp = [
        ...
        { element: "Molybdenum (Mo)", min: "0.80", max: "1.10" },
        { element: "Vanadium (V)", min: "0.10", max: "0.20" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "1.7734 / 14CrMoV69" },
        { country: "France / AFNOR", grade: "15CDV6" },
        { country: "USA / AMS", grade: "AMS 6437" },
        { country: "UK / BS", grade: "BSGG Grade 4" },
    ];
    const apps = [
        "Aerospace structural components", "Rocket motor casings and satellite structures",
        "High-pressure gas containers", "Race car chassis and roll-cages",
        "Lightweight armour systems", "Precision engineering components",
        "Helicopter airframe structures", "Defence and military applications",
    ];
    return (
        <>
            <ProductSEO
                title="15CDV6 Round Bars (1.7734) – Aerospace Chrome Moly Vanadium Steel | Mamta Steel Traders"
                description="Buy 15CDV6 / 1.7734 round bars – chromium-molybdenum-vanadium alloy steel for aerospace, rocket casings, and defence. AMS 6437 certified. Mumbai supplier and global exporter."
                keywords="15CDV6 round bar, 1.7734 steel, 15CDV6 aerospace steel, chrome moly vanadium steel, AMS 6437, 15CDV6 chemical composition, 14CrMoV69 equivalent, buy 15CDV6 bar India"
                canonicalUrl="/product/round-bars/alloy-steel-round/15cdv6-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">15CDV6 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">15CDV6 (1.7734) Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">Chrome-Moly-Vanadium – Aerospace & Defence</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">High-strength weldable Cr-Mo-V alloy steel for aerospace structures, rocket casings, and defence applications.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="15CDV6 1.7734 Round Bar Aerospace Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                                <div className="absolute -top-4 -right-4 bg-gold-primary text-navy-primary px-4 py-2 rounded-lg font-bold shadow-xl">AMS 6437</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">15CDV6 / 1.7734 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300 mb-4"><strong>15CDV6</strong> (1.7734) is a chromium-molybdenum-vanadium (Cr-Mo-V) low alloy steel originally developed for the French aerospace industry. Its unique combination of vanadium addition with CrMo base gives it exceptional strength-to-weight ratio and excellent weldability without preheating for thin sections.</p>
                            <p className="text-gray-700 dark:text-gray-300">It achieves tensile strengths of 900–1100 MPa in the normalised and tempered condition, making it ideal for lightweight structural components in aerospace and defence where every gram counts.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 15CDV6</h3>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                                ...
                                <div className="mt-4 p-4 bg-gradient-to-r from-navy-primary to-navy-secondary text-white rounded-lg text-center">
                                    <p className="font-bold">Size: 10mm – 350mm dia</p>
                                    <p className="text-gold-primary font-semibold">AMS 6437 • EN 10083</p>
                                </div>
                            </div>
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["15CDV6 round bar", "1.7734 steel", "15CDV6 aerospace", "AMS 6437 bar", "chrome moly vanadium steel", "14CrMoV69 equivalent", "15CDV6 weldability", "buy 15CDV6 India", "15CDV6 tensile strength", "15CDV6 vs 4130"].map((kw, i) => (
