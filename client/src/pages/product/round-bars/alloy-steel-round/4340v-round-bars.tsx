...
export default function Grade4340VRoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.38", max: "0.43" },
        { element: "Silicon (Si)", min: "0.15", max: "0.35" },
        { element: "Manganese (Mn)", min: "0.65", max: "0.85" },
        { element: "Nickel (Ni)", min: "1.65", max: "2.00" },
        { element: "Chromium (Cr)", min: "0.70", max: "0.90" },
        { element: "Molybdenum (Mo)", min: "0.20", max: "0.30" },
        { element: "Vanadium (V)", min: "0.05", max: "0.10" },
    ];
    const equivGrades = [
        { country: "USA / AISI", grade: "4340V (Mod)" },
        { country: "Mil Spec", grade: "AMS 6414 / AMS 6415" },
        { country: "US Base Grade", grade: "AISI 4340" },
        { country: "Standard", grade: "ASTM A29 / AMS spec" },
    ];
    const apps = ["Aerospace landing gear components", "Critical aircraft structural members", "Military ordnance and armour parts", "Ultra-high strength drive shafts", "Turbine engine components", "High-performance race car components", "Rocket motor casings and housings", "Premium aerospace fasteners"];
    return (
        <>
            <ProductSEO
                title="4340V Round Bars (AISI 4340 Modified / AMS 6414) – Ultra High Strength Aerospace Steel | Mamta Steel Traders"
                description="Buy 4340V / AISI 4340 modified with vanadium aerospace alloy steel round bars for landing gear, ultra-high strength structural components, and military applications. AMS 6414/6415. Mumbai supplier worldwide."
                keywords="4340V round bar, AISI 4340 modified, AMS 6414, AMS 6415 bar, 4340V chemical composition, ultra high strength aerospace steel, 4340V vanadium, 4340V supplier India, buy 4340V bar"
                canonicalUrl="/product/round-bars/alloy-steel-round/4340v-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">4340V Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">4340V Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">AISI 4340 Modified + Vanadium / AMS 6414 – Aerospace Grade</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Ultra-high strength vanadium-modified 4340 steel for aerospace landing gear, military ordnance, and the most demanding structural applications.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="4340V Round Bar AMS 6414 Vanadium Modified 4340 Aerospace Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">4340V / AMS 6414 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>4340V</strong> (sometimes referred to as "Modified 4340" under AMS 6414/6415) is the standard 4340 Ni-Cr-Mo composition with a micro-vanadium addition (0.05–0.10%). Vanadium refines the austenite grain and improves fatigue resistance, making this grade preferred in aerospace (especially landing gear) and high-performance defence applications where the grain-refined microstructure delivers superior fracture toughness and fatigue strength at equivalent tensile levels (often 1400–1900 MPa+).</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 4340V</h3>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                                ...
                                <div className="mt-4 p-4 bg-gradient-to-r from-navy-primary to-navy-secondary text-white rounded-lg text-center">
                                    <p className="font-bold">Premium Grade | Cert. Available</p>
                                    <p className="text-gold-primary">AMS 6414 / AMS 6415</p>
                                </div>
                            </div>
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["4340V round bar", "AISI 4340 modified vanadium", "AMS 6414 bar", "AMS 6415 steel", "4340V vs 4340", "landing gear steel India", "4340V chemical composition", "4340V supplier India", "buy 4340V bar Mumbai", "ultra high strength aerospace steel India"].map((kw, i) => (
