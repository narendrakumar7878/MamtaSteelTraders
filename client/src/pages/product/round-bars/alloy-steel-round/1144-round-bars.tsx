...
export default function Grade1144RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.40", max: "0.48" },
        { element: "Manganese (Mn)", min: "1.35", max: "1.65" },
        { element: "Phosphorus (P)", min: "—", max: "0.040" },
        { element: "Sulfur (S)", min: "0.24", max: "0.33" },
        { element: "Resulfurized", min: "—", max: "Re-sulfurized" },
    ];
    const equivGrades = [
        { country: "USA / AISI / SAE", grade: "1144 (Stressproof)" },
        { country: "Trade Name", grade: "Stressproof® / Fatigue-Proof®" },
        { country: "Germany / DIN (nearest)", grade: "44SMn28 / 1.0762" },
        { country: "Japan / JIS (nearest)", grade: "SUM41" },
        { country: "Standard", grade: "ASTM A29 / A311" },
    ];
    const apps = ["Hydraulic cylinder piston and body rods", "Precision shafts and spindles", "Pump components and fittings", "CNC turned parts with high strength", "Keyways and driven couplings", "Moderate-stress bolts and threaded parts", "Industrial machinery shafts", "Compressor rod and guide rod"];
    return (
        <>
            <ProductSEO
                title="1144 Round Bars (Stressproof / AISI 1144) – High Strength Free Machining Steel | Mamta Steel Traders"
                description="Buy 1144 / Stressproof alloy steel round bars – high-strength free machining steel for hydraulic rods, precision shafts, and CNC components. ASTM A311. Mumbai supplier worldwide."
                keywords="1144 round bar, 1144 Stressproof, AISI 1144, 1144 free machining steel, 1144 chemical composition, ASTM A311 bar, 1144 supplier India, buy 1144 bar Mumbai, Stressproof bar India"
                canonicalUrl="/product/round-bars/alloy-steel-round/1144-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">1144 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">1144 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">AISI 1144 / Stressproof® – High Strength Free Machining</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">High-strength, free machining carbon steel for hydraulic cylinder rods, precision shafts, and CNC-turned components.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="1144 Stressproof Round Bar AISI 1144 Free Machining Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                                <div className="absolute -top-4 -right-4 bg-gold-primary text-navy-primary px-4 py-2 rounded-lg font-bold shadow-xl">ASTM A311</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">1144 / Stressproof Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>AISI 1144</strong> (marketed as Stressproof® or Fatigue-Proof®) is a re-sulfurized, medium-high carbon, high-manganese free machining steel. Compared to standard 1045, it provides approximately twice the machinability and yield strength of 100,000 psi (690 MPa) minimum in the stress-relieved condition. It is ideal for shafts, pump bodies, and hydraulic cylinder rods machined on CNC lathes and screw machines.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of AISI 1144</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["1144 round bar", "Stressproof bar", "AISI 1144", "ASTM A311", "1144 vs 1045", "1144 machinability", "1144 yield strength", "buy 1144 bar India", "free machining steel India", "1144 vs 4140 machinability"].map((kw, i) => (
