...
export default function Grade20MnCr5RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.17", max: "0.22" },
        { element: "Silicon (Si)", min: "0.15", max: "0.40" },
        { element: "Manganese (Mn)", min: "1.10", max: "1.40" },
        { element: "Chromium (Cr)", min: "1.00", max: "1.30" },
        { element: "Sulfur (S)", min: "—", max: "0.035" },
        { element: "Phosphorus (P)", min: "—", max: "0.025" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "20MnCr5 / 1.7147" },
        { country: "USA / AISI", grade: "5120 / 5115" },
        { country: "Japan / JIS", grade: "SCr420" },
        { country: "Sweden / SS", grade: "2127" },
        { country: "India / IS", grade: "20Cr1" },
    ];
    const apps = ["Automotive transmission gears (high volume)", "Camshafts and balance shafts", "Case-hardened pinion shafts", "Splined shafts for transmissions", "Piston pins and small shafts", "Precision gear components", "Chain sprockets", "Agricultural tractor gears"];
    return (
        <>
            <ProductSEO
                title="20MnCr5 Round Bars (1.7147 / 5120) – Case Hardening Mn-Cr Steel | Mamta Steel Traders"
                description="Buy 20MnCr5 / 1.7147 / AISI 5120 case hardening steel round bars for automotive transmission gears, camshafts, and splined shafts. EN 10084 standard. Mumbai supplier worldwide."
                keywords="20MnCr5 round bar, 1.7147 steel, AISI 5120 equivalent, SCr420, 20MnCr5 chemical composition, case hardening steel, automotive gear bar India, buy 20MnCr5 Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/20mncr5-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">20MnCr5 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">20MnCr5 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.7147 / AISI 5120 – Mn-Cr Case Hardening Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">High volume automotive case hardening Mn-Cr steel for transmission gears, camshafts, and precision splined shafts.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="20MnCr5 Round Bar 1.7147 Case Hardening Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">20MnCr5 / 1.7147 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>20MnCr5</strong> (1.7147) is a manganese-chromium case hardening steel with slightly higher manganese than 16MnCr5, giving it better hardenability for medium-section components. Equivalent to <strong>AISI 5120</strong> and <strong>SCr420 (JIS)</strong>. It is one of the most used gearbox and transmission steels in automotive manufacturing in Europe.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 20MnCr5 (1.7147)</h3>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                                ...
                                <div className="mt-4 p-4 bg-gradient-to-r from-navy-primary to-navy-secondary text-white rounded-lg text-center">
                                    <p className="font-bold">Size: 6mm – 350mm dia</p>
                                </div>
                            </div>
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["20MnCr5 round bar", "1.7147 steel bar", "AISI 5120 equivalent", "SCr420 bar India", "20MnCr5 vs 16MnCr5", "20MnCr5 case hardening", "20MnCr5 chemical composition", "buy 20MnCr5 Mumbai", "20MnCr5 price", "Mn-Cr gear steel India"].map((kw, i) => (
