...
export default function Grade34CrNiMo6RoundBars() {
    const comp = [
        { element: "Carbon (C)", min: "0.30", max: "0.38" },
        { element: "Silicon (Si)", min: "0.15", max: "0.40" },
        { element: "Manganese (Mn)", min: "0.50", max: "0.80" },
        { element: "Nickel (Ni)", min: "1.30", max: "1.70" },
        { element: "Chromium (Cr)", min: "1.30", max: "1.70" },
        { element: "Molybdenum (Mo)", min: "0.15", max: "0.30" },
    ];
    const equivGrades = [
        { country: "Germany / DIN / EN", grade: "34CrNiMo6 / 1.6582" },
        { country: "USA / AISI", grade: "4337 / 4340 (nearest)" },
        { country: "Japan / JIS", grade: "SNCM439" },
        { country: "Standard", grade: "EN ISO 683-2" },
    ];
    const apps = ["Large crankshafts for high-power engines", "Turbine shafts and rotor bodies", "Aircraft structural parts", "Hydraulic cylinders and piston rods", "Military armaments and ballistic components", "Heavy-duty machine tool spindles", "Marine propulsion shafts", "Railway axles and bogies"];
    return (
        <>
            <ProductSEO
                title="34CrNiMo6 Round Bars (1.6582) – High Strength Ni-Cr-Mo Steel | Mamta Steel Traders"
                description="Buy 34CrNiMo6 / 1.6582 high-strength Ni-Cr-Mo alloy steel round bars for heavy crankshafts, turbine shafts, and aircraft structures. EN ISO 683-2. Mumbai supplier worldwide."
                keywords="34CrNiMo6 round bar, 1.6582 steel, 34CrNiMo6 chemical composition, high strength Ni-Cr-Mo steel, crankshaft steel, turbine shaft steel, 34CrNiMo6 supplier India, buy 34CrNiMo6"
                canonicalUrl="/product/round-bars/alloy-steel-round/34crni-mo6-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">34CrNiMo6 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">34CrNiMo6 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">1.6582 – High Strength Ni-Cr-Mo Steel</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">High-strength Ni-Cr-Mo steel for crankshafts, turbine shafts, and high-stress structural applications.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="34CrNiMo6 Round Bar 1.6582 High Tensile Steel" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">34CrNiMo6 / 1.6582 Round Bar – Overview</h2>
                            <p className="text-gray-700 dark:text-gray-300"><strong>34CrNiMo6</strong> (1.6582) is a high-strength Ni-Cr-Mo alloy steel (European equivalent to AISI 4337/4340 range) for use in the quenched and tempered condition. Tensile strengths of 900–1100 MPa are routinely achieved. It is widely used for large crankshafts, turbine shafts, and high-stress aerospace structural components where both strength and toughness are critical.</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 34CrNiMo6</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">{["34CrNiMo6 round bar", "1.6582 steel", "34CrNiMo6 chemical composition", "crankshaft alloy steel", "34CrNiMo6 vs 36CrNiMo4", "buy 34CrNiMo6 Mumbai", "34CrNiMo6 supplier India", "turbine shaft steel bar", "1.6582 equivalent", "34CrNiMo6 mechanical properties"].map((kw, i) => (
