...
export default function Grade42CrMo4RoundBars() {
    ...
    const equivalentGrades = [
        ...
        { country: "UK / BS EN19", grade: "708M40" },
    ...
    const applications = [
        ...
        "Heavy-duty gears and gear shafts",
        "Oil and gas drill collars and tooling",
        "High-strength bolts, studs, and fasteners",
        "Aircraft structural components",
        "Mining equipment and rock drill steels",
    ...
    const specifications = [
        ...
        "DIN 17200 – Heat Treatable Steels",
        "ASTM A434 – Standard Specification for Steel Bars, Alloy",
        "Size Range: 6mm to 500mm diameter",
        "Condition: Annealed, Normalised, Q+T (Quenched & Tempered)",
        "Surface: Black, Bright, Peeled, Chrome plated",
    ];

    const features = [
        { icon: <Zap className="w-6 h-6" />, title: "High Tensile Strength", description: "Tensile strength up to 1100 MPa in Q+T condition" },
        { icon: <Settings className="w-6 h-6" />, title: "Deep Hardenability", description: "Excellent through-hardening for large cross-section components" },
        { icon: <CheckCircle className="w-6 h-6" />, title: "Fatigue Resistant", description: "Superior fatigue strength for rotating and dynamic applications" },
        { icon: <FileText className="w-6 h-6" />, title: "EN 10083 Certified", description: "Complies with EN 10083-3 quenched and tempered steel standard" },
    ];

    return (
        <>
            <ProductSEO
                title="42CrMo4 Round Bar (EN19 / 4140 / 1.7225) – High Tensile Alloy Steel | Mamta Steel Traders"
                description="Buy 42CrMo4 / 1.7225 / EN19 / 4140 alloy steel round bars. High tensile chrome-moly steel for crankshafts, gears, oilfield tools, and fasteners. 6mm–500mm dia. Mumbai supplier and worldwide exporter."
                keywords="42CrMo4 round bar, EN19 steel bar, 4140 equivalent, 1.7225 steel, SCM440 equivalent, 42CrMo4 chemical composition, high tensile steel bar, chrome moly steel, 42CrMo4 supplier India, buy 42CrMo4 Mumbai"
                canonicalUrl="/product/round-bars/alloy-steel-round/42crmo4-round-bars"
            />
                ...
                <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                            ...
                            <ArrowRight className="w-4 h-4 text-gray-400" />
                            <span className="text-navy-primary dark:text-gold-primary font-medium">42CrMo4 Round Bars</span>
                        </nav>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-4">
                ...
                <div className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 py-16 relative z-10">
                        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">42CrMo4 Round Bars
                                    <span className="block text-2xl text-gold-primary font-normal mt-2">EN19 / AISI 4140 / 1.7225</span>
                                </h1>
                                <p className="text-xl mb-8 text-gray-200">Versatile chrome-molybdenum alloy steel for high tensile strength and excellent hardenability in automotive, oil & gas, and machinery applications.</p>
                            ...
                            <div className="relative">
                                <img src={alloys_steel_mamta_steel_traders_img} alt="42CrMo4 Round Bar EN19 4140 1.7225" className="w-full rounded-xl shadow-2xl" loading="lazy" />
                                <div className="absolute -top-4 -right-4 bg-gold-primary text-navy-primary px-4 py-2 rounded-lg font-bold shadow-xl">EN 10083-3</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">42CrMo4 / EN19 / 4140 Round Bar – Overview</h2>
                            <div className="prose prose-lg max-w-none text-gray-700 dark:text-gray-300">
                                <p className="mb-4"><strong>42CrMo4 (1.7225)</strong> is one of the most widely used high-tensile alloy steels globally, known internationally as <strong>AISI 4140</strong>, <strong>EN19</strong> (BS), and <strong>SCM440</strong> (JIS). Its chromium and molybdenum alloying elements provide excellent hardenability, high tensile strength, good fatigue resistance, and toughness at elevated temperatures.</p>
                                <p className="mb-4">Available in quenched and tempered (Q+T) condition with tensile strengths from 700 MPa to over 1100 MPa, this grade is the workhorse material for demanding engineering applications worldwide.</p>
                                <div className="grid md:grid-cols-2 gap-6 mt-6">
                                    <div><h4 className="font-bold mb-2 text-navy-primary dark:text-gold-primary">Supply Conditions:</h4>
                                        <ul className="space-y-1 text-sm"><li>• Annealed / Normalised</li><li>• Quenched & Tempered (Q+T)</li><li>• Black, Bright, Peeled</li></ul>
                                    </div>
                                    <div><h4 className="font-bold mb-2 text-navy-primary dark:text-gold-primary">Material Forms:</h4>
                                        <ul className="space-y-1 text-sm"><li>• Rolled Round Bar</li><li>• Forged Round Bar</li><li>• Hydraulic Cylinder Bar</li><li>• Machined Components</li></ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">Chemical Composition of 42CrMo4 / 1.7225</h3>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                                <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-6">42CrMo4 Equivalent Grades Worldwide</h3>
                        ...
                        <div className="bg-gradient-to-r from-navy-primary to-navy-secondary rounded-xl p-8 text-white mb-12">
                            <h3 className="text-2xl font-bold mb-8 text-center">Applications of 42CrMo4 Round Bars</h3>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-8 mb-12">
                            ...
                            <div className="flex flex-wrap gap-2">{["42CrMo4 equivalent 4140", "EN19 round bar supplier", "1.7225 steel bar", "42CrMo4 chemical composition", "SCM440 equivalent", "42CrMo4 tensile strength", "chrome moly steel bar India", "42CrMo4 quenched tempered", "buy 42CrMo4 bar Mumbai", "42CrMo4 price per kg"].map((kw, i) => (
                                <span key={i} className="px-3 py-1 bg-navy-primary text-white text-xs rounded-full">{kw}</span>
                            ))}</div>
                        </div>
                        <div className="text-center">
                            <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-4">Get 42CrMo4 / EN19 / 4140 Round Bar Quote</h3>
                            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">Competitive pricing, fast delivery across India and worldwide exports.</p>
