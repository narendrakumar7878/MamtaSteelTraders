...
export default function ThirteenEightMoRoundBarsDetail() {
  const chemicalComposition = [
    { element: "Chromium (Cr)", value: "12.25 – 13.25%" },
    { element: "Nickel (Ni)", value: "7.5 – 8.5%" },
    { element: "Molybdenum (Mo)", value: "2.0 – 2.5%" },
    { element: "Aluminum (Al)", value: "0.9 – 1.35%" },
    { element: "Manganese (Mn)", value: "0.10% max" },
    { element: "Silicon (Si)", value: "0.10% max" },
    { element: "Iron (Fe)", value: "Balance" }
  ];

  const thermalProperties = [
    { property: "Density", value: "7.73 g/cm³" },
    { property: "Melting Range", value: "1404 – 1440°C" },
    { property: "Tensile Strength (H950)", value: "1517 MPa min" },
    { property: "Yield Strength (H950)", value: "1413 MPa min" },
    { property: "Fracture Toughness (K1c)", value: "Excellent" }
  ];

  return (
    <>
      <ProductSEO
        title="AMS 5629 13-8Mo Round Bars | UNS S13800 | XM-13 PH Steel Supplier"
        description="Premium AMS 5629 13-8Mo (UNS S13800) round bars. High-strength precipitation hardening stainless steel with exceptional toughness and stress corrosion resistance. Ideal for aerospace landing gear."
        keywords="ams 5629 13-8mo round bars, uns s13800 supplier mumbai, xm-13 stainless steel rods, 13-8 mo bars price, aerospace ph steel 13-8mo"
        canonicalUrl="/product/round-bars/precipitation-hardening-steel/13-8mo-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black font-black uppercase tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">13-8 Mo (UNS S13800)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10 text-white">
            <div className="max-w-4xl text-white">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic overflow-hidden scale-105">The Toughness Titan</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100 italic">13-8 Mo</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105 italic">The pinnacle of PH stainless steels, 13-8 Mo (XM-13) offers the highest combination of strength, toughness, and resistance to stress-corrosion cracking for critical aerospace structures.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black">
              <div className="lg:col-span-2 space-y-12 text-black">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md italic">13-8 Mo (UNS S13800), also known as XM-13, is a martensitic precipitation-hardening stainless steel that has excellent strength, high hardness, superior toughness, and good corrosion resistance. It is produced by vacuum induction melting (VIM) followed by electro-slag remelting (ESR) or vacuum arc remelting (VAR). This double melting practice yields a high degree of micro-cleanliness and exceptional transverse properties. Mamta Steel Traders supplies primary 13-8 Mo bars for landing gear, missile components, and high-performance aerospace structures.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Tensile (H950)</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">1517 MPa (Min)</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Toughness</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">High K1c Grade</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black">
                <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 h-fit italic border-2 border-navy-primary/5 hover:border-gold-primary/20 transition-all font-black text-black">
                  <h3 className="text-xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase border-b-2 border-gold-primary pb-2 underline decoration-gold-primary/10 transition-all transform hover:translate-x-2 font-black italic uppercase tracking-tighter italic">Critical Metrics</h3>
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline">
                      {["Aircraft Landing Gear", "Landing Bay Doors", "Missile Components", "Nuclear Engineering", "High-Stress Fasteners", "Petrochemical Parts"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic text-black font-black uppercase tracking-tighter italic">
           <div className="container mx-auto px-4 relative z-10 text-black">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic">Direct Supplier: 13-8 Mo Bars</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch 13-8 Mo (UNS S13800 / XM-13) round bars for the most demanding aerospace structural requirements. Double-melted (VIM + VAR/ESR) for ultimate micro-cleanliness. Global export ready.</p>
