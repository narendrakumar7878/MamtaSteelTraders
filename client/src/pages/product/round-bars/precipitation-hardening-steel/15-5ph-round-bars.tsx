...
export default function FifteenFivePHRoundBarsDetail() {
  const chemicalComposition = [
    { element: "Chromium (Cr)", value: "14.0 – 15.5%" },
    { element: "Nickel (Ni)", value: "3.5 – 5.5%" },
    { element: "Copper (Cu)", value: "2.5 – 4.5%" },
    { element: "Manganese (Mn)", value: "1.0% max" },
    { element: "Silicon (Si)", value: "1.0% max" },
    { element: "Niobium (Nb) + Ta", value: "0.15 – 0.45%" },
    { element: "Iron (Fe)", value: "Balance" }
  ];

  const thermalProperties = [
    { property: "Density", value: "7.78 g/cm³" },
    { property: "Melting Range", value: "1404 – 1440°C" },
    { property: "Tensile Strength (H900)", value: "1310 MPa min" },
    { property: "Yield Strength (H900)", value: "1172 MPa min" },
    { property: "Hardness (Rockwell C)", value: "40 – 47 HRC" }
  ];

  return (
    <>
      <ProductSEO
        title="15-5 PH Round Bars | UNS S15500 | AMS 5659 Stainless Steel Supplier"
        description="Premium 15-5 PH (UNS S15500 / AMS 5659) round bars. High-strength precipitation hardening stainless steel with superior transverse toughness. Ideal for aerospace and chemical processing."
        keywords="15-5 ph round bars, uns s15500 supplier mumbai, ams 5659 stainless rods price, 15-5ph bars chemical composition, high toughness ph steel"
        canonicalUrl="/product/round-bars/precipitation-hardening-steel/15-5ph-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black font-black uppercase tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">15-5 PH (UNS S15500)</span>
              </nav>
           </div>
        </div>
        <div className="container mx-auto px-4 py-4 text-black">
           <Link href="/product/round-bars/precipitation-hardening-steel" className="inline-flex items-center text-navy-primary dark:text-gold-primary hover:underline font-black uppercase text-xs">
              <ArrowLeft className="w-3 h-3 mr-2" /> Back to PH Hub
           </Link>
        </div>
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10 text-white">
            <div className="max-w-4xl text-white">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic overflow-hidden scale-105">The Transverse Toughness Expert</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100 italic">15-5 PH</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105 italic">The 'ferrite-free' variation of 17-4PH, 15-5 PH (UNS S15500) provides superior toughness and ductility in the transverse direction, critical for heavy structural loads.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black font-black uppercase tracking-tighter italic">
              <div className="lg:col-span-2 space-y-12 text-black font-black uppercase tracking-tighter italic">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md italic">15-5 PH (UNS S15500) is a martensitic precipitation-hardening stainless steel designed to have high strength and excellent corrosion resistance. It is a variant of the senior 17-4 PH alloy, but with a more balanced microstructure (ferrite-free) which leads to significantly improved toughness in the transverse direction. This makes it the preferred choice for heavy aerospace structural parts and components subject to multi-directional stress. Mamta Steel Traders supplies primary 15-5 PH bars under AMS 5659 for gears, shafts, and critical aircraft components.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase tracking-tighter italic">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase font-black uppercase tracking-tighter italic">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Tensile (H900)</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black uppercase tracking-tighter italic">1310 MPa (Min)</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase font-black uppercase tracking-tighter italic">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Microstructure</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black uppercase tracking-tighter italic">Ferrite-Free Grade</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black uppercase tracking-tighter italic">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline font-black uppercase tracking-tighter italic">
                      {["Heavy Structural Parts", "Aircraft Engine Mounts", "Gears and Shafting", "Valve Components", "Nuclear Reactor Parts", "Chemical Process Equipment"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic text-black font-black uppercase tracking-tighter italic">
           <div className="container mx-auto px-4 relative z-10 text-black">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic">Direct Supplier: 15-5PH Bars</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch 15-5 PH (UNS S15500 / AMS 5659) round bars for the world's most critical aerospace structures. Premium 'ferrite-free' metallurgy for superior transverse performance. Global export ready.</p>
