...
export default function AMS5643RoundBarsDetail() {
  const chemicalComposition = [
    { element: "Chromium (Cr)", value: "15.0 – 17.5%" },
    { element: "Nickel (Ni)", value: "3.0 – 5.0%" },
    { element: "Copper (Cu)", value: "3.0 – 5.0%" },
  ...
  const thermalProperties = [
    { property: "Density", value: "7.75 g/cm³" },
    { property: "Melting Range", value: "1404 – 1440°C" },
    { property: "Ams Spec", value: "AMS 5643" },
    { property: "Heat Treatment", value: "Solution Treated" },
    { property: "Hardness (Condition A)", value: "363 HB max" }
  ];

  return (
    <>
      <ProductSEO
        title="AMS 5643 17-4PH Round Bars | Aerospace Grade Stainless Steel | Mumbai"
        description="Premium AMS 5643 17-4PH round bars. Aerospace-certified precipitation hardening stainless steel. High-strength solution heat-treated rods for defense and aircraft components."
        keywords="ams 5643 17-4ph round bars, aerospace grade 17-4ph supplier, ams 5643 bars price mumbai, 17-4ph stainless rods ams 5643, certified aerospace ph steel"
        canonicalUrl="/product/round-bars/precipitation-hardening-steel/ams-5643-round-bars"
      />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic text-black">
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4 text-black font-black uppercase tracking-tighter italic">
              <nav className="flex items-center space-x-2 text-sm flex-wrap text-black font-black uppercase">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400 font-extrabold" />
                 <span className="text-navy-primary dark:text-gold-primary underline decoration-gold-primary decoration-2 underline-offset-4 italic tracking-tighter uppercase">AMS 5643 (17-4 PH)</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10 text-white">
            <div className="max-w-4xl text-white">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block shadow-lg italic overflow-hidden scale-105">The Aerospace Authority</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none underline decoration-gold-primary decoration-4 underline-offset-[12px] opacity-100 italic">AMS 5643</h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl opacity-90 leading-relaxed italic uppercase tracking-tighter scale-105 italic">Aerospace Material Specification AMS 5643 defines the highest quality standards for 17-4 PH stainless steel, ensuring material integrity for defense and high-altitude flight components.</p>
              <div className="flex flex-wrap gap-4 overflow-hidden">
                ...
                <a href="tel:+919819322576" className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-10 py-4 rounded-2xl font-bold transition-all backdrop-blur-sm italic tracking-tighter uppercase text-xl transform hover:scale-105 text-center shadow-lg italic">Aerospace Expert</a>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12 text-black">
              <div className="lg:col-span-2 space-y-12 text-black font-black uppercase tracking-tighter italic">
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 text-black font-black uppercase tracking-tighter italic">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic font-semibold p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl border-l-4 border-gold-primary uppercase tracking-tighter decoration-gold-primary/20 transition-all shadow-md italic">AMS 5643 is the aerospace classification for 17-4 PH. It specifies strict control over chemical composition and heat treatment processes to ensure uniform mechanical properties across different melt batches. This grade is typically supplied in the solution-treated condition (Condition A) and then precipitation-hardened by the end manufacturer to the required strength level (e.g., H900, H1025). Mamta Steel Traders supplies primary AMS 5643 bars for aircraft fasteners, landing gear assemblies, and defense missile parts.</p>
                   ...
                   <div className="relative z-10 font-bold uppercase tracking-tighter italic text-white font-black text-white">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 font-bold uppercase tracking-tighter italic text-white font-black text-white font-black uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">AMS Standard</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic">AMS 5643 Compliance</p>
                          </div>
                          <div className="p-6 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors shadow-sm transform hover:scale-105 transition-all text-white font-black uppercase">
                             <p className="text-gold-primary font-black uppercase text-[10px] tracking-widest mb-1 italic tracking-tighter underline">Certification</p>
                             <p className="text-xl font-black italic tracking-tighter text-white uppercase underline decoration-gold-primary decoration-4 underline-offset-4 italic font-black">Level 3.1 Certified</p>
                          </div>
                      </div>
                   </div>
              ...
              <div className="space-y-8 h-fit font-bold uppercase tracking-tighter italic text-black font-black">
                <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 h-fit italic border-2 border-navy-primary/5 hover:border-gold-primary/20 transition-all font-black text-black">
                  ...
                  <div className="space-y-6 font-bold uppercase tracking-tighter italic text-black font-black uppercase tracking-tighter italic font-black">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary group overflow-hidden h-fit border-4 border-white/5 hover:border-white/20 transition-all font-black">
                   ...
                   <div className="space-y-4 font-black italic uppercase tracking-tighter h-fit underline">
                      {["Aerospace Fasteners", "Landing Gear Parts", "Aircraft Assemblies", "Defense Propulsion", "Missile Structural Parts", "High-Stress Fittings"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 text-center relative overflow-hidden shadow-2xl h-fit font-black italic text-black font-black uppercase tracking-tighter italic font-black uppercase tracking-tighter italic">
           <div className="container mx-auto px-4 relative z-10 text-black">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase underline decoration-gold-primary decoration-4 underline-offset-8 scale-110 transition-transform duration-700 italic">Direct Supplier: AMS 5643 Bars</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-black italic tracking-tighter uppercase border-b border-navy-primary/5 pb-4 italic transform hover:scale-105 transition-all">Mamta Steel Traders delivers ready-to-dispatch AMS 5643 (17-4PH) round bars for critical aerospace and defense systems. Full aerospace-grade certification and traceability for aircraft assembly. Global export support.</p>
