...
export default function A2ToolSteel() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "0.95 – 1.05%" },
    { element: "Chromium (Cr)", value: "4.75 – 5.50%" },
    { element: "Molybdenum (Mo)", value: "0.90 – 1.40%" },
    { element: "Manganese (Mn)", value: "0.40 – 1.00%" },
    { element: "Vanadium (V)", value: "0.15 – 0.50%" },
    { element: "Silicon (Si)", value: "0.10 – 0.50%" }
  ];

  const equivalentGrades = [
    { country: "USA (AISI)", grade: "A2" },
    { country: "Germany (DIN)", grade: "1.2363 / X100CrMoV5" },
    { country: "Japan (JIS)", grade: "SKD12" },
    { country: "France (AFNOR)", grade: "Z100CDV5" }
  ];

  const thermalSpecs = [
    { process: "Forging", temp: "1050 – 900°C", desc: "Heat slowly. Do not forge below 900°C. Air cool slowly." },
    { process: "Annealing", temp: "800 – 850°C", desc: "Slow furnace cool. Max hardness 248 HB." },
    { process: "Hardening", temp: "930 – 970°C", desc: "Air quench. High through-hardening capability." },
    { process: "Tempering", temp: "150 – 500°C", desc: "Double tempering required for dimensional stability." }
  ];

  return (
    <>
      <ProductSEO
        title="A2 Tool Steel Round Bars & Plates | Air Hardening Steel | DIN 1.2363 | Mumbai India"
        description="Premium A2 tool steel supplier in Mumbai. High-quality air hardening tool steel with exceptional toughness and wear resistance. AISI A2, DIN 1.2363, SKD12 certified. Stockist of A2 round bars and flats."
        keywords="A2 tool steel, air hardening steel Mumbai, DIN 1.2363 steel, AISI A2 round bars, chrome molybdenum tool steel Mumbai, high toughness tool steel India"
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic tracking-wider">AISI A2 / DIN 1.2363</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block">Balanced Toughness & Wear</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none">A2 Tool Steel</h1>
              <p className="text-xl text-gray-200 mb-8 leading-relaxed max-w-2xl opacity-90 italic font-medium uppercase tracking-tight italic tracking-tighter italic">Versatile air-hardening alloy with exceptional cross-section through-hardening and impact strength.</p>
              <div className="flex flex-wrap gap-4">
                ...
                <a href="tel:+919819322576" className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-10 py-4 rounded-2xl font-bold transition-all backdrop-blur-sm italic tracking-tighter">Metallurgy Support</a>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2 space-y-12">
                ...
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed italic font-medium italic mb-8 italic italic tracking-tighter">AISI A2 (DIN 1.2363) is a versatile air-hardening tool steel that provides a unique balance of wear resistance and toughness. Its medium alloy content ensures excellent through-hardening in large sections and minimal dimensional change during heat treatment. It is an upgrade over O1 for applications requiring better edge retention and toughness.</p>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 h-fit">
                  <h3 className="text-xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase border-b border-gold-primary pb-2 underline tracking-wider">Equivalent Map</h3>
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary h-fit group">
                   <h3 className="text-2xl font-black mb-6 italic tracking-tighter uppercase italic tracking-tighter">Primary Use Segments</h3>
                   <div className="space-y-4">
                      {["Large Stamping Dies", "Punches & Gauge Heads", "Woodworking Tools", "Trimming Dies", "Lathe Center Heads", "Injection Mould Bases"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700">
           <div className="container mx-auto px-4 text-center">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase italic tracking-tighter">Secure High-Toughness A2 Tool Steel</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic italic tracking-tighter">Mamta Steel Traders is a leading stockist for A2 (Air Hardening) steels in Mumbai. Specialized grinding and custom thickness flats available on order.</p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                 <Link href="/contact" className="bg-navy-primary text-white px-12 py-5 rounded-3xl font-black hover:bg-navy-secondary transition-all shadow-xl italic tracking-tighter uppercase italic tracking-tighter">Bulk Pricing Estimate</Link>
                 <a href="mailto:naren@mamtasteel.com" className="border-4 border-navy-primary text-navy-primary px-12 py-5 rounded-3xl font-black hover:bg-gray-50 transition-all italic tracking-tighter uppercase italic tracking-tighter">Technical Sheet PDF</a>
              </div>
           </div>
        </section>
      </div>
