...
export default function D3ToolSteel() {
  const chemicalComposition = [
    { element: "Carbon (C)", value: "2.00 – 2.25%" },
    ...
    { element: "Sulphur (S)", value: "0.03% max" }
  ];

  const equivalentGrades = [
    { country: "USA (AISI)", grade: "D3" },
    { country: "Germany (DIN)", grade: "1.2080 / X210Cr12" },
    { country: "Japan (JIS)", grade: "SKD1" },
    { country: "UK (BS)", grade: "BD3" }
  ];

  const thermalSpecs = [
    { process: "Forging", temp: "1050 – 850°C", desc: "Heat slowly. Do not forge below 850°C. Cool slowly in sand." },
    { process: "Annealing", temp: "800 – 850°C", desc: "Hold for 2-4 hours. Furnace cool. Max hardness 250 HB." },
    { process: "Hardening", temp: "900 – 950°C", desc: "Oil quench. Martempering is recommended for complex tools." },
    { process: "Tempering", temp: "150 – 400°C", desc: "Double temper for maximum abrasion resistance." }
  ];

  return (
    <>
      <ProductSEO
        title="D3 Tool Steel (HCHCR) Round Bars & Plates | DIN 1.2080 | SKD1 | Mumbai India"
        description="Premium HCHCR-D3 tool steel supplier in Mumbai. High carbon high chromium die steel with extreme abrasion resistance. AISI D3, DIN 1.2080 certified. Expert stockist for heavy-duty blanking tools."
        keywords="D3 tool steel, HCHCR round bars, DIN 1.2080 steel, SKD1 equivalent Mumbai, high carbon die steel, abrasion resistant steel Mumbai, tool steel supplier India"
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-bold tracking-tighter italic">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
           <div className="container mx-auto px-4 py-4">
              <nav className="flex items-center space-x-2 text-sm flex-wrap gap-y-1">
                 ...
                 <ArrowRight className="w-4 h-4 text-gray-400" />
                 <span className="text-navy-primary dark:text-gold-primary font-bold italic tracking-wider">AISI D3 / DIN 1.2080</span>
              </nav>
           </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-navy-primary via-navy-secondary to-slate-800 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
              <span className="bg-gold-primary text-navy-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-6 inline-block">Extreme Abrasion Resistance</span>
              <h1 className="text-5xl md:text-7xl font-black mb-6 italic tracking-tighter uppercase leading-none">D3 Tool Steel</h1>
              <p className="text-xl text-gray-200 mb-8 leading-relaxed max-w-2xl opacity-90 italic font-medium uppercase tracking-tight italic tracking-tighter italic">Superior chromium-rich metallurgy for heavy-duty blanking and deep drawing applications.</p>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2 space-y-12">
                ...
                <div className="bg-white dark:bg-gray-800 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed italic font-medium italic mb-8 italic italic tracking-tighter">AISI D3 (DIN 1.2080) is an oil-hardening tool steel with a high concentration of carbon and chromium. It is specifically optimized for applications requiring maximum resistance to abrasion and surface pressure. Compared to D2, it provides higher hardness (up to 64 HRC) while maintaining excellent dimensional stability.</p>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-br from-gold-primary to-yellow-600 p-8 rounded-[2.5rem] shadow-2xl text-navy-primary h-fit group">
                   <h3 className="text-2xl font-black mb-6 italic tracking-tighter uppercase italic tracking-tighter">High Wear Applications</h3>
                   <div className="space-y-4">
                      {["Heavy Deep Drawing Tools", "Blanking Dies for Hard Metals", "Thread Rolling Dies", "Erosion Resistant Nozzles", "Plastic Mould Liners", "Shear Blades for Thick Sheet"].map((use, i) => (
        ...
        <section className="py-20 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700">
           <div className="container mx-auto px-4 text-center">
              <h2 className="text-4xl font-black text-navy-primary dark:text-white mb-6 italic tracking-tighter uppercase italic tracking-tighter">Ready to Deploy D3 Steel?</h2>
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto font-medium italic italic tracking-tighter">Mamta Steel Traders stocks genuine D3 (HCHCR) round bars and flats for immediate industrial shipment. Technical lab reports included with every batch.</p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                 <Link href="/contact" className="bg-navy-primary text-white px-12 py-5 rounded-3xl font-black hover:bg-navy-secondary transition-all shadow-xl italic tracking-tighter uppercase italic tracking-tighter">Get Batch Pricing</Link>
                 <a href="mailto:naren@mamtasteel.com" className="border-4 border-navy-primary text-navy-primary px-12 py-5 rounded-3xl font-black hover:bg-gray-50 transition-all italic tracking-tighter uppercase italic tracking-tighter">Download Technical Sheet</a>
              </div>
           </div>
        </section>
      </div>
