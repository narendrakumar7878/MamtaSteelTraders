    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="py-16 bg-gray-50" data-testid="welding-processes-section">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-2xl font-bold text-center text-navy-primary mb-12" data-testid="welding-processes-title">
        ...
        <section className="py-16 bg-gray-50" data-testid="api-grades-section">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-2xl font-bold text-center text-navy-primary mb-12" data-testid="api-grades-title">
