...
export default function SS347PipesDetail() {
  ...
  const applications = [
    ...
    "Welded Structures in Heat service",
    "Thermal Processing Equipment",
    "Nuclear Power Generation",
    "Exhaust Systems for Motors"
  ];
  ...
  return (
    <>
      <ProductSEO
        title="SS 347 Pipes & Tubes Stockist Mumbai - Niobium Stabilized Grade"
        description="Leading supplier of SS 347 Stainless Steel Pipes in Mumbai. Niobium stabilized ASTM A312 TP 347 pipes for extreme high-temperature and intergranular corrosion resistance. Mill certified stock."
        keywords="SS 347 pipes, 347 stainless steel pipe Mumbai, ASTM A312 TP 347, Niobium stabilized SS pipes, 347 seamless pipe price, 347 tube supplier India, SS 347 high heat"
        category="Pipes & Tubes"
        productName="Stainless Steel 347 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/stainless-steel/347-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 347 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Niobium Stabilized Durability</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 347 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A312 / ASME SA312 TP 347</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Niobium-stabilized austenitic stainless steel pipes specifically developed for prolonged service in the 800-1500°F (427-816°C) temperature range.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Get Custom Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="SS 347 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Priority Export Rates</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 347 / S34700
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Type 347 is a columbium (Niobium) stabilized austenitic stainless steel. Niobium addition prevents chromium carbide precipitation during welding and improves intergranular corrosion resistance. It is often used in heavy gauge welded equipment and in components operating at high temperatures where sensitization is a risk.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Superior protection against intergranular carbide precipitation.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Heat Resistance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Enhanced structural integrity in continuous 1500°F service.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Weld Synergy</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Perfect for components that cannot be post-weld annealed.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders ensures consistent availability of high-grade SS 347 Pipes. Our stabilized materials are trusted by leading thermal processing and petrochemical industries for their durability and intergranular corrosion resistance. Custom cutting and global shipping available.</p>
