...
import ss_pipe_img from "@/assets/SS ROUND BAR  MAMTA STEEL TRADERS.jpg"; // Using existing premium asset
import { Link } from "wouter";

export default function SS304PipesDetail() {
  ...
  return (
    <>
      <ProductSEO
        title="High Quality SS 304 Pipes & Tubes Supplier in Mumbai India"
        description="Leading stockist and supplier of SS 304 Stainless Steel Pipes in Mumbai. ASTM A312 TP 304 seamless and welded pipes. Best prices, ready stock, and mill certified. Global delivery from Mamta Steel Traders."
        keywords="SS 304 pipes, 304 stainless steel pipe supplier Mumbai, ASTM A312 TP 304, stainless steel 304 tube price India, SS 304 seamless pipe, 304 ERW pipe, SS 304 pipe dimensions, schedule 40 304 pipe"
        category="Pipes & Tubes"
        productName="Stainless Steel 304 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/stainless-steel/304-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 304 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">In Stock - Ready to Ship</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 304 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A312 / ASME SA312 TP 304</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Premium austenitic 304 stainless steel pipes offering exceptional corrosion resistance and mechanical strength for diverse industrial applications.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="SS 304 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 304 / S30400
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Stainless Steel 304 is the most popular grade of stainless steel because of its excellent corrosion resistance and value. It contains between 16 and 24 percent chromium and up to 35 percent nickel, as well as small amounts of carbon and manganese.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">S-Series Specs</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Full range of Sch 5S, 10S, 40S, 80S inventory.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent resistance to oxidizing environments.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Mechanical Edge</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Superior weldability and deep drawing properties.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders maintains the largest inventory of SS 304 Pipes in Mumbai. Whether you need standard schedules or custom cut pieces, our metallurgical experts provide precision solutions.</p>
