...
export default function SS310PipesDetail() {
  ...
  const equivalentGrades = [
    ...
    { country: "India / IS", grade: "Cr25Ni20" },
  ];

  const applications = [
    "Furnace Components & Parts",
  ...
  return (
    <>
      <ProductSEO
        title="SS 310 Pipes & Tubes Supplier in Mumbai India - High Temperature Grade"
        description="Leading stockist of SS 310 Stainless Steel Pipes in Mumbai. High temperature resistant ASTM A312 TP 310 pipes. Exceptional oxidation resistance. Get best prices from Mamta Steel Traders."
        keywords="SS 310 pipes, 310 stainless steel pipe Mumbai, ASTM A312 TP 310, high temperature SS pipes, 310 seamless pipe price, 310 ERW pipe supplier, SS 310 tube specs"
        category="Pipes & Tubes"
        productName="Stainless Steel 310 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/stainless-steel/310-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 310 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Ultra-High Temperature Resistant</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 310 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A312 / ASME SA312 TP 310</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Elite high-chromium-nickel steel pipes designed for extreme heat environments, offering outstanding oxidation resistance up to 2100°F (1150°C).
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center">
                    <Phone className="w-5 h-5 mr-3" /> Expert Consultation
                  </a>
                </div>
              </div>
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="SS 310 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Global Export Rates</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 310 / S31000
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Type 310 is a high chromium nickel austenitic stainless steel designed for use in high temperature applications. Its high chromium and nickel content provide comparable corrosion resistance, superior resistance to oxidation, and the retention of a larger fraction of room temperature strength than common austenitic alloys like Type 304.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Heat Endurance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Constant performance up to 1050°C.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent stability in sulfidizing environments.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Structural Integrity</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">High creep strength and performance.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is India's leading stockist of SS 310 Pipes. We provide mill-certified materials for critical thermal processing applications. Specialized sizes and schedules available for immediate dispatch.</p>
