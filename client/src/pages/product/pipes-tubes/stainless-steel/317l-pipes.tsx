...
export default function SS317LPipesDetail() {
  const chemicalComposition = [
    ...
    { element: "Nickel (Ni)", min: "11.00", max: "15.00" },
    { element: "Molybdenum (Mo)", min: "3.00", max: "4.00" },
  ];
  ...
  const equivalentGrades = [
    { country: "USA / AISI", grade: "317L / S31703" },
    { country: "Germany / DIN", grade: "1.4438" },
    { country: "Japan / JIS", grade: "SUS317L" },
    { country: "France / AFNOR", grade: "Z3CND19-15" },
    { country: "India / IS", grade: "03Cr19Ni13Mo3" },
  ];

  const applications = [
    "Heavy Gauge Welded Components",
    ...
    "Explosives and Fertilizer Plants"
  ];
  ...
  return (
    <>
      <ProductSEO
        title="SS 317L Pipes & Tubes Stockist Mumbai India - Low Carbon High Moly"
        description="Premium SS 317L Stainless Steel Pipes supplier in Mumbai. Low carbon ASTM A312 TP 317L pipes with high molybdenum content for exceptional resistance to chemical corrosion. Readily available stock."
        keywords="SS 317L pipes, 317L stainless steel pipe Mumbai, ASTM A312 TP 317L, FGD system pipes, low carbon SS pipes, 317L seamless pipe supplier India, SS 317L industrial tube"
        category="Pipes & Tubes"
        productName="Stainless Steel 317L Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/stainless-steel/317l-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 317L Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Low Carbon - Peak Chemical Resistance</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 317L Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A312 / ASME SA312 TP 317L</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Extra low-carbon austenitic stainless steel pipes with high molybdenum content, specially designed for superior service in aggresive corrosive and high-purity environments.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Quote for Bulk Orders
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="SS 317L Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 317L / S31703
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Type 317L is the low carbon version of 317. The lower carbon content provides resistance to sensitization during welding and other thermal processes. It offers higher creep, stress-to-rupture, and tensile strength at elevated temperatures than common stainless steels.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Fabrication Ease</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Low carbon content enables seamless welding of heavy gauge components.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Aggresive Environments</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional stability in urea and fertilizer plant processing.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Superior tensile strength at elevated thermal cycles.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Global Supply Chain - Ready Stock</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">As a premier supplier in Mumbai, Mamta Steel Traders provides the highest precision SS 317L Pipes globally. We specialize in complex schedules and low-carbon materials for the most demanding chemical processing environments.</p>
