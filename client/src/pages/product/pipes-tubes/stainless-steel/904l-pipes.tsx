...
export default function SS904LPipesDetail() {
  const chemicalComposition = [
    { element: "Carbon (C)", min: "—", max: "0.02" },
  ...
  const equivalentGrades = [
    ...
    { country: "Japan / JIS", grade: "SUS904L" },
    { country: "France / AFNOR", grade: "Z1NCDU25-20-04" },
    { country: "India / IS", grade: "02Cr20Ni25Mo4.5Cu" },
  ];

  const applications = [
    "Sulfuric Acid Processing Plants",
    ...
    "High Precision Gas Scrubbing"
  ];

  const specifications = [
    "ASTM A312 / ASME SA312",
    "Size: 1/8\" NB to 24\" NB",
    "Schedules: 5S, 10S, 40S, 80S, 160S, XXS",
  ...
  return (
    <>
      <ProductSEO
        title="SS 904L Pipes & Tubes Stockist Mumbai - Super Austenitic Grade"
        description="Premium SS 904L Stainless Steel Pipes supplier in Mumbai. High nickel, molybdenum, and copper ASTM A312 TP 904L pipes for extreme resistance to sulfuric acid and harsh chemicals. Ready stock."
        keywords="SS 904L pipes, 904L stainless steel pipe Mumbai, ASTM A312 TP 904L, sulfuric acid resistant pipes, super austenitic SS pipes, 904L seamless pipe price, 904L tube India"
        category="Pipes & Tubes"
        productName="Stainless Steel 904L Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/stainless-steel/904l-pipes"
      />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 904L Pipes</span>
            </nav>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <Link href="/product/pipes-tubes/stainless-steel-pipes-tubes" className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:underline font-semibold group" data-testid="back-button">
            ...
            Back to Stainless Steel Pipes & Tubes
          </Link>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Super-Austenitic Acid Resistance</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 904L Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A312 / ASME SA312 TP 904L</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  A elite high-alloy super-austenitic stainless steel pipe offering extraordinary resistance to non-oxidizing acids, particularly sulfuric acid, in the most demanding chemical environments.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Get Expert Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="SS 904L Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Wholesale Ex-Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Sulfuric Acid Expert</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Extraordinary stability in sulfuric and phosphoric acid service.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Complex Alloying</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">High Ni, Mo, and Cu for extreme chemical shielding.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Low Carbon Finish</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Minimized carbide precipitation for improved welded life.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">In-Stock Material</p>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Premium Inventory - Ex-Stock</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist of SS 904L Pipes in Mumbai. Our high-alloy super-austenitic materials are trusted by leading phosphate and fertilizer manufacturers globally. Precision testing and comprehensive certifications with every dispatch.</p>
