...
export default function SS304LPipesDetail() {
  ...
  const equivalentGrades = [
    ...
    { country: "France / AFNOR", grade: "Z3CN19-11" },
    { country: "India / IS", grade: "03Cr18Ni11" },
  ];

  const applications = [
    "Welded Structures in Corrosive Environments",
  ...
  return (
    <>
      <ProductSEO
        title="SS 304L Pipes & Tubes Stockist & Supplier Mumbai India"
        description="Premium SS 304L Stainless Steel Pipes supplier in Mumbai. Low carbon ASTM A312 TP 304L seamless and welded pipes. High corrosion resistance for welded applications. Ready stock, best prices."
        keywords="SS 304L pipes, 304L stainless steel pipe Mumbai, ASTM A312 TP 304L, low carbon SS pipes, 304L seamless pipe price, 304L ERW pipe supplier, SS 304L tube dimensions"
        category="Pipes & Tubes"
        productName="Stainless Steel 304L Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/stainless-steel/304l-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 304L Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Low Carbon - Enhanced Weldability</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 304L Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A312 / ASME SA312 TP 304L</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Superior low carbon stainless steel pipes designed to prevent carbide precipitation during welding, ensuring maximum corrosion resistance in welded structures.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Contact for Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="SS 304L Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Competitive Bulk Rates</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 304L / S30403
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Type 304L is the extra low-carbon version of the 304 steel alloy. The lower carbon content in 304L minimizes deleterious or harmful carbide precipitation as a result of welding, thus providing excellent resistance to intergranular corrosion.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Weld Performance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Perfect for heavy gauge welded components.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">ACID Resistance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent stability in oxidizing acid environments.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Mechanical Toughness</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional performance in cryogenic temperatures.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a leading stockist of SS 304L Pipes in Mumbai. Our inventory covers a vast range of schedules and sizes, ensuring immediate fulfillment of your chemical and industrial requirements.</p>
