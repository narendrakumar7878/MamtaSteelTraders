...
export default function SS321PipesDetail() {
  ...
  return (
    <>
      <ProductSEO
        title="SS 321 Pipes & Tubes Stockist Mumbai - Titanium Stabilized Grade"
        description="Premium SS 321 Stainless Steel Pipes supplier in Mumbai. Titanium stabilized ASTM A312 TP 321 pipes for excellent high-temperature performance and intergranular corrosion resistance. Ready stock."
        keywords="SS 321 pipes, 321 stainless steel pipe Mumbai, ASTM A312 TP 321, Titanium stabilized SS pipes, 321 seamless pipe price, 321 tube supplier India, SS 321 high temp"
        category="Pipes & Tubes"
        productName="Stainless Steel 321 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/stainless-steel/321-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">SS 321 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Titanium Stabilized Integrity</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  SS 321 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM A312 / ASME SA312 TP 321</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Elite titanium-stabilized austenitic stainless steel pipes engineered to withstand prolonged exposure to high temperatures (800-1500°F) without sensitization.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Quote Inquiry
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="SS 321 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: SS 321 / S32100
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Type 321 is similar to Type 304 but contains titanium addition. This titanium stabilizer prevents chromium carbide precipitation during welding and in service at temperatures between 427-816°C (800-1500°F). It is widely used in high-temperature environments where intergranular corrosion resistance is critical.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Prevents carbide precipitation during high-temp operations.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Corrosion Edge</h4>
                    ...
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Heat Endurance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent structural performance up to 1500°F.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is one of the most trusted suppliers of SS 321 Pipes in Mumbai. Our titanium-stabilized materials are chosen by leading aircraft and power-generation companies for critical heat-facing components. Fast shipping and bulk pricing available.</p>
