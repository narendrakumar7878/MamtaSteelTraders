...
export default function Inconel601PipesDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", min: "58.00", max: "63.00" },
    { element: "Chromium (Cr)", min: "21.00", max: "25.00" },
    { element: "Aluminum (Al)", min: "1.00", max: "1.70" },
  ...
  const equivalentGrades = [
    { country: "USA / UNS", grade: "N06601" },
    { country: "Germany / DIN", grade: "2.4851" },
    { country: "United Kingdom / BS", grade: "NA 49" },
    { country: "France / AFNOR", grade: "NC23FeA" },
    { country: "ASTM / ASME", grade: "B167 / SB167" },
  ];
  ...
  const applications = [
    ...
    "Waste Incineration Components",
    "Catalytic Grid Supports",
  ...
  return (
    <>
      <ProductSEO
        title="Inconel 601 Pipes & Tubes Stockist Mumbai - Heat Resistant Alloy"
        description="Premium Inconel 601 Pipes supplier in Mumbai. High temperature ASTM B167 UNS N06601 pipes with exceptional oxidation and carburization resistance. Ready stock, mill certified. Mamta Steel Traders."
        keywords="Inconel 601 pipes, Inconel 601 pipe Mumbai, UNS N06601 pipes, heat resistant nickel alloy, Inconel 601 seamless pipe price, Inconel 601 tube India"
        category="Pipes & Tubes"
        productName="Inconel 601 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/inconel/601-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Inconel 601 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Supreme Heat Shielding Alloy</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Inconel 601 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM B167 / UNS N06601</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   Ultra-high performance nickel-chromium-aluminum alloy pipes specifically designed for extreme resistance to high-temperature oxidation and aqueous corrosion.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="Inconel 601 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: Inconel 601 / N06601
                  </h2>
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Oxidation Barrier</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Unrivaled oxidation resistance through 2200°F (1204°C).</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Aluminum Armor</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Added Al provides superior resistance to high-temp spalling.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Aqueous Toughness</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional performance in aggressive aqueous environments.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Premium High-Temp Inventory</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a leading stockist of Inconel 601 Pipes in Mumbai. Our high-nickel-chromium alloys are preferred by global thermal processing and power generation firms for their unmatched oxidation resistance. Full mill certifications and worldwide logistics available.</p>
