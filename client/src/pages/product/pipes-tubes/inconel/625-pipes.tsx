...
export default function Inconel625PipesDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", min: "58.00", max: "—" },
    { element: "Chromium (Cr)", min: "20.00", max: "23.00" },
    { element: "Molybdenum (Mo)", min: "8.00", max: "10.00" },
    { element: "Niobium + Tantalum (Nb+Ta)", min: "3.15", max: "4.15" },
    { element: "Iron (Fe)", min: "—", max: "5.00" },
    { element: "Manganese (Mn)", min: "—", max: "0.50" },
    { element: "Carbon (C)", min: "—", max: "0.10" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "827" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "414" },
    { property: "Elongation (% in 50mm) min", value: "30" },
    { property: "Hardness (Rockwell B) max", value: "100" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "N06625" },
    { country: "Germany / DIN", grade: "2.4856" },
    { country: "United Kingdom / BS", grade: "NA 21" },
    { country: "France / AFNOR", grade: "NC22DMo9Nb" },
    { country: "ASTM / ASME", grade: "B444 / SB444" },
  ];
  ...
  const applications = [
    ...
    "Oil and Gas Pipelines (Sour Gas)",
    "Flare Stacks on Offshore Rigs",
  ...
  return (
    <>
      <ProductSEO
        title="Inconel 625 Pipes & Tubes Stockist Mumbai - High Performance Alloy"
        description="Premium Inconel 625 Pipes supplier in Mumbai. High strength ASTM B444 UNS N06625 pipes with outstanding resistance to seawater and aggressive chemicals. Best price, ready stock. Mamta Steel Traders."
        keywords="Inconel 625 pipes, Inconel 625 pipe Mumbai, UNS N06625 pipes, marine grade nickel alloy, Inconel 625 seamless pipe price, Inconel 625 tube India"
        category="Pipes & Tubes"
        productName="Inconel 625 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/inconel/625-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Inconel 625 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Elite Corrosion Protection</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Inconel 625 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM B444 / UNS N06625</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   Extreme performance nickel-chromium-molybdenum alloy pipes engineered for unmatched strength and resistance to pitting and crevice corrosion in the world's most aggressive environments.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Get Instant Quote
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="Inconel 625 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Seawater Expert</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Virtually immune to chloride-induced stress corrosion cracking.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Multi-Alloy Shield</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Nb and Mo additions provide extreme mechanical strength.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Fatigue Strength</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Superior fatigue and corrosion-fatigue strength.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist of Inconel 625 Pipes in Mumbai. Our high-performance nickel-chromium-molybdenum materials are preferred by global marine and aerospace firms for their unmatched corrosion resistance. Full mill certifications and precision logistics with every order.</p>
