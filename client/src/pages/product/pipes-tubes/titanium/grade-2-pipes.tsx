...
export default function TitaniumGrade2PipesDetail() {
  const chemicalComposition = [
    { element: "Titanium (Ti)", min: "Remainder", max: "—" },
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "345" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "275" },
    { property: "Elongation (% in 50mm) min", value: "20" },
    { property: "Hardness (Rockwell B) max", value: "80" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "R50400" },
    { country: "Germany / DIN", grade: "3.7035" },
    { country: "Japan / JIS", grade: "Class 2" },
    { country: "France / AFNOR", grade: "T40" },
    { country: "ASTM / ASME", grade: "B338 / SB338" },
  ];
  ...
  const applications = [
    ...
    "Marine Components & Hardware",
    "Aerospace Airframe Skins",
  ...
  return (
    <>
      <ProductSEO
        title="Titanium Grade 2 Pipes & Tubes Stockist Mumbai - Pure Titanium"
        description="Premium Titanium Grade 2 Pipes supplier in Mumbai. Commercially pure ASTM B338 UNS R50400 pipes offering ultimate corrosion resistance and high strength-to-weight ratio. Ready stock, best price."
        keywords="Titanium Grade 2 pipes, Titanium pipe Mumbai, UNS R50400 pipes, pure titanium tubes, high performance titanium India, titanium pipe price Mumbai"
        category="Pipes & Tubes"
        productName="Titanium Grade 2 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/titanium/grade-2-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Titanium Grade 2 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">The Corrosive-Immune Metal</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Titanium Grade 2 Pipes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM B338 / UNS R50400</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   Elite commercially pure titanium pipes offering the ultimate strength-to-weight ratio and a virtually indestructible resistance to seawater and pharmaceutical grade chemicals.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="Titanium Grade 2 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: Titanium Grade 2 / R50400
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Titanium Grade 2 is commercially pure titanium and is the most common grade of titanium used for industrial applications. It has excellent corrosion resistance in all types of environments, exceptional strength and excellent formability. It is widely used in marine and offshore sectors, desalination, and chemical processing where ultimate protection from seawater and aggressive media is mandatory.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Seawater Immune</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Naturally forms an oxide layer that is virtually indestructible in ocean service.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Light & Strong</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">45% lighter than steel with comparable tensile strength.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Bio-Compatible</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Non-reactive and safe for pharma and medical fluid processing.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">Material Availability</p>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Premium Titanium Stock</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist of Titanium Grade 2 Pipes in Mumbai. Our high-performance material is the elite choice for marine engineering and advanced chemical reactors where durability and weight are critical. Specialized testing and global logistics included.</p>
