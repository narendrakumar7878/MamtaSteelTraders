...
export default function Incoloy800HPipesDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", min: "30.00", max: "35.00" },
    { element: "Chromium (Cr)", min: "19.00", max: "23.00" },
    { element: "Carbon (C)", min: "0.05", max: "0.10" },
    { element: "Aluminum + Titanium (Al+Ti)", min: "0.85", max: "1.20" },
    { element: "Iron (Fe)", min: "39.50", max: "—" },
    { element: "Manganese (Mn)", min: "—", max: "1.50" },
    { element: "Silicon (Si)", min: "—", max: "1.00" },
    { element: "Grain Size", min: "ASTM 5 or coarser", max: "—" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "450" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "170" },
    { property: "Elongation (% in 50mm) min", value: "30" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "N08810" },
    { country: "Germany / DIN", grade: "1.4958" },
    { country: "United Kingdom / BS", grade: "NA 15H" },
    { country: "France / AFNOR", grade: "Z10NC32-21H" },
  ...
  const applications = [
    ...
    "Industrial Furnaces & Components",
    "Power Generation Boilers",
    "Hydrocarbon Cracking Tubing",
  ...
  return (
    <>
      <ProductSEO
        title="Incoloy 800H Pipes & Tubes Supplier Mumbai - High Creep Strength"
        description="Leading supplier of Incoloy 800H Pipes in Mumbai. Solution annealed ASTM B407 UNS N08810 pipes offering superior creep and rupture properties for extreme high-temp service. Ready stock, best price."
        keywords="Incoloy 800H pipes, Incoloy 800H pipe Mumbai, UNS N08810 pipes, high creep strength Incoloy, thermal processing pipes, Incoloy 800H seamless pipe price"
        category="Pipes & Tubes"
        productName="Incoloy 800H Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/incoloy/800h-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Incoloy 800H Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Optimized Creep Resistance</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Incoloy 800H Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM B407 / UNS N08810</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                    Elite solution-annealed nickel-iron-chromium pipes specifically engineered for superior creep-rupture performance at temperatures above 1100°F (600°C).
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Contact Specialist
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="Incoloy 800H Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Wholesale Stock Mumbai</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: Incoloy 800H / N08810
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Incoloy 800H is the same as Incoloy 800 except for a higher carbon content (0.05-0.10%) and the addition of aluminum and titanium. This modification combined with high-temperature annealing results in significantly higher creep and rupture strength than for alloy 800. It is primarily used at temperatures above 1100°F where resistance to creep and rupture is required.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Creep King</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Extraordinary resistance to creep deformation under load.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Carbon Boost</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Optimized carbon content for maximum high-temp structural life.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Grain Control</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">ASTM 5 or coarser grain size for peak rupture endurance.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">High-Temp Creep Specialists</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist of Incoloy 800H Pipes in Mumbai. Our high-performance materials are the industry standard for thermal power and chemical reactors requiring maximal rupture strength at peak operation. Full technical support and global logistics included.</p>
