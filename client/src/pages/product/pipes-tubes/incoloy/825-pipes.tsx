...
export default function Incoloy825PipesDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", min: "38.00", max: "46.00" },
    { element: "Chromium (Cr)", min: "19.50", max: "23.50" },
    { element: "Iron (Fe)", min: "22.00", max: "—" },
    { element: "Molybdenum (Mo)", min: "2.50", max: "3.50" },
    { element: "Copper (Cu)", min: "1.50", max: "3.00" },
    { element: "Titanium (Ti)", min: "0.60", max: "1.20" },
    { element: "Manganese (Mn)", min: "—", max: "1.00" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "586" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "241" },
    { property: "Elongation (% in 50mm) min", value: "30" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "N08825" },
    { country: "Germany / DIN", grade: "2.4858" },
    { country: "United Kingdom / BS", grade: "NA 16" },
    { country: "France / AFNOR", grade: "NC21FeDU" },
    { country: "ASTM / ASME", grade: "B423 / SB423" },
  ];

  const applications = [
    "Sulfuric Acid Piping & Components",
    "Oil and Gas Well Piping",
    "Nuclear Fuel Reprocessing Equipment",
    "Acid Production & pickling equipment",
  ...
  return (
    <>
      <ProductSEO
        title="Incoloy 825 Pipes & Tubes Stockist Mumbai - Acid Resistant Alloy"
        description="Premium Incoloy 825 Pipes supplier in Mumbai. Nickel-chromium-iron ASTM B423 UNS N08825 pipes with exceptional resistance to sulfuric and phosphoric acids. Ready stock, best pricing. Mamta Steel Traders."
        keywords="Incoloy 825 pipes, Incoloy 825 pipe Mumbai, UNS N08825 pipes, acid resistant nickel alloy, Incoloy 825 seamless pipe price, sulfuric acid pipes India"
        category="Pipes & Tubes"
        productName="Incoloy 825 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/incoloy/825-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Incoloy 825 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Premium Acid Shielding Alloy</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Incoloy 825 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM B423 / UNS N08825</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                    Superior nickel-chromium-iron-molybdenum alloy pipes offering extraordinary resistance to both reducing and oxidizing acids, particularly sulfuric and phosphoric acids.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="Incoloy 825 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: Incoloy 825 / N08825
                  </h2>
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Sulfuric Specialist</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Extraordinary stability in sulfuric acid concentrations of all types.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Ti-Stabilized</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Titanium addition prevents intergranular corrosion after welding.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Stress Shield</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Complete resistance to stress-corrosion cracking in chloride service.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Ex-Stock Acid Resistant Inventory</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a leading stockist of Incoloy 825 Pipes in Mumbai. Our high-nickel-chromium-iron materials are the industry benchmark for oil extraction and chemical reactors facing extreme acid corrosion. Precision certified with global shipping support.</p>
