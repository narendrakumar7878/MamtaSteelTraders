...
export default function Incoloy800PipesDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", min: "30.00", max: "35.00" },
    { element: "Chromium (Cr)", min: "19.00", max: "23.00" },
    { element: "Iron (Fe)", min: "39.50", max: "—" },
    { element: "Carbon (C)", min: "—", max: "0.10" },
    { element: "Aluminum (Al)", min: "0.15", max: "0.60" },
    { element: "Titanium (Ti)", min: "0.15", max: "0.60" },
    { element: "Silicon (Si)", min: "—", max: "1.00" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "520" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "205" },
    { property: "Elongation (% in 50mm) min", value: "30" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "N08800" },
    { country: "Germany / DIN", grade: "1.4876" },
    { country: "United Kingdom / BS", grade: "NA 15" },
    { country: "France / AFNOR", grade: "Z10NC32-21" },
    { country: "ASTM / ASME", grade: "B407 / SB407" },
  ];

  const applications = [
    "Heat Exchangers & Process Piping",
    "Carburizing Equipment Components",
  ...
  return (
    <>
      <ProductSEO
        title="Incoloy 800 Pipes & Tubes Supplier in Mumbai - High Temp Integrity"
        description="Premium Incoloy 800 Pipes supplier in Mumbai. Nickel-iron-chromium ASTM B407 UNS N08800 pipes for excellent structural strength and oxidation resistance at high temperatures. Ready stock, best price."
        keywords="Incoloy 800 pipes, Incoloy 800 pipe Mumbai, UNS N08800 pipes, high temp Incoloy, oxidation resistant pipes, Incoloy 800 seamless pipe price India"
        category="Pipes & Tubes"
        productName="Incoloy 800 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/incoloy/800-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Incoloy 800 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Standard High-Temp Incoloy</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Incoloy 800 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM B407 / UNS N08800</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                    Elite nickel-iron-chromium alloy pipes designed for maximum resistance to oxidation, carburization, and other high-temperature corrosion during prolonged service.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Professional Quote
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center">
                    <Phone className="w-5 h-5 mr-3" /> Technical Dept
                  </a>
                </div>
              </div>
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="Incoloy 800 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Ready Stock Mumbai</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: Incoloy 800 / N08800
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Incoloy 800 is widely used for equipment that must have high strength and resist oxidation, carburization, and other harmful effects of high-temperature exposure. For service requiring optimum creep and rupture properties, Incoloy 800H or 800HT are used. The chromium in the alloy imparts resistance to oxidation and corrosion. The high percentage of nickel maintains an austenitic structure so that the alloy is ductile.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Dual Resistance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Offers superior protection against both oxidation and carburization.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Maintains high structural integrity in continuous thermal cycling.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Austenitic Flow</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">High nickel content ensures excellent ductility and fabricability.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">Size Range Available</p>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Premium High-Nickel Stock</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a leading stockist of Incoloy 800 Pipes in Mumbai. Our high-performance nickel-iron-chromium materials are trusted by petrochemical and power generation leaders for their structural integrity under high heat. Full mill certifications and precision logistics support.</p>
