...
export default function HastelloyC22PipesDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", min: "Remainder", max: "—" },
    { element: "Chromium (Cr)", min: "20.00", max: "22.50" },
    { element: "Molybdenum (Mo)", min: "12.50", max: "14.50" },
    { element: "Iron (Fe)", min: "2.00", max: "6.00" },
    { element: "Tungsten (W)", min: "2.50", max: "3.50" },
  ...
  const mechanicalProperties = [
    ...
    { property: "Elongation (% in 50mm) min", value: "45" },
    { property: "Hardness (Rockwell B) max", value: "100" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "N06022" },
    { country: "Germany / DIN", grade: "2.4602" },
    { country: "Japan / JIS", grade: "NW 6022" },
    { country: "France / AFNOR", grade: "NC21FeD" },
    { country: "ASTM / ASME", grade: "B622 / SB622" },
  ];

  const applications = [
    "Pharmaceutical Processing equipment",
    "Chlorination Systems & Scrubbers",
    "Acid Production Utilities",
    "Marine Surface service",
  ...
  return (
    <>
      <ProductSEO
        title="Hastelloy C22 Pipes & Tubes Stockist Mumbai - Versatile Corrosion Alloy"
        description="Premium Hastelloy C22 Pipes supplier in Mumbai. High nickel-chromium ASTM B622 UNS N06022 pipes with exceptional resistance to both oxidizing and reducing environments. Best price, ready stock."
        keywords="Hastelloy C22 pipes, Hastelloy C22 pipe Mumbai, UNS N06022 pipes, C22 nickel alloy, oxidizing environment pipes, Hastelloy C22 tube price India"
        category="Pipes & Tubes"
        productName="Hastelloy C22 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/hastelloy/c22-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Hastelloy C22 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Total Environmental Resistance</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Hastelloy C22 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM B622 / UNS N06022</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   Elite nickel-chromium-molybdenum-tungsten superalloy pipes providing superior overall corrosion resistance compared to C-276 in both oxidizing and reducing media.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="Hastelloy C22 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Oxidation Expert</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional stability in mixtures containing nitric acid and chlorine ions.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Localized Defense</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Enhanced protection against pitting and crevice corrosion in harsh gaps.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Universal Synergy</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">The most versatile alloy for complex and mixed chemical streams.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist of Hastelloy C22 Pipes in Mumbai. Our high-performance nickel-chromium-molybdenum-tungsten materials are preferred by global pharmaceutical and chemical giants for their versatility in the most aggressive mixed streams. Full certifications and specialized logistics included.</p>
