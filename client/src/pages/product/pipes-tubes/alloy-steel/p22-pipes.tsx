...
export default function P22AlloySteelPipesDetail() {
  const chemicalComposition = [
    ...
    { element: "Chromium (Cr)", min: "1.90", max: "2.60" },
  ...
  const equivalentGrades = [
    { country: "USA / UNS", grade: "UNS K21590" },
    { country: "Germany / DIN", grade: "1.7380 / 10CrMo910" },
    { country: "Japan / JIS", grade: "STBA 24" },
    { country: "France / AFNOR", grade: "10 CD 9.10" },
    { country: "ASTM / ASME", grade: "A335 P22 / SA335 P22" },
  ];

  const applications = [
    "High-Temp Hydrogen Service",
    "Power Plant Main Steam Lines",
    "Hydro-Cracking Reformer Tubes",
    "Desulfurization Plant Fittings",
    "Heavy Wall Pressure Elements",
    "Petrochemical Slurry Piping",
    "Sub-critical Boiler Sections",
  ...
  const specifications = [
    ...
    "Special: 100% NDT & Hydrogen Service Testing"
  ];

  return (
    <>
      <ProductSEO
        title="ASTM A335 P22 Alloy Steel Pipes Stockist Mumbai - Hydrogen Service"
        description="Leading supplier of ASTM A335 Grade P22 Seamless Alloy Steel Pipes in Mumbai. Specialized 2.2Cr-1Mo alloy pipes for high-temperature hydrogen service and power plant applications."
        keywords="ASTM A335 P22 pipes, P22 alloy pipe Mumbai, A335 P22 seamless pipe price, 2.25Cr-1Mo alloy pipes India, high temp hydrogen service P22"
        category="Pipes & Tubes"
        productName="ASTM A335 Grade P22 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/alloy-steel/p22-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">ASTM A335 Grade P22</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">The Hydrogen Guard</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  ASTM A335 P22 Pipes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">2.25% Chromium-Molybdenum Seamless Alloy Steel</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   Engineered for extreme hydrogen service. Delivering superior resistance to high-temperature hydrogen attack (HTHA) and excellent creep-strength for critical refinery infrastructure.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={alloy_pipe_img} alt="ASTM A335 Grade P22 Alloy Steel Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Elite 2.25Cr Stockist</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: ASTM A335 / SA335 P22
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    ASTM A335 Grade P22 is a premium ferritic alloy steel pipe used for high-temperature service. Containing 2.25% chromium and 1% molybdenum, it is specifically recognized for its outstanding performance in high-temperature hydrogen service and its exceptional resistance to creep and graphitization. At Mamta Steel Traders, we verify every P22 batch for microstructure consistency, ensuring that our pipes deliver the structural integrity required for critical oil & gas reformers and power plant high-pressure conduits.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">HTHA Shield</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Proven resistance to High-Temperature Hydrogen Attack in refinery service.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Alloy Precision</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">2.25% Cr and 1% Mo content provides ultimate creep rupture strength.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Deep Security</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Ideal choice for heavy-wall conduits and desulfurization plant fittings.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Global P22 Alloy Leader</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist of ASTM A335 Grade P22 pipes in Mumbai, India. We specialize in providing HTHA-resistant and creep-stable alloy solutions for the world's largest refinery projects. Complete certification and logistics support for your high-pressure conduits.</p>
