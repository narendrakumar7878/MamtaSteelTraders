...
export default function P91AlloySteelPipesDetail() {
  ...
  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "585" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "415" },
    { property: "Elongation (%) min", value: "20" },
    { property: "Hardness (Brinell) range", value: "190 - 250" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "UNS K90901" },
    { country: "Germany / DIN", grade: "1.4903 / X10CrMoVNb9-1" },
    { country: "Japan / JIS", grade: "STBA 26 / STPA 26" },
    { country: "United Kingdom", grade: "BS 1503 629 590" },
    { country: "ASTM / ASME", grade: "A335 P91 / SA335 P91" },
  ];

  const applications = [
    "Ultra-Supercritical Power Plants",
    "High-Efficiency Steam Headers",
    "Combined Cycle Gas Turbines",
    "High-Pressure Reheater Lines",
    "Heat Recovery Steam Generators",
    "Advanced Chemical Process Units",
  ...
  const specifications = [
    ...
    "Type: Seamless (Modified 9Cr-1Mo-V-Nb)",
    "Condition: Normalized & Tempered (Precisely Controlled)",
    "Special: 100% NDT & Creep Rupture Validated"
  ];

  return (
    <>
      <ProductSEO
        title="ASTM A335 P91 Alloy Steel Pipes Stockist Mumbai - High Creep Strength"
        description="Premium ASTM A335 Grade P91 Seamless Alloy Steel Pipes supplier in Mumbai. Modified 9Cr-1Mo-V-Nb alloy for ultra-high temperature steam service in modern power plants."
        keywords="ASTM A335 P91 pipes, P91 alloy pipe Mumbai, A335 P91 seamless pipe price, 9Cr-1Mo-V-Nb alloy pipes India, high creep strength P91"
        category="Pipes & Tubes"
        productName="ASTM A335 Grade P91 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/alloy-steel/p91-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">ASTM A335 Grade P91</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Advanced Thermal Alloy</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  ASTM A335 P91 Pipes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">Modified 9Cr-1Mo-V-Nb Seamless Alloy Steel</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   The pinnacle of high-temperature service. Engineered with vanadium and niobium additions for exceptional creep-rupture strength in ultra-supercritical power plant environments.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={alloy_pipe_img} alt="ASTM A335 Grade P91 Alloy Steel Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Elite V-Nb Alloy Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: ASTM A335 / SA335 P91
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    ASTM A335 Grade P91 is an advanced ferritic/martensitic alloy steel pipe (Modified 9Cr-1Mo) enhanced with Vanadium (V) and Niobium (Nb), and controlled with Nitrogen (N). It is the premier choice for main steam and high-pressure steam headers in high-efficiency power plants. The addition of V and Nb creates stable carbonitrides that significantly enhance the material's long-term creep rupture strength. At Mamta Steel Traders, we strictly monitor the Heat Treatment cycles (Normalizing & Tempering) of our P91 inventory to ensure the precise martensitic microstructure essential for safe operations at temperatures up to 650°C.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Creep Champion</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Vanadium-Niobium micro-alloying provides market-leading thermal stability.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Efficiency Enabler</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Allows thinner wall designs in high-pressure steam headers compared to P22.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Complex Metallurgy</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Requires precise fabrication and PWHT expertise for maximum safety.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Global P91 Alloy Leader</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a specialized stockist of ASTM A335 Grade P91 pipes in Mumbai. We provide high-performance, traceble alloy solutions for ultra-supercritical energy projects. Full technical certification and PWHT guidance supported by decades of metallurgical experience.</p>
