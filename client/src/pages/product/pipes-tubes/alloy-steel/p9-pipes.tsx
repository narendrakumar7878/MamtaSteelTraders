...
export default function P9AlloySteelPipesDetail() {
  const chemicalComposition = [
    ...
    { element: "Silicon (Si)", min: "0.25", max: "1.00" },
  ...
  const mechanicalProperties = [
    ...
    { property: "Hardness (Brinell) max", value: "179" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "UNS K90941" },
    { country: "Germany / DIN", grade: "1.7386 / X12CrMo91" },
    { country: "Japan / JIS", grade: "STBA 26" },
    { country: "France / AFNOR", grade: "Z 10 CD 09 01" },
    { country: "ASTM / ASME", grade: "A335 P9 / SA335 P9" },
  ];
  ...
  const applications = [
    ...
    "Hydro-Cracking Facilities",
    "High-Temp Chemical Process",
    "Industrial Steam Transport"
  ];

  const specifications = [
    "Standard: ASTM A335 / ASME SA335",
    "Size: 1/2\" NB to 30\" NB",
    "Schedules: Sch 40 to Sch XXS",
    "Type: Seamless (Hot Finished / Cold Drawn)",
    "Condition: Normalized & Tempered / Isothermal Annealed",
    "Testing: Ultrasonics, Eddy Current & Hydro-Testing"
  ];

  return (
    <>
      <ProductSEO
        title="ASTM A335 P9 Alloy Steel Pipes Stockist Mumbai - 9Cr-1Mo High Temp"
        description="Premium ASTM A335 Grade P9 Seamless Alloy Steel Pipes supplier in Mumbai. Specialized 9% Chromium and 1% Molybdenum alloy pipes for extreme temperature and corrosion service."
        keywords="ASTM A335 P9 pipes, P9 alloy pipe Mumbai, A335 P9 seamless pipe price, 9Cr-1Mo alloy pipes India, high temp alloy steel P9"
        category="Pipes & Tubes"
        productName="ASTM A335 Grade P9 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/alloy-steel/p9-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">ASTM A335 Grade P9</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Reinforced Thermal Guard</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  ASTM A335 P9 Pipes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">9% Chromium-Molybdenum Elite Alloy Steel</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   Engineered for extreme environments. Delivering enhanced corrosion resistance and creep-rupture strength for high-pressure superheaters and critical energy infrastructure.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={alloy_pipe_img} alt="ASTM A335 Grade P9 Alloy Steel Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Premium 9Cr Stockist</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: ASTM A335 / SA335 P9
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    ASTM A335 Grade P9 is a distinguished ferritic alloy steel pipe designed for elevated temperature service. With a primary composition of 9% chromium and 1% molybdenum, it offers significantly superior oxidation and corrosion resistance compared to lower-chrome grades. At Mamta Steel Traders, we supply P9 pipes that are meticulously heat-treated to ensure maximum creep resistance, making them ideal for the most demanding sections of power plant boilers and hydrocarbon processing units.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Chrome-Moly Alloy</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">9% Cr content provides exceptional defense against high-temp oxidation.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Creep Resistance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">1% Mo addition guarantees structural integrity under high pressure and heat.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Superheater Grade</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Preferred selection for superheater and reheater tubes in modern boilers.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic">1/2" – 30"</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Global P9 Alloy Specialist</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist of ASTM A335 Grade P9 pipes in Mumbai. We provide fully traceble 9Cr-1Mo alloy solutions optimized for high-temperature stability and superior longevity in power and petrochemical sectors. Ready for global dispatch with full MTC support.</p>
