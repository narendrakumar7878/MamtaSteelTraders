...
export default function P11AlloySteelPipesDetail() {
  ...
  const equivalentGrades = [
    { country: "USA / UNS", grade: "UNS K11597" },
    { country: "Germany / DIN", grade: "1.7335 / 13CrMo44" },
    { country: "Japan / JIS", grade: "STBA 23" },
    { country: "France / AFNOR", grade: "15 CD 4.05" },
    { country: "ASTM / ASME", grade: "A335 P11 / SA335 P11" },
  ];

  const applications = [
    "High-Pressure Steam Conduits",
    "Power Station Reheater Lines",
    "Chemical Process Utilities",
    "Refinery Piping Systems",
    "Petrochemical Feed Lines",
    "Boiler Superheater Assemblies",
  ...
  const specifications = [
    ...
    "Condition: Normalized & Tempered / Full Annealed",
    "Testing: 100% PMI & Hydrostatic Testing"
  ];

  return (
    <>
      <ProductSEO
        title="ASTM A335 P11 Alloy Steel Pipes Stockist Mumbai - High Temp Service"
        description="Leading supplier of ASTM A335 Grade P11 Seamless Alloy Steel Pipes in Mumbai. Specialized 1.25Cr-0.5Mo alloy pipes for power plant and refinery applications. Premium certified stock."
        keywords="ASTM A335 P11 pipes, P11 alloy pipe Mumbai, A335 P11 seamless pipe price, 1.25Cr-0.5Mo alloy pipes India, high temp alloy steel P11"
        category="Pipes & Tubes"
        productName="ASTM A335 Grade P11 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/alloy-steel/p11-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">ASTM A335 Grade P11</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">The Industrial Standard</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  ASTM A335 P11 Pipes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">1.25% Chromium-Molybdenum Seamless Alloy Steel</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   Reliable thermal performance for global power generation. Engineered for enhanced creep resistance and structural stability in moderate-to-high temperature steam applications.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={alloy_pipe_img} alt="ASTM A335 Grade P11 Alloy Steel Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">High-Demand Grade Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: ASTM A335 / SA335 P11
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    ASTM A335 Grade P11 is a versatile low-alloy steel pipe containing 1.25% chromium and 0.5% molybdenum. It is one of the most widely used grades in the power industry for steam lines and boiler applications due to its excellent balance of mechanical strength, weldability, and cost-efficiency. At Mamta Steel Traders, we source P11 material that undergoes controlled cooling and tempering to ensure uniform microstructure, providing reliable performance in continuous high-temperature service up to 593°C.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Thermal Balance</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Engineered for optimal performance in moderate-to-high heat steam conduits.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Chromium Boost</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">1.25% Cr enhances long-term resistance to graphitization in steam service.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Reliable Joining</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Superior weldability for secure installations in high-pressure boiler networks.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic">1/2" – 48"</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Global P11 Alloy Stockist</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is the trusted supplier of ASTM A335 Grade P11 pipes in Mumbai, India. We maintain ready stock of large-diameter and heavy-wall pipes to support major boiler retrofits and refinery expansions worldwide. Fully certified for global safety standards.</p>
