...
export default function A53GradeBPipesDetail() {
  ...
  const equivalentGrades = [
    { country: "USA / UNS", grade: "UNS K03005" },
    { country: "Germany / DIN", grade: "St 42.2 / 1.0042" },
    { country: "Japan / JIS", grade: "SGP / STPY 400" },
    { country: "United Kingdom", grade: "BS 1387 Heavy" },
    { country: "ASTM / ASME", grade: "A53 Grade B / SA53 B" },
  ];

  const applications = [
    "General Water Line Distribution",
    "Compressed Air Systems",
    "Steam Lines (Moderate Temp/Pressure)",
    "Structural Support Columns",
    "Handrails and Fencing",
    "Gas Piping Infrastructure",
    "Industrial Plant Utility Lines",
    "HVAC Water Systems"
  ];

  const specifications = [
    "Standard: ASTM A53 / ASME SA53",
    "Type: S (Seamless), E (ERW), F (Furnace Welded)",
    "Size: 1/8\" NB to 26\" NB",
    "Condition: Black & Hot-Dipped Galvanized",
    "Schedules: STD, XS, XXS (Sch 10 to 160)",
    "Length: SRL, DRL & Custom"
  ];

  return (
    <>
      <ProductSEO
        title="ASTM A53 Grade B Steel Pipes Stockist Mumbai - Standard Pressure Pipes"
        description="Premium ASTM A53 Grade B Welded and Seamless Steel Pipes supplier in Mumbai. Specialized for general structural, gas, and water service. Black and Galvanized options ready stock."
        keywords="ASTM A53 Grade B pipes, A53 Gr B pipe Mumbai, general purpose steel pipes, A53 galvanized pipes price India, ASTM A53 seamless pipes"
        category="Pipes & Tubes"
        productName="ASTM A53 Grade B Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/carbon-steel/a53-grade-b"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">ASTM A53 Grade B</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">The Utility Workhorse</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  ASTM A53 Grade B Pipes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">Standard Specification for Welded and Seamless Steel Pipe</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   The versatile solution for standard structural and pressure applications. From gas lines to urban water infrastructure, providing reliable service and excellent durability across the board.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Bulk Inquiry
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center">
                    <Phone className="w-5 h-5 mr-3" /> Technical Help
                  </a>
                </div>
              </div>
              <div className="relative group">
                ...
                <img src={carbon_pipe_img} alt="ASTM A53 Grade B Steel Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest">Utility Standard</p>
                  <p className="text-white font-black text-xl italic uppercase">Black & Galvanized Ready</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: ASTM A53 Grade B / SA53 B
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    ASTM A53 Grade B is a ubiquitous steel pipe grade designed for ordinary uses in steam, water, gas, and air lines. It is suitable for welding and for operations involving coiling, bending, and flanging. Available in Type S (Seamless), Type E (Electric Resistance Welded), and Type F (Furnace Welded), it covers a wide spectrum of industrial and structural needs. At Mamta Steel Traders, we provide A53 Gr B pipes in both black and hot-dipped galvanized finishes, ensuring long-term corrosion protection for urban and industrial infrastructure.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Versatile Utility</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Standard choice for general industrial piping and structural supports.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Galvanized Option</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Hot-dipped zinc coating available for superior atmospheric protection.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Global Certs</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Fully certified to meet ASTM A53 and ASME SA53 standards.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">Standard Range</p>
                    <p className="text-4xl font-black text-gold-primary italic">1/8" – 26"</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Premium General Purpose Stock</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a leading stockist and supplier of ASTM A53 Grade B pipes in Mumbai. We provide high-quality black and galvanized steel solutions for architectural, structural, and low-pressure utility projects across India and the globe. Immediate dispatch with full Mill Test Certificates and compliance support.</p>
