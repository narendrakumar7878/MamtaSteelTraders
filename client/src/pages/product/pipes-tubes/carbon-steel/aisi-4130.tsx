...
export default function AISI4130PipesDetail() {
  ...
  const mechanicalProperties = [
    ...
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "415" },
    { property: "Elongation (%) min", value: "20" },
    { property: "Hardness (Brinell) max", value: "217" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "UNS G41300" },
    { country: "Germany / DIN", grade: "1.7218 / 25CrMo4" },
    { country: "Japan / JIS", grade: "SCM 430" },
    { country: "United Kingdom", grade: "BS 970 708M25" },
    { country: "ASTM / SAE", grade: "AISI 4130 / SAE 4130" },
  ];

  const applications = [
    "Aerospace Structural Tubing",
    "Oil & Gas Downhole Drilling",
    "High-Performance Automotive Chassis",
  ...
  const specifications = [
    "Standard: AISI 4130 / SAE 4130 / 1.7218",
    "Size Range: 1/4\" to 12\" OD",
    "Thickness: 0.5mm to 30mm",
    "Type: Seamless (Cold Drawn / Hot Rolled)",
    "Condition: Normalized / Quenched & Tempered",
    "Surface Finish: Black / Polished / Ground"
  ];

  return (
    <>
      <ProductSEO
        title="AISI 4130 Alloy Steel Pipes Stockist Mumbai - High Strength Chrome-Moly"
        description="Premium AISI 4130 / SAE 4130 Seamless Pipes supplier in Mumbai. High strength, chromium-molybdenum alloy steel pipes for aerospace, automotive, and oil-tool applications. Full MTC provided."
        keywords="AISI 4130 pipes, SAE 4130 pipe Mumbai, 4130 alloy steel pipes, chrome moly pipes price India, UNS G41300 pipes"
        category="Pipes & Tubes"
        productName="AISI 4130 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/carbon-steel/aisi-4130"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">AISI 4130 / SAE 4130</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">The Chrome-Moly Powerhouse</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  AISI 4130 Pipes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">High-Strength Chromium-Molybdenum Alloy Steel</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   Engineered for ultimate strength-to-weight ratio. Delivering superior toughness, weldability, and structural durability for aerospace, automotive, and deep-well drilling applications.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Alloy Inquiry
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center">
                    <Phone className="w-5 h-5 mr-3" /> Material Expert
                  </a>
                </div>
              </div>
              <div className="relative group">
                ...
                <img src={carbon_pipe_img} alt="AISI 4130 Alloy Steel Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest">Alloy Precision</p>
                  <p className="text-white font-black text-xl italic uppercase">High-Performance Chrome-Moly</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: AISI 4130 / 1.7218 / 25CrMo4
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    AISI 4130 is a low-alloy steel containing chromium and molybdenum as strengthening agents. It is known for its excellent weldability, toughness, and high fatigue strength. Often referred to as "Chrome-Moly," this grade is a staple in the aerospace industry for structural tubing and in the oil industry for high-stress drilling equipment. At Mamta Steel Traders, we provide 4130 pipes in various conditions—normalized, annealed, or quenched and tempered—to suit your mechanical design requirements perfectly.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Strength-to-Weight</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional mechanical resilience without the bulk of standard carbon steels.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Chrome-Moly Alloy</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Uniform alloy distribution providing consistent hardness and toughness.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Excellent welding response for complex structural fabrications.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">Standard OD</p>
                    <p className="text-4xl font-black text-gold-primary italic">1/4" – 12"</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Premium Alloy Steel Inventory</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a specialized supplier of AISI 4130 / SAE 4130 pipes in Mumbai. We provide precision-engineered alloy solutions for the world's most demanding aerospace and energy projects. Ready material with full traceability and certifications across global borders.</p>
