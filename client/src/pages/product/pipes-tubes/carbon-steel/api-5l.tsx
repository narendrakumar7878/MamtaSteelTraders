...
export default function API5LPipesDetail() {
  const chemicalComposition = [
    { element: "Carbon (C) max", min: "—", max: "0.26" },
    { element: "Manganese (Mn) max", min: "—", max: "1.40" },
    { element: "Phosphorus (P) max", min: "—", max: "0.030" },
    { element: "Sulfur (S) max", min: "—", max: "0.030" },
    { element: "Vanadium (V) max", min: "—", max: "0.06" },
    { element: "Niobium (Nb) max", min: "—", max: "0.05" },
    { element: "Titanium (Ti) max", min: "—", max: "0.04" },
  ];

  const mechanicalProperties = [
    { property: "Yield Strength (MPa) min", value: "245 - 485" },
    { property: "Tensile Strength (MPa) min", value: "415 - 635" },
    { property: "Elongation (%) min", value: "21" },
    { property: "Yield/Tensile Ratio max", value: "0.93 (PSL2)" },
  ];

  const equivalentGrades = [
    { country: "API 5L Grade B", grade: "L245" },
    { country: "API 5L X42", grade: "L290" },
    { country: "API 5L X52", grade: "L360" },
    { country: "API 5L X65", grade: "L450" },
    { country: "API 5L X70", grade: "L485" },
  ];
  ...
  const applications = [
    ...
    "Onshore Drilling Infrastructure",
    "Refinery Product Lines",
    "High-Pressure Hydrocarbon Piping"
  ];
  ...
  const specifications = [
    ...
    "Size: 1/2\" to 100\" NB",
    "Type: Seamless / ERW / LSAW / SSAW",
    "Wall Thickness: Sch 10 to Sch XXS",
    "Length: SRL, DRL, TRL & Custom"
  ];

  return (
    <>
      <ProductSEO
        title="API 5L Line Pipes Stockist Mumbai - PSL-1 & PSL-2 Grades"
        description="Leading supplier of API 5L Grade B, X42, X52, X65, X70 Line Pipes in Mumbai. Seamless and welded pipes for oil and gas transmission. PSL-2 high-test pipelines with full certification."
        keywords="API 5L pipes, API 5L X52 pipe Mumbai, API 5L X65 line pipe, PSL2 line pipes price India, API Spec 5L pipes"
        category="Pipes & Tubes"
        productName="API 5L Line Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/carbon-steel/api-5l"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">API 5L Line Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">The Energy Arteries</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  API 5L Line Pipes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">Standard-Spec High-Pressure Pipeline Infrastructure</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   The backbone of global oil and gas transmission. Engineered to meet API 5L PSL-1 and PSL-2 specifications, ensuring ultimate safety and performance in the most critical energy corridors.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Project Quote
                  </Link>
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center">
                    <Phone className="w-5 h-5 mr-3" /> Technical Advisor
                  </a>
                </div>
              </div>
              <div className="relative group">
                ...
                <img src={carbon_pipe_img} alt="API 5L Line Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest">Pipeline Grade</p>
                  <p className="text-white font-black text-xl italic uppercase">PSL-1 & PSL-2 Ready Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: API Spec 5L / ISO 3183
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    API 5L is the quintessential specification for line pipe intended for transportation of oil, gas, and water. Divided into PSL-1 (Standard) and PSL-2 (Enhanced), the latter includes more stringent requirements for chemical composition, notch toughness, and non-destructive testing. At Mamta Steel Traders, we stock a wide range from Grade B up to high-test X70. Each pipe is verified for yield-to-tensile ratios and fracture toughness to ensure stability in high-pressure hydrocarbon transport environments.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Energy Backbone</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Trusted global standard for long-distance hydrocarbon transmission.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">PSL-2 Precision</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Enhanced mechanical properties and testing for high-stress conduits.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Hydrostatic Tested</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Factory tested to maintain integrity under peak operational pressure.</p>
                    </div>
                  </div>
                </div>

                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
                  <h3 className="text-2xl font-bold text-navy-primary dark:text-white mb-8 uppercase text-center italic tracking-widest">Chemical Composition (Typical)</h3>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic">1/2" – 100"</p>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
                  <h3 className="text-xl font-bold text-navy-primary dark:text-white mb-6 uppercase border-b-2 border-navy-primary pb-2 inline-block italic tracking-widest">Line Grades</h3>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Global Energy Pipeline Partner</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a major stockist and supplier of API 5L Line Pipes in Mumbai. From local distribution to international energy transit projects, we provide the high-test steel required to power the world. Full project compliance and technical documentation support for PSR/PSL-2 pipelines.</p>
