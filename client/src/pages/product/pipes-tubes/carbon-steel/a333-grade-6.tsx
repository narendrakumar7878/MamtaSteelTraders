...
export default function A333Grade6PipesDetail() {
  ...
  const mechanicalProperties = [
    ...
    { property: "Impact Test Temp (°C)", value: "-45" },
    { property: "Impact Energy (J) min", value: "18" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "UNS K03006" },
    { country: "Germany / DIN", grade: "TTSt 35 N" },
    { country: "Japan / JIS", grade: "STPL 380" },
    { country: "France / AFNOR", grade: "TU 37 C" },
    { country: "ASTM / ASME", grade: "A333 Grade 6 / SA333 6" },
  ];

  const applications = [
    "Cryogenic Service Processing",
    "LNG Storage & Transport",
    "Natural Gas Liquefaction Plants",
    "Low Temperature Pressure Vessels",
    "Refrigeration Piping Systems",
    "Polar & Arctic Infrastructure",
    "Compressed Gas Handling",
    "Petrochemical Low-Temp Utilities"
  ];

  const specifications = [
    "Standard: ASTM A333 / ASME SA333",
    "Size: 1/2\" NB to 36\" NB",
    "Schedules: Sch 20, 40, 80, 160, XXS",
  ...
  return (
    <>
      <ProductSEO
        title="ASTM A333 Grade 6 Pipes Stockist Mumbai - Low Temperature Service"
        description="Premium ASTM A333 Grade 6 Seamless Pipes supplier in Mumbai. Specialized for low-temperature service down to -45°C. Impact tested carbon steel pipes for LNG and cryogenic applications."
        keywords="ASTM A333 Grade 6 pipes, A333 Gr 6 pipe Mumbai, low temperature carbon steel pipe, cryogenic pipes price India"
        category="Pipes & Tubes"
        productName="ASTM A333 Grade 6 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/carbon-steel/a333-grade-6"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">ASTM A333 Grade 6</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">The Cryogenic Specialist</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  ASTM A333 Grade 6 Pipes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">Elite Low-Temperature Seamless Carbon Steel</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                   Specifically designed for sub-zero impact resistance. Engineered for reliability in the most demanding cryogenic environments and LNG infrastructure globally.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Quote Request
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={carbon_pipe_img} alt="ASTM A333 Grade 6 Carbon Steel Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  <p className="text-gold-primary font-bold text-xs uppercase mb-1 tracking-widest">Impact Tested</p>
                  <p className="text-white font-black text-xl italic uppercase">-45°C Certified Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: ASTM A333 / SA333 Grade 6
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    ASTM A333 Grade 6 is the premier selection for nominal wall pipe intended for low-temperature service. Unlike standard carbon steel grades, A333 Gr 6 is mandated to undergo Charpy V-Notch impact testing to ensure toughness at sub-zero temperatures down to -45°C. At Mamta Steel Traders, we source material with fine-grain melting practices and specialized heat treatments (normalizing or quenching and tempering) to meet the most stringent safety regulations in the world.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Arctic Resilience</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Maintains remarkable structural toughness in extreme sub-zero conditions.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Impact Tested</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">100% certified Charpy V-Notch results provided with every shipment.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Cryo-Compatible</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Ideal for LNG systems and refrigeration utilities requiring high safety.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">Available Range</p>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Premium Low-Temp Stockist</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is the trusted name for ASTM A333 Grade 6 pipes in Mumbai. We provide fully certified, impact-tested solutions for global energy giants and cryogenic infrastructure projects. Seamless and welded inventory ready for immediate global dispatch.</p>
