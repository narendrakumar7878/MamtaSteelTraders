...
export default function Monel400PipesDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", min: "63.00", max: "—" },
    { element: "Copper (Cu)", min: "28.00", max: "34.00" },
    { element: "Iron (Fe)", min: "—", max: "2.50" },
    { element: "Manganese (Mn)", min: "—", max: "2.00" },
    { element: "Carbon (C)", min: "—", max: "0.30" },
    { element: "Silicon (Si)", min: "—", max: "0.50" },
    { element: "Sulfur (S)", min: "—", max: "0.024" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "480" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "195" },
    { property: "Elongation (% in 50mm) min", value: "35" },
    { property: "Hardness (Rockwell B) max", value: "75" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "N04400" },
    { country: "Germany / DIN", grade: "2.4360" },
    { country: "United Kingdom / BS", grade: "NA 13" },
    { country: "France / AFNOR", grade: "NU-30" },
    { country: "ASTM / ASME", grade: "B165 / SB165" },
  ];

  const applications = [
    "Marine Engineering & Shipbuilding",
    "Chemical Processing Equipment",
    "Hydrocarbon & Petrochemical Processing",
    "Heat Exchangers & Boilers",
    "Valves, Pumps & Shafts",
    "Electronic Components",
    "Industrial Solvent Processing",
    "Deep Sea Oil Well Components"
  ];
  ...
  return (
    <>
      <ProductSEO
        title="Monel 400 Pipes & Tubes Supplier in Mumbai - Nickel-Copper Alloy"
        description="Leading stockist of Monel 400 Pipes in Mumbai. ASTM B165 UNS N04400 seamless and welded pipes for extreme marine and chemical corrosion resistance. Best prices, ready stock. Mamta Steel Traders."
        keywords="Monel 400 pipes, Monel 400 pipe supplier Mumbai, ASTM B165 UNS N04400, marine grade pipes, nickel copper alloy pipes, Monel 400 seamless pipe price, Monel 400 tube India"
        category="Pipes & Tubes"
        productName="Monel 400 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/monel/400-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Monel 400 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Premium Marine Alloy</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Monel 400 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM B165 / UNS N04400</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  High-performance nickel-copper alloy pipes offering unmatched resistance to seawater and hydrofluoric acid for critical marine and chemical applications.
                </p>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="Monel 400 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Global Wholesale Stock</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: Monel 400 / N04400
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Monel 400 is a nickel-copper alloy that is hardened only by cold working. It has high strength and toughness over a wide temperature range and excellent resistance to many corrosive environments. 400 is widely used in many fields, especially marine and chemical processing.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Marine Master</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Extraordinary stability in seawater and rapid flow conditions.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Chemical Inertness</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Unrivaled resistance to hydrofluoric and sulfuric acids.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Toughness Edge</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional mechanical properties from sub-zero to 480°C.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    ...
                    <p className="text-4xl font-black text-gold-primary italic">1/8" – 12"</p>
                  </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Ex-Stock Material Availability</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist of Monel 400 Pipes in Mumbai. Our high-performance nickel-copper materials are trusted by leading marine and chemical processing firms for critical salt-water and acid environments. Fast delivery and competitive pricing.</p>
