...
export default function MonelK500PipesDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", min: "63.00", max: "—" },
    { element: "Copper (Cu)", min: "27.00", max: "33.00" },
    { element: "Aluminum (Al)", min: "2.30", max: "3.15" },
    { element: "Titanium (Ti)", min: "0.35", max: "0.85" },
    { element: "Iron (Fe)", min: "—", max: "2.00" },
    { element: "Manganese (Mn)", min: "—", max: "1.50" },
    { element: "Silicon (Si)", min: "—", max: "0.50" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "965" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "690" },
    { property: "Elongation (% in 50mm) min", value: "20" },
    { property: "Hardness (Brinell) min", value: "265" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "N05500" },
    { country: "Germany / DIN", grade: "2.4375" },
    { country: "United Kingdom / BS", grade: "NA 18" },
    { country: "France / AFNOR", grade: "NU-30 AT" },
    { country: "ASTM / ASME", grade: "B163 / SB163" },
  ];

  const applications = [
    "Oil Well Drill Collars & Instruments",
    "Marine Propeller & Pump Shafts",
    "Electronic Components & Springs",
    "Valve Components for Marine service",
    "Non-magnetic Housing for deep sea",
    "High-strength Boltings & Fasteners",
    "Doctor Blades & Scrapers",
  ...
  return (
    <>
      <ProductSEO
        title="Monel K500 Pipes & Tubes Supplier in Mumbai - High Strength Alloy"
        description="Premium Monel K500 Pipes supplier in Mumbai. High strength, non-magnetic ASTM B163 UNS N05500 pipes for oil & gas and marine equipment. Age-hardened alloy with superior toughness. Ready stock."
        keywords="Monel K500 pipes, Monel K500 pipe Mumbai, UNS N05500 pipes, high strength nickel pipes, age hardened Monel, Monel K500 tube price, marine shafting pipes"
        category="Pipes & Tubes"
        productName="Monel K500 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/monel/k500-pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Monel K500 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">Ultra-High Strength Alloy</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Monel K500 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM B163 / UNS N05500</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                  Precipitation-hardened nickel-copper alloy pipes providing exceptional strength, non-magnetic properties, and superior corrosion resistance for deep-sea and sub-surface exploration.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/contact" className="bg-gold-primary hover:bg-gold-secondary text-navy-primary px-8 py-4 rounded-xl font-bold transition-all hover:scale-105 shadow-xl inline-flex items-center justify-center group">
                    <Mail className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform" /> Price Quotation
                  </Link>
              ...
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="Monel K500 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
                <div className="absolute -bottom-6 -right-6 bg-navy-secondary border-2 border-gold-primary p-6 rounded-xl shadow-2xl hidden md:block backdrop-blur-md">
                  ...
                  <p className="text-white font-black text-xl italic uppercase">Specialized Stock Mumbai</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Age Hardened</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Enhanced mechanical properties via precipitation hardening.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Non-Magnetic</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Retains non-magnetic properties down to -101°C.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">Strength Edge</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Double the tensile and triple the yield strength of Alloy 400.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Specialized Alloy Inventory</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a niche stockist of high-strength Monel K500 Pipes in Mumbai. Our materials are preferred for critical oil drilling and marine propulsion systems requiring maximum mechanical performance. Precision engineering and full global compliance.</p>
