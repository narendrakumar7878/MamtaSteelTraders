...
export default function Alloy20PipesDetail() {
  const chemicalComposition = [
    { element: "Nickel (Ni)", min: "32.50", max: "35.00" },
    ...
    { element: "Niobium (Nb)", min: "8x C", max: "1.00" },
    { element: "Manganese (Mn)", min: "—", max: "2.00" },
    { element: "Carbon (C)", min: "—", max: "0.07" },
  ];

  const mechanicalProperties = [
    { property: "Tensile Strength (MPa) min", value: "550" },
    { property: "Yield Strength 0.2% Proof (MPa) min", value: "241" },
    { property: "Elongation (% in 50mm) min", value: "30" },
    { property: "Hardness (Rockwell B) max", value: "95" },
  ];

  const equivalentGrades = [
    { country: "USA / UNS", grade: "N08020" },
    { country: "Germany / DIN", grade: "2.4660" },
    { country: "ASTM / ASME", grade: "B729 / SB729" },
    { country: "Carpenter", grade: "20Cb-3" },
    { country: "CN7M", grade: "Cast equivalent" },
  ];

  const applications = [
    "Sulfuric Acid Production & Storage",
    "Chemical Processing Reactors",
    "Food and Dye Production Utilities",
  ...
  return (
    <>
      <ProductSEO
        title="Alloy 20 Pipes & Tubes Stockist Mumbai - Carpenter 20 Grade"
        description="Premium Alloy 20 Pipes supplier in Mumbai. High nickel-chromium-copper ASTM B729 UNS N08020 pipes specialized for hot sulfuric acid service. Ready stock, best pricing. Mamta Steel Traders."
        keywords="Alloy 20 pipes, Alloy 20 pipe Mumbai, UNS N08020 pipes, Carpenter 20 pipes, sulfuric acid resistant pipes, Alloy 20 seamless pipe price India"
        category="Pipes & Tubes"
        productName="Alloy 20 Pipes"
        specifications={specifications}
        canonicalUrl="/product/pipes-tubes/alloy-20/pipes"
      />
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-blue-600 dark:text-blue-400 font-medium tracking-tight">Alloy 20 Pipes</span>
            </nav>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="bg-gold-primary/20 text-gold-primary border border-gold-primary/30 px-4 py-1 text-xs uppercase tracking-widest rounded-full font-bold">The Sulfuric Acid Specialist</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 uppercase tracking-tight leading-tight">
                  Alloy 20 Pipes & Tubes
                  <span className="block text-2xl text-gold-primary font-normal mt-2 normal-case tracking-wide">ASTM B729 / UNS N08020</span>
                </h1>
                <p className="text-xl mb-8 text-blue-100 leading-relaxed max-w-xl font-light">
                    Elite columbium-stabilized nickel-chromium-copper alloy pipes engineered for maximum resistance to sulfuric acid and high-chloride environments.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="tel:+919819322576" className="border-2 border-white/30 hover:bg-white hover:text-navy-primary px-8 py-4 rounded-xl font-bold transition-all inline-flex items-center justify-center">
                    <Phone className="w-5 h-5 mr-3" /> Expert Assistance
                  </a>
                </div>
              </div>
              <div className="relative group">
                ...
                <img src={ss_pipe_img} alt="Alloy 20 Pipes" className="relative w-full rounded-2xl shadow-2xl border border-white/10 object-cover h-[400px]" />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-2xl font-bold text-navy-primary dark:text-white mb-6 border-b-2 border-gold-primary pb-2 inline-block uppercase italic tracking-tighter">
                    Grade Assessment: Alloy 20 / N08020
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8 font-light">
                    Alloy 20 is an austenitic, nickel-iron-chromium super alloy with additions of Copper and Molybdenum which provide resistance to hostile environments, pitting, and crevice corrosion. It is stabilized with Columbium to minimize carbide precipitation during welding. Alloy 20 was designed specifically for maximum resistance to acid attack, especially sulfuric acid.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-t-4 border-navy-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-blue-400 uppercase text-sm mb-2 italic tracking-widest">Acid Master</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Exceptional performance in hot sulfuric acid production streams.</p>
                    </div>
                    <div className="p-6 bg-gold-50 dark:bg-gold-900/10 rounded-xl border-t-4 border-gold-primary">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-gold-primary uppercase text-sm mb-2 italic tracking-widest">Columbium Stabilized</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Prevents intergranular corrosion in the heat-affected weld zones.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border-t-4 border-slate-900">
                      ...
                      <h4 className="font-bold text-navy-primary dark:text-white uppercase text-sm mb-2 italic tracking-widest">SCC Proof</h4>
                      <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Highly resistant to stress-corrosion cracking in chloride service.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="bg-navy-primary rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
                  ...
                  <div className="p-6 bg-white/10 rounded-xl mb-8 border border-white/20 text-center backdrop-blur-sm">
                    <p className="text-xs text-blue-300 uppercase tracking-widest mb-2 font-bold">In-Stock sizes</p>
            ...
            <div className="text-center bg-navy-primary p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-4xl font-black text-white mb-6 uppercase italic relative z-10 tracking-widest">Premium Acid-Spec Inventory</h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto relative z-10 text-lg font-light">Mamta Steel Traders is a premier stockist of Alloy 20 Pipes in Mumbai. Our high-performance Carpenter 20 grade materials are preferred by chemical and fertilizer manufacturers for their unmatched endurance in concentrated hot acid streams. Full mill certifications and precision logistics support.</p>
