...
export default function Navbar() {
  ...
  return (
    <nav className="bg-navy-secondary text-white shadow-lg">
                    ...
                    <div className="py-2">
                      ...
                      {mobileSubmenus.bars && (
                        <div className="ml-5 mt-1 space-y-1 animate-in slide-in-from-top duration-200">
                          ...
                          <Link href="/product/round-bars/alloy-steel-f-series" className="flex items-center py-1 text-xs font-semibold text-navy-primary hover:text-gold-primary" onClick={toggleMobileMenu} data-testid="mobile-link-alloy-steel-f-series">
                            Alloy Steel F Series
                          </Link>
                          <div className="ml-2 space-y-1">
                            ...
                            <Link href="/product/round-bars/f91-round-bars" className="flex items-center py-1 text-xs text-gray-600 hover:text-gold-primary" onClick={toggleMobileMenu} data-testid="mobile-link-f91-round-bars">
                              • F91 Round Bars
                            </Link>
                          </div>
